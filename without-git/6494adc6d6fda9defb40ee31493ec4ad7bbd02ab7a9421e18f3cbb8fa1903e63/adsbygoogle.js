    ...
    */
    ...
    function fn() {
        ...
        if (Q(Mh)) {
            ...
            if (!b.google_plmetrics && window.PerformanceObserver) {
                ...
                for (var c = b.next(); !c.done; c = b.next()) c = c.value, gn(a).observe({
                    type: c,
                    buffered: !0
                });
                hn(a)
    ...
    function pn(a, b, c) {
        ...
        if (document.hasTrustToken && !Q(Qh)) {
            ...
            window.goog_tt_state_map = window.goog_tt_state_map && window.goog_tt_state_map instanceof n.Map ? new n.Map([].concat(ma(e), ma(window.goog_tt_state_map))) : e;
            window.goog_tt_promise_map && window.goog_tt_promise_map instanceof n.Map || (window.goog_tt_promise_map =
                new n.Map)
        }
    }
    u(pn, uj);
    ...
    function xn(a) {
        if (document.hasTrustToken && !Q(Qh) && a.i) {
            ...
            if (b && b instanceof n.Map) {
                ...
                }) && (a = b.get(Y.issuerOrigin), a || (a = wn(), b.set(Y.issuerOrigin, a)), c.push(a));
