                ...
                return i(e, [{
                    ...
                    value: function() {
                        var t = o(n.mark((function t(r, o, a, i, u) {
                            var l, f, v, m, b, w, _, P, j, M, N, D, U, F, W, B, H, q, G, z, V, $, X, K, Q, Y, J, Z, ee, te, re, ne, oe, ae, ie, ue, ce, se;
                            return n.wrap((function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    ...
                                    case 61:
                                        ...
                                        if (W = h.parseRelativeUrl(U), B = W.pathname, H = g.getRouteRegex(F), q = y.getRouteMatcher(H)(B), z = (G = F === B) ? C(F, B, M) : {}, q && (!G || z.result)) {
                                            t.next = 76;
                                            break
                                        }
                                        ...
                                        throw new Error((G ? "The provided `href` (".concat(o, ") value is missing query values (").concat(V.join(", "), ") to be interpolated properly. ") : "The provided `as` value (".concat(B, ") is incompatible with the `href` value (").concat(F, "). ")) + "Read more: https://nextjs.org/docs/messages/".concat(G ? "href-interpolation-failed" : "incompatible-href-as"));
                                    case 74:
                                        t.next = 77;
                                        break;
                                    case 76:
                                        G ? a = p.formatWithValidation(Object.assign({}, W, {
                                            pathname: z.result,
                                            query: R(M, z.params)
                                        })) : Object.assign(M, q);
                                    case 77:
                                    ...
                                    case 81:
                                        if (X = t.sent, Q = (K = X).error, Y = K.props, J = K.__N_SSG, Z = K.__N_SSP, !J && !Z || !Y) {
                                            t.next = 107;
                                            break
                                        }
                                    ...
                                    case 106:
                                        X = t.sent;
                                    case 107:
                                        return e.events.emit("beforeHistoryChange", a, b), this.changeState(r, o, a, i), i._h && "/_error" === j && 500 === (null === (v = self.__NEXT_DATA__.props) || void 0 === v || null === ($ = v.pageProps) || void 0 === $ ? void 0 : $.statusCode) && (null === Y || void 0 === Y ? void 0 : Y.pageProps) && (Y.pageProps.statusCode = 500), ie = i.shallow && this.route === F, ce = null !== (ue = i.scroll) && void 0 !== ue ? ue : !ie, se = ce ? {
                                            x: 0,
                                            y: 0
                                        } : null, t.next = 116, this.set(F, j, M, w, X, null !== u && void 0 !== u ? u : se).catch((function(e) {
