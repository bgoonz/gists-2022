define("core/utils/getEmbeddedData", [], function() {
...
}), define("recommendations/tracking", ["jquery", "core/bus", "core/analytics/jester", "common/main", "recommendations/common"], function(a, b, c, d, e) {
    "use strict";
    ...
    function f(a) {
        var e = a.forum,
            f = e.get("id"),
            g = e.get("pk");
        a.session.user.id && c.client.set("user_id", a.session.user.id), a.session.on("change:id", function(a) {
...
}), define("common/utils", ["jquery", "underscore", "loglevel", "common/urls", "core/utils/cookies"], function(a, b, c, d, e) {
    "use strict";
    ...
    g.globalUniqueId = function(a) {
        ...
        function c() {
            ...
            for (var g = 0, h = a.length; g < h; g++) {
                var i = 1,
                    ...
                    k = j[0],
                    l = "";
                "[object Array]" === Object.prototype.toString.call(j[1][0]) && (j = j[1], i = 0);
        ...
        e.id = d, f.getElementsByTagName("head")[0].appendChild(e), window.createPopup || e.appendChild(f.createTextNode("")), c()
    };
    var h = g.CORS = {
    ...
    h.request = function() {
        return "withCredentials" in new window.XMLHttpRequest ? h.XHR2 : function() {
            return null
        }
    ...
    g.getPageHeight = function() {
        ...
        if (f.createEvent) {
            if (c = f.createEvent("MouseEvents"), b)
                for (d in g) g.hasOwnProperty(d) && b.hasOwnProperty(d) && (g[d] = b[d]);
            c.initMouseEvent("click", !0, !0, window, 0, 0, 0, 0, 0, g.ctrlKey, g.altKey, g.shiftKey, g.metaKey, 0, null), e.dispatchEvent && e.dispatchEvent(c)
        } else if (f.createEventObject) {
            if (c = f.createEventObject(), c.eventType = "click", b)
                for (d in g) g.hasOwnProperty(d) && b.hasOwnProperty(d) && (c[d] = b[d]);
            e.fireEvent("onclick", c)
        }
    }, g.delayLinkClick = function(a, c) {
        a.preventDefault(), b.delay(b.bind(g.triggerClick, this, c, a.originalEvent), 100)
    ...
    var j = /[<>]|:\/\//;
    return g.isPlainText = function(a) {
        return !a.match(j)
...
}), define("common/models", ["require", "underscore", "backbone", "modernizr", "core/UniqueModel", "core/models/User", "core/models/Forum", "core/utils/url/serialize", "core/utils/guid", "common/utils", "common/urls", "core/shared/urls", "backbone.uniquemodel"], function(a, b, c, d, e, f, g, h, i, j, k, l) {
    "use strict";
    var m = g.extend({
            defaults: {
                settings: {}
        ...
        n = c.Model.extend({
            ...
            set: function() {
                return this.lastModified = new Date, c.Model.prototype.set.apply(this, arguments)
            },
            sync: function() {
                var a = this.toJSON(),
            ...
            make: function(a) {
                return a.client_context || (a.client_context = i.generate()), new e(n, a)
            }
        });
...
}), define("common/collections/LoggedOutCache", ["backbone", "core/common/cached-storage"], function(a, b) {
    "use strict";
    var c = [{
            id: "welcome",
            title: "",
...
}), define("common/Session", ["jquery", "underscore", "core/analytics/jester", "core/api", "core/bus", "core/config", "common/models", "common/urls", "core/models/Session", "core/UniqueModel", "core/utils/cookies", "core/utils/url/serialize", "core/WindowBus", "common/keys", "common/utils", "common/collections/LoggedOutCache", "recommendations/common", "recommendations/tracking"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
    "use strict";
    var s, t = 3500,
        u = {},
        v = new m,
        w = i.extend({
                ...
                return c._request = d.call("embed/threadDetails.json", {
                    ...
                    success: function(a) {
                        ...
                        d.user && b.extend(f, d.user, {
                            votes: d.votes
                        }), c.set(d.session), f.id ? (c.setUser(new j(g.User, f)), e.users.add(c.user), d.thread && (e.set("userScore", d.thread.userScore), e.set("userSubscription", d.thread.userSubscription), e.set("userRating", d.thread.userRating))) : c.loginAsAnon(), d.blockedUsers && b.each(d.blockedUsers, function(a) {
                            new j(g.User, {
                                id: a
                            }).set({
                                isBlocked: !0
            ...
            authServices: b.defaults({
                ...
                sso: function x() {
                    ...
                    ! function f() {
                        o.isWindowClosed(d) ? e.frame.sendHostMessage("reload") : b.delay(f, 500)
                    }()
                }
...
}), define("recommendations/models", ["backbone", "moment", "core/time"], function(a, b, c) {
    "use strict";
    var d = function(a) {
        var d = a.prototype;
        return a.extend({
            ...
            initialize: function(a, d) {
                if (this.set("threadForum", a.forum), d && d.humanFriendlyTimestamp) {
            ...
            toString: function() {
                return "recommendations link: " + this.get("title") + " " + this.get("link") + " (id = " + this.id + ")"
            }
        })
    }(a.Model);
    return {
...
}), define("recommendations/collections", ["underscore", "backbone", "loglevel", "core/api", "core/utils/html", "recommendations/models"], function(a, b, c, d, e, f) {
    "use strict";
    var g = 1e4,
        h = b.Collection.extend({
            url: d.getURL("discovery/listTopPost.json"),
            parse: function(a) {
                for (var c = b.Collection.prototype.parse.call(this, a), d = 0, f = c.length; d < f; d++) c[d].plaintext = e.stripTags(c[d].message);
                return c
            }
        }),
        i = b.Collection.extend({
            ...
            initialize: function(a, b) {
                this.model = f.RelatedThread, this.forum = b.forum, this.minLength = b.minLength, this.maxLength = b.maxLength, this.settings = b.settings, this.featuredComments = b.featuredComments, this.forumUrl = b.forumUrl, this.identifier = b.identifier, this.threadUrl = b.threadUrl
            },
            ...
            fetch: function() {
                var a;
                this.identifier ? a = "ident:" + this.identifier : this.threadUrl && (a = "url:" + this.threadUrl);
                var d = {
                        timeout: g,
                        data: {
                            forum: this.forum,
                    ...
                    f = this;
                return this.featuredComments && (e = e.then(function() {
                    return f.getFeaturedPosts()["catch"](function(a) {
                        c.info("There was a problem fetching featured comments: ", a)
                    })
                })), e
            },
            parse: function(a) {
            ...
            validateThreads: function(a) {
                var b = this,
                    c = a.filter(function(a) {
                        return Boolean(a.id) && Boolean(a.images.length) && Boolean(a.title) && Boolean(a.description) && Boolean(a.url)
                    });
                return this.forumUrl ? (this.forumUrl = this.forumUrl.replace(/(^\w+:|^)\/\/(www\.)?/, "").split("/")[0].toLowerCase(), c.filter(function(a) {
            ...
            getFeaturedPosts: function() {
                ...
                var c = Promise.resolve(this.previews.fetch({
                    data: {
                        thread: b
                    },
    ...
    return j
}), define("recommendations/helpers", ["underscore", "jquery", "loglevel"], function(a, b, c) {
    "use strict";
    var d = function(d, e) {
            function f() {
                var a = .2;
            ...
            function g() {
                i.lastChild && !a.contains(["...", "…"], i.lastChild.nodeValue) && (l = i.appendChild(window.document.createTextNode(" " + o)), f() && (i.removeChild(l), i.removeChild(i.lastChild), g()))
            }
            if (!d.closest("body").length) return void c.info("lineTruncate called on el not on DOM");
            if (d.text().length < 1) return void c.info("lineTruncated called on empty el");
            var h = function(a) {
                return 3 !== a.nodeType
            };
            if (a.any(d.children(), h)) return void c.info("lineTruncate called on non-flat el");
            var i = d[0],
                j = i;
            if ("block" !== d.css("display"))
                for (; j.parentNode && (j = j.parentNode, "block" !== b(j).css("display")););
            ...
            if (f()) {
                ...
                if (p.length) {
                    ...
                    d.empty();
                    var u = s.length;
                    for (m = 0; m < u && (t += s[m].length + 1, !(t >= r)); m++) 0 !== m && (s[m] = " " + s[m]), i.appendChild(window.document.createTextNode(s[m]));
                    if (f())
                        for (; i.lastChild && f();) l = i.removeChild(i.lastChild);
                    else {
                        do l = i.appendChild(window.document.createTextNode(" " + s[m])), m += 1; while (!f() && m < u);
                        i.removeChild(l)
                    }
                    o && (a.isString(o) || (o = "…"), g())
                }
...
}), define("recommendations/models/Container", ["underscore", "backbone", "core/analytics/jester", "common/Session", "recommendations/helpers", "recommendations/models/State"], function(a, b, c, d, e, f) {
    "use strict";
    return b.Model.extend({
        initialize: function(b) {
            var c = this;
            c.app = b.app, c.threads = b.threads, c.collections = [], a.bindAll(c, "prepareData", "validateCollectionMin"), c.set("sectionNames", ["col-organic"]), c.set("sectionIds", a.map(c.get("sectionNames"), function(a) {
                return a + "-" + c.cid
            })), c.collections.push(this.threads), this.state = new f, c.threads && c.threads.each(function(a) {
                a.state = c.state
            })
        },
        validateCollectionMin: function() {
            for (var a = this.collections, b = this.get("sectionNames").slice(0), c = this.get("sectionIds").slice(0), d = a.length; d > 0;) {
                d -= 1;
                var e = a[d];
                e.length < e.minLength && (a.splice(d, 1), b.splice(d, 1), c.splice(d, 1), d = a.length)
            }
...
define("templates/recommendationsCollection", ["underscore", "react", "core/strings", "core/utils/object/get"], function(a, b, c, d) {
    "use strict";
    var e = c.gettext,
        f = function(c) {
        ...
        g = function(a) {
            ...
            return b.createElement("div", {
                ...
                className: "overlay"
            })), g.disableOverlay ? null : b.createElement("h3", {
                ...
                className: "meta"
            }, g.metaDate ? b.createElement("li", {
                className: "time"
            }, f.createdAgo) : null, " ", g.metaComments && f.posts > 0 ? b.createElement("li", {
                className: "comments"
            }, 1 === f.posts ? e("1 comment") : e("%(numPosts)s comments", {
                numPosts: f.posts
            }), " ") : null), g.contentPreview ? b.createElement(h, _extends({
                settings: g
            }, f)) : null, g.featuredComment && !g.contentPreview ? b.createElement(i, f) : null)
        },
        h = function(a) {
            return b.createElement("div", {
            ...
            }, a.settings.titleHidden || !a.settings.disableOverlay ? b.createElement("span", {
                "data-role": "recommend-description-snippet",
                className: "line-truncate",
                "data-line-truncate": "5"
            }, a.description) : b.createElement("h3", {
                className: "recommend-post-title",
                title: a.title
            }, b.createElement("span", {
                "data-role": "recommend-thread-title",
        ...
        i = function(a) {
            ...
            }, d(a.preview, ["author", "name"], null))), b.createElement("div", {
...
define("recommendations/views/links/BaseCollectionView", ["underscore", "jquery", "backbone", "react", "react-dom", "recommendations/helpers", "templates/recommendationsCollection"], function(a, b, c, d, e, f, g) {
    "use strict";
    var h = c.View.extend({
        events: {
        ...
        swapHref: function(b) {
            b.setAttribute("data-href", b.getAttribute("href")), b.setAttribute("href", b.getAttribute("data-redirect"));
            var c = 100;
            a.delay(function() {
        ...
        initialize: function(a) {
            this.app = a.model.app, this.initContext = a.context, this.settings = a.settings, this.adSupported = a.adSupported, this.elementsSelector = "div.recommend-post", this.$elements = this.$el.find(this.elementsSelector);
        ...
        metaPlacement: function() {
            ...
            c.length && "absolute" === b(c[0]).css("position") && a.each(c, function(a, c) {
                var e = 10,
                    f = e + "px";
                if (d.length) {
                    var g = b(d[c]),
        ...
        resizeImage: function(a) {
            var b = this.app.get("cardWidth"),
                ...
                d = 0,
                e = a.images[0];
            return e.width > b && e.height > c ? e.height < e.width ? (d = c / e.height, e.height = c, e.width *= d, e.url += "&h=" + e.height) : (d = b / e.width, e.width = b, e.height *= d, e.url += "&w=" + e.width) : e.size || (e.url += "&h=" + c), a.image = e, a
        },
        getTemplateContext: function() {
            this.appContext || (this.appContext = this.model.app.toJSON()), this.settings = a.extend(this.settings, this.appContext);
            var b = a.extend({
            ...
            if (d) {
                ...
                a.each(b.collection, function(a) {
                    a.advertisement_id = a[f], a.domIdSuffix = a[f], a.domIdSuffix = e + a.domIdSuffix, a.recommendationLink = a.url
                })
            }
            return b
        },
        onImageError: function(a) {
            a.target.src = "https://c.disquscdn.com/next/recommendations/assets/img/img-placeholder.df52e7638153b73862008d3d0556fdda.png"
        },
        render: function() {
            var a = this.getTemplateContext();
            return this.el.children.length || e.render(d.createElement(g, _extends({
                onError: this.onImageError
            }, a)), this.el), this.$elements = this.$el.find(this.elementsSelector), this.truncate(), this.metaPlacement(), this
        },
    ...
    return h
}), define("templates/recommendationsMain", ["underscore", "react", "core/strings", "core/utils/object/get"], function(a, b, c, d) {
    "use strict";
    var e = c.gettext,
        f = function(c) {
            var f = c.settings.contentPreview ? "" : "no-preview";
            f = c.settings.titleHidden || !c.settings.disableOverlay ? f : "has-preview-title";
            var g = c.settings.metaDate || c.settings.metaComments ? "" : "no-meta";
            return b.createElement("div", {
                id: c.id,
                className: "recommend-main " + f + " " + g
            }, a.map(c.sections, function(a) {
                return b.createElement("section", {
                    id: a.id,
                    ...
                    forumName: b.createElement("strong", {
    ...
    return f
}), define("recommendations/views/links/MainView", ["jquery", "underscore", "backbone", "core/bus", "recommendations/views/links/BaseCollectionView", "templates/recommendationsMain"], function(a, b, c, d, e, f) {
    "use strict";
    var g = c.View.extend({
        events: {
        ...
        initialize: function(a) {
            a = a || {}, this.settings = a.settings, this.adSupported = a.adSupported
        },
        handleClick: function(b) {
            var c = a(b.currentTarget),
                e = c.data("link");
            d.trigger("uiAction:recommendationsClick", e), b.stopPropagation(), window.open(e, "_blank")
        },
        ...
        render: function() {
            var c = this;
            return c.model.validateData(), c.renderViews(), c.resizeHandler = b.debounce(function() {
                c.views && b.invoke(c.views, "render")
            }, 100), a(window).on("resize", c.resizeHandler), this
        },
        renderViews: function() {
            var c = this.getTemplateContext(),
                d = this;
            c.settings = d.settings, c.adSupported = d.adSupported, this.$el.html(f(c)), this.$el.addClass("recommendations-wrapper");
        ...
        remove: function() {
            c.View.prototype.remove.call(this), this.resizeHandler && a(window).off("resize", this.resizeHandler)
        }
    });
    return g
}), define("recommendations/views/Placement", ["backbone", "core/bus", "common/utils", "recommendations/views/links/MainView"], function(a, b, c, d) {
    "use strict";
    var e = a.View.extend({
        className: "post-list",
        initialize: function(a) {
            a = a || {}, this.placement = a.placement, this.settings = a.settings, this.adSupported = a.adSupported, this.threadUrl = a.threadUrl, this._enabled = !0, this._collapse()
        },
        setRequestBin: function(a) {
            this._bin = a
        },
        tryPlacement: function(a) {
            this._unsetView(), a.state.set("placement", this.placement), this._recommendations = new d({
                model: a,
                settings: this.settings,
                adSupported: this.adSupported
            }), this.$el.html(this._recommendations.el), this._recommendations.render(), this._expand()
        },
        ...
        remove: function() {
            return this._unsetView(), a.View.prototype.remove.apply(this, arguments)
        },
        _unsetView: function() {
            this._recommendations && (this._recommendations.model.state.unset("placement"), this._recommendations.remove(), this._recommendations = null)
        },
        _expand: function() {
            if (this._enabled) {
                this.$el.css({
    ...
    return e
}), define("recommendations/app", ["backbone", "jquery", "loglevel", "core/bus", "recommendations/collections", "recommendations/models/Container", "recommendations/views/Placement"], function(a, b, c, d, e, f, g) {
    "use strict";
    var h = a.Model.extend({
        ...
        initialize: function() {
            this.$el = b(this.get("el")), this.forum = this.get("forum"), this.settings = this.get("settings"), this.initPlacement(), this.createDataCollections(), this.run(), this.set("innerContainerId", this.get("innerContainerName") + "-" + this.cid)
        },
        initPlacement: function() {
            ...
            }), b("#recommendations-layout").html(this.position.$el), this.listenToOnce(this.position, "recommendations:expanded", function() {
        ...
        run: function() {
            var a = this;
            return a.getRecommendationsData().then(function() {
                return a.threads.length < a.get("minLength") ? (c.debug("Not enough recommended threads, bailing out"), void d.frame.sendHostMessage("fail", {
                    height: "0px"
...
define("recommendations/views", ["backbone", "jquery", "underscore", "loglevel", "raven", "stance", "core/analytics/identity", "core/bus", "core/mixins/appliesPublisherClasses", "core/switches", "core/utils", "core/utils/isIframed", "common/models", "common/Session", "common/utils", "recommendations/app", "recommendations/common", "templates/recommendationsLayout"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
    "use strict";
    var s = window.document,
        t = a.View.extend({
            initialize: function(a) {
                q.setRecommendations(this), a = a || {}, this.language = s.documentElement.lang, n.setDefaults(a.session), this.session = n.get(), this.forum = new m.Forum, this.forum.set(a.forum), this.states = {
                    hasError: !1,
                    inViewport: !1,
                    fullyVisible: !1,
                ...
                l(window) ? this.listenTo(h.frame, "init", b) : c.defer(b), this.renderLayout()
            },
            bootstrap: function(a) {
                this.config = a = a || o.getConfigFromHash(window), this.states.fullyVisible = a.startedFullyVisible, this.config.experiment = a.experiment || {}, this.activateExperiment(this.config.experiment), a.forceSwitch && j.forceFeature(a.forceSwitch), g.init({
                    isPrivate: a.isPrivate
                }), a.impressionId && g.impression.setImpressionId(a.impressionId), this.bindBusListeners(), this.applyPublisherClasses(), this.forum.get("settings").organicDiscoveryEnabled && a.recsOutsideEmbedEnabled ? this.initRecommendations() : this.setErrorMessage({
                    message: "It appears that Recommendations are not enabled on the current forum. If you are a moderator you can enable this feature in the {LINK}.",
                    linkText: "settings",
                    linkUrl: "https://" + this.forum.id + ".disqus.com/admin/settings/recommendations"
            ...
            activateExperiment: function(a) {
                if (a.experiment && a.variant) {
                    var b = a.experiment,
                        c = a.variant;
                    b = b.replace(/_hidden$/, ""), j.forceFeature(["experiment", b, c].join(":"))
                }
            },
            initRecommendations: function() {
                this.states.hasError || this.states.recommendationsLoaded || (this.app = this.createRecommendationsApp(), this.listenToOnce(this.app, "recommendations:visible", function() {
                    this.expand()
                }), this.states.recommendationsLoaded = !0)
            },
            createRecommendationsApp: function() {
                var a = c.extend({}, _extends({
            ...
            setErrorMessage: function(a) {
                if (this.states.hasError) return void d.debug(a.message.replace("{LINK}", a.linkText));
                this.states.hasError = !0;
                var b = this.$el.find("#recommendations-error"),
                    c = '<a href="' + a.linkUrl + '" target="_blank" rel="noopener noreferrer">' + a.linkText + "</a>";
                b.html(a.message.replace("{LINK}", c)), b.show(), d.debug(a.message.replace("{LINK}", a.linkText)), this.expand()
            },
            whenFullyVisible: function() {
                var a = b.Deferred();
                return this.states.fullyVisible ? a.resolve() : this.listenTo(this, "frame.visible", function() {
                    a.resolve()
                }), a.promise()
            },
            expand: function() {
            ...
            addFeatureDetectionClasses: function() {
                ...
                k.isMobileUserAgent() && a.addClass("mobile"), k.isMobileUserAgent() || a.addClass("use-opacity-transitions")
            }
        });
    return i.call(t.prototype), {
        Recommendations: t
    }
}), define("recommendations/main", ["jquery", "core/utils/getEmbeddedData", "recommendations/tracking", "recommendations/views"], function(a, b, c, d) {
    "use strict";
    return {
        init: function() {
            var e = b("forumData"),
                f = b("recommendationSettings");
            delete f.id, a.extend(e, {
                settings: f
            });
