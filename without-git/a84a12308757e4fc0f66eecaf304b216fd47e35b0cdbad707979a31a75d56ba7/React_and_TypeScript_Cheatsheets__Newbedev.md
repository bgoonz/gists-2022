### Basic Cheatsheet Table of Contents [#](https://newbedev.com/react-and-type-script-cheatsheets#basic-cheatsheet-table-of-contents "Basic Cheatsheet Table of Contents")

**Expand Table of Contents**

-   [Section 1: Setup TypeScript with React](https://newbedev.com/react-and-type-script-cheatsheets#section-1-setup-typescript-with-react)
    -   [Prerequisites](https://newbedev.com/react-and-type-script-cheatsheets#prerequisites)
    -   [React + TypeScript Starter Kits](https://newbedev.com/react-and-type-script-cheatsheets#react--typescript-starter-kits)
    -   [Import React](https://newbedev.com/react-and-type-script-cheatsheets#import-react)
-   [Section 2: Getting Started](https://newbedev.com/react-and-type-script-cheatsheets#section-2-getting-started)
    -   [Function Components](https://newbedev.com/react-and-type-script-cheatsheets#function-components)
    -   [Hooks](https://newbedev.com/react-and-type-script-cheatsheets#hooks)
    -   [useState](https://newbedev.com/react-and-type-script-cheatsheets#usestate)
    -   [useReducer](https://newbedev.com/react-and-type-script-cheatsheets#usereducer)
    -   [useEffect](https://newbedev.com/react-and-type-script-cheatsheets#useeffect)
    -   [useRef](https://newbedev.com/react-and-type-script-cheatsheets#useref)
    -   [useImperativeHandle](https://newbedev.com/react-and-type-script-cheatsheets#useimperativehandle)
    -   [Custom Hooks](https://newbedev.com/react-and-type-script-cheatsheets#custom-hooks)
    -   [Class Components](https://newbedev.com/react-and-type-script-cheatsheets#class-components)
    -   [You May Not Need `defaultProps`](https://newbedev.com/react-and-type-script-cheatsheets#you-may-not-need-defaultprops)
    -   [Typing `defaultProps`](https://newbedev.com/react-and-type-script-cheatsheets#typing-defaultprops)
    -   [Consuming Props of a Component with defaultProps](https://newbedev.com/react-and-type-script-cheatsheets#consuming-props-of-a-component-with-defaultprops)
        -   [Problem Statement](https://newbedev.com/react-and-type-script-cheatsheets#problem-statement)
        -   [Solution](https://newbedev.com/react-and-type-script-cheatsheets#solution)
    -   [Misc Discussions and Knowledge](https://newbedev.com/react-and-type-script-cheatsheets#misc-discussions-and-knowledge)
    -   [Basic Prop Types Examples](https://newbedev.com/react-and-type-script-cheatsheets#basic-prop-types-examples)
    -   [Useful React Prop Type Examples](https://newbedev.com/react-and-type-script-cheatsheets#useful-react-prop-type-examples)
    -   [getDerivedStateFromProps](https://newbedev.com/react-and-type-script-cheatsheets#getderivedstatefromprops)
    -   [Forms and Events](https://newbedev.com/react-and-type-script-cheatsheets#forms-and-events)
    -   [Context](https://newbedev.com/react-and-type-script-cheatsheets#context)
    -   [Basic Example](https://newbedev.com/react-and-type-script-cheatsheets#basic-example)
    -   [Extended Example](https://newbedev.com/react-and-type-script-cheatsheets#extended-example)
    -   [forwardRef/createRef](https://newbedev.com/react-and-type-script-cheatsheets#forwardrefcreateref)
    -   [Portals](https://newbedev.com/react-and-type-script-cheatsheets#portals)
    -   [Error Boundaries](https://newbedev.com/react-and-type-script-cheatsheets#error-boundaries)
        -   [Option 1: Using react-error-boundary](https://newbedev.com/react-and-type-script-cheatsheets#option-1-using-react-error-boundary)
        -   [Options 2: Writing your custom error boundary component](https://newbedev.com/react-and-type-script-cheatsheets#options-2-writing-your-custom-error-boundary-component)
    -   [Concurrent React/React Suspense](https://newbedev.com/react-and-type-script-cheatsheets#concurrent-reactreact-suspense)
-   [Troubleshooting Handbook: Types](https://newbedev.com/react-and-type-script-cheatsheets#troubleshooting-handbook-types)
    -   [Union Types and Type Guarding](https://newbedev.com/react-and-type-script-cheatsheets#union-types-and-type-guarding)
    -   [Optional Types](https://newbedev.com/react-and-type-script-cheatsheets#optional-types)
    -   [Enum Types](https://newbedev.com/react-and-type-script-cheatsheets#enum-types)
    -   [Type Assertion](https://newbedev.com/react-and-type-script-cheatsheets#type-assertion)
    -   [Simulating Nominal Types](https://newbedev.com/react-and-type-script-cheatsheets#simulating-nominal-types)
    -   [Intersection Types](https://newbedev.com/react-and-type-script-cheatsheets#intersection-types)
    -   [Union Types](https://newbedev.com/react-and-type-script-cheatsheets#union-types)
    -   [Overloading Function Types](https://newbedev.com/react-and-type-script-cheatsheets#overloading-function-types)
    -   [Using Inferred Types](https://newbedev.com/react-and-type-script-cheatsheets#using-inferred-types)
    -   [Using Partial Types](https://newbedev.com/react-and-type-script-cheatsheets#using-partial-types)
    -   [The Types I need weren't exported!](https://newbedev.com/react-and-type-script-cheatsheets#the-types-i-need-werent-exported)
    -   [The Types I need don't exist!](https://newbedev.com/react-and-type-script-cheatsheets#the-types-i-need-dont-exist)
        -   [Slapping `any` on everything](https://newbedev.com/react-and-type-script-cheatsheets#slapping-any-on-everything)
        -   [Autogenerate types](https://newbedev.com/react-and-type-script-cheatsheets#autogenerate-types)
        -   [Typing Exported Hooks](https://newbedev.com/react-and-type-script-cheatsheets#typing-exported-hooks)
        -   [Typing Exported Components](https://newbedev.com/react-and-type-script-cheatsheets#typing-exported-components)
-   [Troubleshooting Handbook: Operators](https://newbedev.com/react-and-type-script-cheatsheets#troubleshooting-handbook-operators)
-   [Troubleshooting Handbook: Utilities](https://newbedev.com/react-and-type-script-cheatsheets#troubleshooting-handbook-utilities)
-   [Troubleshooting Handbook: tsconfig.json](https://newbedev.com/react-and-type-script-cheatsheets#troubleshooting-handbook-tsconfigjson)
-   [Troubleshooting Handbook: Fixing bugs in official typings](https://newbedev.com/react-and-type-script-cheatsheets#troubleshooting-handbook-fixing-bugs-in-official-typings)
-   [Troubleshooting Handbook: Globals, Images and other non-TS files](https://newbedev.com/react-and-type-script-cheatsheets#troubleshooting-handbook-globals-images-and-other-non-ts-files)
-   [Other React + TypeScript resources](https://newbedev.com/react-and-type-script-cheatsheets#other-react--typescript-resources)
-   [Editor Tooling and Integration](https://newbedev.com/react-and-type-script-cheatsheets#editor-tooling-and-integration)
-   [Linting](https://newbedev.com/react-and-type-script-cheatsheets#linting)
-   [Other React + TypeScript resources](https://newbedev.com/react-and-type-script-cheatsheets#other-react--typescript-resources-1)
-   [Recommended React + TypeScript talks](https://newbedev.com/react-and-type-script-cheatsheets#recommended-react--typescript-talks)
-   [Time to Really Learn TypeScript](https://newbedev.com/react-and-type-script-cheatsheets#time-to-really-learn-typescript)
-   [Example App](https://newbedev.com/react-and-type-script-cheatsheets#example-app)
-   [My question isn't answered here!](https://newbedev.com/react-and-type-script-cheatsheets#my-question-isnt-answered-here)
    -   [Contributors](https://newbedev.com/react-and-type-script-cheatsheets#contributors)
    -   [Prerequisites](https://newbedev.com/react-and-type-script-cheatsheets#prerequisites)
    -   [React + TypeScript Starter Kits](https://newbedev.com/react-and-type-script-cheatsheets#react--typescript-starter-kits)
    -   [Import React](https://newbedev.com/react-and-type-script-cheatsheets#import-react)
-   [Section 2: Getting Started](https://newbedev.com/react-and-type-script-cheatsheets#section-2-getting-started)
    ...
    -   [Class Components](https://newbedev.com/react-and-type-script-cheatsheets#class-components)
    -   [Typing defaultProps](https://newbedev.com/react-and-type-script-cheatsheets#typing-defaultprops)
    -   [Types or Interfaces?](https://newbedev.com/react-and-type-script-cheatsheets#types-or-interfaces)
    -   [Basic Prop Types Examples](https://newbedev.com/react-and-type-script-cheatsheets#basic-prop-types-examples)
    -   [Useful React Prop Type Examples](https://newbedev.com/react-and-type-script-cheatsheets#useful-react-prop-type-examples)
    -   [getDerivedStateFromProps](https://newbedev.com/react-and-type-script-cheatsheets#getDerivedStateFromProps)
    -   [Forms and Events](https://newbedev.com/react-and-type-script-cheatsheets#forms-and-events)
    ...
    -   [Error Boundaries](https://newbedev.com/react-and-type-script-cheatsheets#error-boundaries)
    -   [Concurrent React/React Suspense](https://newbedev.com/react-and-type-script-cheatsheets#concurrent-reactreact-suspense)
-   [Basic Troubleshooting Handbook: Types](https://newbedev.com/react-and-type-script-cheatsheets#basic-troubleshooting-handbook-types)
    -   [Union Types and Type Guarding](https://newbedev.com/react-and-type-script-cheatsheets#union-types-and-type-guarding)
    -   [Optional Types](https://newbedev.com/react-and-type-script-cheatsheets#optional-types)
    -   [Enum Types](https://newbedev.com/react-and-type-script-cheatsheets#enum-types)
    -   [Type Assertion](https://newbedev.com/react-and-type-script-cheatsheets#type-assertion)
    ...
    -   [The Types I need don't exist!](https://newbedev.com/react-and-type-script-cheatsheets#the-types-i-need-dont-exist)
        ...
        -   [Typing Exported Components](https://newbedev.com/react-and-type-script-cheatsheets#typing-exported-components)
-   [Troubleshooting Handbook: Operators](https://newbedev.com/react-and-type-script-cheatsheets#troubleshooting-handbook-operators)
-   [Troubleshooting Handbook: Utilties](https://newbedev.com/react-and-type-script-cheatsheets#troubleshooting-handbook-utilities)
-   [Troubleshooting Handbook: tsconfig.json](https://newbedev.com/react-and-type-script-cheatsheets#troubleshooting-handbook-tsconfigjson)
-   [Troubleshooting Handbook: Bugs in official typings](https://newbedev.com/react-and-type-script-cheatsheets#troubleshooting-handbook-bugs-in-official-typings)
-   [Recommended React + TypeScript codebases to learn from](https://newbedev.com/react-and-type-script-cheatsheets#recommended-react--typescript-codebases-to-learn-from)
-   [Editor Tooling and Integration](https://newbedev.com/react-and-type-script-cheatsheets#editor-tooling-and-integration)
-   [Linting](https://newbedev.com/react-and-type-script-cheatsheets#linting)
-   [Other React + TypeScript resources](https://newbedev.com/react-and-type-script-cheatsheets#other-react--typescript-resources)
-   [Recommended React + TypeScript talks](https://newbedev.com/react-and-type-script-cheatsheets#recommended-react--typescript-talks)
...
## Section 1: Setup TypeScript with React [#](https://newbedev.com/react-and-type-script-cheatsheets#section-1-setup-typescript-with-react "Section 1: Setup TypeScript with React")

### Prerequisites [#](https://newbedev.com/react-and-type-script-cheatsheets#prerequisites "Prerequisites")
...
4.  having read [the React section of the new TypeScript playground](https://www.typescriptlang.org/play/index.html?jsx=2&esModuleInterop=true&e=181#example/typescript-with-react) (optional: also step through the 40+ examples under [the playground's](https://www.typescriptlang.org/play/index.html) Examples section)
...
### React + TypeScript Starter Kits [#](https://newbedev.com/react-and-type-script-cheatsheets#react-typescript-starter-kits "React + TypeScript Starter Kits")
...
-   [CodeSandbox](https://ts.react.new/) - cloud IDE, boots up super fast
...
### Import React [#](https://newbedev.com/react-and-type-script-cheatsheets#import-react "Import React")
...
## Section 2: Getting Started [#](https://newbedev.com/react-and-type-script-cheatsheets#section-2-getting-started "Section 2: Getting Started")

### Function Components [#](https://newbedev.com/react-and-type-script-cheatsheets#function-components "Function Components")
...
### Hooks [#](https://newbedev.com/react-and-type-script-cheatsheets#hooks "Hooks")

Hooks are [supported in `@types/react` from v16.8 up](https://github.com/DefinitelyTyped/DefinitelyTyped/blob/a05cc538a42243c632f054e42eab483ebf1560ab/types/react/index.d.ts#L800-L1031).

### useState [#](https://newbedev.com/react-and-type-script-cheatsheets#usestate "useState")
...
### useReducer [#](https://newbedev.com/react-and-type-script-cheatsheets#usereducer "useReducer")
...
### useEffect [#](https://newbedev.com/react-and-type-script-cheatsheets#useeffect "useEffect")
...
### useRef [#](https://newbedev.com/react-and-type-script-cheatsheets#useref "useRef")
...
### useImperativeHandle [#](https://newbedev.com/react-and-type-script-cheatsheets#useimperativehandle "useImperativeHandle")
...
### Custom Hooks [#](https://newbedev.com/react-and-type-script-cheatsheets#custom-hooks "Custom Hooks")
...
function useArray() {
  ...
  return [numberValue, functionValue]; 
}
...
### More Hooks + TypeScript reading: [#](https://newbedev.com/react-and-type-script-cheatsheets#more-hooks-typescript-reading- "More Hooks + TypeScript reading:")
...
### Example React Hooks + TypeScript Libraries: [#](https://newbedev.com/react-and-type-script-cheatsheets#example-react-hooks-typescript-libraries- "Example React Hooks + TypeScript Libraries:")
...
### Class Components [#](https://newbedev.com/react-and-type-script-cheatsheets#class-components "Class Components")
...
### Typing getDerivedStateFromProps [#](https://newbedev.com/react-and-type-script-cheatsheets#typing-getderivedstatefromprops "Typing getDerivedStateFromProps")
...
### You May Not Need `defaultProps` [#](https://newbedev.com/react-and-type-script-cheatsheets#you-may-not-need-code-defaultprops-code- "You May Not Need <code>defaultProps</code>")
...
-   [https://twitter.com/hswolff/status/1133759319571345408](https://twitter.com/hswolff/status/1133759319571345408)
...
### Typing `defaultProps` [#](https://newbedev.com/react-and-type-script-cheatsheets#typing-code-defaultprops-code- "Typing <code>defaultProps</code>")
...
### Consuming Props of a Component with defaultProps [#](https://newbedev.com/react-and-type-script-cheatsheets#consuming-props-of-a-component-with-defaultprops "Consuming Props of a Component with defaultProps")

A component with `defaultProps` may seem to have some required props that actually aren't.

### Problem Statement [#](https://newbedev.com/react-and-type-script-cheatsheets#problem-statement "Problem Statement")
...
### Solution [#](https://newbedev.com/react-and-type-script-cheatsheets#solution "Solution")
...
### Misc Discussions and Knowledge [#](https://newbedev.com/react-and-type-script-cheatsheets#misc-discussions-and-knowledge "Misc Discussions and Knowledge")
...
-   [https://github.com/typescript-cheatsheets/react-typescript-cheatsheet/issues/87](https://github.com/typescript-cheatsheets/react-typescript-cheatsheet/issues/87)
...
### Typing Component Props [#](https://newbedev.com/react-and-type-script-cheatsheets#typing-component-props "Typing Component Props")

This is intended as a basic orientation and reference for React developers familiarizing with TypeScript.

### Basic Prop Types Examples [#](https://newbedev.com/react-and-type-script-cheatsheets#basic-prop-types-examples "Basic Prop Types Examples")
...
### Useful React Prop Type Examples [#](https://newbedev.com/react-and-type-script-cheatsheets#useful-react-prop-type-examples "Useful React Prop Type Examples")
...
### Types or Interfaces? [#](https://newbedev.com/react-and-type-script-cheatsheets#types-or-interfaces- "Types or Interfaces?")

You can use either Types or Interfaces to type Props and State, so naturally the question arises - which do you use?

### TL;DR [#](https://newbedev.com/react-and-type-script-cheatsheets#tl-dr "TL;DR")

Use Interface until You Need Type - [orta](https://twitter.com/orta/status/1356129195835973632?s=20).

### More Advice [#](https://newbedev.com/react-and-type-script-cheatsheets#more-advice "More Advice")
...
### Useful table for Types vs Interfaces [#](https://newbedev.com/react-and-type-script-cheatsheets#useful-table-for-types-vs-interfaces "Useful table for Types vs Interfaces")
...
### getDerivedStateFromProps [#](https://newbedev.com/react-and-type-script-cheatsheets#getderivedstatefromprops "getDerivedStateFromProps")
...
### Forms and Events [#](https://newbedev.com/react-and-type-script-cheatsheets#forms-and-events "Forms and Events")
...
### Context [#](https://newbedev.com/react-and-type-script-cheatsheets#context "Context")

### Basic Example [#](https://newbedev.com/react-and-type-script-cheatsheets#basic-example "Basic Example")
...
### Extended Example [#](https://newbedev.com/react-and-type-script-cheatsheets#extended-example "Extended Example")
...
### forwardRef/createRef [#](https://newbedev.com/react-and-type-script-cheatsheets#forwardref-createref "forwardRef/createRef")
...
More info: [https://medium.com/@martin\_hotell/react-refs-with-typescript-a32d56c4d315](https://medium.com/@martin_hotell/react-refs-with-typescript-a32d56c4d315)
...
### Portals [#](https://newbedev.com/react-and-type-script-cheatsheets#portals "Portals")
...
### Error Boundaries [#](https://newbedev.com/react-and-type-script-cheatsheets#error-boundaries "Error Boundaries")

### Option 1: Using react-error-boundary [#](https://newbedev.com/react-and-type-script-cheatsheets#option-1-using-react-error-boundary "Option 1: Using react-error-boundary")
...
### Options 2: Writing your custom error boundary component [#](https://newbedev.com/react-and-type-script-cheatsheets#options-2-writing-your-custom-error-boundary-component "Options 2: Writing your custom error boundary component")
...
### Concurrent React/React Suspense [#](https://newbedev.com/react-and-type-script-cheatsheets#concurrent-react-react-suspense "Concurrent React/React Suspense")
...
## Troubleshooting Handbook: Types [#](https://newbedev.com/react-and-type-script-cheatsheets#troubleshooting-handbook-types "Troubleshooting Handbook: Types")
...
### Union Types and Type Guarding [#](https://newbedev.com/react-and-type-script-cheatsheets#union-types-and-type-guarding "Union Types and Type Guarding")
...
### Optional Types [#](https://newbedev.com/react-and-type-script-cheatsheets#optional-types "Optional Types")
...
### Enum Types [#](https://newbedev.com/react-and-type-script-cheatsheets#enum-types "Enum Types")
...
### Type Assertion [#](https://newbedev.com/react-and-type-script-cheatsheets#type-assertion "Type Assertion")
...
### Simulating Nominal Types [#](https://newbedev.com/react-and-type-script-cheatsheets#simulating-nominal-types "Simulating Nominal Types")
...
### Intersection Types [#](https://newbedev.com/react-and-type-script-cheatsheets#intersection-types "Intersection Types")
...
### Union Types [#](https://newbedev.com/react-and-type-script-cheatsheets#union-types "Union Types")
...
### Overloading Function Types [#](https://newbedev.com/react-and-type-script-cheatsheets#overloading-function-types "Overloading Function Types")
...
### Using Inferred Types [#](https://newbedev.com/react-and-type-script-cheatsheets#using-inferred-types "Using Inferred Types")
...
### Using Partial Types [#](https://newbedev.com/react-and-type-script-cheatsheets#using-partial-types "Using Partial Types")
...
### The Types I need weren't exported! [#](https://newbedev.com/react-and-type-script-cheatsheets#the-types-i-need-weren-39-t-exported- "The Types I need weren't exported!")
...
### The Types I need don't exist! [#](https://newbedev.com/react-and-type-script-cheatsheets#the-types-i-need-don-39-t-exist- "The Types I need don't exist!")
...
### Slapping `any` on everything [#](https://newbedev.com/react-and-type-script-cheatsheets#slapping-code-any-code-on-everything "Slapping <code>any</code> on everything")
...
### Autogenerate types [#](https://newbedev.com/react-and-type-script-cheatsheets#autogenerate-types "Autogenerate types")
...
### Typing Exported Hooks [#](https://newbedev.com/react-and-type-script-cheatsheets#typing-exported-hooks "Typing Exported Hooks")
...
### Typing Exported Components [#](https://newbedev.com/react-and-type-script-cheatsheets#typing-exported-components "Typing Exported Components")
...
## Troubleshooting Handbook: Operators [#](https://newbedev.com/react-and-type-script-cheatsheets#troubleshooting-handbook-operators "Troubleshooting Handbook: Operators")
...
## Troubleshooting Handbook: Utilities [#](https://newbedev.com/react-and-type-script-cheatsheets#troubleshooting-handbook-utilities "Troubleshooting Handbook: Utilities")
...
## Troubleshooting Handbook: tsconfig.json [#](https://newbedev.com/react-and-type-script-cheatsheets#troubleshooting-handbook-tsconfig-json "Troubleshooting Handbook: tsconfig.json")
...
## Troubleshooting Handbook: Fixing bugs in official typings [#](https://newbedev.com/react-and-type-script-cheatsheets#troubleshooting-handbook-fixing-bugs-in-official-typings "Troubleshooting Handbook: Fixing bugs in official typings")
...
## Time to Really Learn TypeScript [#](https://newbedev.com/react-and-type-script-cheatsheets#time-to-really-learn-typescript "Time to Really Learn TypeScript")
...
-   Step through the 40+ examples under [the playground's](https://www.typescriptlang.org/play/index.html) Examples section, written by @Orta
-   Anders Hejlsberg's overview of TS: [https://www.youtube.com/watch?v=ET4kT88JRXs](https://www.youtube.com/watch?v=ET4kT88JRXs)
-   Marius Schultz: [https://blog.mariusschulz.com/series/typescript-evolution](https://blog.mariusschulz.com/series/typescript-evolution) with an [Egghead.io course](https://egghead.io/courses/advanced-static-types-in-typescript)
-   Basarat's Deep Dive: [https://basarat.gitbook.io/typescript/](https://basarat.gitbook.io/typescript/)
...
## Other React + TypeScript resources [#](https://newbedev.com/react-and-type-script-cheatsheets#other-react-typescript-resources "Other React + TypeScript resources")
...
## Editor Tooling and Integration [#](https://newbedev.com/react-and-type-script-cheatsheets#editor-tooling-and-integration "Editor Tooling and Integration")

-   VSCode
    -   swyx's VSCode Extension: [https://github.com/sw-yx/swyx-react-typescript-snippets](https://github.com/sw-yx/swyx-react-typescript-snippets)
    -   amVim: [https://marketplace.visualstudio.com/items?itemName=auiworks.amvim](https://marketplace.visualstudio.com/items?itemName=auiworks.amvim)
-   VIM
    ...
    -   NeoVim: [https://github.com/neoclide/coc.nvim](https://github.com/neoclide/coc.nvim)
    -   other discussion: [https://mobile.twitter.com/ryanflorence/status/1085715595994095620](https://mobile.twitter.com/ryanflorence/status/1085715595994095620)
...
## Linting [#](https://newbedev.com/react-and-type-script-cheatsheets#linting "Linting")
...
Follow the TypeScript + ESLint docs at [https://github.com/typescript-eslint/typescript-eslint](https://github.com/typescript-eslint/typescript-eslint):
...
You can read a [fuller TypeScript + ESLint setup guide here](https://blog.matterhorn.dev/posts/learn-typescript-linting-part-1/) from Matterhorn, in particular check [https://github.com/MatterhornDev/learn-typescript-linting](https://github.com/MatterhornDev/learn-typescript-linting).
