...
let PhotosMimeType = require('PhotosMimeType');

let createArrayFromMixed = require('createArrayFromMixed');
let emptyFunction = require('emptyFunction');

let CR_LF_REGEX = new RegExp('\u000D\u000A', 'g');
let LF_ONLY = '\u000A';
...
class DataTransfer {
   ...
   */
  isImage() {
    let isImage = this.types.some((type) => {
