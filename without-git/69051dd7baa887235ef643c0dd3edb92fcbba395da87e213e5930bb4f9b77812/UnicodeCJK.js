...
// let R_KANA_SUPPLEMENT     = '\U0001B000-\U0001B0FF';
...
// let R_IDEO_EXT_B = '\U00020000-\U0002A6DF';
// let R_IDEO_EXT_C = '\U0002A700-\U0002B73F';
// let R_IDEO_EXT_D = '\U0002B740-\U0002B81F';
 ...
 * Hangul
 */
// let R_HANGUL_JAMO           = '\u1100-\u11FF';
// let R_HANGUL_JAMO_EXT_A     = '\uA960-\uA97F';
// let R_HANGUL_JAMO_EXT_B     = '\uD7B0-\uD7FF';
// let R_HANGUL_COMPATIBILITY  = '\u3130-\u318F';
// let R_HANGUL_COMP_HALFWIDTH = '\uFFA0-\uFFDF';
...
function hasIdeoOrSyll(str) {
  REGEX_IDEO_OR_SYLL = REGEX_IDEO_OR_SYLL ||
    new RegExp('[' + R_IDEO_OR_SYLL + ']');
...
function charCodeToKatakana(chr) {
  ...
  return String.fromCharCode(
      (charCode < I_HIRAGANA[0] || charCode > I_HIRAGANA[1])
      ? charCode
      : charCode + I_HIRAGANA_TO_KATAKANA);
}
