...
let UnicodeBidi = require('UnicodeBidi');
...
describe('UnicodeBidi', function() {
  ...
  describe('firstStrongChar', function() {
    let fsc = UnicodeBidi.firstStrongChar;
  ...
  describe('firstStrongCharDir', function() {
    let fsd = UnicodeBidi.firstStrongCharDir;
  ...
  describe('resolveBlockDir', function() {
    let rbd = UnicodeBidi.resolveBlockDir;
  ...
  describe('getDirection', function() {
    let getDir = UnicodeBidi.getDirection;
  ...
  describe('isDirectionLTR', function() {
    let isDirLTR = UnicodeBidi.isDirectionLTR;
  ...
  describe('isDirectionRTL', function() {
    let isDirRTL = UnicodeBidi.isDirectionRTL;
