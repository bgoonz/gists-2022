...
const ArrayIterators = (function() {
  ...
  return {
    keys: hasNative
      ? (array) => array.keys()
      : (array) => new ArrayIterator(array, KIND_KEYS),

    values: hasNative
      ? (array) => array.values()
      : (array) => new ArrayIterator(array, KIND_VALUES),

    entries: hasNative
      ? (array) => array.entries()
      : (array) => new ArrayIterator(array, KIND_ENTRIES),
  };
})();
...
const StringIterators = (function() {
  ...
  return {
    ...
    values: hasNative
      ...
      : (string) => new StringIterator(string),
