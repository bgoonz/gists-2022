...
let IntegerBufferSet = require('IntegerBufferSet');
...
describe('IntegerBufferSet-test', function() {
  ...
  it('set should be empty right after creating it', function() {
    let bufferSet = new IntegerBufferSet();
  ...
  it('set should allow to replace vales out of specified range', function() {
    ...
    let assignedPosition = bufferSet.replaceFurthestValuePosition(
  ...
  it(
    ...
    function() {
      ...
      let position = bufferSet.replaceFurthestValuePosition(
