          ...
          Q.loadPage("/_error")
            ...
            .then(function (r) {
              ...
              return Promise.resolve(
                e.props ? e.props : w.loadGetInitialProps(t, u)
              ).then(function (t) {
                return ge(
                  j({}, e, {
                    err: n,
                          ...
                          switch ((t.prev = t.next)) {
                            ...
                            case 18:
                              if (
                                ...
                                (w = S(E(a) ? O(a) : a, this.locale)),
                                (this._inFlightRoute = a),
                                (_ = f !== this.locale),
                                i._h || !this.onlyAHashChange(w) || _)
                              ) {
                                t.next = 35;
                                break;
                              }
                            ...
                            case 51:
                              if (
                                (this.urlIsNew(w) || _ || (r = "replaceState"),
                                (U = a),
                                ...
                                l &&
                                  ...
                                  P.pathname !== j &&
                                    ((j = P.pathname),
                                    (P.pathname = k(j)),
                                    (o = p.formatWithValidation(P)))),
                                (F = c.removePathTrailingSlash(j)),
                                L(a))
                              ) {
                                t.next = 61;
                                break;
                            ...
                            case 61:
                              ...
                              if (
                                ((W = h.parseRelativeUrl(U)),
                                (B = W.pathname),
                                (H = g.getRouteRegex(F)),
                                (q = y.getRouteMatcher(H)(B)),
                                (z = (G = F === B) ? C(F, B, M) : {}),
                                q && (!G || z.result))
                              ) {
                                t.next = 76;
                              ...
                              if (
                                !(
                                  (V = Object.keys(H.groups).filter(function (
                                    e
                                  ) {
                                    return !M[e];
                                  })).length > 0
                            ...
                            case 116:
                              ...
                              throw (
                                (e.events.emit("routeChangeError", Q, w, b), Q)
                              );
                            case 119:
                              return (
