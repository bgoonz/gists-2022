...
(function () {
  if (
    window.$mcSite === undefined ||
    window.$mcSite.adwords_remarketing === undefined
  ) {
    return;
  }
  ...
  window.$mcSite.runIfOptedIn(function () {
    ...
    script.onload = function () {
      var allow_personalization_settings =
        settings.google_allow_ad_personalization_signals;
...
(function () {
  ...
  if (
    window.$mcSite === undefined ||
    window.$mcSite.facebookPixel === undefined
  ) {
    return;
  }

  if (
    !window.$mcSite.facebookPixel.settings ||
    !!$mcSite.facebookPixel.installed ||
    !window.$mcSite.facebookPixel.settings.enabled
  ) {
    return;
  }
