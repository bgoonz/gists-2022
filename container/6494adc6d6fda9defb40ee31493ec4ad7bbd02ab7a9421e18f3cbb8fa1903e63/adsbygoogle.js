(function (sttc) {
  ...
  var db =
    "function" === typeof n.Symbol && "symbol" === typeof (0, n.Symbol)()
      ? (0, n.Symbol)(void 0)
      : void 0;
    ...
    if (null != a) {
      if (Array.isArray(a)) a = kb(a, b);
        ...
        var c = {},
          d;
        for (d in a)
          Object.prototype.hasOwnProperty.call(a, d) && (c[d] = jb(a[d], b));
        a = c;
      } else a = b(a);
      return a;
    }
  ...
  function x(a, b, c) {
    ...
    a: {
      ...
      void 0 !== b && -1 < b
        ? ((this.m = Math.max(b, a + 1 - this.l)), (this.j = void 0))
    ...
    if (c)
      for (b = 0; b < c.length; b++)
        if (((a = c[b]), a < this.m))
          (a += this.l),
            (d = this.i[a]) ? Array.isArray(d) && eb(d) : (this.i[a] = ob);
        else {
          d = this.j || (this.j = this.i[this.m + this.l] = {});
          var e = d[a];
          e ? Array.isArray(e) && eb(e) : (d[a] = ob);
        }
  }
  ...
  function vb(a, b, c, d) {
    (c = wb(a, c)) &&
      c !== b &&
      null != d &&
      (a.h && c in a.h && (a.h[c] = void 0), B(a, c, void 0));
    return B(a, b, d);
  }
  ...
  function bc(a) {
    var b,
      c = null === (b = Zb()) || void 0 === b ? void 0 : b.createScriptURL(a);
  ...
  function Vc(a, b) {
    ...
    a &&
      ...
      (a = Ub(
        a instanceof Ib && a.constructor === Ib && a.h === Kb
          ? a.i
          : "type_error:Const"
      )),
      vc(d, a));
    ...
    if (a instanceof Array) {
      if (((d = d || 0), d < c.length)) {
        for (var f = [], g = 0; g < a.length; g++)
          f.push(gd(a[g], b, c, d + 1, e));
        return f.join(c[d]);
      }
    } else if ("object" == typeof a)
      return (
        (e = e || 0), 2 > e ? encodeURIComponent(fd(a, b, c, d, e + 1)) : "..."
      );
  ...
  function vd() {
    ...
    var a = null;
    v &&
      ((v.google_js_reporting_queue = v.google_js_reporting_queue || []),
      (this.events = v.google_js_reporting_queue),
      (a = v.google_measure_js_timing));
  ...
  function wd(a) {
    a &&
      sd &&
      ud() &&
      (sd.clearMarks("goog_" + a.label + "_" + a.uniqueId + "_start"),
      sd.clearMarks("goog_" + a.label + "_" + a.uniqueId + "_end"));
  }
    ...
    try {
      ...
      if (
        ...
        for (m = 1; m < b.length; ++m) {
          var q = b[m];
          q.url ||
            ((q.url = k.location.ancestorOrigins[m - 1] || ""), (q.Ha = !0));
        }
  ...
  function Fe(a, b, c, d) {
    var e = (d = void 0 === d ? 0 : d),
      ...
      g;
    K(Ge).j[e] =
      null != (g = null == (f = K(Ge).j[e]) ? void 0 : f.add(b))
        ? g
        : new n.Set().add(b);
    e = Ee();
    ...
    Ra(b, function (h) {
      ...
      Ra(a, function (l) {
        ...
        if (q) {
          ...
          if ((E = m)) {
            var P;
            E = !(null == (P = K(Ge).h.get(h)) || !P.has(q));
          }
          E && g.push(m);
          e ||
            ((P = K(Ge)),
            P.h.has(h) || P.h.set(h, new n.Map()),
            P.h.get(h).has(q) || P.h.get(h).set(q, []),
            d && P.h.get(h).get(q).push(d));
          k[q] = l.toJSON();
        }
      });
    });
  ...
  function kf(a) {
    ...
    M(
      ...
      function (b) {
        for (
          var c = K(Ae), d = t([Jd, Kd, Ld]), e = d.next();
          !e.done;
          e = d.next()
        )
          (e = e.value), p(Object, "assign").call(Object, c.h[e], b[e]);
      },
      a
    );
  }
  ...
  function pf(a) {
    ...
    v.google_measure_js_timing ||
      ((a = yd),
      (a.h = !1),
      a.events != a.i.google_js_reporting_queue &&
        (ud() && Ra(a.events, wd), (a.events.length = 0)));
  }
  (function (a) {
    ld = a || new jd();
  ...
  function tf(a) {
    return function (b) {
      ...
      of.G(a, b instanceof Error ? b : Error(b), void 0, void 0);
    };
  }
  ...
  function uf(a, b, c, d) {
    ...
    return 0 == e.indexOf("TagError")
      ? ((c = b instanceof Wc ? b.error : b),
        c.pbr || ((c.pbr = !0), of.G(a, b, 0.1, d, "puberror")),
        !1)
      : of.G(a, b, c, d);
  }
  var vf = {
      ...
      ? (null ==
        ...
        null == a.google_reactive_ads_global_state.sideRailAvailableSpace &&
          (a.google_reactive_ads_global_state.sideRailAvailableSpace =
            new n.Map()))
      : (a.google_reactive_ads_global_state = new wf());
  ...
  function Mf() {
    if (Kf && !tc(Lf)) {
      var a = "." + Sc.domain;
      try {
        for (; 2 < a.split(".").length && !tc(Lf); )
          (Sc.domain = a = a.substr(a.indexOf(".") + 1)), (Lf = window.parent);
      } catch (b) {}
      tc(Lf) || (Lf = window);
    }
    Lf !== window &&
  ...
  Xf.prototype.map = function (a) {
    return null != this.h
      ? ((a = a(this.h.value)), a instanceof Xf ? a : $f(a))
      : this;
  };
  ...
  var qg = {},
    rg = new mg(
      ["google-auto-placed"],
      ((qg.google_reactive_ad_format = 40), (qg.google_tag_origin = "qs"), qg)
    );
  ...
  function ci(a, b) {
    return !(
      (Ic.test(b.google_ad_width) || Hc.test(a.style.width)) &&
      (Ic.test(b.google_ad_height) || Hc.test(a.style.height))
    );
  }
  ...
  function si(a, b) {
    ...
    c = Infinity;
    do
      (d = b.style && H(b.style.height)) && (c = Math.min(c, d)),
        (d = mi(b, a, "maxHeight", H)) && (c = Math.min(c, d));
  ...
  function Ci(a) {
    ...
    if (A(a, 1) || a.getId() || 0 < pb(a, 4).length) {
      ...
      d && (e += d);
      c && (e += "#" + Bi(c));
      if (b) for (c = 0; c < b.length; c++) e += "." + Bi(b[c]);
  ...
  function Ii(a) {
    switch (A(a, 8)) {
      ...
      case 2:
        ...
        return null != b
          ? $f(b)
          : bg(Error("Missing dimension when creating placement id"));
      case 3:
  ...
  function Ki(a) {
    ...
    return b
      ? Sa(
          Ta(b.pubads().getSlots(), function (c) {
  ...
  function Pi(a, b) {
    ...
    b.forEach(function (e) {
      if (Eb(e, ug, 1, xg)) {
        ...
        D(e, sg, 3) &&
          D(D(e, sg, 3), fg, 1) &&
          (f = Qi(a, D(D(e, sg, 3), fg, 1))) &&
          c.set(za(f), A(D(e, sg, 3), 2));
      } else Eb(e, vg, 2, xg) ? Ri(a, Eb(e, vg, 2, xg), c) : Eb(e, wg, 3, xg) && Si(a, Eb(e, wg, 3, xg), d);
    });
    return new Oi(c, d);
  }
  ...
  function ej(a, b) {
    ...
    if (k) {
      b: {
        ...
        var y = (Ki(e) || Li(e, "div[id^=div-gpt-ad]")).concat(
          Li(e, "iframe[id^=google_ads_iframe]")
        );
        var F = Li(
            e,
          ...
          E = Li(e, "div.googlepublisherpluginad");
        k = [].concat(
          Li(e, "iframe[id^=aswift_],iframe[id^=google_ads_frame]"),
          Li(e, "ins.adsbygoogle")
        );
        h = [];
        l = t([
          [l.wb, m],
    ...
    for (e = 0; e < c.length; e++) {
      ...
      if (
        !D(k, lg, 4) ||
        !g.contains(A(D(k, lg, 4), 1)) ||
        1 !== A(k, 8) ||
        (k && null != A(k, 4) && d[A(D(k, lg, 4), 2)])
      )
        f = null;
      else {
        f.i++;
  ...
  function fj(a, b, c, d) {
    if ((b && null != A(b, 4) && d[A(D(b, lg, 4), 2)]) || 1 != A(b, 8))
      return null;
    d = D(b, fg, 1);
    if (!d) return null;
    d = Ci(d);
  ...
  function lj() {
    ...
    return null != b &&
      ...
      "object" == typeof b.S
      ? (mj = b)
      : (a.google_persistent_state_async = mj = new kj());
  }
  ...
  var mj = null,
    qj = {},
    oj =
      ((qj[8] = "google_prev_ad_formats_by_region"),
      (qj[9] = "google_prev_ad_slotnames_by_region"),
      qj);
  ...
  function Ej(a) {
    ...
    if (!1 === a.gdprApplies) var c = !0;
      ...
      void 0 === a.internalErrorState && (a.internalErrorState = vj(a)),
        (c =
          "error" === a.cmpStatus ||
  ...
  function Uj(a) {
    this.h = a;
    this.i = a.document;
    this.j = (a = (a = Sj(this.i)) ? D(a, Rj, 5) || null : null)
      ? A(a, 2)
      : null;
    ...
    if (!U(I).ama_ran_on_page) {
      ...
      if (d) {
        if (null != A(d, 24)) {
          ...
          c.availableAbg = !0;
          var e, f;
          c.ablationFromStorage = !!(null == (e = D(d, Bg, 24))
            ? 0
            : null == (f = D(e, Dg, 3))
            ? 0
            : Eb(f, Eg, 2, Fg));
        ...
        if ((g = D(d, Mg, 13)) && 1 === A(g, 1)) {
          ...
          (Hi(a).ablatingThisPageview = !0), ok(a, 1);
        Vc(3, [d.toJSON()]);
  ...
  var Jk = {},
    Kk =
      ((Jk.image_stacked = 1 / 1.91),
      (Jk.image_sidebyside = 1 / 3.82),
      (Jk.mobile_banner_image_sidebyside = 1 / 3.82),
      (Jk.pub_control_image_stacked = 1 / 1.91),
      (Jk.pub_control_image_sidebyside = 1 / 3.82),
      (Jk.pub_control_image_card_stacked = 1 / 1.91),
      (Jk.pub_control_image_card_sidebyside = 1 / 3.74),
      (Jk.pub_control_text = 0),
      (Jk.pub_control_text_card = 0),
      Jk),
    Lk = {},
    Mk =
      ((Lk.image_stacked = 80),
      (Lk.image_sidebyside = 0),
      (Lk.mobile_banner_image_sidebyside = 0),
      (Lk.pub_control_image_stacked = 80),
      (Lk.pub_control_image_sidebyside = 0),
      (Lk.pub_control_image_card_stacked = 85),
      (Lk.pub_control_image_card_sidebyside = 0),
      (Lk.pub_control_text = 80),
      (Lk.pub_control_text_card = 80),
      Lk),
    Nk = {},
    Ok =
      ((Nk.pub_control_image_stacked = 100),
      (Nk.pub_control_image_sidebyside = 200),
      (Nk.pub_control_image_card_stacked = 150),
      (Nk.pub_control_image_card_sidebyside = 250),
      (Nk.pub_control_text = 100),
      (Nk.pub_control_text_card = 150),
      Nk);
  ...
  function Pk(a) {
    ...
    for (var d = [], e = [], f = 0; f < b.length; f++) {
      var g = Number(c[f]);
      if (p(Number, "isNaN").call(Number, g) || 0 === g)
        return {
  ...
  function Wk(a, b) {
    ...
    if ("pedestal" == b.google_content_recommendation_ui_type)
      return new Sk(9, new Vk(a, Math.floor(a * b.google_phwr)));
    var c = mc();
    468 > a
      ? c
        ? ((c = a - 8 - 8),
          (c =
            ...
            Math.floor(
              11 *
                (c * Kk.mobile_banner_image_sidebyside +
  ...
  function cl(a, b, c, d, e) {
    ...
    if ("in-article" == f) {
      ...
      else if (((a = gi(b, c, g, 0.2, e)), !0 !== a)) (e.gfwrnwer = a), (a = g);
      else if ((a = Af(b)))
  ...
  function jl(a, b, c, d, e, f) {
    b = "auto" == b ? (0.25 >= a / Math.min(1200, Af(c)) ? 4 : 3) : fi(b);
    var g = !1,
      h = !1;
    if (488 > Af(c)) {
      var k = ai(d, c);
    ...
    null != e.google_max_responsive_height &&
      l.push(ri(e.google_max_responsive_height));
    var m = [
      function (r) {
        return !r.fb;
      },
    ...
    l = qf(248, function () {
      ...
      a: if (f) {
        ...
        Q(Gh) && !pi(d, c) && (y = Math.max(y, 0.5 * zf(c).clientHeight));
        r = {
    ...
    g = l.W;
    l = l.U;
    return "in-article" === e.google_ad_layout && ll(c)
      ? {
          W: ml(a, c, d, g, e),
          U: !1,
          na: b,
  ...
  function nl(a, b, c, d, e) {
    ...
    g = g.C;
    if (!0 !== g || a == f)
      return new Sk(12, new S(a, d), null, null, !0, g, 100);
    a = jl(f, "auto", b, c, e, !0);
  ...
  function Ql(a, b, c, d) {
    c = void 0 === c ? "" : c;
    return 1 === b && Rl(c, void 0 === d ? null : d)
      ? !0
      : Sl(a, c, function (e) {
  ...
  function Rl(a, b) {
    return b
      ? 13 === wb(b, Ml)
        ...
        : 14 === wb(b, Ml) &&
          "" !== a &&
          1 === pb(Eb(b, zl, 14, Ml), 1).length &&
          pb(Eb(b, zl, 14, Ml), 1)[0] === a
        ? rb(D(Eb(b, zl, 14, Ml), yl, 2), 1)
        : !1
      : !1;
  }
  ...
  function fm() {
    ...
    this[Kd] =
      ...
      (a[11] = function (b) {
        ...
        b = void 0 === b ? "" : b;
        c = void 0 === c ? window : c;
        b = (c = (c = c.location.href.match(oc)[3] || null) ? decodeURI(c) : c)
          ? Dc(c + b)
          : null;
    ...
    Ra(e, function (q) {
      ...
      if ((q = km(a, q, c, r)))
        0 !== wb(r, ne) && l.push(r),
          ...
          d.push(r),
          lm(a, r, k ? 4 : c),
          (q = G(q, Ud, 2)) && (k ? Oe(q, Qe(), a.h, r) : Oe(q, [c], a.h, r));
    });
    var m;
  ...
  function zm(a, b, c, d) {
    ...
    var f =
      void 0 === f
        ? new we(
            null != (wm = null == (tm = D(a, Jl, 5)) ? void 0 : C(tm, 2, 0))
              ? wm
              : 0,
            null != (xm = null == (um = D(a, Jl, 5)) ? void 0 : C(um, 4, 0))
              ? xm
              : 0,
            null != (ym = null == (vm = D(a, Jl, 5)) ? void 0 : rb(vm, 3))
              ? ym
              : !1
          )
        : f;
    d.hasOwnProperty("init-done")
      ? (hf(
          ...
          Ta(G(a, Hl, 2), function (g) {
            return g.toJSON();
          })
        ),
        hf(ff, d)(
          Ta(G(a, Ud, 1), function (g) {
            return g.toJSON();
          }),
          e
        ),
        b && hf(gf, d)(b),
        Am(d, e))
      : (qm(K(hm).init(G(a, Hl, 2), e, f, c), d),
        jf(d),
        kf(d),
        lf(d),
        Am(d, e),
        Oe(G(a, Ud, 1), [e], f, void 0, !0),
        (Be = Be || !(!c || !c.eb)),
        sm(K(fm)),
        b && sm(b));
  }
  ...
  var Fm = {},
    Gm =
      ((Fm.google_ad_modifications = !0),
      (Fm.google_analytics_domain_name = !0),
      (Fm.google_analytics_uacct = !0),
      (Fm.google_pause_ad_requests = !0),
      (Fm.google_user_agent_client_hint = !0),
      Fm);
  ...
  function Km(a) {
    ...
    if (
      null !==
        (d =
          null !==
            (b = null === f || void 0 === f ? void 0 : f.google_ad_client) &&
          void 0 !== b
            ? b
            : null ===
      ...
      b: {
        f = a.document.getElementsByTagName("script");
        ...
        for (var g = f.length - 1; 0 <= g; g--) {
          ...
          if (
            ...
            ((h.google_parsed_script_for_pub_code = !0), (h = a(h)))
          ) {
            f = h;
            break b;
          }
            ...
            switch (((e = e.value), e.entryType)) {
              case "layout-shift":
                ...
                if (!e.hadRecentInput) {
                  ...
                  var g = Zm(e, c, d);
                  g && ((f.m += e.value), f.wa++);
                  if (5e3 < e.startTime - f.va || 1e3 < e.startTime - f.ya)
                    (f.va = e.startTime), (f.h = 0), (f.i = 0);
                  f.ya = e.startTime;
                  f.h += e.value;
                  g && (f.i += e.value);
                  f.h > f.R &&
    ...
    if (!a.xa) {
      ...
      window.LayoutShift &&
        ...
        window.LayoutShiftAttribution &&
          ((b += Wm("cas", a.m)), (b += Vm("nas", a.wa))),
        (b += Wm("wls", a.R)),
        (b += Wm("tls", a.Aa)),
        window.LayoutShiftAttribution && (b += Wm("was", a.Ba)));
      window.LargestContentfulPaint &&
        ((b += Vm("lcp", a.ua)), (b += Vm("lcps", a.ta)));
  ...
  var on = K(Vh).h(Th.h, Th.defaultValue);
  ...
  function pn(a, b, c) {
    ...
    b && qn() && this.h.push(X);
    c && this.h.push(Y);
    if (document.hasTrustToken && !Q(Qh)) {
      var e = new n.Map();
      this.h.forEach(function (f) {
      ...
      window.goog_tt_state_map =
        window.goog_tt_state_map && window.goog_tt_state_map instanceof n.Map
          ? new n.Map([].concat(ma(e), ma(window.goog_tt_state_map)))
          : e;
      (window.goog_tt_promise_map &&
        window.goog_tt_promise_map instanceof n.Map) ||
        (window.goog_tt_promise_map = new n.Map());
    }
  }
  u(pn, uj);
  ...
  function xn(a) {
    if (document.hasTrustToken && !Q(Qh) && a.i) {
      ...
      if (b && b instanceof n.Map) {
        ...
        a.h.some(function (e) {
          ...
          a || ((a = wn()), b.set(Y.issuerOrigin, a)),
          c.push(a));
        if (0 < c.length && n.Promise && n.Promise.all) return n.Promise.all(c);
      }
    }
  }
  var yn =
  ...
  function zn() {
    ...
    return "function" !==
      typeof (null ===
        (b =
          null === (a = null === I || void 0 === I ? void 0 : I.navigator) ||
          void 0 === a
            ? void 0
            : a.userAgentData) || void 0 === b
        ? void 0
        : b.getHighEntropyValues)
      ? null
      : I.navigator.userAgentData.getHighEntropyValues(yn).then(function (c) {
          var d = new Mj();
          d = B(d, 1, c.platform);
  ...
  function Bn(a, b, c) {
    c = void 0 === c ? "" : c;
    I.google_sa_impl &&
      !I.document.getElementById("google_shimpl") &&
      (delete I.google_sa_queue,
      (I.google_sl_win = null),
      delete I.google_sa_impl);
    I.google_sa_queue ||
      ((I.google_sa_queue = []),
      Q(sh) || (I.google_sl_win = I),
      (I.google_process_slots = rf(215, function () {
        return Cn(I.google_sa_queue);
      })),
      (a = Dn(c, a, b)),
      (vc(I.document, a).id = "google_shimpl"));
  }
  ...
  function Gn(a) {
    ...
    e.name = "google_esf";
    a = a.sb;
    a = a instanceof $b ? cc(a).toString() : Tb(a).toString();
    e.src = a;
  ...
  function In(a, b, c, d, e) {
    ...
    c = (d = !!a.document.getElementById(f + "_anchor"))
      ? function (h) {
          return h();
        }
      : function (h) {
    ...
    En(
      ...
      function () {
        ...
        b.dninfo += "_" + h;
        (h = a.google_sa_impl(g)) && h.catch && h.catch(tf(911));
      },
      c
    );
  }
  ...
  function Jn(a, b, c) {
    ...
    d =
      ...
      (!Gk[c.google_ad_width + "x" + c.google_ad_height] &&
  ...
  function Pn(a, b, c, d) {
    ...
    !(g = Q(rh) || (!(488 > Af(c)) && !Q(Bh))) &&
      (g = Q(Dh)) &&
      ((g = c === c.top),
      g || (uc(c) ? (b.gfwrnwer = 3) : (b.gfwrnwer = 16), (g = !1)),
      (g = !g));
    if (g) d = !1;
    else {
      g = uc(c) || c;
      ...
      d =
        g.location && "#ftptohbh" === g.location.hash
          ? 2
          : rk(g.location, "google_responsive_slot_preview") || Q(Ch)
          ? 1
          : Q(Ah)
          ? 2
          : Ql(g, 1, h, d)
          ...
          : 0;
      if ((g = 0 !== d))
        b: if (b.google_reactive_ad_format || ol(c, b) || ci(a, b)) g = !1;
        else {
    ...
    if ((e = ol(c, b))) ql(e, a, b, c, d);
      ...
      if (ci(a, b)) {
        if ((d = xc(a, c)))
          (a.style.width = d.width), (a.style.height = d.height), bi(d, b);
  ...
  function ao(a, b, c) {
    ...
    if (!bo(a, b, d)) {
      ...
      if (e) {
        ...
        if (
          U(I).page_contains_reactive_tag &&
          !U(I).allow_second_reactive_tag
        ) {
          if (e.pltais) {
            pk(!1);
            return;
    ...
    if (f && f.Ca && "on" != b.google_adtest && !e) {
      ...
      if (!f.oa || (f.oa && ((0 == g ? null : e / g) || 0) >= f.oa))
        return (
          ...
          "slot" == f.qb &&
            (null !== Jc(a.getAttribute("width")) && a.setAttribute("width", 0),
            null !== Jc(a.getAttribute("height")) &&
  ...
  function lo(a, b) {
    ...
    if (c) {
      ...
      ((null == (g = Eb(b, yl, 13, Ml)) ? 0 : rb(g, 3)) && Q(Hh))
        ? no(f, a)
        : Sn(function () {
            no(f, a);
          });
  ...
  function mo(a) {
    ...
    if (
      (a = sc(c) || a.getAttribute("data-ad-client") || "") &&
    ...
    if (0 !== e)
      ...
      if (e) to(a, d);
        ...
        if (!b.google_ad_client)
          throw new J("Ad client is missing from the slot.");
  ...
  function uo(a) {
    if (a) {
      if (!Zn(a) && (a.id ? (a = co(a.id)) : (a = null), !a))
        throw new J("'element' has already been filled.");
      if (!("innerHTML" in a))
        throw new J("'element' is not a good DOM element.");
    } else if (((a = co()), !a))
      throw new J(
  ...
  function xo() {
    ...
    (f =
      ...
      (b.h ? (b = b.h) : ((b.h = Kc(b.i, "__uspapiLocator")), (b = b.h)),
      (f = null != b));
    c.l ||
      (c.i || (c.i = c.h.googlefc ? c.h : Kc(c.h, "googlefcPresent")),
      (c.l = !0));
    sf(
      "cmpMet",
      {
  ...
  function Ao(a) {
    Number(a)
      ? (U(I).pause_ad_requests = !0)
      : ((U(I).pause_ad_requests = !1),
        (a = function () {
  ...
  function Do() {
    for (
      var a = t(p(Xn, "keys").call(Xn)), b = a.next();
      !b.done;
      b = a.next()
    ) {
      b = b.value;
      var c = Xn.get(b);
      -1 !== c && (v.clearTimeout(c), Xn.delete(b));
    }
    a = {};
    for (
      b = 0;
      ...
      Xn.has(b) ||
        ...
        qf(
          ...
          (function (d) {
            return function () {
              3 === d.da
                ? Vn.handleAdConfig(d.Z)
                : 2 === d.da && Vn.handleAdBreakBeforeReady(d.Z).catch(tf(730));
            };
          })(a)
        ));
  }
