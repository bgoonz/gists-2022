  ...
  var t = {
          ...
          return (
            !s &&
              ...
              o.addEventListener(
                i,
                (e = function () {
                  for (o.removeEventListener(i, e), s = 1; (e = n.shift()); )
                    e();
                })
              ),
            function (t) {
      ...
      412: (t, e, n) => {
        ...
        "function" != typeof v.Promise
          ? (v.Promise = m)
          : (v.Promise.prototype.finally || (v.Promise.prototype.finally = o),
          ...
          s = (function () {
            ...
            return (
              ...
              (t.prototype.create = function (t, e, n, s) {
                ...
                return (
                  (u._initPromise = (0, r.request)(
                    "".concat(c.bootstrapUrl, "/widget/").concat(c.key, ".json")
                  )
                    .then(function (t) {
                      var n = (0, r.parseJSON)(t);
                      return (
                        delete e.features,
                        u.init((0, r.mergeDeep)(n, n.config, e), n.features),
                        e &&
                          e.key &&
                          (0, o.trackOptions)(u.options, Object.keys(e)),
                        s && s(void 0, u),
              ...
              (t.prototype.createWidget = function (t, e, n) {
                ...
                return (
                  ...
                  (0, r.request)(
                    ...
                    return (
                      delete e.features,
                      p.init((0, r.mergeDeep)(u, u.config, e), u.features),
                      e &&
                        e.key &&
                        (0, o.trackOptions)(p.options, Object.keys(e)),
                      p
                    );
                  })
                );
                    ...
                    return (
                      ...
                      [
                        ...
                        (0, i.request)(
                          t.widgetTrackerUrl +
                            "/track/options?key="
                              .concat(t.key, "&options=")
                              .concat(undefined.join(","), "&domain=")
                              .concat(window.location.hostname)
                        ),
                      ]
                    );
              ...
              (e.onreadystatechange = function () {
                4 === e.readyState &&
                  (e.status >= 200 && e.status < 300
                    ...
                    : o(
                        new Error(
                          "Request failed with status ".concat(e.status)
                        )
                      ));
              }),
                e.open("GET", t, !0),
          ...
          u = (function () {
            ...
            return (
              (t.prototype.setOptions = function (t) {
                return (
                  (this.options = (0, a.mergeDeep)(this.options, t)),
                  this.features &&
                    (this.features.rating || (this.options.ratingEnabled = !1),
                    this.features.groups ||
                      (this.options.groupSelectEnabled = !1),
                  ...
                  this._pushApi &&
                    this._pushApi.forEach(function (t) {
                      "recording:disable" === t[0]
                        ...
                        : "recording:off" === t[0] &&
                          (n.options.recordingOff = !0);
                    });
              }),
              (t.prototype.createContainer = function () {
                var t = document.createElement("div");
                return (
                  (t.id = "".concat(this.id, "-application")),
                  t.setAttribute("style", "display: none"),
                  this.options.zIndex &&
                    (t.style.zIndex = "".concat(this.options.zIndex + 1)),
              ...
              (t.prototype.createFrame = function () {
                ...
                return (
                  (t.id = "".concat(this.id, "-application-iframe")),
                  t.setAttribute("title", "Smartsupp"),
                  t.setAttribute("aria-hidden", "true"),
                  t.setAttribute(
                    "style",
                    "width: 100%; height: 100%; border: none; position: absolute; left: 0"
                  ),
                  this.options.zIndex &&
                    (t.style.zIndex = "".concat(this.options.zIndex + 1)),
                  t
                    ...
                    switch (n.label) {
                      ...
                      case 2:
                        ...
                        if (
                          ...
                          !(e = (0, a.resolveTargetElement)(t)))
                        )
                          throw new Error("target element not found");
                        return (
                          (this.el = this.createContainer()),
                          this.renderFrame(this.el, e),
                          (this.rendered = !0),
                          [2]
                        );
                    }
              ...
              (t.prototype.renderFrame = function (t, e) {
                ...
                o.addEventListener("load", function () {
                  var t,
                    e,
                    s =
                      null !== (t = o.contentDocument) && void 0 !== t
                        ? t
                  ...
                  (u.id = "body"),
                    (u.dataset.smartsuppId = n.id),
                    (u.innerHTML = '<div id="root"></div>'),
                    r(n, void 0, void 0, function () {
                      ...
                      return i(this, function (e) {
                        switch (e.label) {
                          ...
                          case 1:
                            return (
                              e.sent().entrypoints.forEach(function (e) {
                                var n = (0, a.createScript)(
                                  s,
                                  t.getBaseUrl() + "/".concat(e)
                                );
                                c.appendChild(n);
                              }),
                              [2]
              ...
              (t.prototype.getInternalApiUrl = function () {
                return ""
                  .concat(this.options.bootstrapUrl, "/widget/")
                  .concat(this.options.key, "/code.js");
              }),
                    ...
                    (this._pushApi.forEach(function (n) {
                      ...
                      try {
                        e.options.widgetTrackerEnabled &&
                          (0, s.trackOperation)(e.options, o[0]),
                          t.execute(o);
                      } catch (t) {
                        console.log(t);
                      }
              ...
              (t.prototype.initSmartlook = function (t) {
                ...
                (o.async = !0),
                  ...
                  this.options.recordingDisable
                    ? this.smartlook("disable")
                    : this.smartlook(function () {
                        e.exec("variables", {
    ...
    (() => {
      ...
      if (
        ...
        (window.SMARTSUPP_LOADED = !0),
          (window.$smartsupp = new e.SmartsuppLoader({
            widgetVersion: 1,
