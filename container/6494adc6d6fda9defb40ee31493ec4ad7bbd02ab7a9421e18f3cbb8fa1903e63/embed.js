...
(function(a, k) {
    ...
    q.isXdUrl = function(b) {
        return /^\./.test(b) ? !1 : /^\/\//.test(b) ? !0 : (b = b.match(/^([^\/\:]+\:)\/+([^\/]+)/)) && (b[1] != N || R && b[2] != R);
    };
    ...
    if (v("native-xhr") && !v("dojo-force-activex-xhr")) O = function() {
    ...
    q.getText = function(b, d, a) {
        ...
        l.open("GET", sa(b), !1);
        l.send(null);
        if (200 == l.status || !location.host && !l.status) a && a(l.responseText, d);
    ...
    var F = {},
        ...
        da = function(b) {
            var d, a, l, p;
            for (d in ba) a = ba[d], (l = d.match(/^url\:(.+)/)) ? M["url:" + Na(l[1], b)] = a : "*now" == d ? p = a : "*noref" != d && (l = la(d, b, !0), M[l.mid] = M["url:" + l.url] = a);
            p && p(Ca(b));
            ba = {};
        },
        Oa = function(b) {
        ...
        Da = function(b, d) {
            d.splice(0, d.length);
            for (var a in b) d.push([a, b[a], new RegExp("^" + Oa(a) + "(/|$)"), a.length]);
            d.sort(function(b, d) {
                return d[3] - b[3];
            });
            return d;
        ...
        ma = function(d, a, p) {
            for (var c in d) {
                ...
                if ("async" == c) {
                    var e = d[c];
                    q.legacyMode = w = g(e) && /sync|legacyAsync/.test(e) ? e : e ? !1 : "sync";
                    q.async = !w;
                }
                d[c] !== u && (q.rawConfig[c] = d[c], "has" != c && v.add("config-" + c, d[c], 0, a));
            }
            q.baseUrl || (q.baseUrl = "./");
            /\/$/.test(q.baseUrl) || (q.baseUrl += "/");
            for (c in d.has) v.add(c, d.has[c], 0, a);
            b(d.packages, Pa);
            for (var m in d.packagePaths) b(d.packagePaths[m], function(b) {
                var d = m + "/" + b;
                g(b) && (b = {
                    name: b
                });
            ...
            if (a) Qa.push({
                ...
                for (c in d.config) a = Y(c, p), a.config = l(a.config || {}, d.config[c]);
    ...
    for (var aa, fa, ua, na; h < ta.length;)
        if (aa = ta[h++], (ua = aa.getAttribute("src")) && (na = ua.match(/(((.*)\/)|^)dojo\.js(\W|$)/i)) && (fa = na[3] || "", k.baseUrl = k.baseUrl || fa, ca = aa), ua = aa.getAttribute("data-dojo-config") || aa.getAttribute("djConfig")) W = q.eval("({ " + ua + " })", "data-dojo-config"), ca = aa;
    q.rawConfig = {};
    ma(k, 1);
    v("dojo-cdn") && ((B.dojo.location = fa) && (fa += "/"), B.dijit.location = fa + "../dijit/", B.dojox.location = fa + "../dojox/");
    ma(a, 1);
    ma(W, 1);
    var oa = function(d) {
            ka(function() {
        ...
        Ma = function(b, d, a, c, e) {
            ...
            if (m(b))
                if (b.length) {
                    a = "require*" + y();
                    for (var h, r = [], C = 0; C < b.length;) h = b[C++], r.push(Y(h, c));
                    f = l(va("", a, 0, ""), {
                        injected: 2,
                        deps: r,
                        def: d || n,
        ...
        Ca = function(b) {
            ...
            d || (d = function(a, l, p) {
                return Ma(a, l, p, b, d);
            }, b.dojoRequire = l(d, q), d.module = b, d.toUrl = function(d) {
                return Na(d, b);
        ...
        Fa = function(b, d) {
            if (d)
                for (var a = 0; a < d.length; a++)
                    if (d[a][2].test(b)) return d[a];
            return 0;
        },
        Sa = function(b) {
            var d = [],
                a, l;
            for (b = b.replace(/\\/g, "/").split("/"); b.length;) a = b.shift(), ".." == a && d.length && ".." != l ? (d.pop(), l = d[d.length - 1]) : "." != a && d.push(l = a);
            return d.join("/");
        },
        va = function(b, d, a, l) {
            var p = q.isXdUrl(l);
        ...
        Ta = function(d, a, l, c, e, g, m, h, y) {
            ...
            c = (C = Fa(d, m)) ? C[1] + d.substring(C[3]) : a ? r.location + "/" + q : v("config-tlmSiblingOfDojo") ? "../" + d : d;
            /(^\/)|(\:)/.test(c) || (c = e + c);
        ...
        Y = function(b, d, a) {
            var l, p;
            (l = b.match(/^(.+?)\!(.*)$/)) ? (p = Y(l[1], d, a), "sync" != w || p.executed || (ra(p), 2 !== p.injected || p.executed || ka(function() {
                ja(p);
            }), p.executed ? za(p) : S.unshift(p)), 5 !== p.executed || p.load || za(p), p.load ? (l = Ua(p, l[2], d), b = p.mid + "!" + (p.dynamic ? ++Va + "!" : "") + l) : (l = l[2], b = p.mid + "!" + ++Va + "!waitingForPlugin"), b = {
                plugin: p,
                mid: b,
                req: Ca(d),
                prid: l
        ...
        gb = function(d) {
            ...
            b(d.loadQ, function(b) {
                var p = Ua(d, b.prid, b.req.module),
                    c = d.dynamic ? b.mid.replace(/waitingForPlugin$/, p) : d.mid + "!" + p,
                    p = l(l({}, b), {
                        mid: c,
                        prid: p,
                        injected: 0
            ...
            d.loadQ = 0;
            var p = function(b) {
                    for (var d = b.deps || [], l = 0; l < d.length; l++)(b = a[d[l].mid]) && (d[l] = b);
                },
                c;
            for (c in H) p(H[c]);
            b(S, p);
        ...
        hb = [],
        ja = function(b, d) {
            if (4 === b.executed) return q.trace("loader-circular-dependency", [hb.concat(b.mid).join("-\x3e")]), !b.def || d ? Aa : b.cjs && b.cjs.exports;
            if (!b.executed) {
                if (!b.def) return Aa;
                var a = b.mid,
                    l = b.deps || [],
                ...
                for (b.executed = 4; c = l[g++];) {
                    ...
                    if (c === Aa) return b.executed = 0, q.trace("loader-exec-module", ["abort", a]), Aa;
                    e.push(c);
                }
        ...
        ha = function() {
            pa || ka(function() {
                X();
                for (var b, d, a = 0; a < S.length;) b = Ha, d = S[a], ja(d), b != Ha ? (X(), a = 0) : a++;
            });
        };
    ...
    var sa = "function" == typeof a.fixupUrl ? a.fixupUrl : function(b) {
        ...
        Xa = function(b) {
            ...
            d.load ? d.load(b.prid, b.req, a) : d.loadQ ? d.loadQ.push(b) : (d.loadQ = [b], S.unshift(d), ra(d));
        },
        ea = 0,
        qa = 0,
        Ia = 0,
        wa = function(b, d) {
            ...
            Ia = 1;
            if (v("config-dojo-loader-catches")) try {
                b === ea ? ea.call(null) : q.eval(b, v("dojo-loader-eval-hint-url") ? d.url : d.mid);
            } catch (a) {
                A("error", p("evalModuleThrew", d));
            } else b === ea ? ea.call(null) : q.eval(b, v("dojo-loader-eval-hint-url") ? d.url : d.mid);
            Ia = 0;
        },
        ra = function(d) {
            var a = d.mid,
                c = d.url;
            if (!(d.executed || d.injected || T[a] || d.url && (d.pack && T[d.url] === d.pack || 1 == T[d.url])))
                if (bb(d), d.plugin) Xa(d);
                    ...
                    if (ea = M[a] || M["url:" + d.url]) q.trace("loader-inject", ["cache", d.mid, c]), wa(ea, d), e();
                    else {
                        if (w)
                            ...
                            var g = function(l) {
                                if ("sync" == w) {
                                    ...
                                    if (d.finish) {
                                        ...
                                        var p = d.finish;
                                        delete d.finish;
                                        Ja(l, ["dojo", ("dojo/require!" + p.join(",")).replace(/\./g, "/")], function(d) {
                                            b(p, function(b) {
                                                d.dojoRequire(b);
                                            });
                                        });
                                    ...
                                    e();
                                } else(l = Q(d, l)) ? (wa(l, d), e()) : (qa = d, q.injectUrl(sa(c), e, d), qa = 0);
                            };
        ...
        Ya = function(d, a) {
            for (var l = [], p, c; xa.length;) c = xa.shift(), a && (c[0] = a.shift()), p = c[0] && Y(c[0]) || d, l.push([p, c[1], c[2]]);
            da(d);
            b(l, function(b) {
                oa(Ka.apply(null, b));
            });
        ...
        Ra = function() {
            ya();
            q.waitms && (Ba = r.setTimeout(function() {
                ya();
                A("error", p("timeout", T));
            }, q.waitms));
        };
    ...
    var La = function(b, d, a, l) {
            if (v("ie-event-behavior")) return b.attachEvent(a, l),
                function() {
                    b.detachEvent(a, l);
                };
    ...
    q.injectUrl = function(b, d, a) {
        ...
        var l = La(a, "load", "onreadystatechange", function(b) {
                ...
                if ("load" === b.type || /complete|loaded/.test(a.readyState)) l(), c(), d && d();
            }),
    ...
    var Ja = function(b, d, a) {
        var l = arguments.length,
            ...
            e = [0, b, d];
        1 == l ? e = [0, f(b) ? c : [], b] : 2 == l && g(b) ? e = [b, f(d) ? c : [], d] : 3 == l && (e = [b, d, a]);
        ...
        if ((l = e[0] && Y(e[0])) && !T[l.mid]) oa(Ka(l, e[1], e[2]));
            ...
            l ? (da(l), oa(Ka(l, e[1], e[2]))) : A("error", p("ieDefineFailed", e[0]));
            ha();
        }
    };
    Ja.amd = {
...
dojoRequire({
    cache: {
        "dojo/main": function() {
            dojoDefine("./_base/kernel ./has require ./sniff ./_base/lang ./_base/array ./_base/config ./ready ./_base/declare ./_base/connect ./_base/Deferred ./_base/json ./_base/Color ./has!dojo-firebug?./_firebug/firebug ./_base/browser ./_base/loader".split(" "), function(a, k, h, n, c, e, f, g) {
                f.isDebug && h(["./_firebug/firebug"]);
                var m = f.dojoRequire;
                m && (m = e.map(c.isArray(m) ? m : [m], function(b) {
                    return b.replace(/\./g, "/");
                }), a.isAsync ? h(m) : g(1, function() {
                    h(m);
                }));
                return a;
            });
        ...
        "dojo/_base/kernel": function() {
            dojoDefine(["../has", "./config", "require", "module"], function(a, k, h, n) {
                var c, e;
                c = function() {
                    return this;
                }();
                ...
                for (e in f) n = f[e], n[1]._scopeName = n[0], k.noGlobals || (c[n[0]] = n[1]);
                m.scopeMap = f;
                ...
                var b;
                for (c = 0; b = n[c++];) console[b] || function() {
                    var a = b + "";
                ...
                a("dojo-debug-messages") && (m.deprecated = function(b, a, d) {}, m.experimental = function(b, a) {});
                if (k.modulePaths) {
                    m.deprecated("dojo.modulePaths", "use paths configuration");
                    a = {};
                    for (e in k.modulePaths) a[e.replace(/\./g, "/")] = k.modulePaths[e];
                    h({
                        paths: a
                    });
                }
                m.moduleUrl = function(b, a) {
                    ...
                    var d = null;
                    b && (d = h.toUrl(b.replace(/\./g, "/") + (a ? "/" + a : "") + "/*.*").replace(/\/\*\.\*/, "") + (a ? "" : "/"));
                    return d;
                };
                m._hasResource = {};
                return m;
        ...
        "dojo/sniff": function() {
            dojoDefine(["./has"], function(a) {
                ...
                a.add("bb", (0 <= h.indexOf("BlackBerry") || 0 <= h.indexOf("BB10")) && parseFloat(h.split("Version/")[1]) || void 0);
                a.add("trident", parseFloat(k.split("Trident/")[1]) || void 0);
                a.add("svg", "undefined" !== typeof SVGAngle);
                a("webkit") || (0 <= h.indexOf("Opera") && a.add("opera", 9.8 <= n ? parseFloat(h.split("Version/")[1]) || n : n), 0 <= h.indexOf("Gecko") && !a("khtml") && !a("webkit") && !a("trident") && a.add("mozilla", n), a("mozilla") && a.add("ff", parseFloat(h.split("Firefox/")[1] || h.split("Minefield/")[1]) || void 0), document.all && !a("opera") && (h = parseFloat(k.split("MSIE ")[1]) || void 0, (k = document.documentMode) && 5 != k && Math.floor(h) != k && (h = k), a.add("ie", h)), a.add("wii", "undefined" != typeof opera && opera.wiiremote));
                return a;
            });
        },
        "dojo/_base/lang": function() {
            dojoDefine(["./kernel", "../has", "../sniff"], function(a, k) {
                ...
                var h = k("bug-for-in-skips-shadowed") ? "hasOwnProperty valueOf isPrototypeOf propertyIsEnumerable toLocaleString toString constructor".split(" ") : [],
                    n = h.length,
                    c = function(b, l, p) {
                        p || (p = b[0] && a.scopeMap[b[0]] ? a.scopeMap[b.shift()][1] : a.global);
                        try {
                    ...
                    m = {
                        ...
                        _mixin: function(b, a, p) {
                            var d, c, e, g = {};
                            for (d in a) c = a[d], d in b && (b[d] === c || d in g && g[d] === c) || (b[d] = p ? p(c) : c);
                            if (k("bug-for-in-skips-shadowed") && a)
                                for (e = 0; e < n; ++e) d = h[e], c = a[d], d in b && (b[d] === c || d in g && g[d] === c) || (b[d] = p ? p(c) : c);
                            return b;
                        },
                        mixin: function(b, a) {
                            b || (b = {});
                            for (var c = 1, d = arguments.length; c < d; c++) m._mixin(b, arguments[c]);
                            return b;
                        },
                        ...
                        extend: function(b, a) {
                            for (var c = 1, d = arguments.length; c < d; c++) m._mixin(b.prototype, arguments[c]);
                            return b;
                        },
                        ...
                        hitch: function(b, l) {
                            ...
                            if (m.isString(l)) {
                                b = b || a.global;
                                if (!b[l]) throw ['lang.hitch: scope["', l, '"] is null (scope\x3d"', b, '")'].join("");
                                return function() {
                        ...
                        clone: function(b) {
                            ...
                            var a, c, d;
                            if (m.isArray(b))
                                for (a = [], c = 0, d = b.length; c < d; ++c) c in b && a.push(m.clone(b[c]));
            ...
            dojoDefine(["./kernel", "../has", "./lang"], function(a, k, h) {
                ...
                function e(b) {
                    ...
                    return function(e, h, f, k) {
                        ...
                        k = e && e.length || 0;
                        var n = b ? k + d : c;
                        f === g ? f = b ? c : k + d : 0 > f ? (f = k + f, 0 > f && (f = c)) : f = f >= k ? k + d : f;
                ...
                var f = {},
                    g, m = {
                        ...
                        map: function(b, a, c, d) {
                            ...
                            "string" == typeof a && (a = f[a] || n(a));
                            if (c)
                                for (; e < g; ++e) d[e] = a.call(c, b[e], e, b);
                            else
                                for (; e < g; ++e) d[e] = a(b[e], e, b);
                            return d;
                        },
                        filter: function(b, a, c) {
                            ...
                            if (c)
                                ...
                                for (; d < e; ++d) m = b[d], a(m, d, b) && g.push(m);
                            return g;
                        },
                        clearCache: function() {
                            f = {};
        ...
        "dojo/ready": function() {
            dojoDefine(["./_base/kernel", "./has", "require", "./domReady", "./_base/lang"], function(a, k, h, n, c) {
                var e = 0,
                    f = [],
                    g = 0;
                k = function() {
                ...
                var m = function() {
                    if (!g) {
                        for (g = 1; e && (!n || 0 == n._Q.length) && (h.idle ? h.idle() : 1) && f.length;) {
                            var b = f.shift();
                            try {
                                b();
                            } catch (d) {
                ...
                var b = a.ready = a.addOnLoad = function(b, d, e) {
                        ...
                        "number" != typeof b ? (e = d, d = b, b = 1E3) : l.shift();
                ...
                a.config.parseOnLoad && !a.isAsync && b(99, function() {
                    a.parser || (a.deprecated("Add explicit require(['dojo/parser']);", "", "2.0"), h(["dojo/parser"]));
                });
                n ? n(k) : k();
                return b;
            });
            ...
            dojoDefine(["./has"], function(a) {
                ...
                if (!g) {
                    var l = [],
                        p = function(b) {
                            b = b || n.event;
                            g || "readystatechange" == b.type && !e[c.readyState] || (f && (c.readyState = "complete"), g = 1, h());
                        },
                        d = function(b, d) {
                    ...
                    d(n, "load");
                    "onreadystatechange" in c ? d(c, "readystatechange") : f || l.push(function() {
        ...
        "dojo/_base/declare": function() {
            dojoDefine(["./kernel", "../has", "./lang"], function(a, k, h) {
                ...
                function c(b, d, a) {
                    var c, e, l, g, p, f, m, h = this._inherited = this._inherited || {};
                    ...
                    m = h.p;
                    if ("constructor" != c) {
                        if (h.c !== g && (m = 0, f = l[0], p = f._meta, p.hidden[c] !== g)) {
                            (e = p.chains) && "string" == typeof e[c] && n("calling chained method with inherited: " + c, this.declaredClass);
                            do
                                if (p = f._meta, e = f.prototype, p && (e[c] === g && e.hasOwnProperty(c) || p.hidden[c] === g)) break; while (f = l[++m]);
                            m = f ? m : -1;
                        }
                        if (f = l[++m])
                            if (e = f.prototype, f._meta && e.hasOwnProperty(c)) a = e[c];
                                ...
                                g = u[c];
                                do
                                    if (e = f.prototype, (a = e[c]) && (f._meta ? e.hasOwnProperty(c) : a !== g)) break; while (f = l[++m]);
                            }
                        a = f && a || u[c];
                    } else {
                        if (h.c !== g && (m = 0, (p = l[0]._meta) && p.ctor !== g)) {
                            for ((e = p.chains) && "manual" === e.constructor || n("calling chained constructor with inherited", this.declaredClass);
                                (f = l[++m]) && (!(p = f._meta) || p.ctor !== g););
                            m = f ? m : -1;
                        }
                        for (;
                            (f = l[++m]) && !(a = (p = f._meta) ? p.ctor : f););
                        a = f && a;
                    }
                    h.c = a;
                    h.p = m;
                ...
                function m(b, d) {
                    for (var a in d) "constructor" != a && d.hasOwnProperty(a) && (b[a] = d[a]);
                    if (k("bug-for-in-skips-shadowed"))
                        for (var c = h._extraNames, e = c.length; e;) a = c[--e], "constructor" != a && d.hasOwnProperty(a) && (b[a] = d[a]);
                }
                ...
                function l(b, d) {
                    b instanceof Array || "function" == typeof b || (d = b, b = void 0);
                    d = d || {};
                    b = b || [];
                ...
                function p(b, d) {
                    return function() {
                        ...
                        for (l = g - 1; 0 <= l; --l) e = b[l], (e = (g = e._meta) ? g.ctor : e) && e.apply(this, p ? p[l] : a);
                ...
                function d(b, d) {
                    return function() {
                        var a = arguments,
                            ...
                            e = a[0];
                        if (!(this instanceof a.callee)) return t(a);
                        d && (e && (e = e.preamble) && (c = e.apply(this, c) || c), (e = this.preamble) && e.apply(this, c));
                        b && b.apply(this, a);
                ...
                function q(b, d, a) {
                    return function() {
                        var c, e, l = 0,
                            g = 1;
                        a && (l = d.length - 1, g = -1);
                        for (; c = d[l]; l += g) e = c._meta, (c = (e ? e.hidden : c.prototype)[b]) && c.apply(this, arguments);
                    };
                }
                ...
                function x(a, f, k) {
                    ...
                    if ("[object Array]" == z.call(f)) {
                        ...
                        for (var U = f.length, K = 0, B, L, G, H; K < U; ++K) {
                            (B = f[K]) ? "[object Function]" != z.call(B) && n("mixin #" + K + " is not a callable constructor.", D): n("mixin #" + K + " is unknown. Did you use dojo.require to pull it in?", D);
                            L = B._meta ? B._meta.bases : [B];
                            G = 0;
                            for (B = L.length - 1; 0 <= B; --B) H = L[B].prototype, H.hasOwnProperty("declaredClass") || (H.declaredClass = "uniqName_" + E++), H = H.declaredClass, J.hasOwnProperty(H) || (J[H] = {
                                count: 0,
                                refs: [],
                                cls: L[B]
                            }, ++F), H = J[H], G && G !== H && (H.refs.push(G), ++G.count), G = H;
                            ++G.count;
                            I[0].refs.push(G);
                        }
                        for (; I.length;) {
                            ...
                            if (G)
                                for (K = 0, U = t.length; K < U; ++K) G = t[K], --G.count || I.push(G);
                        }
                    ...
                    for (w = D - 1; w; --w)(I = F[w]._meta) && I.chains && (A = v(A || {}, I.chains));
                    t["-chains-"] && (A = v(A || {}, t["-chains-"]));
                    I = !A || !A.hasOwnProperty("constructor");
                    F[0] = J = A && "manual" === A.constructor ? y(F) : 1 == F.length ? d(k.constructor, I) : p(F, I);
                    J._meta = {
                        bases: F,
                        hidden: k,
                        chains: A,
                    ...
                    if (A)
                        for (P in A) t[P] && "string" == typeof A[P] && "constructor" != P && (I = t[P] = q(P, F, "after" === A[P]), I.nom = P);
                    return J;
                }
                var v = h.mixin,
                    u = Object.prototype,
                ...
                a.safeMixin = x.safeMixin = function(b, d) {
                    var a, c;
                    for (a in d) c = d[a], c === u[a] && a in u || "constructor" == a || ("[object Function]" == z.call(c) && (c.nom = a), b[a] = c);
                    if (k("bug-for-in-skips-shadowed"))
                        for (var e = h._extraNames, l = e.length; l;) a = e[--l], c = d[a], c === u[a] && a in u || "constructor" == a || ("[object Function]" == z.call(c) && (c.nom = a), b[a] = c);
                    return b;
                };
                return a.declare = x;
            });
        ...
        "dojo/_base/connect": function() {
            dojoDefine("./kernel ../on ../topic ../aspect ./event ../mouse ./sniff ./lang ../keys".split(" "), function(a, k, h, n, c, e, f, g) {
                function m(b, d, c, l, f) {
                    l = g.hitch(c, l);
                    if (!b || !b.addEventListener && !b.attachEvent) return n.after(b || a.global, d, l, !0);
                ...
                var l = {
                    ...
                    y;
                y = f("events-keypress-typed") ? function(b, a) {
                    var c = k(b, "keydown", function(b) {
                            var c = b.keyCode,
                                e = 13 != c && 32 != c && (27 != c || !f("ie")) && (48 > c || 90 < c) && (96 > c || 111 < c) && (186 > c || 192 < c) && (219 > c || 222 < c) && 229 != c;
                            if (e || b.ctrlKey) {
                                e = e ? 0 : c;
                                if (b.ctrlKey) {
                                    if (3 == c || 13 == c) return a.call(b.currentTarget, b);
                ...
                var q = {
                    ...
                    connect: function(b, d, a, c, e) {
                        ...
                        var p = l[f + 1];
                        g.push("string" == typeof p || "function" == typeof p ? l[f++] : null, l[f++]);
        ...
        "dojo/on": function() {
            dojoDefine(["./has!dom-addeventlistener?:./aspect", "./_base/kernel", "./sniff"], function(a, k, h) {
                function n(b, d, a, c, e) {
                    if (c = d.match(/(.*):(.*)/)) return d = c[2], c = c[1], g.selector(c, d).call(e, b, a);
                    h("touch") && (m.test(d) && (a = E(a)), h("event-orientationchange") || "orientationchange" != d || (d = "resize", b = window, a = E(a)));
                    y && (a = y(a));
                ...
                g.matches = function(b, d, a, c, e) {
                    ...
                    for (; !e.matches(b, d, a);)
                        if (b == a || !1 === c || !(b = b.parentNode) || 1 != b.nodeType) return !1;
                    return b;
                };
                g.selector = function(b, d, a) {
                    return function(c, e) {
                        ...
                        var f = "function" == typeof b ? {
                            ...
                            p = d.bubble;
                        return p ? g(c, p(l), e) : g(c, d, function(b) {
                            var d = l(b.target);
                ...
                var b = [].slice,
                    l = g.emit = function(d, a, l) {
                        ...
                        do d[g] && d[g].apply(d, f); while (l && l.bubbles && (d = d.parentNode));
                ...
                if (!h("event-stopimmediatepropagation")) var d = function() {
                        this.modified = this.immediatelyStopped = !0;
                    },
                    y = function(b) {
                        return function(a) {
                            if (!a.immediatelyStopped) return a.stopImmediatePropagation = d, b.apply(this, arguments);
                        };
                    };
                if (h("dom-addeventlistener")) g.emit = function(b, d, a) {
                    ...
                    g._fixEvent = function(b, d) {
                        ...
                        if (!b.target) switch (b.target = b.srcElement, b.currentTarget = d || b.srcElement, "mouseover" == b.type && (b.relatedTarget = b.fromElement), "mouseout" == b.type && (b.relatedTarget = b.toElement), b.stopPropagation || (b.stopPropagation = v, b.preventDefault = u), b.type) {
                            case "keypress":
                                var c = "charCode" in b ? b.charCode : b.keyCode;
                                10 == c ? (c = 0, b.keyCode = 13) : 13 == c || 27 == c ? c = 0 : 3 == c && (c = 99);
                                b.charCode = c;
                                c = b;
                    ...
                    var t = function(b) {
                            return function(d) {
                                ...
                                var a = b.call(this, d);
                                d.modified && (q || setTimeout(function() {
                                    q = null;
                                }), q = d);
                                return a;
                            };
                        ...
                        x = function(b, d, c) {
                            c = t(c);
                            if (((b.ownerDocument ? b.ownerDocument.parentWindow : b.parentWindow || b.window || window) != top || 5.8 > h("jscript")) && !h("config-_allow_leaks")) {
                    ...
                    E = function(b) {
                        return function(d) {
                            ...
                            if (!a) {
                                ...
                                if (d.type) {
                                    if (h("touch-can-modify-event-delegate")) z.prototype = d, a = new z();
                                    else {
                                        var a = {},
                                            l;
                                        for (l in d) a[l] = d[l];
                ...
                function a(a, c, b, e) {
                    ...
                    if (d) {
                        ...
                        remove: function() {
                            if (h.advice) {
                                var d = h.previous,
                                    e = h.next;
                                e || d ? (d ? d.next = e : a[c] = e, e && (e.previous = d)) : delete a[c];
                                a = b = h.advice = null;
                            }
                        },
                        id: n++,
                    ...
                    if (f && !d) {
                        if ("after" == c) {
                            ...
                            f.next = h;
                            h.previous = f;
                        } else "before" == c && (a[c] = h, h.next = f, f.previous = h);
                    } else a[c] = h;
                    return h;
                }
                ...
                function k(c) {
                    return function(e, b, l, f) {
                        ...
                        d && d.target == e || (e[b] = k = function() {
                            for (var b = n, d = arguments, a = k.before; a;) d = a.advice.apply(this, d) || d, a = a.next;
                            if (k.around) var c = k.around.advice(this, d);
                            for (a = k.after; a && a.id < b;) {
                                if (a.receiveArguments) var e = a.advice.apply(this, d),
                                    c = e === h ? c : e;
        ...
        "dojo/_base/event": function() {
            dojoDefine(["./kernel", "../on", "../has", "../dom-geometry"], function(a, k, h, n) {
                if (k._fixEvent) {
                    var c = k._fixEvent;
                ...
                var e = {
                    ...
                    stop: function(a) {
                        h("dom-addeventlistener") || a && a.preventDefault ? (a.preventDefault(), a.stopPropagation()) : (a = a || window.event, a.cancelBubble = !0, k._preventDefault.call(a));
                    }
                };
                a.fixEvent = e.fix;
                a.stopEvent = e.stop;
        ...
        "dojo/dom-geometry": function() {
            dojoDefine(["./sniff", "./_base/window", "./dom", "./dom-style"], function(a, k, h, n) {
                ...
                g.getMarginBox = function(b, c) {
                    ...
                    if (a("mozilla")) {
                        var x = parseFloat(e.left),
                            e = parseFloat(e.top);
                        isNaN(x) || isNaN(e) ? k && k.style && (k = n.getComputedStyle(k), "visible" != k.overflow && (f += "none" != k.borderLeftStyle ? t(b, k.borderLeftWidth) : 0, m += "none" != k.borderTopStyle ? t(b, k.borderTopWidth) : 0)) : (f = x, m = e);
                    } else(a("opera") || 8 == a("ie") && !a("quirks")) && k && (k = n.getComputedStyle(k), f -= "none" != k.borderLeftStyle ? t(b, k.borderLeftWidth) : 0, m -= "none" != k.borderTopStyle ? t(b, k.borderTopWidth) : 0);
                    return {
                        l: f,
                        t: m,
                        w: b.offsetWidth + d.w,
                ...
                g.getContentBox = function(b, c) {
                    ...
                    d ? (e = b.clientHeight, m.w = m.h = 0) : (d = b.offsetWidth, e = b.offsetHeight);
                ...
                g.setContentSize = function(b, a, e) {
                    ...
                    var d = a.w;
                    a = a.h;
                    f(b) && (e = g.getPadBorderExtents(b, e), 0 <= d && (d += e.w), 0 <= a && (a += e.h));
                    c(b, NaN, NaN, d, a);
                };
                var m = {
                    l: 0,
                ...
                g.fixIeBiDiScrollLeft = function(b, c) {
                    ...
                    if (e && !g.isBodyLtr(c)) {
                        var d = a("quirks"),
                            ...
                            m = k.global;
                        6 == e && !d && m.frameElement && f.scrollHeight > f.clientHeight && (b += f.clientLeft);
                ...
                g.position = function(b, c) {
                    ...
                    c && (e = g.docScroll(b.ownerDocument), d.x += e.x, d.y += e.y);
                    return d;
                };
            ...
            dojoDefine(["./kernel", "./lang", "../sniff"], function(a, k, h) {
                var n = {
                    ...
                    withGlobal: function(c, e, f, g) {
                        var m = a.global;
                        try {
                            return a.global = n.global = c, n.withDoc.call(null, c.document, e, f, g);
                        } finally {
                            a.global = n.global = m;
                        }
                    },
                    withDoc: function(c, e, f, g) {
                        var m = n.doc,
                            ...
                            p, d, k;
                        try {
                            return a.doc = n.doc = c, a.isQuirks = h.add("quirks", "BackCompat" == a.doc.compatMode, !0, !0), h("ie") && (k = c.parentWindow) && k.navigator && (p = parseFloat(k.navigator.appVersion.split("MSIE ")[1]) || void 0, (d = c.documentMode) && 5 != d && Math.floor(p) != d && (p = d), a.isIE = h.add("ie", p, !0, !0)), f && "string" == typeof e && (e = f[e]), e.apply(f, g || []);
                        } finally {
                            a.doc = n.doc = m, a.isQuirks = h.add("quirks", b, !0, !0), a.isIE = h.add("ie", l, !0, !0);
                        }
                    }
                };
                k.mixin(a, n);
            ...
            dojoDefine(["./sniff", "./_base/window"], function(a, k) {
                ...
                a("ie") ? h.byId = function(a, e) {
                    ...
                    if (!g || g.attributes.id.value != a && g.id != a) {
                        ...
                        if (!f || f.nodeName) f = [f];
                        for (var m = 0; g = f[m++];)
                            if (g.attributes && g.attributes.id && g.attributes.id.value == a || g.id == a) return g;
                    } else return g;
                } : h.byId = function(a, e) {
                ...
                a.add("css-user-select", function(a, e, f) {
                    ...
                    var g = "userSelect";
                    do
                        if ("undefined" !== typeof a[g]) return g; while (f-- && (g = e[f] + "UserSelect"));
                    return !1;
                });
                var n = a("css-user-select");
                h.setSelectable = n ? function(a, e) {
                    ...
                    var f = a.getElementsByTagName("*"),
                        g = f.length;
                    if (e)
                        for (a.removeAttribute("unselectable"); g--;) f[g].removeAttribute("unselectable");
                    else
                        for (a.setAttribute("unselectable", "on"); g--;) f[g].setAttribute("unselectable", "on");
                };
                return h;
            });
        },
            ...
            dojoDefine(["./sniff", "./dom"], function(a, k) {
                ...
                n = a("webkit") ? function(b) {
                    ...
                    if (1 == b.nodeType) {
                        ...
                        !a && b.style && (b.style.display = "", a = c.getComputedStyle(b, null));
                    }
                    return a || {};
                ...
                var f = function(b, a) {
                    ...
                    m = 9 > a("ie") || 10 > a("ie") && a("quirks") ? function(b, a) {
                        "" === a && (a = 1);
                        var c = 100 * a;
                        1 === a ? (b.style.zoom = "", f(b) && (b.style.filter = b.style.filter.replace(/\s*progid:DXImageTransform.Microsoft.Alpha\([^\)]+?\)/i, ""))) : (b.style.zoom = 1, f(b) ? f(b, 1).Opacity = c : b.style.filter += " progid:DXImageTransform.Microsoft.Alpha(Opacity\x3d" + c + ")", f(b, 1).Enabled = !0);
                        if ("tr" == b.tagName.toLowerCase())
                            for (c = b.firstChild; c; c = c.nextSibling) "td" == c.tagName.toLowerCase() && m(c, a);
                        return a;
                    } : function(b, a) {
        ...
        "dojo/mouse": function() {
            dojoDefine(["./_base/kernel", "./on", "./has", "./dom", "./_base/window"], function(a, k, h, n, c) {
                function e(a, c) {
                    var m = function(b, e) {
                    ...
                    m.bubble = function(b) {
                        return e(a, function(a, c) {
                            var d = b(a.target),
                                e = a.relatedTarget;
                            if (d && d != (e && 1 == e.nodeType && b(e))) return c.call(d, a);
                        });
                    };
                    return m;
                }
                ...
                c = h("dom-quirks") && h("ie") || !h("dom-addeventlistener") ? {
                    LEFT: 1,
                    MIDDLE: 4,
                    RIGHT: 2,
                ...
                a.mouseButtons = c;
                a = h("events-mousewheel") ? "mousewheel" : function(a, c) {
        ...
        "dojo/_base/Deferred": function() {
            dojoDefine("./kernel ../Deferred ../promise/Promise ../errors/CancelError ../has ./lang ../when".split(" "), function(a, k, h, n, c, e, f) {
                var g = function() {},
                    ...
                    b = a.Deferred = function(a) {
                        ...
                        function d() {
                            for (var b; !b && u;) {
                                ...
                                if (d) try {
                                    var f = d(y);
                                    f && "function" === typeof f.then ? f.then(e.hitch(a.deferred, "resolve"), e.hitch(a.deferred, "reject"), e.hitch(a.deferred, "progress")) : (d = b && void 0 === f, b && !d && (x = f instanceof Error), a.deferred[d && x ? "reject" : "resolve"](d ? y : f));
                                } catch (l) {
                                    a.deferred.reject(l);
                                } else x ? a.deferred.reject(y) : a.deferred.resolve(y);
                            }
                        }
                        var y, q, r, t, x, v, u, z = this.promise = new h();
                        ...
                        z.cancel = this.cancel = function() {
                            if (!q) {
                                var b = a && a(w);
                                q || (b instanceof Error || (b = new n(b)), b.log = !1, w.reject(b));
                            }
                            r = !0;
                        };
                        m(z);
        ...
        "dojo/Deferred": function() {
            dojoDefine(["./has", "./_base/lang", "./errors/CancelError", "./promise/Promise", "./promise/instrumentation"], function(a, k, h, n, c) {
                var e = Object.freeze || function() {},
                    ...
                    l = function(b) {
                        var a = this.promise = new n(),
                            ...
                            m, k, t, x = !1,
                            v = [];
                        Error.captureStackTrace && (Error.captureStackTrace(c, l), Error.captureStackTrace(a, l));
                        ...
                        this.cancel = a.cancel = function(a, d) {
                            if (!m) {
                                ...
                                x = !0;
                                if (!m) return "undefined" === typeof a && (a = new h()), u(a), a;
                                if (2 === m && k === a) return a;
        ...
        "dojo/promise/instrumentation": function() {
            dojoDefine(["./tracer", "../has", "../_base/lang", "../_base/array"], function(a, k, h, n) {
                function c(b, a, c) {
                ...
                function g() {
                    ...
                    m = n.filter(m, function(b) {
                        return b.timestamp < d ? (b.handled || c(b.error, b.rejection, b.deferred), !1) : !0;
                    });
                ...
                return function(b) {
                    ...
                    if (d) {
                        ...
                        else if ("report-unhandled-rejections" === d || !0 === d || 1 === d) b.instrumentRejected = f, l = parseInt(c[0], 10) || l;
                        else throw Error("Unsupported instrumentation usage \x3c" + d + "\x3e");
                    }
                };
            });
        },
        "dojo/promise/tracer": function() {
            dojoDefine(["../_base/lang", "./Promise", "../Evented"], function(a, k, h) {
                function n(a) {
                    setTimeout(function() {
                        e.apply(c, a);
                    }, 0);
            ...
            dojoDefine(["./Deferred", "./promise/Promise"], function(a, k) {
                return function(h, n, c, e) {
                    var f = h && "function" === typeof h.then,
                        g = f && h instanceof k;
                    if (!f) return 1 < arguments.length ? n ? n(h) : h : new a().resolve(h);
                    g || (f = new a(h.cancel), h.then(f.resolve, f.reject, f.progress), h = f.promise);
        ...
        "dojo/_base/json": function() {
            dojoDefine(["./kernel", "../json"], function(a, k) {
                ...
                a.toJson = function(h, n) {
                    return k.stringify(h, function(a, e) {
                        if (e) {
            ...
            dojoDefine(["./has"], function(a) {
                ...
                return {
                    parse: a("json-parse") ? JSON.parse : function(a, c) {
                        if (c && !/^([\s\[\{]*(?:"(?:\\.|[^"])*"|-?\d[\d\.]*(?:[Ee][+-]?\d+)?|null|true|false|)[\s\]\}]*(?:,|:|$))+$/.test(a)) throw new SyntaxError("Invalid characters in JSON");
                        return eval("(" + a + ")");
                    },
                    stringify: function(a, c, e) {
                        function f(a, b, l) {
                            ...
                            if (a instanceof Date) return '"{FullYear}-{Month+}-{Date}T{Hours}:{Minutes}:{Seconds}Z"'.replace(/\{(\w+)(\+)?\}/g, function(b, d, c) {
                                b = a["getUTC" + d]() + (c ? 1 : 0);
                                return 10 > b ? "0" + b : b;
                            });
                            ...
                            if (a instanceof Array) {
                                var n = a.length,
                                    r = [];
                                for (l = 0; l < n; l++) k = f(a[l], d, l), "string" != typeof k && (k = "null"), r.push(q + d + k);
                                return "[" + r.join(",") + q + b + "]";
                            }
                            r = [];
                            for (l in a) {
        ...
        "dojo/_base/Color": function() {
            dojoDefine(["./kernel", "./lang", "./array", "./config"], function(a, k, h, n) {
                ...
                k.extend(c, {
                    ...
                    setColor: function(a) {
                        k.isString(a) ? c.fromString(a, this) : k.isArray(a) ? c.fromArray(a, this) : (this._set(a.r, a.g, a.b, a.a), a instanceof c || this.sanitize());
                        return this;
                    },
                    sanitize: function() {
                        return this;
        ...
        "dojo/_base/browser": function() {
            ...
            dojoDefine("../ready ./kernel ./connect ./unload ./window ./event ./html ./NodeList ../query ./xhr ./fx".split(" "), function(a) {
                return a;
            });
        },
                ...
                var n = window,
                    c = {
                        addOnWindowUnload: function(c, f) {
                            a.windowUnloaded || h(n, "unload", a.windowUnloaded = function() {});
        ...
        "dojo/_base/html": function() {
            dojoDefine("./kernel ../dom ../dom-style ../dom-attr ../dom-prop ../dom-class ../dom-construct ../dom-geometry".split(" "), function(a, k, h, n, c, e, f, g) {
                a.byId = k.byId;
        ...
        "dojo/dom-attr": function() {
            dojoDefine("exports ./sniff ./_base/lang ./dom ./dom-style ./dom-prop".split(" "), function(a, k, h, n, c, e) {
                function f(a, c) {
                ...
                a.get = function(a, c) {
                    ...
                    if ("href" != d && ("boolean" == typeof y || h.isFunction(y))) return y;
                    k = m[k] || c;
                ...
                a.set = function(b, f, k) {
                    ...
                    if (q || "boolean" == typeof k || h.isFunction(k)) return e.set(b, f, k);
        ...
        "dojo/dom-prop": function() {
            dojoDefine("exports ./_base/kernel ./sniff ./_base/lang ./dom ./dom-style ./dom-construct ./_base/connect".split(" "), function(a, k, h, n, c, e, f, g) {
                function m(a) {
                    var b = "";
                    a = a.childNodes;
                ...
                a.set = function(d, k, m) {
                    ...
                    if ("innerHTML" == r) return h("ie") && d.tagName.toLowerCase() in {
                        col: 1,
                        colgroup: 1,
                        table: 1,
                        tbody: 1,
                        ...
                        tr: 1,
                        title: 1
                    } ? (f.empty(d), d.appendChild(f.toDom(m, d.ownerDocument))) : d[r] = m, d;
                    if ("textContent" == r && !h("dom-textContent")) return f.empty(d), d.appendChild(d.ownerDocument.createTextNode(m)), d;
                    if (n.isFunction(m)) {
                        var t = d[p];
                        t || (t = l++, d[p] = t);
                        b[t] || (b[t] = {});
        ...
        "dojo/dom-construct": function() {
            dojoDefine("exports ./_base/kernel ./sniff ./_base/window ./dom ./dom-attr".split(" "), function(a, k, h, n, c, e) {
                function f(a, b) {
                    var c = b.parentNode;
                ...
                var m = {
                    ...
                    y;
                for (y in m) m.hasOwnProperty(y) && (k = m[y], k.pre = "option" == y ? '\x3cselect multiple\x3d"multiple"\x3e' : "\x3c" + k.join("\x3e\x3c") + "\x3e", k.post = "\x3c/" + k.reverse().join("\x3e\x3c/") + "\x3e");
                var q;
                8 >= h("ie") && (q = function(a) {
                ...
                a.toDom = function(a, c) {
                    ...
                    var f = a.match(b),
                        ...
                        e = l[e];
                    if (f && m[g])
                        for (f = m[g], e.innerHTML = f.pre + a + f.post, f = f.length; f; --f) e = e.firstChild;
                    else e.innerHTML = a;
                    if (1 == e.childNodes.length) return e.removeChild(e.firstChild);
                    for (g = c.createDocumentFragment(); f = e.firstChild;) g.appendChild(f);
                    return g;
                };
                a.place = function(b, d, e) {
                    ...
                    if ("number" == typeof e) {
                        var g = d.childNodes;
                        !g.length || g.length <= e ? d.appendChild(b) : f(b, g[0 > e ? 0 : e]);
                    } else switch (e) {
                        case "before":
                            f(b, d);
                            break;
                        case "after":
                            e = b;
                            (g = d.parentNode) && (g.lastChild == d ? g.appendChild(e) : g.insertBefore(e, d.nextSibling));
                            break;
                        case "replace":
        ...
        "dojo/dom-class": function() {
            dojoDefine(["./_base/lang", "./_base/array", "./dom"], function(a, k, h) {
                function n(a) {
                ...
                return c = {
                    contains: function(a, b) {
                        return 0 <= (" " + h.byId(a).className + " ").indexOf(" " + b + " ");
                    },
                    add: function(a, b) {
                        a = h.byId(a);
                        b = n(b);
                        var c = a.className,
                            e, c = c ? " " + c + " " : " ";
                        e = c.length;
                        for (var d = 0, f = b.length, g; d < f; ++d)(g = b[d]) && 0 > c.indexOf(" " + g + " ") && (c += g + " ");
                    ...
                    remove: function(c, b) {
                        ...
                        if (void 0 !== b) {
                            b = n(b);
                            e = " " + c.className + " ";
                            for (var f = 0, d = b.length; f < d; ++f) e = e.replace(" " + b[f] + " ", " ");
                            e = a.trim(e);
                        } else e = "";
                    ...
                    toggle: function(a, b, e) {
                        ...
                        if (void 0 === e) {
                            b = n(b);
                            for (var f = 0, d = b.length, g; f < d; ++f) g = b[f], c[c.contains(a, g) ? "remove" : "add"](a, g);
        ...
        "dojo/_base/NodeList": function() {
            dojoDefine(["./kernel", "../query", "./array", "./html", "../NodeList-dom"], function(a, k, h) {
                k = k.NodeList;
                var n = k.prototype;
        ...
        "dojo/query": function() {
            dojoDefine("./_base/kernel ./has ./dom ./on ./_base/array ./_base/lang ./selector/_loader ./selector/_loader!default".split(" "), function(a, k, h, n, c, e, f, g) {
                function m(a, b) {
                    var d = function(c, d) {
                ...
                var b = Array.prototype,
                    ...
                    q = function(a) {
                        ...
                        if (b || !c.sort) {
                            for (var d = b ? this : [], f = d.length = c.length, g = 0; g < f; g++) d[g] = c[g];
                            if (b) return d;
                            c = d;
                        }
                        e._mixin(c, t);
        ...
        "dojo/selector/acme": function() {
            dojoDefine(["../dom", "../sniff", "../_base/array", "../_base/lang", "../_base/window"], function(a, k, h, n, c) {
                var e = n.trim,
                    f = h.forEach,
                    ...
                    l = function(a) {
                        ...
                        for (var b = function(b, c) {
                            ...
                            }, c = [], d = -1, f = -1, g = -1, h = -1, k = -1, l = -1, n = -1, p, E = "", t = "", v, C = 0, q = a.length, r = null, u = null, x = function() {
                                ...
                                0 <= k && (r.classes.push(b(k + 1, C).replace(/\\/g, "")), k = -1);
                            }; E = t, t = a.charAt(C), C < q; C++) "\\" != E && (r || (v = C, r = {
                            query: null,
                            pseudos: [],
                            attrs: [],
                            classes: [],
                        ...
                        }, n = C), p ? t == p && (p = null) : "'" == t || '"' == t ? p = t : 0 <= d ? "]" == t ? (u.attr ? u.matchFor = b(g || d + 1, C) : u.attr = b(d + 1, C), !(d = u.matchFor) || '"' != d.charAt(0) && "'" != d.charAt(0) || (u.matchFor = d.slice(1, -1)), u.matchFor && (u.matchFor = u.matchFor.replace(/\\/g, "")), r.attrs.push(u), u = null, d = g = -1) : "\x3d" == t && (g = 0 <= "|~^$*".indexOf(E) ? E : "", u.type = g + t, u.attr = b(d + 1, C - g.length), g = C + 1) : 0 <= f ? ")" == t && (0 <= h && (u.value = b(f + 1, C)), h = f = -1) : "#" == t ? (x(), l = C + 1) : "." == t ? (x(), k = C) : ":" == t ? (x(), h = C) : "[" == t ? (x(), d = C, u = {}) : "(" == t ? (0 <= h && (u = {
                            name: b(h + 1, C),
                            value: null
                        }, r.pseudos.push(u)), f = C) : " " == t && E != t && (x(), 0 <= h && r.pseudos.push({
                            name: b(h + 1, C)
                        }), r.loops = r.pseudos.length || r.attrs.length || r.classes.length, r.oquery = r.query = b(v, C), r.otag = r.tag = r.oper ? null : r.tag || "*", r.tag && (r.tag = r.tag.toUpperCase()), c.length && c[c.length - 1].oper && (r.infixOper = c.pop(), r.query = r.infixOper.query + " " + r.query), c.push(r), r = null));
                        return c;
                    },
                    p = function(a, b) {
                        return a ? b ? function() {
                    ...
                    E = function(a) {
                        ...
                        e = -1;
                        for (b = b.firstElementChild || b.firstChild; b; b = b[x]) u(b) && (k("ie") ? b.setAttribute("_i", ++c) : b._i = ++c, a === b && (e = c));
                        return e;
                    },
                    C = function(a) {
                        return !(E(a) % 2);
                    ...
                    O = 9 > k("ie") || 9 == k("ie") && k("quirks") ? function(a) {
                        var b = a.toLowerCase();
                        "class" == b && (a = "className");
                        return function(c) {
                    ...
                    N = function(a, c) {
                        ...
                        var d = null;
                        "el" in c || (d = p(d, y));
                        "tag" in c || "*" != a.tag && (d = p(d, function(b) {
                            return b && (m ? b.tagName : b.tagName.toUpperCase()) == a.getTag();
                        }));
                        "classes" in c || f(a.classes, function(a, b, c) {
                        ...
                        "pseudos" in c || f(a.pseudos, function(a) {
                            var b = a.name;
                            Q[b] && (d = p(d, Q[b](b, a.value)));
                        });
                        "attrs" in c || f(a.attrs, function(a) {
                            var b, c = a.attr;
                            a.type && r[a.type] ? b = r[a.type](c, a.matchFor) : c.length && (b = O(c));
                            b && (d = p(d, b));
                        });
                        "id" in c || a.id && (d = p(d, function(b) {
                            return !!b && b.id == a.id;
                        }));
                        d || "default" in c || (d = b);
                        return d;
                    ...
                    J = function(a) {
                        a = a || b;
                        return function(b, c, d) {
                            for (var e = 0, f = b.children || b.childNodes; b = f[e++];) u(b) && (!d || W(b, d)) && a(b, e) && c.push(b);
                            return c;
                        };
                    },
                    P = {},
                    F = function(e) {
                        ...
                        if (h) m = {
                            el: 1
                        }, l && (m.tag = 1), k = N(e, m), "+" == h ? f = R(k) : "~" == h ? f = I(k) : "\x3e" == h && (f = J(k));
                        else if (e.id) k = !e.loops && l ? b : N(e, {
                            el: 1,
                            id: 1
                        }), f = function(b, c) {
                            ...
                            if (f && k(f)) {
                                ...
                                for (var g = f.parentNode; g && g != b;) g = g.parentNode;
                                if (g) return d(f, c);
                            }
                        };
                        else if (m && /\{\s*\[native code\]\s*\}/.test(String(m)) && e.classes.length && !g) var k = N(e, {
                                el: 1,
                                classes: 1,
                                id: 1
                            }),
                            ...
                            f = function(a, b, c) {
                                b = d(0, b);
                                for (var e, f = 0, g = a.getElementsByClassName(n); e = g[f++];) k(e, a) && W(e, c) && b.push(e);
                                return b;
                            };
                        else l || e.loops ? (k = N(e, {
                            el: 1,
                            tag: 1,
                            id: 1
                        }), f = function(a, b, c) {
                            b = d(0, b);
                            for (var f, g = 0, h = (f = e.getTag()) ? a.getElementsByTagName(f) : []; f = h[g++];) k(f, a) && W(f, c) && b.push(f);
                            return b;
                        }) : f = function(a, b, c) {
                            b = d(0, b);
                            for (var f = 0, g = e.getTag(), g = g ? a.getElementsByTagName(g) : []; a = g[f++];) W(a, c) && b.push(a);
                            return b;
                        };
                        return P[e.query] = f;
                    },
                    ...
                    V = function(a, b) {
                        ...
                        if (!K || b || -1 != "\x3e~+".indexOf(c) || k("ie") && -1 != a.indexOf(":") || g && 0 <= a.indexOf(".") || -1 != a.indexOf(":contains") || -1 != a.indexOf(":checked") || -1 != a.indexOf("|\x3d")) {
                            var e = a.match(/([^\s,](?:"(?:\\.|[^"])+"|'(?:\\.|[^'])+'|[^,])*)/g);
                            return A[a] = 2 > e.length ? Z(a) : function(a) {
                                for (var b = 0, c = [], d; d = e[b++];) c = c.concat(Z(d)(a));
                                return c;
                            };
                        }
                    ...
                    ca = function(a) {
                        ...
                        if (k("ie") && m) {
                            ...
                            for (c = 0; c < a.length; c++)(d = a[c]) && y(d) && b.push(d);
                        } catch (f) {} else
                            for (c = 0; c < a.length; c++)(d = a[c]) && d._zipIdx != M && (b.push(d), d._zipIdx = M);
                        return b;
                    },
                    da = function(a, b) {
                        b = b || c.doc;
                ...
                da.filter = function(b, c, d) {
                    for (var e = [], f = l(c), f = 1 != f.length || /[^\w#\.]/.test(c) ? function(b) {
                            return -1 != h.indexOf(da(c, a.byId(d)), b);
                        } : N(f[0]), g = 0, k; k = b[g]; g++) f(k) && e.push(k);
                    return e;
                };
                return da;
            });
        ...
        "dojo/NodeList-dom": function() {
            dojoDefine("./_base/kernel ./query ./_base/array ./_base/lang ./dom-class ./dom-construct ./dom-geometry ./dom-attr ./dom-style".split(" "), function(a, k, h, n, c, e, f, g, m) {
                function b(a) {
                    return function(b, c, d) {
                ...
                n.extend(d, {
                    _normalize: function(b, c) {
                        ...
                        f = typeof b;
                        "string" == f || "number" == f ? (b = e.toDom(b, c && c.ownerDocument), b = 11 == b.nodeType ? n._toArray(b.childNodes) : [b]) : n.isArrayLike(b) ? n.isArray(b) || (b = n._toArray(b)) : b = [b];
                        d && (b._runParse = !0);
                        return b;
                    },
                        ...
                        if (1 == c.nodeType || "only" != d)
                            for (var g, h = b.length, k = h - 1; 0 <= k; k--) {
                                ...
                                if (b._runParse && a.parser && a.parser.parse)
                                    for (g || (g = c.ownerDocument.createElement("div")), g.appendChild(l), a.parser.parse(g), l = g.firstChild; g.firstChild;) g.removeChild(g.firstChild);
                                k == h - 1 ? e.place(l, c, d) : c.parentNode.insertBefore(l, c);
                                c = l;
                            }
                    },
                    ...
                    addContent: function(a, b) {
                        ...
                        for (var c = 0, d; d = this[c]; c++) a.length ? this._place(a, d, b, 0 < c) : e.empty(d);
                        return this;
                    }
                });
                return d;
        ...
        "dojo/_base/xhr": function() {
            dojoDefine("./kernel ./sniff require ../io-query ../dom ../dom-form ./Deferred ./config ./json ./lang ./array ../on ../aspect ../request/watch ../request/xhr ../request/util".split(" "), function(a, k, h, n, c, e, f, g, m, b, l, p, d, y, q, r) {
                a._xhrObj = q._create;
                var t = a.config;
                ...
                a._ioSetArgs = function(d, g, h, k) {
                    ...
                    r.addCallback(h);
                    var q = d.load;
                    q && b.isFunction(q) && r.addCallback(function(a) {
                        return q.call(d, a, l);
                    });
                    var v = d.error;
                    v && b.isFunction(v) && r.addErrback(function(a) {
                        return v.call(d, a, l);
                    });
                    var u = d.handle;
                    u && b.isFunction(u) && r.addBoth(function(a) {
                        return u.call(d, a, l);
                    });
                    r.addErrback(function(a) {
                        return k(a, r);
                    });
                    t.ioPublish && a.publish && !1 !== l.args.ioPublish && (r.addCallbacks(function(b) {
                ...
                var v = function(a) {
                    ...
                    z = function(b) {
                        0 >= w && (w = 0, t.ioPublish && a.publish && (!b || b && !1 !== b.ioArgs.args.ioPublish) && a.publish("/dojo/io/stop"));
                    },
                    w = 0;
                ...
                a._ioNotifyStart = function(b) {
                    t.ioPublish && a.publish && !1 !== b.ioArgs.args.ioPublish && (w || a.publish("/dojo/io/start"), w += 1, a.publish("/dojo/io/send", [b]));
                };
                ...
                return {
                    ...
                    queryToObject: function(h) {
                        ...
                        for (var c = {}, e, f, g = 0, m = h.length; g < m; ++g)
                            if (f = h[g], f.length) {
                                var b = f.indexOf("\x3d");
                                0 > b ? (e = k(f), f = "") : (e = k(f.slice(0, b)), f = k(f.slice(b + 1)));
        ...
        "dojo/dom-form": function() {
            dojoDefine(["./_base/lang", "./dom", "./io-query", "./json"], function(a, k, h, n) {
                var c = {
                    fieldToObject: function(a) {
                        ...
                        if (a = k.byId(a)) {
                            ...
                            if (g && h && !a.disabled)
                                if ("radio" == h || "checkbox" == h) a.checked && (c = a.value);
                                else if (a.multiple) {
                                for (c = [], a = [a.firstChild]; a.length;)
                                    for (g = a.pop(); g; g = g.nextSibling)
                                        if (1 == g.nodeType && "option" == g.tagName.toLowerCase()) g.selected && c.push(g.value);
                                        else {
                    ...
                    toObject: function(e) {
                        ...
                        for (var g = 0, h = e.length; g < h; ++g) {
                            ...
                            if (l && n && 0 > "file|submit|image|reset|button".indexOf(n) && !b.disabled) {
                                ...
                                if (null !== b) {
                                    var q = d[y];
                                    "string" == typeof q ? d[y] = [q, b] : a.isArray(q) ? q.push(b) : d[y] = b;
                                }
        ...
        "dojo/request/watch": function() {
            dojoDefine("./util ../errors/RequestTimeoutError ../errors/CancelError ../_base/array ../_base/window ../has!host-browser?dom-addeventlistener?:../on:".split(" "), function(a, k, h, n, c, e) {
                function f() {
                    for (var a = +new Date(), c = 0, d; c < b.length && (d = b[c]); c++) {
                        var e = d.response,
                            f = e.options;
                        d.isCanceled && d.isCanceled() || d.isValid && !d.isValid(e) ? (b.splice(c--, 1), g._onAction && g._onAction()) : d.isReady && d.isReady(e) ? (b.splice(c--, 1), d.handleResponse(e), g._onAction && g._onAction()) : d.startTime && d.startTime + (f.timeout || 0) < a && (b.splice(c--, 1), d.cancel(new k("Timeout exceeded", e)), g._onAction && g._onAction());
                    }
                ...
                function g(a) {
                    ...
                    a.isFulfilled() || (b.push(a), m || (m = setInterval(f, 50)), a.response.options.sync && f());
                }
                var m = null,
                    b = [];
        ...
        "dojo/request/util": function() {
            dojoDefine("exports ../errors/RequestError ../errors/CancelError ../Deferred ../io-query ../_base/array ../_base/lang ../promise/Promise".split(" "), function(a, k, h, n, c, e, f, g) {
                function m(a) {
                    return l(a);
                }
                ...
                a.deepCreate = function(b, c) {
                    ...
                    var e = f.delegate(b),
                        g, h;
                    for (g in b)(h = b[g]) && "object" === typeof h && (e[g] = a.deepCreate(h, c[g]));
                ...
                a.deferred = function(c, d, e, q, r, t) {
                    var x = new n(function(a) {
                        d && d(x, c);
                        return a && (a instanceof k || a instanceof h) ? a : new h("Request canceled", c);
                    });
                    x.response = c;
                    x.isValid = e;
                    x.isReady = q;
                    ...
                    a.notify && e.then(f.hitch(a.notify, "emit", "load"), f.hitch(a.notify, "emit", "error"));
                    q = e.then(b);
                    r = new g();
        ...
        "dojo/request/xhr": function() {
            dojoDefine(["../errors/RequestError", "./watch", "./handlers", "./util", "../has"], function(a, k, h, n, c) {
                function e(b, c) {
                    var d = b.xhr;
                    ...
                    c ? this.reject(c) : n.checkStatus(d.status) ? this.resolve(b) : (c = new a("Unable to load " + b.url + " status: " + d.status, b), this.reject(c));
                }
                ...
                function g(h, t, x) {
                    ...
                    var z, w = n.deferred(u, d, b, l, e, function() {
                        ...
                        E = u.xhr = g._create();
                    if (!E) return w.cancel(new a("XHR was not created")), x ? w : w.promise;
                    u.getHeader = f;
                    p && (z = p(E, w, u));
                    var C = t.data,
                        X = !t.sync,
                    ...
                    try {
                        ...
                        c("native-response-type") && t.handleAs in m && (E.responseType = m[t.handleAs]);
                        var O = t.headers;
                        h = v ? !1 : "application/x-www-form-urlencoded";
                        if (O)
                            for (var N in O) "content-type" === N.toLowerCase() ? h = O[N] : O[N] && E.setRequestHeader(N, O[N]);
                        h && !1 !== h && E.setRequestHeader("Content-Type", h);
                        O && "X-Requested-With" in O || E.setRequestHeader("X-Requested-With", "XMLHttpRequest");
        ...
        "dojo/request/handlers": function() {
            dojoDefine(["../json", "../_base/kernel", "../_base/array", "../has", "../selector/_loader"], function(a, k, h, n) {
                function c(a) {
                ...
                var e;
                if (n("activex")) {
                    var f = ["Msxml2.DOMDocument.6.0", "Msxml2.DOMDocument.4.0", "MSXML2.DOMDocument.3.0", "MSXML.DOMDocument"],
                        g;
                    e = function(a) {
                        function b(a) {
                            try {
        ...
        "dojo/_base/fx": function() {
            dojoDefine("./kernel ./config ./lang ../Evented ./Color ../aspect ../sniff ../dom ../dom-style".split(" "), function(a, k, h, n, c, e, f, g, m) {
                var b = h.mixin,
                    l = {},
                ...
                h.extend(d, {
                    _startTimer: function() {
                        this._timer || (this._timer = e.after(r, "run", h.hitch(this, "_cycle"), !0), y++);
                ...
                l.animateProperty = function(f) {
                    ...
                    f = new d(f);
                    e.after(f, "beforeBegin", h.hitch(f, function() {
                        var a = {},
                            d;
        ...
        "dojo/_base/loader": function() {
            dojoDefine("./kernel ../has require module ../json ./lang ./array".split(" "), function(a, k, h, n, c, e, f) {
                var g = function(a) {
                        return a.replace(/\./g, "/");
                    },
                    m = /\/\/>>built/,
                    ...
                    d = function() {
                        var a, c;
                        for (c in O)
                            if (a = O[c], void 0 === a.noReqPluginCheck && (a.noReqPluginCheck = /loadInit\!/.test(c) || /require\!/.test(c) ? 1 : 0), !a.executed && !a.noReqPluginCheck && a.injected == z) return;
                        Z(function() {
                            var a = b;
                            b = [];
                    ...
                    y = function(b, c, d) {
                        ...
                        if (0 != f) throw "unmatched paren around character " + e.lastIndex + " in: " + b;
                    ...
                    x = function(a, b) {
                        var c, d, e, f = [],
                            g = [];
                        c = [];
                        for (b = b || a.replace(q, function(a) {
                                r.lastIndex = t.lastIndex = 0;
                                return r.test(a) || t.test(a) ? "" : a;
                            }); c = r.exec(b);) d = r.lastIndex, e = d - c[0].length, d = y(b, d, e), "loadInit" == c[2] ? f.push(d[0]) : g.push(d[0]), r.lastIndex = d[1];
                        c = f.concat(g);
                    ...
                    v = h.initSyncLoader(p, d, function(a, b) {
                        ...
                        e = a.mid + "-*loadInit";
                        for (var h in R("dojo", a).result.scopeMap) f.push(h), g.push('"' + h + '"');
                ...
                a.dojoRequire = function(a, b) {
                    var c = function(a, b) {
                        ...
                        if (Q.length && Q[0].finish) Q[0].finish.push(a);
                            ...
                            if (c.executed) return c.result;
                            d == u ? c.cjs ? N.unshift(c) : Q.length && (Q[0].finish = [a]) : N.push(c);
                        }
                    }(a, b);
                ...
                a.platformRequire = function(b) {
                    ...
                    for (var c; b.length;) e.isArray(c = b.shift()) ? a.dojoRequire.apply(a, c) : a.dojoRequire(c);
                };
                ...
                return {
                    ...
                    loadInit: function(b, c, d) {
                        c([b], function(b) {
                            c(b.names, function() {
                                for (var e = "", f = [], h = 0; h < arguments.length; h++) e += "var " + b.names[h] + "\x3d arguments[" + h + "]; ", f.push(arguments[h]);
                                eval(e);
                                var k = c.module,
                                    l = [],
                                    m, e = {
...
dojoRequire({
    cache: {
        ...
        "dijit/_base/manager": function() {
            dojoDefine(["dojo/_base/array", "dojo/_base/config", "dojo/_base/lang", "../registry", "../main"], function(a, k, h, n, c) {
                var e = {};
        ...
        "dijit/registry": function() {
            dojoDefine(["dojo/_base/array", "dojo/_base/window", "./main"], function(a, k, h) {
                var n = {},
                    c = {},
                    e = {
                        length: 0,
                        add: function(a) {
                            if (c[a.id]) throw Error("Tried to register widget with id\x3d\x3d" + a.id + " but that id is already registered");
                            c[a.id] = a;
                            this.length++;
                        },
                        remove: function(a) {
                        ...
                        getUniqueId: function(a) {
                            var e;
                            do e = a + "_" + (a in n ? ++n[a] : n[a] = 0); while (c[e]);
        ...
        "dojo/parser": function() {
            dojoDefine("require ./_base/kernel ./_base/lang ./_base/array ./_base/config ./dom ./_base/window ./_base/url ./aspect ./promise/all ./date/stamp ./Deferred ./has ./query ./on ./ready".split(" "), function(a, k, h, n, c, e, f, g, m, b, l, p, d, y, q, r) {
                function t(a) {
                    return eval("(" + a + ")");
                }
                ...
                function v(b, c) {
                    ...
                    if (!z[d]) {
                        for (var e = [], f = 0, g = b.length; f < g; f++) {
                            var k = b[f];
                            e[e.length] = z[k] = z[k] || h.getObject(k) || ~k.indexOf("/") && (c ? c(k) : a(k));
                        }
                        f = e.shift();
                        z[d] = e.length ? f.createSubclass ? f.createSubclass(e) : f.extend.apply(f, e) : f;
                    }
                    return z[d];
                }
                new Date("X");
                var u = 0;
                m.after(h, "extend", function() {
                    u++;
                }, !0);
                var z = {},
                    w = {
                        ...
                        construct: function(a, b, c, e, f, p) {
                            function r(a) {
                                U && h.setObject(U, a);
                                for (D = 0; D < G.length; D++) m[G[D].advice || "after"](a, G[D].method, h.hitch(a, G[D].func), !0);
                            ...
                            d("dom-attributes-explicit") ? w = b.attributes : d("dom-attributes-specified-flag") ? w = n.filter(b.attributes, function(a) {
                                return a.specified;
                            }) : (p = (/^input$|^img$/i.test(b.nodeName) ? b : b.cloneNode(!1)).outerHTML.replace(/=[^\s"']+|="[^"]*"|='[^']*'/g, "").replace(/^\s*<[a-zA-Z0-9]*\s*/, "").replace(/\s*>.*$/, ""), w = n.map(p.split(/\s+/), function(a) {
                                var c = a.toLowerCase();
                                return {
                                    name: a,
                            ...
                            p = "data-" + F + "-";
                            var A = {};
                            "dojo" !== F && (A[p + "props"] = "data-dojo-props", A[p + "type"] = "data-dojo-type", A[p + "mixins"] = "data-dojo-mixins", A[F + "type"] = "dojoType", A[p + "id"] = "data-dojo-id");
                            for (var D = 0, z, F = [], U, K; z = w[D++];) {
                                ...
                                switch (A[L] || L) {
                                    ...
                                    case "style":
                                        ...
                                        break;
                                    default:
                                        if (B in v || (B = x(a)[L] || B), B in v) switch (typeof v[B]) {
                                            case "string":
                                                u[B] = z;
                                                break;
                                            case "number":
                                            ...
                                            case "boolean":
                                                ...
                                                break;
                                            case "function":
                                                "" === z || -1 != z.search(/[^\w\.]+/i) ? u[B] = new Function(z) : u[B] = h.getObject(z, !1) || new Function(z);
                                                F.push(B);
                                                break;
                                            default:
                                                L = v[B], u[B] = L && "length" in L ? z ? z.split(/\s*,\s*/) : [] : L instanceof Date ? "" == z ? new Date("") : "now" == z ? new Date() : l.fromISOString(z) : L instanceof g ? k.baseUrl + z : t(z);
                                        } else u[B] = z;
                                }
                            }
                            for (w = 0; w < F.length; w++) A = F[w].toLowerCase(), b.removeAttribute(A), b[A] = null;
                            if (K) try {
                                K = t.call(e.propsThis, "{" + K + "}"), h.mixin(u, K);
                            } catch (ba) {
                                throw Error(ba.toString() + " in data-dojo-props\x3d'" + K + "'");
                            }
                            h.mixin(u, c);
                            f || (f = a && (a._noScript || v._noScript) ? [] : y("\x3e script[type^\x3d'dojo/']", b));
                            var G = [],
                                H = [],
                                V = [],
                                M = [];
                            if (f)
                                for (D = 0; D < f.length; D++) A = f[D], b.removeChild(A), c = A.getAttribute(p + "event") || A.getAttribute("event"), e = A.getAttribute(p + "prop"), K = A.getAttribute(p + "method"), F = A.getAttribute(p + "advice"), w = A.getAttribute("type"), A = this._functionFromScript(A, p), c ? "dojo/connect" == w ? G.push({
                                    method: c,
                                    func: A
                                }) : "dojo/on" == w ? M.push({
                                    event: c,
                                    func: A
                                }) : u[c] = A : "dojo/aspect" == w ? G.push({
                                    method: K,
                                    advice: F,
                                    func: A
                                }) : "dojo/watch" == w ? V.push({
                            ...
                            a = (f = a.markupFactory || v.markupFactory) ? f(u, b, a) : new a(u, b);
                        ...
                        scan: function(b, c) {
                            ...
                            for (var u = {
                                ...
                                if (r) {
                                    ...
                                    else if (x && "script" == r.nodeName.toLowerCase())(B = r.getAttribute("type")) && /^dojo\/\w/i.test(B) && x.push(r), r = r.nextSibling;
                            ...
                            var G = new p();
                            g.length ? (d("dojo-debug-messages"), (c.contextRequire || a)(g, function() {
                                G.resolve(n.filter(f, function(a) {
                                    if (!a.ctor) try {
                    ...
                    n = function() {
                        for (var a = arguments, e = [a[0]], f = 1; f < a.length; f++)
                            if (a[f]) {
                                var g = new n(a[f] + ""),
                                    e = new n(e[0] + "");
                                if ("" == g.path && !g.scheme && !g.authority && !g.query) null != g.fragment && (e.fragment = g.fragment), g = e;
                                else if (!g.scheme && (g.scheme = e.scheme, !g.authority && (g.authority = e.authority, "/" != g.path.charAt(0)))) {
                                    for (var e = (e.path.substring(0, e.path.lastIndexOf("/") + 1) + g.path).split("/"), m = 0; m < e.length; m++) "." == e[m] ? m == e.length - 1 ? e[m] = "" : (e.splice(m, 1), m--) : 0 < m && (1 != m || "" != e[0]) && ".." == e[m] && ".." != e[m - 1] && (m == e.length - 1 ? (e.splice(m, 1), e[m - 1] = "") : (e.splice(m - 1, 2), m -= 2));
                                    g.path = e.join("/");
                                }
                                e = [];
                        ...
                        null != this.authority && (a = this.authority.match(h), this.user = a[3] || null, this.password = a[4] || null, this.host = a[6] || a[7], this.port = a[9] || null);
                    };
        ...
        "dojo/promise/all": function() {
            dojoDefine(["../_base/array", "../Deferred", "../when"], function(a, k, h) {
                var n = a.some;
                return function(a) {
                    var e, f;
                    a instanceof Array ? f = a : a && "object" === typeof a && (e = a);
                    var g, m = [];
                    if (e) {
                        f = [];
                        for (var b in e) Object.hasOwnProperty.call(e, b) && (m.push(b), f.push(e[b]));
                        g = {};
                    } else f && (g = []);
            ...
            dojoDefine(["../_base/lang", "../_base/array"], function(a, k) {
                ...
                h.fromISOString = function(a, c) {
                    ...
                    if (e) {
                        ...
                        e[1] && e[1]--;
                        e[6] && (e[6] *= 1E3);
                        c && (c = new Date(c), k.forEach(k.map("FullYear Month Date Hours Minutes Seconds Milliseconds".split(" "), function(a) {
                            return c["get" + a]();
                        }), function(a, c) {
                            e[c] = e[c] || a;
                        }));
                        f = new Date(e[0] || 1970, e[1] || 0, e[2] || 1, e[3] || 0, e[4] || 0, e[5] || 0, e[6] || 0);
                        100 > e[0] && f.setFullYear(e[0] || 1970);
                        var g = 0,
                            m = e[7] && e[7].charAt(0);
                        "Z" != m && (g = 60 * (e[8] || 0) + (Number(e[9]) || 0), "-" != m && (g *= -1));
                ...
                h.toISOString = function(a, c) {
                    ...
                    var f = [],
                        g = c.zulu ? "getUTC" : "get",
                        h = "";
                    "time" != c.selector && (h = a[g + "FullYear"](), h = ["0000".substr((h + "").length) + h, e(a[g + "Month"]() + 1), e(a[g + "Date"]())].join("-"));
                    f.push(h);
                    if ("date" != c.selector) {
                        h = [e(a[g + "Hours"]()), e(a[g + "Minutes"]()), e(a[g + "Seconds"]())].join(":");
                        g = a[g + "Milliseconds"]();
                        c.milliseconds && (h += "." + (100 > g ? "0" : "") + e(g));
                        if (c.zulu) h += "Z";
                        else if ("time" != c.selector) var g = a.getTimezoneOffset(),
                            b = Math.abs(g),
                            h = h + ((0 < g ? "-" : "+") + e(Math.floor(b / 60)) + ":" + e(b % 60));
                        f.push(h);
                    }
                    return f.join("T");
                };
        ...
        "dojo/request/script": function() {
            dojoDefine("module ./watch ./util ../_base/kernel ../_base/array ../_base/lang ../on ../dom ../dom-construct ../has ../_base/window".split(" "), function(a, k, h, n, c, e, f, g, m, b, l) {
                function p(a, b) {
                    a.canDelete && t._remove(a.id, b.options.frameDoc, !0);
                }

                function d(a) {
                    w && w.length && (c.forEach(w, function(a) {
                ...
                function t(a, b, c) {
                    ...
                    a = g.url;
                    b = g.options;
                    var l = h.deferred(g, p, d, b.jsonp ? null : b.checkString ? q : y, r);
                    e.mixin(l, {
                        id: "dojo_request_script" + x++,
                        canDelete: !1
                    });
                    b.jsonp && (new RegExp("[?\x26]" + b.jsonp + "\x3d").test(a) || (a += (~a.indexOf("?") ? "\x26" : "?") + b.jsonp + "\x3d" + (b.frameDoc ? "parent." : "") + "dojo_request_script_callbacks." + l.id), l.canDelete = !0, z[l.id] = function(a) {
                        g.data = a;
                        l.handleResponse(g);
                    });
                    ...
                    if (!b.canAttach || b.canAttach(l)) {
                        ...
                        if (!b.jsonp && !b.checkString) var n = f(m, v, function(a) {
                            if ("load" === a.type || u.test(m.readyState)) n.remove(), l.scriptLoaded = a;
                        });
                    }
                    k(l);
        ...
        "mojo/signup-forms/Loader": function() {
            dojoDefine(["dojo/request/script"], function(a) {
                return {
                    start: function(k) {
                        if (!(k && k.baseUrl && k.uuid && k.lid)) throw Error("Missing base url, uuid and/or lid parameter(s).");
                    ...
                    _getFormSettingsUrl: function(a, h, n) {
                        return "//" + a + "/subscribe/form-settings?u\x3d" + h + "\x26id\x3d" + n;
                    },
                    _getFormSubscribeUrl: function(a, h, n) {
                        return "//" + a + "/subscribe/form-post?u\x3d" + h + "\x26id\x3d" + n + "\x26popup\x3dtrue";
                    },
