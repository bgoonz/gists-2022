...
(function (f, n) {
  ...
  return {
    best: function (g) {
      ...
      for (m = 0; m < h && "" !== g[m]; m++);
      if (m < d)
        for (g.splice(m, 1, "0000"); g.length < d; ) g.splice(m, 0, "0000");
      for (m = 0; m < d; m++) {
        for (var h = g[m].split(""), f = 0; 3 > f; f++)
...
(function (f) {
  ...
  function h(a, b) {
    return g(a.split(l), b).join(".");
  }
  function d(a) {
    for (var b = [], c = 0, d = a.length, l, e; c < d; )
      (l = a.charCodeAt(c++)),
        55296 <= l && 56319 >= l && c < d
          ? ((e = a.charCodeAt(c++)),
            56320 == (e & 64512)
              ? b.push(((l & 1023) << 10) + (e & 1023) + 65536)
              : (b.push(l), c--))
          : b.push(l);
    return b;
  }
  ...
  function r(a, b, c) {
    var d = 0;
    a = c ? z(a / H) : a >> 1;
    for (a += z(a / b); a > (v * t) >> 1; d += p) a = z(a / v);
    return z(d + ((v + 1) * a) / (a + x));
  }
  function k(b) {
    var c = [],
      d = b.length,
    ...
    0 > g && (g = 0);
    for (v = 0; v < g; ++v)
      128 <= b.charCodeAt(v) && n("not-basic"), c.push(b.charCodeAt(v));
    for (g = 0 < g ? g + 1 : 0; g < d; ) {
      v = e;
      l = 1;
      for (f = p; ; f += p) {
  ...
  function u(b) {
    ...
    l = 0;
    g = F;
    for (k = 0; k < m; ++k) (f = b[k]), 128 > f && u.push(D(f));
    for ((e = B = u.length) && u.push(a); e < m; ) {
      v = q;
      for (k = 0; k < m; ++k) (f = b[k]), f >= c && f < v && (v = f);
      y = e + 1;
      v - c > z((q - l) / y) && n("overflow");
      l += (v - c) * y;
      c = v;
      for (k = 0; k < m; ++k)
        if (((f = b[k]), f < c && ++l > q && n("overflow"), f == c)) {
          h = l;
          for (v = p; ; v += p) {
            f = v <= g ? s : v >= g + t ? t : v - g;
            if (h < f) break;
  ...
  var y = "object" == typeof exports && exports,
    A = "object" == typeof module && module && module.exports == y && module,
    C = "object" == typeof global && global;
  if (C.global === C || C.window === C) f = C;
  var e,
    q = 2147483647,
    p = 36,
    s = 1,
  ...
  e = {
    version: "1.2.3",
    ucs2: { decode: d, encode: m },
    decode: k,
    encode: u,
    toASCII: function (a) {
      return h(a, function (a) {
        return c.test(a) ? "xn--" + u(a) : a;
      });
    },
    toUnicode: function (a) {
      return h(a, function (a) {
        return b.test(a) ? k(a.slice(4).toLowerCase()) : a;
      });
    },
  };
  if (
    ...
    if (A) A.exports = e;
    else for (G in e) e.hasOwnProperty(G) && (y[G] = e[G]);
  else f.punycode = e;
})(this);
(function (f, n) {
  "object" === typeof exports
  ...
  var n = f && f.SecondLevelDomains,
    g = {
      ...
      has: function (h) {
        var d = h.lastIndexOf(".");
        if (0 >= d || d >= h.length - 1) return !1;
        var f = h.lastIndexOf(".", d - 1);
        if (0 >= f || f >= d - 1) return !1;
        var n = g.list[h.slice(d + 1)];
        return n ? 0 <= n.indexOf(" " + h.slice(f + 1, d) + " ") : !1;
      },
      is: function (f) {
        var d = f.lastIndexOf(".");
        ...
        return m ? 0 <= m.indexOf(" " + f.slice(0, d) + " ") : !1;
      },
      get: function (f) {
        var d = f.lastIndexOf(".");
        if (0 >= d || d >= f.length - 1) return null;
        var m = f.lastIndexOf(".", d - 1);
        if (0 >= m || m >= d - 1) return null;
        var n = g.list[f.slice(d + 1)];
        return !n || 0 > n.indexOf(" " + f.slice(m + 1, d) + " ")
          ? null
          : f.slice(m + 1);
      },
      noConflict: function () {
...
(function (f, n) {
  ...
  function k(a, b) {
    ...
    if (r(b)) {
      c = 0;
      for (d = b.length; c < d; c++) if (!k(a, b[c])) return !1;
      return !0;
    }
    var e = w(b);
    c = 0;
  ...
  var p = { encode: "encode", decode: "decode" },
    s,
    t = function (a, b) {
      return function (c) {
  ...
  for (s in p) d[s + "PathSegment"] = t("pathname", p[s]);
  d.encodeReserved = t("reserved", "encode");
  ...
  d.parseUserinfo = function (a, b) {
    var c = a.indexOf("/"),
      l = -1 < c ? a.lastIndexOf("@", c) : a.indexOf("@");
    -1 < l && (-1 === c || l < c)
      ? ((c = a.substring(0, l).split(":")),
  ...
  d.parseQuery = function (a, b) {
    ...
    if (!a) return {};
    for (var c = {}, l = a.split("&"), e = l.length, f, k, g = 0; g < e; g++)
      (f = l[g].split("=")),
        (k = d.decodeQuery(f.shift(), b)),
        (f = f.length ? d.decodeQuery(f.join("="), b) : null),
        c[k]
          ? ("string" === typeof c[k] && (c[k] = [c[k]]), c[k].push(f))
          : (c[k] = f);
    return c;
  };
  d.build = function (a) {
  ...
  d.buildQuery = function (a, b, c) {
    ...
    for (f in a)
      if (q.call(a, f) && f)
        if (r(a[f]))
          for (e = {}, k = 0, g = a[f].length; k < g; k++)
            void 0 !== a[f][k] &&
              void 0 === e[a[f][k] + ""] &&
              ((l += "&" + d.buildQueryParameter(f, a[f][k], c)),
              !0 !== b && (e[a[f][k] + ""] = !0));
        else void 0 !== a[f] && (l += "&" + d.buildQueryParameter(f, a[f], c));
  ...
  d.addQuery = function (a, b, c) {
    if ("object" === typeof b)
      for (var l in b) q.call(b, l) && d.addQuery(a, l, b[l]);
  ...
  d.removeQuery = function (a, b, c) {
    var l;
    if (r(b)) for (c = 0, l = b.length; c < l; c++) a[b[c]] = void 0;
    else if ("object" === typeof b)
      for (l in b) q.call(b, l) && d.removeQuery(a, l, b[l]);
    else if ("string" === typeof b)
      if (void 0 !== c)
        if (a[b] === c) a[b] = void 0;
        else {
          if (r(a[b])) {
            ...
            var e = {},
              f,
              k;
            if (r(c)) for (f = 0, k = c.length; f < k; f++) e[c[f]] = !0;
            else e[c] = !0;
            f = 0;
            for (k = l.length; f < k; f++)
              void 0 !== e[l[f]] && (l.splice(f, 1), k--, f--);
            a[b] = l;
          }
        }
      else a[b] = void 0;
  ...
  d.hasQuery = function (a, b, c, l) {
    if ("object" === typeof b) {
      for (var e in b) if (q.call(b, e) && !d.hasQuery(a, e, b[e])) return !1;
      return !0;
    }
    if ("string" !== typeof b)
      throw new TypeError(
    ...
    switch (w(c)) {
      case "Undefined":
        return b in a;
      case "Boolean":
        return (a = Boolean(r(a[b]) ? a[b].length : a[b])), c === a;
      case "Function":
        return !!c(a[b], b, a);
      case "Array":
        return r(a[b]) ? (l ? k : u)(a[b], c) : !1;
      case "RegExp":
        return r(a[b]) ? (l ? k(a[b], c) : !1) : Boolean(a[b] && a[b].match(c));
      case "Number":
        c = String(c);
      case "String":
        return r(a[b]) ? (l ? k(a[b], c) : !1) : a[b] === c;
      default:
        throw new TypeError(
  ...
  d.withinString = function (a, b, c) {
    ...
    for (l.lastIndex = 0; ; ) {
      ...
      g = g.index;
      if (c.ignoreHtml) {
        var h = a.slice(Math.max(g - 3, 0), g);
        if (h && k.test(h)) continue;
      }
      var h = g + a.slice(g).search(e),
        u = a.slice(g, h).replace(f, "");
      (c.ignore && c.ignore.test(u)) ||
        ((h = g + u.length),
        (u = b(u, g, h, a)),
        (a = a.slice(0, g) + u + a.slice(h)),
        (l.lastIndex = g + u.length));
    }
    l.lastIndex = 0;
    return a;
  };
  d.ensureValidHostname = function (a) {
    if (a.match(d.invalid_hostname_characters)) {
      ...
      if (f.toASCII(a).match(d.invalid_hostname_characters))
        throw new TypeError(
  ...
  e.href = function (a, b) {
    ...
    if ("string" === typeof a) this._parts = d.parse(a, this._parts);
      ...
      for (c in ((l = l ? a._parts : a), l))
        q.call(this._parts, c) && (this._parts[c] = l[c]);
  ...
  e.is = function (a) {
    ...
    this._parts.hostname &&
      ...
      (b = c || e),
      (k = (f = !b) && g && g.has(this._parts.hostname)),
      (h = f && d.idn_expression.test(this._parts.hostname)),
      (u = f && d.punycode_expression.test(this._parts.hostname)));
  ...
  e.tld = function (a, b) {
    ...
    if (void 0 === a) {
      ...
      return !0 !== b && g && g.list[c.toLowerCase()]
        ? g.get(this._parts.hostname) || c
        : c;
    }
    if (a)
  ...
  e.segmentCoded = function (a, b, c) {
    ...
    if (void 0 === b) {
      ...
      if (r(a)) for (e = 0, f = a.length; e < f; e++) a[e] = d.decode(a[e]);
      else a = void 0 !== a ? d.decode(a) : void 0;
      return a;
    }
    if (r(b)) for (e = 0, f = b.length; e < f; e++) b[e] = d.decode(b[e]);
  ...
  e.readable = function () {
    ...
    a._parts.hostname &&
      (a.is("punycode") && f
        ? ((b += f.toUnicode(a._parts.hostname)),
    ...
    if (a._parts.query) {
      for (
        var c = "", e = 0, k = a._parts.query.split("&"), g = k.length;
        e < g;
        e++
      ) {
        var h = (k[e] || "").split("="),
...
(function (f, n) {
  ...
  function g(d) {
    if (g._cache[d]) return g._cache[d];
  ...
  g.expand = function (d, f) {
    var h = r[d.operator],
      m = h.named ? "Named" : "Unnamed",
      n = d.variables,
      e = [],
      q,
      p,
  ...
  g.expandNamed = function (d, g, h, m, n, e) {
    var q = "",
      p = g.encode;
    ...
    var s = !d[p].length,
      ...
      w;
    r = 0;
    for (w = d.val.length; r < w; r++)
      n
        ? ((x = f[p](d.val[r][1].substring(0, n))),
          2 === d.type && (t = f[p](d.val[r][0].substring(0, n))))
        : s
        ? ((x = f[p](d.val[r][1])),
          2 === d.type
            ? ((t = f[p](d.val[r][0])), d[p].push([t, x]))
            : d[p].push([void 0, x]))
        : ((x = d[p][r][1]), 2 === d.type && (t = d[p][r][0])),
        q && (q += m),
        h
          ? (q += t + (g || x ? "=" : "") + x)
          : (r || (q += f[p](e) + (g || x ? "=" : "")),
  ...
  g.expandUnnamed = function (d, g, h, n, m) {
    var e = "",
      q = g.encode;
    g = g.empty_name_separator;
    var p = !d[q].length,
    ...
    for (w = d.val.length; r < w; r++)
      m
        ? (t = f[q](d.val[r][1].substring(0, m)))
        : p
        ? ((t = f[q](d.val[r][1])),
          d[q].push([2 === d.type ? f[q](d.val[r][0]) : void 0, t]))
        : (t = d[q][r][1]),
        e && (e += n),
        2 === d.type &&
          ((s = m ? f[q](d.val[r][0].substring(0, m)) : d[q][r][0]),
          (e += s),
          (e = h ? e + (g || t ? "=" : "") : e + ",")),
        (e += t);
    return e;
  ...
  g.noConflict = function () {
    n.URITemplate === g && (n.URITemplate = d);
    return g;
  };
  w.expand = function (d) {
    var f = "";
    (this.parts && this.parts.length) || this.parse();
    d instanceof h || (d = new h(d));
    for (var m = 0, n = this.parts.length; m < n; m++)
      f +=
        "string" === typeof this.parts[m]
          ? this.parts[m]
          : g.expand(this.parts[m], d);
    return f;
  };
  w.parse = function () {
    ...
    for (f.lastIndex = 0; ; ) {
      p = f.exec(d);
      if (null === p) {
        n.push(d.substring(e));
        break;
      } else n.push(d.substring(e, p.index)), (e = p.index + p[0].length);
      if (!r[p[1]])
        throw Error('Unknown Operator "' + p[1] + '" in "' + p[0] + '"');
      if (!p[3]) throw Error('Unclosed Expression "' + p[0] + '"');
      q = p[2].split(",");
      for (var t = 0, w = q.length; t < w; t++) {
        s = q[t].match(h);
        if (null === s)
          throw Error('Invalid Variable "' + q[t] + '" in "' + p[0] + '"');
        if (s[1].match(m))
          throw Error('Invalid Variable Name "' + s[1] + '" in "' + p[0] + '"');
        q[t] = {
          name: s[1],
          explode: !!s[3],
      ...
      if (!q.length)
        throw Error('Expression Missing Variable(s) "' + p[0] + '"');
      n.push({ expression: p[0], operator: p[1], variables: q });
    }
    n.length || n.push(d);
    this.parts = n;
    return this;
  ...
  h.prototype.get = function (d) {
    var f = this.data,
      ...
      h;
    if (void 0 !== this.cache[d]) return this.cache[d];
    this.cache[d] = g;
    f =
      "[object Function]" === String(Object.prototype.toString.call(f))
        ? f(d)
        : "[object Function]" === String(Object.prototype.toString.call(f[d]))
        ? f[d](d)
        : f[d];
    if (void 0 !== f && null !== f)
  ...
  f.expand = function (d, h) {
    var m = new g(d).expand(h);
    return new f(m);
  };
  return g;
});
