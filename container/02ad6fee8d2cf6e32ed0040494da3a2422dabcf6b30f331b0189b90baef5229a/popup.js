  ...
  cache: {
    ...
    "mojo/signup-forms/PopupSignupForm": function () {
      dojoDefine(
        ...
        function (m, h, g, l, d, b, k, e, a, f, c, C, n, r, x, v, w) {
          var y = null;
          return m("PopupSignupForm", [h, g, w], {
            ...
            postMixInProperties: function () {
              this.config.popupOpacity &&
                (this.popupOpacity = this.config.popupOpacity / 100);
              this.config.popupDelay &&
                (isNaN(Number(this.config.popupDelay))
                  ? (this.popupDelay = this.config.popupDelay)
                  : (this.popupDelay = 1e3 * this.config.popupDelay));
            ...
            startup: function () {
              ...
              null === y &&
                ...
                this._skipShowingPopup() ||
                  ...
                  this._setupModal(),
                  r([this.loadModalCss(), this.loadCustomCss()]).then(
                    e.hitch(this, "openModal")
                  )));
            },
            openModal: function () {
              function a() {
              ...
              function f() {
                window.innerHeight + window.scrollY >=
                  ...
                  (c(), document.removeEventListener("scroll", f, !1));
              }

              function b() {
                window.innerHeight + window.scrollY >=
                  document.body.offsetHeight &&
                  (c(), document.removeEventListener("scroll", b, !1));
              }
              ...
              "exit" == this.popupDelay
                ? -1 < window.navigator.userAgent.indexOf("Edge") ||
                  dojo.isIE ||
                  (window.screen && 640 > window.screen.width)
                  ? setTimeout(c, 1e3)
                  : document.firstElementChild.addEventListener(p, a, !1)
                : "middle" == this.popupDelay
                ? document.addEventListener("scroll", f, !1)
                : "bottom" == this.popupDelay
                ? document.addEventListener("scroll", b, !1)
                : setTimeout(c, this.popupDelay);
            },
            closeModal: function () {
              this._closeModal();
            },
            ...
            _closeModal: function () {
              if (this.closable)
                if (
                  (-1 === window.location.href.indexOf("mailchimp.com") &&
                    this._setCookie(),
                  void 0 === this.modalContainer.style.animation ||
                  ...
                  try {
                    this.modalContainer.addEventListener(
                      ...
                      v.add(this.modalContainer, "mc-modal--close");
                  } catch (a) {
                    this._hideOverlay();
                  }
            },
            ...
            _setupModal: function () {
              this.origOverflowValue = dojo.getComputedStyle(
                document.body
              ).overflow;
              ...
              a(
                k("[data-action\x3d'close-mc-modal']")[0],
                "click",
                e.hitch(this, "closeModal")
              );
              a(
                window.document,
                "keyup",
            ...
            loadModalCss: function () {
              ...
              "dev" == this.env
                ? ((b.href =
                    "//" +
                    this.appDomain +
                    "/css/signup-forms/popup/modal.css"),
                  "slide" === this.config.modalVariation
                    ? (b.href =
                        "//" +
                        this.appDomain +
                        "/css/signup-forms/popup/modal-slidein.css")
                    : "fixed" === this.config.modalVariation &&
                      (b.href =
                        "//" +
                        this.appDomain +
                        "/css/signup-forms/popup/modal-fixed.css"))
                : ((b.href =
                    "//downloads.mailchimp.com/css/signup-forms/popup/" +
                    this.version +
                    "/modal.css"),
                  "slide" === this.config.modalVariation
                    ? (b.href =
            ...
            loadCustomCss: function () {
              ...
              if (this.styles)
                for (var c in this.styles)
                  if (this.styles.hasOwnProperty(c))
                    switch (c) {
                      case "modal":
                        for (var d in this.styles[c])
                          switch (d) {
              ...
              !this.template ||
                (3 !== this.template && 4 !== this.template) ||
                this.addCSSRule(b, ".mc-modal", "width: 603px;");
              a.resolve();
              return a.promise;
            },
            _setCookie: function () {
              ...
              document.cookie =
                "MCPopupClosed\x3dyes;expires\x3d" +
                a.toGMTString() +
                ";path\x3d/";
            },
              ...
              for (i = 0; i < a.length; i++)
                if (
                  ...
                  -1 !== parts[0].indexOf("MCPopupClosed") ||
                    -1 !== parts[0].indexOf("MCPopupSubscribed"))
                )
                  return !0;
              return !1;
            },
        ...
        function (
          ...
          l = b("dijit._WidgetBase", [y, u], {
              ...
              if (!a._setterAttrs) {
                ...
                for (c in b)
                  /^on/.test(c) && (a[c.substring(2).toLowerCase()] = c),
                    /^_set[A-Z](.*)Attr$/.test(c) &&
                      ((c =
                        c.charAt(4).toLowerCase() + c.substr(5, c.length - 9)),
                      (b.attributeMap && c in b.attributeMap) || f.push(c));
              }
            },
            ...
            create: function (a, b) {
              ...
              if (this.domNode) {
                ...
                c &&
                  c.parentNode &&
                  this.domNode !== c &&
                  (c.parentNode.replaceChild(this.domNode, c), (f = !0));
            ...
            startup: function () {
              this._started ||
                ...
                h.forEach(this.getChildren(), function (a) {
                  a._started ||
                    a._destroyed ||
                    !x.isFunction(a.startup) ||
                    (a.startup(), (a._started = !0));
                }));
            },
            ...
            destroy: function (a) {
              function b(f) {
                f.destroyRecursive
                  ? f.destroyRecursive(a)
                  : f.destroy && f.destroy(a);
              }
              this._beingDestroyed = !0;
              this.uninitialize();
              ...
              this.domNode &&
                h.forEach(p.findWidgets(this.domNode, this.containerNode), b);
            ...
            destroyRendering: function (a) {
              ...
              this.domNode &&
                (a
                  ? e.remove(this.domNode, "widgetId")
                  : f.destroy(this.domNode),
                delete this.domNode);
              this.srcNodeRef &&
                (a || f.destroy(this.srcNodeRef), delete this.srcNodeRef);
            },
            ...
            set: function (a, b) {
              ...
              var c = this[f.s];
              if (x.isFunction(c))
                var p = c.apply(this, Array.prototype.slice.call(arguments, 1));
              else {
                var c =
                    this.focusNode && !x.isFunction(this.focusNode)
                      ? "focusNode"
                      : "domNode",
                ...
                f =
                  a in this.attributeMap
                    ...
                    : f.s in this
                    ? this[f.s]
                    : (e && f.l in e && "function" != typeof b) ||
                      /^aria-|^data-|^role$/.test(a)
                    ? c
                    : null;
            ...
            _set: function (a, b) {
              ...
              !this._created ||
                f === b ||
                (f !== f && b !== b) ||
                (this._watchCallbacks && this._watchCallbacks(a, f, b),
            ...
            emit: function (a, b, f) {
              ...
              this._started &&
                ...
                v.emit(this.domNode, a.toLowerCase(), b);
              return c;
            },
            on: function (a, b) {
              var f = this._onMap(a);
            ...
            _onMap: function (a) {
              ...
              if (!f) {
                ...
                for (c in b.prototype)
                  /^on/.test(c) && (f[c.replace(/^on/, "").toLowerCase()] = c);
              }
            ...
            getChildren: function () {
              return this.containerNode
                ? p.findWidgets(this.containerNode)
                : [];
            },
            getParent: function () {
            ...
            placeAt: function (a, b) {
              ...
              !c || !c.addChild || (b && "number" !== typeof b)
                ? ((c =
                    c && "domNode" in c
                      ? c.containerNode && !/after|before|replace/.test(b || "")
                        ? c.containerNode
                        : c.domNode
                      : k.byId(a, this.ownerDocument)),
                  f.place(this.domNode, c, b),
                  !this._started &&
    ...
    "dojo/Stateful": function () {
      dojoDefine(
        ["./_base/declare", "./_base/lang", "./_base/array", "./when"],
        function (m, h, g, l) {
          return m("dojo.Stateful", null, {
            ...
            set: function (d, b) {
              ...
              var a;
              "function" === typeof k
                ? (a = k.apply(this, Array.prototype.slice.call(arguments, 1)))
                : (this[d] = b);
            ...
            own: function () {
              ...
              m.forEach(
                ...
                function (d) {
                  ...
                  var k,
                    e = h.before(this, "destroy", function (a) {
                      d[k](a);
                    }),
                    a = [];
                  d.then
                    ? ((k = "cancel"), d.then(b, b))
                    : m.forEach(g, function (f) {
                        "function" === typeof d[f] &&
                          (k || (k = f), a.push(h.after(d, f, b, !0)));
                      });
                },
                this
              );
    ...
    "dijit/_TemplatedMixin": function () {
      dojoDefine(
        "dojo/cache dojo/_base/declare dojo/dom-construct dojo/_base/lang dojo/on dojo/sniff dojo/string ./_AttachMixin".split(
          " "
        ),
        function (m, h, g, l, d, b, k, e) {
          var a = h("dijit._TemplatedMixin", e, {
            ...
            buildRendering: function () {
              if (!this._rendered) {
                this.templateString ||
                  (this.templateString = m(this.templatePath, {
                    sanitize: !0,
                  }));
                ...
                if (l.isString(b)) {
                  if (
                    ((c = g.toDom(this._stringRepl(b), this.ownerDocument)),
                    1 != c.nodeType)
                  )
                    throw Error("Invalid template: " + b);
          ...
          a.getCachedTemplate = function (b, c, d) {
            ...
            if (l) {
              try {
                if (!l.ownerDocument || l.ownerDocument == (d || document))
                  return l;
              } catch (h) {}
              g.destroy(l);
            }
    ...
    "dijit/_AttachMixin": function () {
      dojoDefine(
        "require dojo/_base/array dojo/_base/connect dojo/_base/declare dojo/_base/lang dojo/mouse dojo/on dojo/touch ./_WidgetBase".split(
          " "
        ),
        function (m, h, g, l, d, b, k, e, a) {
          var f = d.delegate(e, {
              mouseenter: b.enter,
              mouseleave: b.leave,
          ...
          g = l("dijit._AttachMixin", null, {
            ...
            _processTemplateNode: function (a, b, c) {
              ...
              if (g)
                for (var l = g.split(/\s*,\s*/); (g = l.shift()); )
                  d.isArray(e[g]) ? e[g].push(a) : (e[g] = a),
                    (f = "containerNode" != g),
                    this._attachPoints.push(g);
              if (
                (b = b(a, "dojoAttachEvent") || b(a, "data-dojo-attach-event"))
              )
                for (g = b.split(/\s*,\s*/), l = d.trim; (b = g.shift()); )
                  if (b) {
                    var h = null;
                    -1 != b.indexOf(":")
                      ? ((h = b.split(":")), (b = l(h[0])), (h = l(h[1])))
                      : (b = l(b));
                    h || (h = b);
    ...
    "dojo/touch": function () {
      dojoDefine(
        "./_base/kernel ./aspect ./dom ./dom-class ./_base/lang ./on ./has ./mouse ./domReady ./_base/window".split(
          " "
        ),
        function (m, h, g, l, d, b, k, e, a, f) {
          function c(a, c, f) {
            return x && f
              ? function (a, c) {
                  return b(a, f, c);
          ...
          function n(a, c, d) {
            if (!e.isRight(a)) {
              ...
              if ((t = !a.target.disabled && n && n.dojoClick))
                if (
                  ((u = (q = "useTarget" == t) ? n : a.target),
                  q && a.preventDefault(),
                  (z = a.changedTouches
                    ? a.changedTouches[0].pageX - f.global.pageXOffset
                    : a.clientX),
                  (p = a.changedTouches
                      ...
                      function (b) {
                        ...
                        if (
                          ...
                          "click" == a &&
                            ("INPUT" != c.tagName ||
                              ("radio" == c.type &&
                                (l.contains(c, "dijitCheckBoxInput") ||
                                  l.contains(c, "mblRadioButton"))) ||
                              ("checkbox" == c.type &&
                                (l.contains(c, "dijitCheckBoxInput") ||
                                  l.contains(c, "mblCheckBox")))) &&
                            "TEXTAREA" != c.tagName &&
                            "AUDIO" != c.tagName &&
                            "VIDEO" != c.tagName)
                        ) {
                          ...
                          try {
                            if ("A" == c.tagName) {
                              for (
                                ;
                                (c = c.parentElement) &&
                                !c.classList.contains("dijitMenu") &&
                                !c.classList.contains("dijitButtonNode");
          ...
          var r = 5 > k("ios"),
            ...
            v = (function () {
              ...
              for (b in {
                ...
                a[b] = k("MSPointer")
                  ? "MSPointer" + b.charAt(0).toUpperCase() + b.slice(1)
                  : "pointer" + b;
              return a;
            })(),
            w = k("touch-events"),
            ...
            (x
              ...
              : a(function () {
                  ...
                  b(f.doc, "touchmove", function (c) {
                    G = new Date().getTime();
                    var d = f.doc.elementFromPoint(
                      c.pageX - (r ? 0 : f.global.pageXOffset),
                      c.pageY - (r ? 0 : f.global.pageYOffset)
                    );
                    d &&
                      (H !== d &&
                        (b.emit(H, "dojotouchout", {
                          relatedTarget: d,
                          bubbles: !0,
                        }),
                        ...
                        (H = d)),
                      b.emit(d, "dojotouchmove", a(c)) || c.preventDefault());
                  });
    ...
    "mojo/signup-forms/SignupFormFrame": function () {
      dojoDefine(
        ...
        function (m, h, g, l, d, b, k, e, a, f, c, C, n, r, x, v, w, y) {
          var t = {
          ...
          return m([h, y], {
            ...
            constructor: function (a) {
              if (
                !a.iframe ||
                !a.iframe.tagName ||
                "iframe" != a.iframe.tagName.toLowerCase()
              )
                throw Error(
                  "You must specify an iframe attribute to an iframe element"
                );
            },
            postMixInProperties: function () {
              this.config.template && (this.template = this.config.template);
              ...
              this.config.styles && (this.styles = this.config.styles);
              this.styles.hasOwnProperty("modal") &&
                this.styles.modal.hasOwnProperty("max_width") &&
            ...
            postCreate: function () {
              ...
              r([
                ...
                this.loadLayoutCss(),
                this.loadCustomCss(),
              ]).then(d.hitch(this, "updateDocHeight"));
              k(
                window,
                "resize",
            ...
            _overrideDescriptionForFixedLayout: function () {
              ...
              this.signupForm.isStrictContent() &&
                (a = "\x3cp\x3e" + a + "\x3c/p\x3e");
            ...
            _addMobileClass: function (a) {
              ...
              a
                ? n.add(b, "modalContent--mobile")
                : n.remove(b, "modalContent--mobile");
            },
            ...
            loadCommonCss: function () {
              ...
              b.href =
                "dev" === this.env
                  ? "//" + this.appDomain + "/css/signup-forms/popup/common.css"
                  : "//downloads.mailchimp.com/css/signup-forms/popup/" +
                    this.version +
                    "/common.css";
              b.media = "all";
            ...
            loadLayoutCss: function () {
              ...
              "dev" === this.env
                ? ((this.layoutCssNode.href =
                    "//" +
                    this.appDomain +
                    "/css/signup-forms/popup/layout-" +
                    this.template +
                    ".css"),
                  "fixed" === this.config.modalVariation &&
                    ((this.layoutCssNode.href =
                      "//" +
                      this.appDomain +
                      "/css/signup-forms/popup/layout-fixed.css"),
                    (this.template = 1)))
                : ((this.layoutCssNode.href =
                    "//downloads.mailchimp.com/css/signup-forms/popup/" +
                    this.version +
              ...
              this.frameDoc
                ...
                .appendChild(this.layoutCssNode);
              return a.promise;
            },
                    ...
                    switch (c) {
                          ...
                          switch (d) {
                            ...
                            case "alignment":
                              "right" == this.styles[c][d]
                                ? this.addCSSRule(b, ".button", "float:right;")
                                : "center" == this.styles[c][d]
                                ? (this.addCSSRule(
                                    b,
                                    ".button",
                                ...
                                : this.addCSSRule(b, ".button", "float:left;");
                              break;
                            case "style":
                              "full" == this.styles[c][d] &&
                                this.addCSSRule(b, ".button", "width:100%;");
                          }
                        break;
                      case "labels":
                        if (!this.signupForm.isStrictContent())
                          for (d in this.styles[c])
                            switch (d) {
                              case "color":
                                this.addCSSRule(
                                  b,
                      ...
                      case "headingFont":
                        this.addCSSRule(
                          ...
                          ".strictContent h1, .strictContent h2, .strictContent h3, .strictContent h4",
                          "font-family:" +
                            this._getFontFamilyByKey(this.styles[c]) +
                            ";"
                        );
                        break;
                      case "paragraphFont":
      ...
      dojoDefine(
        ...
        function (
          ...
          var F = m([], {
              ...
              d.forEach(
                ...
                a.hitch(this, function (a) {
                  b =
                    "radio" == a.type ||
                    "checkbox" == a.type ||
                    "option" == a.tagName.toLowerCase()
                      ? "boolean" === typeof b
                        ? b && !this._checked(a)
                        : !this._checked(a)
                      : "boolean" === typeof b
                      ? b && this._empty(a.value)
                      : this._empty(a.value);
                })
              );
              return b;
            ...
            isPhone: function () {
              return this._phone(
                this.phoneAreaNode.value,
                this.phoneDetail1Node.value,
                this.phoneDetail2Node.value
              );
            },
            isUrl: function () {
            ...
            isBirthday: function () {
              return (
                this._monthDigits(this.monthNode.value) &&
                this._dayDigits(this.dayNode.value)
              );
            },
            isDate: function () {
              return (
                this._yearDigits(this.yearNode.value) &&
                this._monthDigits(this.monthNode.value) &&
                this._dayDigits(this.dayNode.value)
              );
            },
            isAddress: function () {
              return (
                !this._empty(this.address1Node.value) &&
                !this._empty(this.cityNode.value) &&
                !this._empty(this.stateNode.value) &&
                this._checked(b(":checked", this.countrySelectNode)[0]) &&
                !this._empty(this.zipNode.value)
              );
            },
            ...
            _phone: function (a, b, c) {
              return (
                ...
                this._digits(b) &&
                this._digits(c) &&
                this._exactLength(a, 3) &&
                this._exactLength(b, 3) &&
                this._exactLength(c, 4)
              );
            },
            _checked: function (a) {
          ...
          l = m([l, F], {
            ...
            validateField: function () {
              var a = [],
                ...
                c;
              this.required &&
                ((b = !this.isEmpty()) || a.push("This field is required."));
            ...
            setFieldValidationStatus: function (a) {
              0 < a.length
                ? this.setFieldAsInvalid(a[0])
                : this.setFieldAsValid();
            },
            ...
            _getErrorsNode: function () {
              ...
              a ||
                (a = n.place(
                  '\x3cdiv class\x3d"invalid-error"\x3e\x3c/div\x3e',
                  this.domNode
                ));
              return a;
            },
          ...
          l = m([h, g, l], {
            ...
            postCreate: function () {
              this.inputs = b(
                "input:not([type\x3d'hidden']), select option",
                this.domNode
              );
            ...
            _createPlaceholderNode: function () {
              return n.place(
                '\x3cdiv class\x3d"helpText"\x3e\x3c/div\x3e',
                this.domNode
              );
            },
          });
          var A = m([l], {
            ...
            W = m([l], {
              ...
              toggleEmailPlaceholder: function (a) {
                a
                  ? x.set(this.emailInput, "placeholder", "Enter your email")
                  : x.remove(this.emailInput, "placeholder");
              },
            }),
            N = m([l], {
              templateString: K,
              ...
              postCreate: function () {
                this.inherited(arguments);
                "DD/MM" == this.dateformat &&
                  (n.place(this.dayNode, this.inputsContainer, "first"),
            ...
            E = m([l], {
              ...
              postCreate: function () {
                ...
                "MM/DD/YYYY" == this.dateformat
                  ? (n.place(this.monthNode, this.inputsContainer, "first"),
                    n.place(this.yearNode, this.inputsContainer, "last"))
                  : "DD/MM/YYYY" === this.dateformat &&
                    (n.place(this.dayNode, this.inputsContainer, "first"),
                    n.place(this.yearNode, this.inputsContainer, "last"));
              },
            }),
            ...
            Q = m([l], {
              ...
              postCreate: function () {
                d.forEach(
                  this.choices,
                  a.hitch(this, function (a, b) {
                    var c = this.merge_id
                        ? this.name + "-" + b
                        : this.name + "-" + this.group_id + "-" + b,
                      c = "mc-" + c,
                      f =
                        '\x3cli\x3e\x3cinput id \x3d"' +
                        c +
                        '" type\x3d"' +
                        this.type +
                        '" value\x3d"' +
          ...
          return m("SignupForm", [h, g, y], {
            ...
            postMixInProperties: function () {
              ...
              this.gdprMCLegal = n.toDom(
                "\x3cspan\x3e" + this.config.gdprMCLegal + "\x3c/span\x3e"
              );
              this.config.buttonLabel &&
                (this.buttonLabel = this.config.buttonLabel);
            },
            postCreate: function () {
              this.hasGdprEnabled &&
                ((this.gdprContainer = new S({
                  gdprLabel: this.gdprLabel,
                  gdprDescription: this.gdprDescription,
                  gdprLegal: this.gdprLegal,
                  gdprMCLegal: this.gdprMCLegal,
                })),
                "modal" !== this.modalVariation ||
                  (1 !== this.template && 2 !== this.template) ||
                  this.gdprContainer.placeAt(
                ...
                a.formIsValid
                  ? (a.config.captcha
                      ? ((d = a._getCaptchaForm()),
                        window.open(d),
                        r.set(
                          b(".mc-closeModal", this.modalClose)[0],
                          "display",
                          "none"
                        ),
                        r.set(
                          b(".mc-modal", this.mcModal)[0],
                          "display",
                          "none"
                        ),
                        r.set(
                          b(".mc-modal-bg", this.modalOverlay)[0],
                          "display",
                          "none"
                        ))
                      : f
                          .get(a._getJsonPostUrl(), {
                            jsonp: "c",
                            query: c.toQuery(a.formNode),
                          })
                          .then(function (b) {
                            "error" === b.result
                              ? a._handleErrorResponse(b)
                              : (a._handleSuccessResponse(b),
                                b.webEngagementCookieValue &&
                                  a.setCookie(
                                    "mcListMember",
                                    b.webEngagementCookieValue,
                                    7889238e3
            ...
            isStrictContent: function () {
              return Boolean(
                this.config.styles && this.config.styles.baseFontSize
              );
            },
            getStrictContentContainerClasses: function () {
              return this.isStrictContent()
            ...
            setCookieOnSubscribe: function () {
              ...
              document.cookie =
                "MCPopupSubscribed\x3dyes;expires\x3d" +
                a.toUTCString() +
                ";path\x3d/";
            },
            updateBadge: function () {
              var a =
                  "1.0" !== this.config.version &&
                  !!this.config.useRewards &&
                  !!this.config.rewardsUrl,
                b = this.textBadge && this.textBadgefixed;
              a && !b
                ? ((this.textBadgefixed = new t({
                    rewardsUrl: this.config.rewardsUrl,
                  }).placeAt(this.fixedBadge, "last")),
                  (this.textBadge = new t({
                    rewardsUrl: this.config.rewardsUrl,
                  }).placeAt(this.formContentContainer, "after")))
                : !a &&
                  b &&
                  (this.textBadgefixed.destroyRecursive(!1),
                  this.textBadge.destroyRecursive(!1),
                  (this.textBadge = this.textBadgefixed = null));
            },
            addFields: function () {
              this.fieldNodes.length &&
                ...
                this.hasGdprEnabled &&
                  n.empty(this.gdprContainer.gdprFieldsContainer));
              d.forEach(
                this.fields,
                a.hitch(this, function (a) {
                  var b = this._createField(a);
                  this.hasGdprEnabled && a.marketing_preference_id
                    ? b.placeAt(this.gdprContainer.gdprFieldsContainer)
                    : b.placeAt(this.formFieldsContainer);
                  b.startup();
                })
              );
            },
            ...
            addHoneypot: function () {
              var a = n.toDom(
                '\x3cdiv style\x3d"position:absolute;left:-5000px;"\x3e\x3cinput type\x3d"text" name\x3d"' +
                  this.honeypotFieldName +
                  '" tabindex\x3d"-1" value\x3d""\x3e\x3c/div\x3e'
              );
              "fixed" === this.modalVariation &&
                (a = n.toDom(
                  '\x3cdiv style\x3d"position:absolute;top:-5000px;width:0" aria-hidden\x3d"true"\x3e\x3cinput type\x3d"text" name\x3d"' +
                    this.honeypotFieldName +
                    '" tabindex\x3d"-1" value\x3d""\x3e\x3c/div\x3e'
                ));
            ...
            getOrCreateFormSuccessNode: function () {
              ...
              a ||
                ((a = (
                  ...
                  this.getStrictContentContainerClasses()
                ).trim()),
                (a = n.place(
                  '\x3cdiv class\x3d"' + a + '"\x3e\x3c/div\x3e',
                  this.formResponseMessages
                )));
              return a;
            },
            ...
            _handleSuccessResponse: function (c) {
              var f = this.getOrCreateFormSuccessNode(),
                ...
                p =
                  "custom" !== e
                    ? "\x3cspan style\x3d'font-size: 24px;'\x3e\x3cspan style\x3d'font-family:arial,helvetica neue,helvetica,sans-serif;'\x3e" +
                      c.msg +
                      "\x3c/span\x3e\x3c/span\x3e"
                    : c.msg;
              this.setFormSuccessMessage(p);
              (c = b(".flash-errors", this.formResponseMessages)[0]) &&
                r.set(c, "display", "none");
              this.formNode.reset();
              d.forEach(this.fieldNodes, function (a) {
                a.resetField();
              });
            ...
            _handleErrorResponse: function (a) {
              ...
              a.msg &&
                ((c = b(".flash-errors", this.formResponseMessages)[0]) ||
                  (c = n.place(
                    '\x3cdiv class\x3d"flash-errors"\x3e\x3c/div\x3e',
                    this.formResponseMessages
                  )),
                w.set(c, a.msg),
                "absolute" ===
                  r.getComputedStyle(this.formImageContainer).position &&
                  r.set(this.formImageContainer, {
                    top: C.getMarginBox(c).h + "px",
                  }));
              a.errors &&
                (this.hasGdprEnabled && "gdpr_error" === a.type
                  ? n.place(
                      "\x3cdiv class\x3d'invalid-error'\x3e" +
                        a.errors.msg +
                        "\x3c/div\x3e",
                      this.gdprContainer.gdprFormResponseMessages,
                      "only"
                    )
                  : d.forEach(this.fieldNodes, function (b) {
                      a.errors.hasOwnProperty(b.merge_id)
                        ? b.setFieldAsInvalid(a.errors[b.merge_id])
                        : b.setFieldAsValid();
                    }));
            },
            _getJsonPostUrl: function () {
              ...
              return (a = a.replace(
                "/form-post?u\x3d",
                "/form-post-json?u\x3d"
              ));
            },
            _getCaptchaForm: function () {
              var a = this.subscribeUrl.replace(
                  "/form-post?u\x3d",
                  "/post?u\x3d"
                ),
    ...
    "dijit/_FocusMixin": function () {
      dojoDefine(
        ["./focus", "./_WidgetBase", "dojo/_base/declare", "dojo/_base/lang"],
        function (m, h, g, l) {
          l.extend(h, {
            focused: !1,
            onFocus: function () {},
    ...
    "dijit/focus": function () {
      dojoDefine(
        ...
        function (m, h, g, l, d, b, k, e, a, f, c, C, n, r, x, v, w) {
            ...
            q = new (h([C, k], {
              ...
              constructor: function () {
                var a = e.hitch(this, function (a) {
                  ...
                  g.isDescendant(this.prevNode, a) &&
                ...
                if (e) {
                  var g = c("pointer-events")
                    ...
                    n = a(b.document, g, function (a) {
                      (a && a.target && null == a.target.parentNode) ||
                        d._onTouchNode(f || a.target, "mouse");
                    }),
                    h = a(e, "focusin", function (a) {
                      if (a.target.tagName) {
                        ...
                        "#document" != b &&
                          "body" != b &&
                          (x.isFocusable(a.target)
                            ? d._onFocusNode(f || a.target)
                            : d._onTouchNode(f || a.target));
                      }
                    }),
                ...
                if (a[d] != c[f]) {
                  ...
                  for (e = f; 0 <= e && c[e] != a[e]; e--)
                    if ((f = v.byId(c[e])))
                      (f._hasBeenBlurred = !0),
                        f.set("focused", !1),
                        f._focusManager == this && f._onBlur(b),
                        this.emit("widget-blur", f, b);
                  for (e++; e <= d; e++)
                    if ((f = v.byId(a[e])))
                      f.set("focused", !0),
                        f._focusManager == this && f._onFocus(b),
                        this.emit("widget-focus", f, b);
                }
              },
              focus: function (a) {
                if (a)
          ...
          for (var u in q)
            /^_/.test(u) ||
              (w.focus[u] = "function" == typeof q[u] ? e.hitch(q, u) : q[u]);
    ...
    "dojo/window": function () {
      dojoDefine(
        "./_base/lang ./sniff ./_base/window ./dom ./dom-geometry ./dom-style ./dom-construct".split(
          " "
        ),
        function (m, h, g, l, d, b, k) {
          ...
          var e = {
            getBox: function (a) {
              a = a || g.doc;
              var b =
                  "BackCompat" == a.compatMode ? g.body(a) : a.documentElement,
                c = d.docScroll(a);
              if (h("touch")) {
                var l = e.get(a);
            ...
            get: function (a) {
              if (h("ie") && e !== document.parentWindow) {
                a.parentWindow.execScript(
                  "document._parentWindow \x3d window;",
                  "Javascript"
                );
            ...
            scrollIntoView: function (a, f) {
              try {
                ...
                if (a != e && a != n)
                  if (
                    !(h("mozilla") || k || m || h("opera") || h("trident")) &&
                    "scrollIntoView" in a
                  )
                    a.scrollIntoView(!1);
                  else {
                    var v = "BackCompat" == c.compatMode,
                      w = Math.min(
                        ...
                        n.clientWidth || e.clientWidth
                      ),
                      y = Math.min(
                        e.clientHeight || n.clientHeight,
                        n.clientHeight || e.clientHeight
                      ),
                      c = m || v ? e : n,
                      t = f || d.position(a),
                      q = a.parentNode,
                      m = function (a) {
                        return 6 >= k || (7 == k && v)
                          ? !1
                          : h("position-fixed-support") &&
                              "fixed" == b.get(a, "position").toLowerCase();
                      },
                      u = this,
                      z = function (a, b, c) {
                        "BODY" == a.tagName || "HTML" == a.tagName
                          ? u.get(a.ownerDocument).scrollBy(b, c)
                          : (b && (a.scrollLeft += b), c && (a.scrollTop += c));
                      };
                    if (!m(a))
                      for (; q; ) {
                        q == e && (q = c);
                        var p = d.position(q),
                          ...
                          K =
                            "rtl" ==
                            b.getComputedStyle(q).direction.toLowerCase();
                        if (q == c) {
                          p.w = w;
                          p.h = y;
                          c == n &&
                          ...
                          0 < G &&
                            0 < H &&
                            (K &&
                              h("rtl-adjust-position-for-verticalScrollBar") &&
                              (p.x += H),
                            (p.w = G));
                          G = q.clientHeight;
                          H = p.h - G;
                        ...
                        0 < T * O &&
                          (q.scrollLeft ||
                            q == c ||
                            q.scrollWidth > q.offsetHeight) &&
                          ((F = Math[0 > O ? "max" : "min"](O, T)),
                          K &&
                            ((8 == k && !v) || 9 <= k || h("trident")) &&
                            (F = -F),
                          (A = q.scrollLeft),
                        ...
                        0 < U * P &&
                          (q.scrollTop ||
                            q == c ||
                            q.scrollHeight > q.offsetHeight) &&
                          ((F = Math.ceil(Math[0 > P ? "max" : "min"](P, U))),
                          (A = q.scrollTop),
                          z(q, 0, F),
                          (F = q.scrollTop - A),
                          (t.y -= F));
    ...
    "dijit/a11y": function () {
      dojoDefine(
        "dojo/_base/array dojo/dom dojo/dom-attr dojo/dom-style dojo/_base/lang dojo/sniff ./main".split(
          " "
        ),
        function (m, h, g, l, d, b, k) {
          var e = {
            ...
            hasDefaultTabStop: function (a) {
              switch (a.nodeName.toLowerCase()) {
                ...
                case "iframe":
                  ...
                  return (
                    b &&
                    ("true" == b.contentEditable ||
                      (b.firstChild && "true" == b.firstChild.contentEditable))
                  );
                default:
            ...
            effectiveTabIndex: function (a) {
              return g.get(a, "disabled")
                ? void 0
                : g.has(a, "tabIndex")
                ? +g.get(a, "tabIndex")
                : e.hasDefaultTabStop(a)
                ? 0
                : void 0;
            },
    ...
    "dojo/request/script": function () {
      dojoDefine(
        ...
        function (m, h, g, l, d, b, k, e, a, f, c) {
          function C(a, b) {
          ...
          function w(a, c, f) {
            ...
            var e = g.deferred(
              ...
              C,
              n,
              c.jsonp ? null : c.checkString ? x : r,
              v
            );
            b.mixin(e, {
            ...
            if (!c.canAttach || c.canAttach(e)) {
              ...
              if (!c.jsonp && !c.checkString)
                var m = k(l, t, function (a) {
                  if ("load" === a.type || q.test(l.readyState))
                    m.remove(), (e.scriptLoaded = a);
                });
            }
            h(e);
    ...
    "dojo/html": function () {
      dojoDefine(
        "./_base/kernel ./_base/lang ./_base/array ./_base/declare ./dom ./dom-construct ./parser".split(
          " "
        ),
        function (m, h, g, l, d, b, k) {
          var e = 0,
            a = {
              ...
              _ContentSetter: l("dojo.html._ContentSetter", null, {
                ...
                constructor: function (a, b) {
                  ...
                  this.id ||
                    (this.id = ["Setter", b ? b.id || b.tagName : "", e++].join(
                      "_"
                    ));
                },
                set: function (a, b) {
                ...
                setContent: function () {
                  ...
                  if (!b)
                    throw Error(
                      this.declaredClass + ": setContent given no node"
                    );
                  try {
                ...
                empty: function () {
                  ...
                  this.parseResults &&
                    ...
                    (g.forEach(this.parseResults, function (a) {
                      a.destroy && a.destroy();
                    }),
                ...
                onBegin: function () {
                  ...
                  if (
                    h.isString(b) &&
                    (this.cleanContent && (b = a._secureForInnerHtml(b)),
                    this.extractContent)
                  ) {
              ...
              set: function (b, c, d) {
                void 0 == c && (c = "");
                return d
                  ? new a._ContentSetter(
                      h.mixin(d, {
                        content: c,
                        node: b,
                      })
                    ).set()
                  : a._setNodeContent(b, c, !0);
              },
            };
    ...
    "dojo/parser": function () {
      dojoDefine(
        ...
        function (m, h, g, l, d, b, k, e, a, f, c, C, n, r, x, v) {
          function w(a) {
            return eval("(" + a + ")");
          }
          ...
          var u = {},
            z = {
              ...
              _functionFromScript: function (a, b) {
                ...
                e &&
                  e.length &&
                  l.forEach(e.split(/\s*,\s*/), function (a) {
                    c += "with(" + a + "){";
                    d += "}";
                  });
              ...
              instantiate: function (a, b, c) {
                ...
                l.forEach(a, function (a) {
                  var c =
                    d in b ? b[d] : a.getAttribute(e) || a.getAttribute(d);
                  if (c) {
              ...
              construct: function (b, d, f, k, m, q) {
                ...
                q && g.mixin(v, q);
                var t;
                n("dom-attributes-explicit")
                  ? (t = d.attributes)
                  : n("dom-attributes-specified-flag")
                  ? (t = l.filter(d.attributes, function (a) {
                      return a.specified;
                    }))
                  : ((q = (
                      /^input$|^img$/i.test(d.nodeName) ? d : d.cloneNode(!1)
                    ).outerHTML
                      .replace(/=[^\s"']+|="[^"]*"|='[^']*'/g, "")
                      .replace(/^\s*<[a-zA-Z0-9]*\s*/, "")
                      .replace(/\s*>.*$/, "")),
                    (t = l.map(q.split(/\s+/), function (a) {
                      var b = a.toLowerCase();
                      return {
                        name: a,
                        value:
                          ("LI" == d.nodeName && "value" == a) || "enctype" == b
                            ? d.getAttribute(b)
                            : d.getAttributeNode(b).value,
                      };
                    })));
                      ...
                      if ((E in C || (E = y(b)[I] || E), E in C))
                        switch (typeof C[E]) {
                          ...
                          case "function":
                            "" === D || -1 != D.search(/[^\w\.]+/i)
                              ? (v[E] = new Function(D))
                              : (v[E] = g.getObject(D, !1) || new Function(D));
                            F.push(E);
                            break;
                          default:
                            (I = C[E]),
                ...
                for (t = 0; t < F.length; t++)
                  (A = F[t].toLowerCase()), d.removeAttribute(A), (d[A] = null);
                if (N)
                  try {
                    (N = w.call(k.propsThis, "{" + N + "}")), g.mixin(v, N);
                  } catch (V) {
                    throw Error(
                      V.toString() + " in data-dojo-props\x3d'" + N + "'"
                    );
                  }
                g.mixin(v, f);
                m ||
                  (m =
                    b && (b._noScript || C._noScript)
                      ? []
                      : r("\x3e script[type^\x3d'dojo/']", d));
                var J = [],
                  Q = [],
                  R = [],
                  S = [];
                if (m)
                  for (B = 0; B < m.length; B++)
                    (A = m[B]),
                      d.removeChild(A),
                      (f =
                        A.getAttribute(q + "event") || A.getAttribute("event")),
                      (k = A.getAttribute(q + "prop")),
                      (N = A.getAttribute(q + "method")),
                      (F = A.getAttribute(q + "advice")),
                      ...
                      f
                        ...
                        : Q.push(A);
                b = (m = b.markupFactory || C.markupFactory)
                  ? m(v, d, b)
                  : new b(v, d);
              ...
              scan: function (a, b) {
                ...
                for (
                  ...
                  if (u) {
                    if (1 != u.nodeType) u = u.nextSibling;
                    else if (z && "script" == u.nodeName.toLowerCase())
                      (E = u.getAttribute("type")) &&
                        /^dojo\/\w/i.test(E) &&
                        z.push(u),
                        (u = u.nextSibling);
                      ...
                      if (E || (x && (3 != x.nodeType || x.nextSibling))) {
                        ...
                        y =
                          u.stopParser ||
                          (y && y.prototype.stopParser && !b.template);
                        u = x;
                ...
                var J = new C();
                f.length
                  ? (n("dojo-debug-messages"),
                    (b.contextRequire || m)(f, function () {
                      J.resolve(
                        l.filter(d, function (a) {
                          if (!a.ctor)
                            try {
      ...
      dojoDefine(["./kernel"], function (m) {
        var h = /^(([^:/?#]+):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?$/,
          ...
          l = function () {
            for (var d = arguments, b = [d[0]], k = 1; k < d.length; k++)
              if (d[k]) {
                ...
                if ("" == e.path && !e.scheme && !e.authority && !e.query)
                  null != e.fragment && (b.fragment = e.fragment), (e = b);
                else if (
                  !e.scheme &&
                  ((e.scheme = b.scheme),
                  !e.authority &&
                    ((e.authority = b.authority), "/" != e.path.charAt(0)))
                ) {
                  for (
                    var b = (
                        b.path.substring(0, b.path.lastIndexOf("/") + 1) +
                        e.path
                      ).split("/"),
                      a = 0;
                    a < b.length;
            ...
            null != this.authority &&
              ((d = this.authority.match(g)),
              (this.user = d[3] || null),
              (this.password = d[4] || null),
              (this.host = d[6] || d[7]),
              (this.port = d[9] || null));
          };
      ...
      dojoDefine(
        ...
        function (m, h, g) {
          ...
          return function (d) {
            ...
            d instanceof Array
              ? (k = d)
              : d && "object" === typeof d && (b = d);
            var e,
              a = [];
            if (b) {
              k = [];
              for (var f in b)
                Object.hasOwnProperty.call(b, f) && (a.push(f), k.push(b[f]));
              e = {};
            } else k && (e = []);
    ...
    "mojo/widgets/badges/TextBadge": function () {
      dojoDefine(
        [
          ...
          "dojo/text!./templates/textBadge.html",
          "dojo/dom-attr",
        ],
        function (m, h, g, l, d) {
          return m([h, g], {
      ...
      dojoDefine(["dojo/_base/declare", "dojo/sniff"], function (m, h) {
        return m([], {
          ...
          getStyleSheet: function (g) {
            9 > h("ie")
              ? (g = g.styleSheet)
              : (g.appendChild(document.createTextNode("")), (g = g.sheet));
        ...
        function (m, h, g, l, d, b, k, e, a, f, c, C, n, r, x, v, w, y) {
          ...
          return m([h, y], {
            ...
            loadBannerCss: function () {
              ...
              b.href =
                "dev" == this.env
                  ? "//" + this.appDomain + "/css/signup-forms/popup/banner.css"
                  : "//downloads.mailchimp.com/css/signup-forms/popup/" +
                    this.version +
                    "/banner.css";
              b.media = "all";
    ...
    "dojo/NodeList-manipulate": function () {
      dojoDefine(
        "./query ./_base/lang ./_base/array ./dom-construct ./dom-attr ./NodeList-dom".split(
          " "
        ),
        function (m, h, g, l, d) {
          function b(a) {
          ...
          function k(a, b) {
            "string" == typeof a
              ? ((a = l.toDom(a, b && b.ownerDocument)),
                11 == a.nodeType && (a = a.childNodes[0]))
              : 1 == a.nodeType && a.parentNode && (a = a.cloneNode(!1));
            return a;
          }
          var e = m.NodeList;
          h.extend(e, {
            _placeMultiple: function (a, b) {
              for (
                var c = "string" == typeof a || a.nodeType ? m(a) : a,
                  d = [],
                  e = 0;
                e < c.length;
                e++
                ...
                for (
                  var g = c[e], h = this.length, k = h - 1, w;
                  (w = this[k]);
                  k--
                )
                  0 < e && ((w = this._cloneNode(w)), d.unshift(w)),
                    k == h - 1
                      ? l.place(w, g, b)
              ...
              d.length &&
                (d.unshift(0),
                d.unshift(this.length - 1),
                Array.prototype.splice.apply(this, d));
              return this;
            },
            innerHTML: function (a) {
              return arguments.length
                ? this.addContent(a, "only")
                : this[0].innerHTML;
            },
            text: function (a) {
              if (arguments.length) {
                for (var b = 0, c; (c = this[b]); b++)
                  1 == c.nodeType && d.set(c, "textContent", a);
                return this;
              }
              for (var e = "", b = 0; (c = this[b]); b++)
                e += d.get(c, "textContent");
              return e;
            },
            val: function (a) {
              if (arguments.length) {
              ...
              if ((d = this[0]) && 1 == d.nodeType) {
                ...
                if ("SELECT" == d.nodeName.toUpperCase() && d.multiple) {
                  ...
                  for (k = 0; k < e.length; k++)
                    (m = e[k]), m.selected && a.push(m.value);
                  a.length || (a = null);
                }
                return a;
              }
            ...
            replaceAll: function (a) {
              a = m(a);
              for (
                var b = this._normalize(this, this[0]), c = 0, d;
                (d = a[c]);
                c++
              )
    ...
    "url:mojo/signup-forms/templates/gdprBlock.html":
