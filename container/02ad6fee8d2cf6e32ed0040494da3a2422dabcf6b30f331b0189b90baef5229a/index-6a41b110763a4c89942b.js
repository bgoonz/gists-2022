                  ...
                  children: [
                    (0, i.jsx)("pre", {
                      children: (0, i.jsxs)("code", {
                        ...
                        children: [
                          ...
                          " addFileButton = document.getElementById(",
                          (0, i.jsx)("span", {
                            className: "hljs-string",
                          ...
                          "\n",
                          "          ",
                          "processFileButton.forEach((btn) => (btn.disabled = ",
                          (0, i.jsx)("span", {
                            className: "hljs-literal",
                            children: "true",
                          }),
                    ...
                    (0, i.jsxs)("p", {
                      children: [
                        ...
                        " useEffect, useState ",
                        "}",
                        ' from "react"; import PDFButtons from "./PDFButtons"; import imageDataURLfromFile from "../../methods/imageDataURLfromFile";',
                      ],
                    }),
                    (0, i.jsxs)("p", {
                      children: [
                    ...
                    (0, i.jsxs)("p", {
                      children: [
                        "  useEffect(() => ",
                        "{",
                        "const temp = []; const arr = Array.from(files); const myFunction = async () => ",
                        "{",
                        'const addFileButton = document.getElementById("addFileButton"); const processFileButton = document.querySelectorAll("#processFileButton"); addFileButton.innerText = "Adding Files ..."; addFileButton.disabled = true; processFileButton.forEach((btn) => (btn.disabled = true));',
                      ],
                    }),
                    (0, i.jsx)("pre", {
                      children: (0, i.jsxs)("code", {
                    ...
                    (0, i.jsxs)("p", {
                      children: [
                        ...
                        "{",
                        'e.target.innerText = "Processing Files...."; e.target.disabled = true; const filteredFiles = filesLocal.filter((file) => !file.deleted); await method(filteredFiles); e.target.innerText = "Save and Download"; e.target.disabled = false;',
                        "}",
                        ";",
                      ],
                    }),
                          ...
                          children: [
                            ...
                            (0, i.jsxs)("p", {
                              ...
                              children: [
                                ...
                                ".** please take a moment to understand the different layers ** the\xa0",
                                (0, i.jsx)("span", {
                                  className: "caps",
                                  style: {
                                    boxSizing: "border-box",
                                    ...
                                    (0, i.jsxs)("tr", {
                                      ...
                                      children: [
                                        ...
                                        (0, i.jsxs)("td", {
                                          ...
                                          children: [
                                            "The core layer is where a binary\xa0",
                                            (0, i.jsx)("span", {
                                              className: "caps",
                                              style: {
                                                boxSizing: "border-box",
                                            ...
                                            " ",
                                            "is parsed and interpreted. This layer is the foundation for all subsequent layers. ** is not ********** here because using it ******** is considered an advanced usage and the\xa0",
                                            (0, i.jsx)("span", {
                                              className: "caps",
                                              style: {
                                                boxSizing: "border-box",
                                            ...
                                            " ",
                                            "is likely to change. For an example of using the core layer see the\xa0",
                                            (0, i.jsxs)("a", {
                                    ...
                                    (0, i.jsxs)("tr", {
                                      ...
                                      children: [
                                        ...
                                        (0, i.jsxs)("td", {
                                          ...
                                          children: [
                                            "The display layer ***** the core ***** and exposes an easier to use\xa0",
                                            (0, i.jsx)("span", {
                                              className: "caps",
                                              style: {
                                                boxSizing: "border-box",
                                            ...
                                            " ",
                                            "to render PDFs and get other *********** out of a document. This\xa0",
                                            (0, i.jsx)("span", {
                                              className: "caps",
                                              style: {
                                                boxSizing: "border-box",
                                    ...
                                    (0, i.jsxs)("tr", {
                                      ...
                                      children: [
                                        ...
                                        (0, i.jsxs)("td", {
                                          ...
                                          children: [
                                            "The viewer is built on the display layer and is the\xa0",
                                            (0, i.jsx)("span", {
                                              className: "caps",
                                              style: {
                                                boxSizing: "border-box",
                                            ...
                                            " ",
                                            "****** ** ******* and the other browser extensions within the project. It can be a good starting point for ******** your *** viewer.\xa0",
                                            (0, i.jsx)("em", {
                                              style: {
                                                boxSizing: "border-box",
                                              },
                                              children:
                                                "However, we do *** if you plan to embed the viewer in your own site, that it not just be an unmodified version. Please re-skin it or build **** it.",
                                            }),
                                          ],
                                        }),
                                      ],
                                ...
                                (0, i.jsxs)("div", {
                                  ...
                                  children: [
                                    ...
                                    (0, i.jsxs)("p", {
                                      ...
                                      children: [
                                        "Includes the generic build of\xa0",
                                        (0, i.jsx)("span", {
                                          className: "caps",
                                          style: {
                                            boxSizing: "border-box",
                            ...
                            (0, i.jsx)("pre", {
                              ...
                              children: (0, i.jsxs)("code", {
                                ...
                                children: [
                                  ...
                                  "\u251c\u2500\u2500 pdf.*.js",
                                  "                           ",
                                  "- wrapper files *** bundling",
                                  "\n",
                                  "\u2502",
                                  "   ",
                                  "\u2514\u2500\u2500 worker_loader.js",
                                  "                   ",
                                  "- **** for developer builds to **** worker files",
                                  "\n",
                                  "\u251c\u2500\u2500 test/",
                                  "                                  ",
                                  "- unit, font and reference tests",
                                  "\n",
                                  "\u251c\u2500\u2500 web/",
                                  "                                   ",
                                  "- viewer layer",
                            ...
                            (0, i.jsxs)("p", {
                              ...
                              children: [
                                "With the prebuilt ** source version, open\xa0",
                                (0, i.jsx)("code", {
                                  style: {
                                    boxSizing: "border-box",
                                    fontFamily: '"Anonymous Pro", monospace',
                                ...
                                " ",
                                "in a browser and the test pdf should load. Note: the worker is not enabled for file:// urls, so use a server. If you\u2019re using the source build and have node, you can run\xa0",
                                (0, i.jsx)("code", {
                                  style: {
                                    boxSizing: "border-box",
                                    fontFamily: '"Anonymous Pro", monospace',
                            ...
                            (0, i.jsxs)("p", {
                              ...
                              children: [
                                "For a further walkthrough ** a ******* viewer, *** the ***** world example. More documentation *** be found in our\xa0",
                                (0, i.jsx)("a", {
