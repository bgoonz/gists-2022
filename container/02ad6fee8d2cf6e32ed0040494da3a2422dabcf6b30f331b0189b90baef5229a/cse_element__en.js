(function () {
  ...
  ka(
    ...
    function (a) {
      ...
      k.prototype.has = function (l) {
        return c(l) && Ia(l, f) && Ia(l[f], this.Fb);
      };
  ...
  ka(
    ...
    function (a) {
      ...
      c.prototype.delete = function (k) {
        ...
        return k.Fa && k.list
          ? (k.list.splice(k.index, 1),
            k.list.length || delete this.Ve[k.id],
            (k.Fa.dc.next = k.Fa.next),
            (k.Fa.next.dc = k.Fa.dc),
            (k.Fa.head = null),
            this.size--,
            !0)
          : !1;
      ...
      c.prototype.forEach = function (k, l) {
        for (var m = this.entries(), u; !(u = m.next()).done; )
          (u = u.value), k.call(l, u[1], u[0], this);
      };
  ...
  function Nb() {
    ...
    B("Windows")
      ...
      : -1 != xb().toLowerCase().indexOf("kaios")
  ...
  var Gc = function (a, b, c) {
      ...
      a: {
        ...
        void 0 !== b && -1 < b
          ? ((this.je = Math.max(b, a + 1 - this.zd)), (this.rb = null))
          : (this.je = Number.MAX_VALUE);
      }
      if (c)
  ...
  g.Ac = function (a, b) {
    return -1 === a
      ...
      ? this.rb
        ? this.rb[a]
        : void 0
      : (void 0 === b ? 0 : b) && this.rb && this.rb[a]
      ? this.rb[a]
      : this.$a[a + this.zd];
  };
  g.Iw = function (a) {
      ...
      for (var d in c) {
        ...
        if (e) {
          ...
          if (Array.isArray(e)) {
            if (e.length)
              for (
                f = a.Sj(e[0].constructor, h, f), h = 0;
                h < Math.min(f.length, e.length);
                h++
              )
                Ic(f[h], e[h]);
  ...
  function Mc() {
    ...
    function b(t) {
      for (var z = h, v = 0; 64 > v; v += 4)
        z[v / 4] = (t[v] << 24) | (t[v + 1] << 16) | (t[v + 2] << 8) | t[v + 3];
      for (v = 16; 80 > v; v++)
        (t = z[v - 3] ^ z[v - 8] ^ z[v - 14] ^ z[v - 16]),
          (z[v] = ((t << 1) | (t >>> 31)) & 4294967295);
      t = e[0];
      var U = e[1],
        ca = e[2],
        S = e[3],
      ...
      for (v = 0; 80 > v; v++) {
        if (40 > v)
          ...
          60 > v
            ? ((F = (U & ca) | (S & (U | ca))), (C = 2400959708))
            : ((F = U ^ ca ^ S), (C = 3395469782));
        F =
          ((((t << 5) | (t >>> 27)) & 4294967295) + F + pa + C + z[v]) &
          4294967295;
        pa = S;
        S = ca;
    ...
    function c(t, z) {
      if ("string" === typeof t) {
        ...
        for (var v = [], U = 0, ca = t.length; U < ca; ++U)
          v.push(t.charCodeAt(U));
        t = v;
      }
      z || (z = t.length);
      v = 0;
    ...
    return {
      ...
      digest: d,
      At: function () {
        for (var t = d(), z = "", v = 0; v < t.length; v++)
          z +=
            "0123456789ABCDEF".charAt(Math.floor(t[v] / 16)) +
            "0123456789ABCDEF".charAt(t[v] % 16);
        return z;
      },
    };
  }
  ...
  var gd = function (a) {
      return a instanceof fd && a.constructor === fd && a.Vr === ed
        ? a.gr
        : "type_error:Const";
    },
    ed = {},
  ...
  var sd = function (a) {
      return a instanceof rd && a.constructor === rd
        ? a.uk
  ...
  var Ld = function (a) {
      return a instanceof Kd && a.constructor === Kd
        ? a.sk
    ...
    Od = function (a) {
      ...
      for (c in a)
        if (Object.prototype.hasOwnProperty.call(a, c)) {
          ...
          var d = a[c];
          null != d &&
            ((d = Array.isArray(d) ? d.map(Md).join(" ") : Md(d)),
            (b += c + ":" + d + ";"));
        }
  ...
  function Md(a) {
    if (a instanceof yd)
      return (
        'url("' + zd(a).replace(/</g, "%3c").replace(/[\\"]/g, "\\$&") + '")'
      );
    ...
    if (/[{;}]/.test(a))
      throw new kb("Value does not allow [{;}], got: %s.", [a]);
    return a;
  }
  ...
  var Xd = function (a) {
    return a instanceof Wd && a.constructor === Wd
      ? a.rk
  ...
  var be = function (a) {
      return a instanceof ae && a.constructor === ae
        ? a.qk
        : "type_error:SafeHtml";
    },
    de = function (a) {
  ...
  g.clear = function () {
    for (var a = this.Vu().keys, b = a.length - 1; 0 <= b; b--)
      this.remove(a[b]);
  };
  g.pz = function (a) {
    this.uc.cookie = a;
  ...
  g.Vu = function () {
    for (var a = this.Yn(), b = [], c = [], d, e, f = 0; f < a.length; f++)
      (e = lb(a[f])),
        (d = e.indexOf("=")),
        -1 == d
          ? (b.push(""), c.push(e))
    ...
    xe = function (a, b) {
      ...
      if (f) e = !0;
        ...
        f =
          h.get("SAPISID") ||
          h.get("APISID") ||
          h.get("__Secure-3PAPISID") ||
          h.get("SID");
        ve(e) && (f = f || h.get("__Secure-1PAPISID"));
        e = !!f;
      }
      e &&
        ((e = (c =
        ...
        (e = e
          ? Oc(String(x.location.href), e, c ? "SAPISIDHASH" : "APISIDHASH", a)
          : null) && d.push(e),
        c &&
          ve(b) &&
          ((b = we("__1PSAPISID", "__Secure-1PAPISID", "SAPISID1PHASH", a)) &&
            d.push(b),
          (a = we("__3PSAPISID", "__Secure-3PAPISID", "SAPISID3PHASH", a)) &&
            d.push(a)));
  ...
  g.hs = function (a, b) {
    this.Hd
      ? void 0 !== b
        ? a.call(b)
        : a()
      : (this.hd || (this.hd = []), this.hd.push(void 0 !== b ? bb(a, b) : a));
  };
  g.Tb = function () {
    if (this.hd) for (; this.hd.length; ) this.hd.shift()();
  };
  var Je = function (a, b) {
    this.type = a;
  ...
  Le.prototype.stopPropagation = function () {
    ...
    this.Ye.stopPropagation
      ? this.Ye.stopPropagation()
      : (this.Ye.cancelBubble = !0);
  };
  ...
  g.add = function (a, b, c, d, e) {
    ...
    -1 < h
      ? ((b = a[h]), c || (b.$f = !1))
      : ((b = new Pe(b, null, this.src, f, !!d, e)), (b.$f = c), a.push(b));
    return b;
  };
  g.remove = function (a, b, c, d) {
    ...
    return -1 < b
      ? (e[b].$g(),
        ...
        0 == e.length && (delete this.Ia[a], this.Lf--),
        !0)
      : !1;
  };
  g.Wp = function (a) {
  ...
  var Se = "closure_lm_" + ((1e6 * Math.random()) | 0),
    ...
    cf = function (a, b, c, d, e) {
      ...
      if (!a) return !1;
      if ((a = Ze(a))) if ((b = a.rj(b, c, d, e))) return df(b);
      return !1;
    },
    df = function (a) {
      ...
      b.removeEventListener
        ...
        : b.detachEvent
        ? b.detachEvent(af(c), d)
        : b.addListener && b.removeListener && b.removeListener(d);
      Ue--;
      (c = Ze(b))
        ? (c.Wp(a), 0 == c.Lf && ((c.src = null), (b[Se] = null)))
        : a.$g();
      return !0;
    },
    af = function (a) {
  ...
  g.dispatchEvent = function (a) {
    ...
    a.qf ||
      ...
      a.qf || (e = h.ug(d, !1, a) && e));
    if (c)
      for (f = 0; !a.qf && f < c.length; f++)
        (h = a.currentTarget = c[f]), (e = h.ug(d, !1, a) && e);
    return e;
  };
  g.Tb = function () {
    ff.qd.Tb.call(this);
  ...
  gf.prototype.zs = function () {
    ...
    this.ui = Math.min(
      ...
      this.Se +
        (this.Rp
          ? Math.round(this.Rp * (Math.random() - 0.5) * 2 * this.Se)
          : 0)
    );
  };
  var hf = function () {};
  ...
  pf.prototype.remove = function () {
    ...
    this.Je &&
      ((a = this.Je),
      (this.Je = this.Je.next),
      this.Je || (this.Jh = null),
      (a.next = null));
    return a;
  };
  ...
  g.am = function (a) {
    0 == this.wb &&
      (this.Ra ? (this.Ra.Ls(this, a), (this.Ra = null)) : this.me(3, a));
  };
  g.Ls = function (a, b) {
    if (this.oc) {
      for (
        var c = 0, d = null, e = null, f = this.oc;
        f && (f.Sf || (c++, f.Qc == a && (d = f), !(d && 1 < c)));
        f = f.next
      )
        d || (e = f);
      d &&
        (0 == this.wb && 1 == c
          ? this.am(b)
          : (e ? this.sy(e) : this.Hp(), this.bn(d, 3, b)));
    }
  };
  g.Ml = function (a) {
    ...
    if (0 == this.wb) {
      ...
      a: {
        ...
        if (c instanceof zf) {
          c.AA(d, e, this);
          var f = !0;
        } else if (yf(c)) c.then(d, e, this), (f = !0);
        else {
          if (Xa(c))
            try {
              var h = c.then;
  ...
  g.CA = function () {
    if (this.enabled) {
      ...
      0 < a && a < 0.8 * this.Ug
        ? (this.za = this.If.setTimeout(this.Wl, this.Ug - a))
  ...
  g.start = function () {
    this.enabled = !0;
    this.za ||
      ((this.za = this.If.setTimeout(this.Wl, this.Ug)),
      (this.bp = Date.now()));
  };
  g.stop = function () {
    this.enabled = !1;
  ...
  g.send = function (a, b, c, d) {
    ...
    this.ey &&
      ...
      ((this.D.onprogress = bb(function (h) {
        this.tp(h, !0);
      }, this)),
      this.D.upload && (this.D.upload.onprogress = bb(this.tp, this)));
    try {
    ...
    for (d = b.next(); !d.done; d = b.next())
      (c = r(d.value)),
        (d = c.next().value),
        (c = c.next().value),
        this.D.setRequestHeader(d, c);
    this.Ik && (this.D.responseType = this.Ik);
    "withCredentials" in this.D &&
      this.D.withCredentials !== this.Dl &&
      (this.D.withCredentials = this.Dl);
    if ("setTrustToken" in this.D && this.tl)
      try {
    ...
    try {
      this.em(),
        0 < this.ic &&
          ((this.Cl = Yf(this.D))
            ? ((this.D.timeout = this.ic),
              (this.D.ontimeout = bb(this.Hf, this)))
            : (this.Ch = Jf(this.Hf, this.ic, this))),
        (this.Qg = !0),
        this.D.send(a),
        (this.Qg = !1);
    } catch (h) {
  ...
  var Yf = function (a) {
    return (
      ac && lc(9) && "number" === typeof a.timeout && void 0 !== a.ontimeout
    );
  };
  g = Tf.prototype;
  g.st = function () {
  ...
  g.Tb = function () {
    this.D &&
      (this.jc &&
        ((this.jc = !1), (this.$c = !0), this.D.abort(), (this.$c = !1)),
      this.bg(!0));
    Tf.qd.Tb.call(this);
  };
  g.vp = function () {
  ...
  g.up = function () {
    if (
      ...
      if (this.Qg && 4 == this.Dg()) Jf(this.vp, 0, this);
        ...
        try {
          this.Wo()
            ? (this.dispatchEvent("complete"), this.dispatchEvent("success"))
            : this.Pm();
        } finally {
          this.bg();
        }
  ...
  g.getResponse = function () {
    try {
      ...
      switch (this.Ik) {
        ...
        case "arraybuffer":
          if ("mozResponseArrayBuffer" in this.D)
            return this.D.mozResponseArrayBuffer;
      }
      return null;
    } catch (a) {
      return null;
  ...
  g.getResponseHeader = function (a) {
    if (this.D && this.Vj())
      return (a = this.D.getResponseHeader(a)), null === a ? void 0 : a;
  };
  ...
  var jg = function (a, b, c, d, e, f, h, k, l, m, u) {
    ...
    this.Uo =
      ...
      (65 <= Kb("Chromium") ||
        45 <= Kb("Firefox") ||
        12 <= Kb("Safari") ||
        ((Mb() || B("iPad") || B("iPod")) && 0 <= wb(Nb(), 12))) &&
      !!window &&
      !!window.navigator &&
      !!window.navigator.sendBeacon;
    a = new ag().yq(1);
    f ||
      ((f = new $f().Lz(document.documentElement.getAttribute("lang"))),
      a.Kq(f));
    this.Ad.xq(a);
    this.Ad.Mz(this.bk);
    this.Tc = new gf(1e4, 3e5, 0.1);
    ...
    this.Vo ||
      (We(document, "visibilitychange", function () {
  ...
  g.Sm = function (a) {
    this.Tc = new gf(1 > a ? 1 : a, 3e5, 0.1);
  ...
  g.flush = function (a, b) {
    ...
    if (0 === this.cb.length) a && a();
      ...
      if (this.rp > d && this.jl < d) b && b("throttled");
        ...
        var h = this.Fn();
        this.ye &&
          ((d["X-Goog-AuthUser"] = this.ye), (h = Pf(h, "authuser", this.ye)));
        this.kk &&
          ((d["X-Goog-PageId"] = this.kk), (h = Pf(h, "pageId", this.kk)));
        if (f && this.$o === f) b && b("stale-auth-token");
        else if ((this.Ts(), this.gi)) e.xe(), d && JSON.stringify(d), a && a();
        else {
          var k = e.xe(),
            l;
  ...
  g.sq = function (a, b, c) {
    if (0 !== this.cb.length) {
      var d = this.Fn();
      for (
        var e = d.search(Rf), f = 0, h, k = [];
        0 <= (h = Qf(d, f, "format", e));

      )
        k.push(d.substring(f, h)),
          (f = Math.min(d.indexOf("&", h) + 1 || e, e));
      k.push(d.substr(f));
  ...
  g.Rv = function (a) {
    ...
    if (a) {
      ...
      b &&
        ((a = Number(b.dv())),
        0 < a && ((this.jl = Date.now()), (this.rp = this.jl + a)),
        (b = b.getExtension(ig))) &&
        ((b = b.uv()), -1 != b && this.zz(b));
    }
  };
  g.yt = function () {
    return 0.01 > this.KA()
  ...
  var ng = function (a) {
    ...
    pg = function (a, b) {
      a.classList
        ...
        : ((a = a.classList ? a.classList : ng(a).match(/\S+/g) || []),
          (b = 0 <= Ob(a, b)));
      return b;
    },
    D = function (a, b) {
        ...
        : pg(a, b) &&
          og(
            ...
            Array.prototype.filter
              .call(
                a.classList ? a.classList : ng(a).match(/\S+/g) || [],
                function (c) {
                  return c != b;
                }
              )
  ...
  var zg = function (a, b, c) {
    ...
    if (0 == ("url(" < d ? -1 : "url(" == d ? 0 : 1)) {
      if (
        ...
        a = c
          ? (a = c(b, a)) && "about:invalid#zClosurez" != zd(a)
            ? 'url("' + zd(a).replace(wg, yg) + '")'
            : null
          : null;
      }
      return a;
  ...
  function ah(a, b) {
    return (
      Tg(Pg, a, a.getPropertyValue ? "getPropertyValue" : "getAttribute", [
        b,
      ]) || ""
    );
  }
    ...
    gh = function (a, b) {
      ...
      kh(a).forEach(function (d) {
        ...
        0 != e.lastIndexOf("--", 0) &&
          ...
          ((d = ah(a, d)), (d = zg(e, d, b)), null != d && bh(c, e, d));
      });
    ...
    mh = function (a) {
      ...
      for (var f; (f = a.nextNode()); )
        c.forEach(function (h) {
          Tg(Ig, f, f.matches ? "matches" : "msMatchesSelector", [
            h.selectorText,
          ]) &&
            h.style &&
            lh(f, h.style);
  ...
  rh.prototype.set = function (a, b) {
    if (Tg(Dg, a, "hasAttribute", [this.Ed])) {
      ...
      (c = this.Ih.push(b) - 1), Vg(a, this.Ed, c.toString()), this.Yj.push(a);
    return this;
  };
  rh.prototype.get = function (a) {
    if (Tg(Dg, a, "hasAttribute", [this.Ed]))
      return (
        (a = parseInt(Tg(Eg, a, "getAttribute", [this.Ed]) || null, 10)),
        this.Ih[a]
      );
  };
    ...
    Ah = function (a) {
      ...
      a.xt.forEach(function (b) {
        if (0 != b.lastIndexOf("data-", 0))
          throw new kb('Only "data-" attributes allowed, got: %s.', [b]);
  ...
  var Bh = function (a) {
      return function (b, c) {
        return (b = a(lb(b), c)) && "about:invalid#zClosurez" != zd(b)
          ? zd(b)
          : null;
      };
    },
  ...
  yh.prototype.Aw = function () {
    ...
    Eh(this.Ab, this.mc, "* CLASS", cb(Ih, this.ol));
  ...
  function Th(a) {
    var b,
      c = null === (b = Qh()) || void 0 === b ? void 0 : b.createHTML(a);
  ...
  var Wh = Nh(function () {
      var a;
      return null !== (a = Vh("Element", "attributes")) && void 0 !== a
        ? a
        : Vh("Node", "attributes");
    }),
    Xh = Nh(function () {
  ...
  function gi(a) {
    try {
      for (
        var b = Th("<html><body>" + a),
          c = new DOMParser().parseFromString(Uh(b), "text/html"),
          d = c.createDocumentFragment();
        Zh(c.body).length;

      )
        d.appendChild($h(c.body));
      return d;
    } catch (e) {
      return (
        (a = Th(a)),
  ...
  hi.prototype.uu = function (a, b) {
    b = this.Um.get(b);
    return (null === b || void 0 === b ? 0 : b.has(a))
      ? b.get(a)
      : this.ts.has(a)
      ? {
          Ka: 1,
  ...
  g.zx = function (a) {
    ...
    if (Yh(a) !== Node.ELEMENT_NODE)
      return (
        this.ke(
          "Node: " + a + " was dropped as it was not a text or element node"
        ),
    ...
    if (null === b)
      return (
        this.ke("Node name was null for node: " + a), NodeFilter.FILTER_REJECT
      );
  ...
  g.Qy = function (a, b) {
    ...
    for (var d = a.next(); !d.done; d = a.next()) {
      ...
      if (
        (d =
          null === (c = b.getNamedItem(d)) || void 0 === c
            ? void 0
            : c.value) &&
        !e.has(d)
      )
  ...
  g.Mm = function (a, b, c, d) {
    return d &&
      (this.ws(b, this.qc) ||
        (1 == this.qc && nd.test(id(a, c))) ||
        (-1 == this.qc && md.test(id(a, c))))
      ? 1 == this.qc
        ? "\u200e"
        : "\u200f"
      : "";
  ...
  var Gi = {
    ...
    Hi = {
      ...
      "sorry-message": function () {
        var a = r([
            "Please verify that you are not a robot. $$DIVIDER1$$Learn more.",
            "",
          ]),
          b = a.next().value;
        a = a.next().value;
  ...
  function Xi(a, b, c) {
    ...
    (void 0 === c.be ? 0 : c.be) || d
      ? ((b = new yh().rs().UA(Sc).WA(Sc).VA(Hd).XA(Hd).Zf().Sa(b)), si(a, b))
      : si(a, Lh(b));
  }
  ...
  function Si(a) {
    return a in mj
      ? mj[a]
      : (mj[a] = -1 != navigator.userAgent.toLowerCase().indexOf(a));
  }
  var mj = {},
    nj = function (a) {
      this.Is = a + "branding";
  ...
  var xj = this,
    yj = vd(
      gd(
        new fd(
          dd,
          "https://support.google.com/programmable-search/answer/6001359#captcha"
        )
      )
    ),
    zj = vd(
      gd(new fd(dd, "https://www.google.com/recaptcha/api.js?render=explicit"))
    ),
    Aj,
    Bj = gd(new fd(dd, "display:none;"));
  ...
  var Cj = function (a) {
    ...
    Dj = function () {
      var a;
      (null == (a = x.console) ? 0 : a.log) &&
        x.console.log("Unable to load recaptcha widget");
    },
    Ej = function () {
    ...
    Fj = function (a, b, c, d) {
      ...
      x.grecaptcha.render(b.iy, {
        sitekey: a
          ...
          : "6LdE6qgbAAAAANq2Tal4NuP8YdGwtfdTpCLArNE-",
        callback: function (f) {
        ...
        f = function (t) {
          t && "gsc-wrapper" === t.className
            ? ((t = t.firstElementChild),
              (t = null != t && d.includes(t.className)))
            : (t = !1);
          return t;
        },
        h = function (t) {
  ...
  var Rj = function (a, b, c) {
    ...
    Sj = function (a) {
      ...
      for (c in Nj) {
        for (
          var d = a.getElementsByTagName("gcse:" + c), e = 0;
          e < d.length;
          e++
        )
          b.push(d[e]);
  ...
  var Wj = function (a, b) {
    ...
    Xj = function (a, b) {
      ...
      if (b) {
        ...
        "div" == c
          ? ((e = "data-"),
            (c = (a.className || a.getAttribute("class")).substr(5)))
          : (c = c.substr(5));
        d = Wj(a, e);
      }
      this.attributes = d;
  ...
  bk.render = function (a, b) {
    ...
    try {
      ...
      for (m = a.firstChild; m; m = e ? m : m.nextSibling) {
        var t = m.cloneNode(!1);
        if (1 != m.nodeType)
          (3 != m.nodeType || m.nodeValue.match(/\S/)) && E(k, t);
        else {
          u("foreach");
          !e &&
            h &&
            ((d.Foreach = l && "function" == typeof l.join ? l : [l]),
            (c = 0),
            (e = !0));
          if (e)
  ...
  ik.prototype.on = function () {
    ...
    for (var c = (b = !1); this.nh.length && !this.Zh; ) {
      ...
      if ((e = this.df ? f : e))
        try {
          ...
          void 0 !== h &&
            ((this.df = this.df && (h == a || this.Rw(h))), (this.fc = a = h));
          if (
            yf(a) ||
            ("function" === typeof x.Promise && a instanceof x.Promise)
          )
            this.Zh = c = !0;
        } catch (k) {
    ...
    c &&
      ((h = bb(this.xm, this, !0)),
      (c = bb(this.xm, this, !1)),
      a instanceof ik ? (a.Pf(h, c), (a.Ds = !0)) : a.then(h, c));
  ...
  var rk = function (a, b) {
      ...
      e.onload = e.onreadystatechange = function () {
        (e.readyState &&
          ...
          (ok(e, c.VC || !1, k), h.Ks(null));
      };
      e.onerror = function () {
        ok(e, !0, k);
        h.Vi(new pk(0, "Error while loading script " + d));
      };
      f = c.attributes || {};
      $c(f, {
  ...
  var Q = function () {
    ...
    sk = 0;
  y(
    "module$exports$cse$search.Search.BASE",
    "https://www.google.com/cse/static"
  );
  var tk = /style=([^&]*)/;
  ...
  y(
    "module$exports$cse$search.Search.ORDER_BY_RELEVANCE",
    "order-by-relevance"
  );
  y("module$exports$cse$search.Search.ORDER_BY_DATE", "order-by-date");
  y(
    "module$exports$cse$search.Search.ORDER_BY_ASCENDING_DATE",
    "order-by-ascending-date"
  );
  y("module$exports$cse$search.Search.RESTRICT_TYPE", "restrict-type");
  y(
    "module$exports$cse$search.Search.RESTRICT_SAFESEARCH",
    "restrict-safesearch"
  );
  ...
  y(
    "module$exports$cse$search.Search.RESTRICT_EXTENDED_ARGS",
    "restrict-extended"
  );
  ...
  Q.prototype.Op = function (a, b) {
    ...
    this.Vb && this.M
      ? ((a = this.Sc
        ...
        (a += "?rsz=" + this.xa + "&num=" + this.Vc() + "&hl=en"))
      : this.Ub &&
        this.M &&
        (a =
  ...
  Q.prototype.Sq = function (a) {
    ...
    "number" === typeof a
      ? (b = a)
      : isNaN(parseInt(a, 10)) || (b = parseInt(a, 10));
  ...
  Q.prototype.Rq = function (a, b) {
    ...
    "number" === typeof a
      ? (d = a)
      : isNaN(parseInt(a, 10)) || (d = parseInt(a, 10));
    d >= b && d <= c
      ? (this.xa = d)
      : "filtered_cse" == a
      ? (this.xa = a)
  ...
  Q.prototype.execute = function (a, b, c) {
    ...
    if (c && 0 < c)
      if (
        this.cursor &&
        this.cursor.pages &&
        this.cursor.pages[c - 1] &&
        this.cursor.pages[c - 1].start
      )
  ...
  var vk = function (a, b) {
    ...
    c[d] = function (e) {
      ...
      var u, t;
      l =
        null != (t = null == (u = e.error) ? void 0 : u.submessage) ? t : null;
      var z, v;
  ...
  Q.prototype.ho = function (a, b) {
    this.cursor &&
      ...
      ((a = this.sg(this.Ib, void 0, this.cursor.pages[a].start)),
      b && (a += "&rsToken=" + b),
      (this.cursor = null),
      (this.Cc = a),
      this.M && (this.Vb || this.Ub)
        ? Ri(vk(this, a))
        : Pi(this.Vn(this.Ib, a)));
  };
  Q.prototype.gotoPage = Q.prototype.ho;
  Q.prototype.wg = function () {
    return this.cursor && null != this.cursor.currentPageIndex
      ? this.cursor.currentPageIndex + 1
      : null;
  };
  ...
  Q.prototype.jd = function (a, b, c, d, e, f, h) {
    ...
    this.sb
      ? this.sb
          .vd(this.Ib, "onSearchComplete", this.$n(), function () {
            return k.xp(a, b, c, d, e, f, h);
          })
          .apply(this)
      : this.xp(a, b, c, d, e, f, h);
  };
  ...
  g.xp = function (a, b, c, d, e, f, h) {
    ...
    if (
      ...
      !this.Cc ||
      e === this.Cc ||
      e === this.Cc + "&g-recaptcha-response=" + (this.gh || "")
    ) {
      if (this.results && 0 < this.results.length)
        for (e = 0; e < this.results.length; e++)
          this.results[e].html && wk(this.results[e].html);
          ...
          for (c = 0; c < a.context.facets.length; c++)
            a.context.facets[c].facet_search_label &&
              ...
              0 < f &&
                ((d.count = f),
                (d.width = Math.ceil(
                  (100 * f) / parseInt(a.context.total_results, 10)
                )),
                b.push(d)));
          0 < b.length &&
            b.sort(function (k, l) {
      ...
      a && a.promotions
        ? (this.promotions = a.promotions)
        : "promotions" in this && delete this.promotions;
      a && a.omittedResults
        ? (this.omittedResults = a.omittedResults)
        : "omittedResults" in this && delete this.omittedResults;
      a && a.spelling
        ? (this.spelling = a.spelling)
        : "spelling" in this && delete this.spelling;
  ...
  var yk = function (a, b, c) {
      return 3 == a[b].length
        ? new xk(a[b][1] || (c && c.prefetchQuery), a[b][2], a[b][0], c)
        : new xk("", "", a[b], c);
    },
    zk = function (a, b) {
      if (a.length)
  ...
  y("module$exports$cse$search.Search.scaleImage", function (a, b, c, d, e) {
    ...
    d &&
      ((d.width = a.width),
      (d.height = a.height),
      e && (d.style.left = (c.width - a.width) / 2 + "px"));
    return a;
  });
  var Ak;
  ...
  g.nu = function (a) {
    ...
    d &&
      ((a = fj(d, Ii["learn-more"])), D(a, "gs-stylized-error-link"), E(b, a));
    return {
      html: b,
    };
  };
  ...
  g.Th = function () {
    var a = [];
    this.Fc &&
      (0 == this.Fc.indexOf("more:") || 0 == this.Fc.indexOf("less:")
        ? a.push(this.Fc)
        : a.push("more:" + this.Fc));
    return a;
  };
  ...
  function Dk(a, b) {
    ...
    if (/^[\s\xa0]*$/.test(a))
      throw Error("Invalid or missing CX value: '" + a + "'");
    return new Ck(a, b);
  }
  var Ek = bk,
    Fk = function () {
  ...
  g.ec = function (a) {
    var b = this.Y.ld();
    return this.M && b
      ? a.replace(new RegExp("[ +]?" + b.replace(/^[\s\xa0]+/, "")), "")
      : a;
  };
  g.Uc = function () {
    return (this.Qe = [
      "gsc-" + this.Ta + "Result",
      "gsc-" + this.Ta + "Result-popup",
    ].join(" "));
  };
  y(
    "module$exports$cse$CustomImageSearch.RawCompletion",
    function (a, b, c, d, e) {
      var f = 0;
      a && (f = parseInt(a, 10));
      a = yk(Gk, f, b);
  ...
  Fk.prototype.sg = function (a, b, c) {
    ...
    "off" == this.ab || "active" == this.ab
      ? (f += "&safe=" + this.ab)
      : this.ub && (f += "&safe=" + this.ub);
    ...
    window.google.loader.GoogleLocale &&
      ...
      this.M &&
      (b +=
        "&googlehost=" + encodeURIComponent(window.google.loader.GoogleLocale));
    return b;
  };
  ...
  Fk.prototype.Hc = function (a, b) {
    if ("restrict-safesearch" == a)
      this.ub = b ? ("active" == b || "off" == b ? b : null) : null;
    else if ("restrict-extended" == a)
      if (b) for (var c in b) (a = b[c]), Hk[c] && (this.Wa[c] = a);
      else this.Wa = {};
  };
  ...
  var Ik = function (a) {
    ...
    b &&
      ...
      ((b.style.display = "block"), (a.style.zIndex = 4e3));
  };
    ...
    window.google.loader.GoogleLocale &&
      (b =
        this.Ub && this.M
          ? b +
            ("&googlehost=" +
              encodeURIComponent(window.google.loader.GoogleLocale))
          : b +
            ("&gl=" + encodeURIComponent(window.google.loader.GoogleLocale)));
    return b;
  };
  g.pt = function (a, b) {
    var c = $i({
  ...
  g.ni = function (a) {
    ...
    if (a.image) {
      var d = a.image.url
        .replace("resize_w=40", "resize_w=60")
        .replace("resize_h=40", "resize_h=60");
    ...
    a.clicktrackUrl &&
      ((d = {}),
      (d["data-cturl"] = a.clicktrackUrl),
      (d["data-ctorig"] = a.url));
    d = gj(a.url, a.title, this.$e(), "gs-title", void 0, d);
    if (a.titleRight) {
      var f = aj("", "gs-promotion-title-right");
    ...
    if (a.bodyLines)
      for (
        e = a.bodyLines, f = "right" == a.bodyLinkAlignment, h = 0;
        h < e.length;
        h++
      ) {
        var l = e[h],
        ...
        u &&
          t &&
          ((m = fj(u, "", this.$e())),
          l.clicktrackUrl && Nk(m, l.clicktrackUrl, u),
          (l = aj("", "gs-title")),
          si(l, this.$b.Sa(t)),
          E(m, l));
        t = L("gs-snippet");
      ...
      for (var b = a.html.firstChild; b; b = b.nextSibling)
        if (1 == b.nodeType) {
          "a" == b.tagName.toLowerCase() &&
            b.href == a.unescapedUrl &&
            Nk(b, a.clicktrackUrl, a.unescapedUrl);
          for (var c = b.getElementsByTagName("a"), d = 0, e; (e = c[d]); d++)
            e.href == a.unescapedUrl && Nk(e, a.clicktrackUrl, a.unescapedUrl);
        }
    this.Pl(a.html);
  };
  ...
  R.prototype.Hc = function (a, b) {
    "restrict-safesearch" == a &&
      (this.ub = b
        ? "active" == b || "off" == b || "moderate" == b
          ? b
          : null
        : null);
    if ("restrict-extended" == a)
      if (b) for (var c in b) (a = b[c]), Lk[c] && (this.Wa[c] = a);
      else this.Wa = {};
  };
  ...
  var Rk = function (a, b) {
      ...
      if (this.Ui) {
        ...
        this.yl && window.addEventListener
  ...
  g.Wq = function (a, b) {
    ...
    if (!Tk(this.dd, a)) {
      ...
      for (var e in d)
        null != d[e] &&
          Sk[e] &&
          a.push(encodeURIComponent(e) + "=" + encodeURIComponent(d[e]));
      d = a.join("&");
      this.ak && (d = this.ak + "&" + d);
      this.yl
        ? ((e = document.title || ""),
          (d = "#" + d),
          b
            ? window.history.replaceState(null, e, d)
            : window.history.pushState(null, e, d))
        : this.zl &&
          ((e = this.Cs + "#" + d),
          b
            ? window.location.replace(e)
            : ((b = mi(e)), (window.location.href = qi(b))));
    }
  };
  g.getState = function () {
    var a = {},
  ...
  var Vk = function (a) {
    ...
    for (var f = a.next(); !f.done; f = a.next()) {
      ...
      if (h.bodyLines && 0 < h.bodyLines.length)
        for (
          k = h.bodyLines[0], l = r(c), m = l.next();
          !m.done;
          m = l.next()
        ) {
          var u = r(m.value);
      ...
      if (h.image)
        for (
          h = h.image, k = {}, f.image = k, l = r(d), m = l.next();
          !m.done;
          m = l.next()
        )
          (u = r(m.value)),
  ...
  for (
    var Wk = {
        ...
        V2_MINIMALIST:
          "//www.google.com/cse/static/style/look/v2/minimalist.css",
        V2_DEFAULT: "//www.google.com/cse/static/style/look/v2/default.css",
      },
      Xk = r(Object.entries(Wk)),
      Yk = Xk.next();
    !Yk.done;
    Yk = Xk.next()
  ) {
  ...
  var gl = function (a, b, c, d, e, f) {
    function h(m) {
      if (e)
        for (var u = 0, t; (t = m[u++]); )
          for (var z = 0; z < e.length; ++z) if (t == e[z]) return !0;
      return !1;
    }
    var k = !1,
      l = {
  ...
  var hl = /\s/g,
    ...
    Al = function (a) {
      for (var b = rl.length, c = 0; c < b; c += 2)
        a = a.replace(rl[c], rl[c + 1].source);
      return a;
    },
    Bl = function (a) {
      for (var b = rl.length, c = 0; c < b; c += 2)
        a = a.replace(rl[c + 1], rl[c].source);
      a = a.replace(pl, " ");
      return a.replace(ql, "\u3000");
    },
    Cl = function (a, b) {
      return a && (-1 < a.indexOf(" ") || kl.test(a))
        ? ((a = a.replace(ll, " ")), a.replace(b ? ml : jl, ""))
        : a;
    },
    Dl = function (a, b, c) {
  ...
  B("iPad") ||
    (B("Android") && !B("Mobile")) ||
    B("Silk") ||
    !(B("iPod") || B("iPhone") || B("Android") || B("IEMobile")) ||
    Db();
  var Rl = B("Android"),
    Sl = B("Macintosh");
  ...
  function $l(a, b) {
    a.innerHTML != b &&
      (b &&
        (Kl
          ? b &&
            (-1 < b.indexOf(" ") || kl.test(b)) &&
            ((b = b.replace(il, "&#x3000;")), (b = b.replace(hl, "&nbsp;")))
          : Jl && (b = '<pre style="font:inherit;margin:0">' + b + "</pre>")),
      (b = Ki(b)),
      me(a, b));
  }
  ...
  function hm(a) {
    var b = {};
    if (a) for (var c = 0, d; (d = a[c++]); ) b[d.xj()] = d;
    return b;
  }
  ...
  function lm(a) {
    return Tl
      ? a + ""
      : (Kl ? "progid:DXImageTransform.Microsoft.Alpha(" : "alpha(") +
          "opacity=" +
          Math.floor(100 * a) +
          ")";
  }
  ...
  var pm = function (a) {
    var b,
      c = function (e) {
        ...
        if (b) {
          var h = e.Ig();
          "focus" == h || "blur" == h || "mousedown" == h
            ? (f = 3)
            : (e.ph("partnerid", a), e.Uk("types", "t"));
        }
        return f;
      },
      d = function () {
    ...
    var c = function () {
      ...
      d = function (e) {
        for (var f = [], h = [], k = e.yc(), l = !1, m = 0, u; (u = k[m++]); )
          if (34 == u.getType())
            h.length < b && (h.push(u), u.getParameters().ib("c") && (l = !0));
          else if (f.length < a) {
            var t = f,
              z = t.push;
            u = gl(
        ...
        for (k = 0; (m = h[k++]); )
          (t = m.getParameters()),
            ...
            (z.d = t.ib("d")),
            (z.e = l),
            f.push(gl("", "", f.length, m.getType(), m.zj(), el(z)));
        return rm(e.bf(), f, e.getParameters(), e.Oo(), e.Kw(), !0);
      };
    return {
      getType: function () {
        return 122;
  ...
  var vm = function (a, b, c, d, e, f) {
    ...
    wm = [
      127, 149, 134, 494, 123, 121, 126, 553, 118, 115, 128, 160, 173, 119, 116,
      152, 153, 129, 120, 374, 124, 158, 155, 131, 130, 147, 570, 141, 142, 137,
      143, 138, 144, 139, 140, 135, 136,
    ];
  g = vm.prototype;
  g.H = function (a) {
    this.Da();
  ...
  g.oz = function (a, b) {
    for (var c = this.ji[a] || [], d = 0, e; d < b.length; ++d)
      (e = this.Tn(a, b[d])) && c.push(e);
    this.ji[a] = c;
  };
  g.Tn = function (a, b) {
    ...
    return {
      addRule: function (m, u) {
        if (b) {
          if (c) {
            m = m.split(",");
            for (var t = [], z = 0, v; (v = m[z++]); )
              (v = k.test(v) ? v.replace(k, h + "$1") : h + " " + v), t.push(v);
            m = t.join(",");
          }
          l.push(m, "{", u, "}");
        }
      ...
      vs: function () {
        if (b && l.length) {
          ...
          m.styleSheet
            ...
            : ((u = document.createTextNode(u)), m.appendChild(u));
        }
      },
      prefix: function (m, u) {
        var t = m + (u || "");
  ...
  var Am = function (a, b, c, d, e) {
    ...
    function pa(n) {
      var q = n.pg,
        ...
        O = q[139];
      q[136] || O || da || J
        ? ((n.pg[136] = !0), (n.pg[141] = !0), (sa = J ? 3 : 1))
        : (sa = 0);
    }
    var F,
      C,
  ...
  var Im = function () {
    function a(C, K, M, T) {
      ...
      if (U) {
        N = "";
        for (
          var qa = 4 + Math.floor(32 * Math.random()), ia = 0, wa;
          ia < qa;
          ++ia
        )
          (wa =
            0.3 > Math.random()
              ...
              : (0.5 < Math.random() ? 65 : 97) +
                Math.floor(26 * Math.random())),
            (N += String.fromCharCode(wa));
        yl("gs_gbg", N, C);
      }
      N = Xl("script");
      K = Li(K + C.join("&"));
      ...
      F = {
        ...
        H: function (C) {
          ...
          0 == C.ki &&
            ...
            (z = C.Dk),
            (v = C.pA),
            (U = "https:" == document.location.protocol),
            h(f),
            (new Image().src = u + t + "/generate_204"));
        },
        getType: function () {
          return 149;
        },
  ...
  g.Jv = function () {
    this.C.Wy
      ? this.search(5)
      : (this.N.isVisible() ? this.N.wi() : this.Xf(), this.iq());
  };
  g.Gv = function (a) {
    this.ia &&
      a.bo() == this.ia.length &&
      (this.Gf && this.Gf.clear(),
      this.C.Vy && this.search(2),
      this.L.Hi(this.ia));
  };
  g.Dv = function (a) {
  ...
  g.ko = function (a, b, c, d) {
    ...
    var e = !1,
      f = !1;
    if (a != this.ia || "onremovechip" == c)
      Dl(c, "key") ? this.kb.add(1) : "paste" == c && this.kb.add(2),
        (e = !0),
        this.Iv(a, c),
        a && !nl.test(a) && (d = !0),
        (f = !0);
  ...
  g.Gj = function () {
    if (this.GA) {
      ...
      for (var a = 0, b; (b = this.Ge[a++]); ) if (b.isEnabled()) return !0;
    }
    return !1;
  };
  g.pk = function () {
  ...
  g.jo = function (a) {
    ...
    this.Va == a
      ? this.N.Yc() &&
        b == this.ia.length &&
        (this.N.ef()
          ? this.C.dj && ((a = this.N.cf()), this.Ep.search(a.Eb(), 6))
          : this.C.vx && this.Xd())
      : this.Bb && 0 == b && this.Bb.az();
  };
  g.An = function () {
    if (this.N.Yc()) {
  ...
  g.Jl = function (a, b) {
    ...
    return (c || a ? c && a && c.toLowerCase() == a.toLowerCase() : 1)
      ? !1
      : (this.mm(), b ? this.fl(a, !0) : this.Pb(a), !0);
  };
  g.Dp = function (a, b) {
    this.ia = a || "";
    this.ze();
  ...
  function Mm() {
    ...
    function Fa(H, ja, Ya) {
      for (var ta = 0, Ma = 0, fb; Ma < H.length; ++Ma)
        (fb = H[Ma]) && fb.position == Ya && (ja.push(fb), ++ta);
      return ta;
    }

    function va(H, ja) {
      null == ea || p.Wg(ea)
        ? (ya(H), null == ea ? n.iq() : ((H = p.bj(Ba[ea])), n.rh(H), Ra.Qi(H)))
        : (p.Fh(H), ja());
    }
  ...
  Pm.prototype.dw = function (a) {
    ...
    for (var b = !1, c = !1, d = 0, e; d < a.length; ++d)
      if (
        ((e = a.charAt(d)),
        !Qm.test(e) && (Om.test(e) ? (c = !0) : (b = !0), c && b))
      )
        return !0;
    return !1;
  };
  ...
  g.La = function (a, b, c, d, e) {
    ...
    h ||
      ((h = f[b] = []),
      (f = this.Lu(b, a.Rr ? window : jm(a), h)),
      "string" == typeof b
        ? a.addEventListener
  ...
  g.bv = function (a) {
    this.tc &&
      ...
      this.tc &&
        this.tc.length &&
        window.postMessage("sbox.df", window.location.href));
  };
  g.Lu = function (a, b, c) {
    return bb(function (d, e) {
      if (
        c.length &&
        ((d = d || this.ru(b)), (d.Kf = e || a), this.Vx(d, c), d.Vg)
      )
        return (
          delete d.Vg, d.Lw && (d = b.event || d), em(d), (d.returnValue = !1)
        );
    }, this);
  };
  g.ru = function (a) {
  ...
  g.Vx = function (a, b) {
    for (var c, d, e = 0, f; (f = b[e++]); )
      f.ek ? (d = !0) : c || (f.Mw ? this.Ry(f, a) : (c = f.process(a)));
    if (d) for (e = 0; (f = b[e]); ) f.ek ? b.splice(e, 1) : ++e;
  };
  g.Ry = function (a, b) {
    this.defer(function () {
      a.process(b);
  ...
  Wm.prototype.rv = function (a, b) {
    return this.qg && this.pl
      ? ((a += b),
        (b = this.qg.decode(this.pl)),
        (a = this.qg.qv(a, b)),
        (a = a.slice(0, 8)),
        this.qg.encode(a))
      : "";
  ...
  g.search = function (a, b) {
    if (this.qq) {
      for (var c = !1, d = 0, e; (e = this.qq[d++]); )
        2 == e.Cg(a, b) && (c = !0);
      if (c) return;
    }
    if ((a && !nl.test(a)) || this.C.Oc || (this.Bb && this.Bb.Oc()))
      bl.test(b)
        ? this.ij && !this.tg && (this.tg = bm(this.ij, "btnI", "1"))
        : this.tg && (this.ij.removeChild(this.tg), (this.tg = null)),
        this.L.search(a, b),
        this.cg(),
        this.J.va(14, {
          query: a,
  ...
  g.Mp = function () {
    ...
    if (!(2 < this.pc.Jn()) && this.bd) {
      ...
      if (b) for (var c in b) yl(c, b[c], a);
      this.L.Ii();
  ...
  g.Np = function (a, b) {
    if (this.Hb) {
      ...
      if (!b.To()) {
        ...
        this.Zw(b) ||
          (++this.tm, this.fq.process(a) || ++this.Bp, this.QA(b, a));
        this.OA(a);
      }
    }
  };
  ...
  kn.prototype.process = function (a) {
    var b = this.hx(a);
    if (b) {
      if (this.Hk) for (var c = 0, d; (d = this.Hk[c++]); ) a = d.Pt(a);
      this.pd.sz(a);
      this.$x(a);
    }
    this.L.Ni(a, b);
  ...
  kn.prototype.hx = function (a) {
    ...
    b == d
      ? (c = !0)
      : ((b = Cl(b)),
        (a = (d = a.bf()) ? d.tj() : Cl(a.hb().toLowerCase())),
        (c = c ? c.bf().tj() : ""),
        (c =
          0 == b.indexOf(a)
            ? 0 == b.indexOf(c)
  ...
  var pn = function (a) {
    ...
    un = function (a, b) {
      for (var c = a.YA, d = 0; 64 > d; d += 4)
        c[d / 4] = b[d] | (b[d + 1] << 8) | (b[d + 2] << 16) | (b[d + 3] << 24);
      var e = a.pa[0];
      b = a.pa[1];
      d = a.pa[2];
      for (var f = a.pa[3], h, k, l, m = 0; 64 > m; ++m)
        16 > m
          ? ((h = f ^ (b & (d ^ f))), (k = m))
          : 32 > m
    ...
    sn = function (a, b, c) {
      ...
      a.total += c;
      for (var d = 0; d < c; ++d)
        (a.buffer[a.Yf++] = b[d]), 64 == a.Yf && (un(a, a.buffer), (a.Yf = 0));
    },
    tn = function (a) {
      var b = Array(16),
        c = 8 * a.total,
  ...
  xn.prototype.bold = function (a, b) {
    ...
    for (
      var c = "", d = [], e = b.length - 1, f = 0, h = -1, k;
      (k = b.charAt(f));
      ++f
    )
      " " == k || "\t" == k
    ...
    c = "";
    for (f = e = 0; (h = a[f]); ++f)
      (k = d[h.sf].sf) && (c += "<b>" + b.substring(e, k - 1) + "</b> "),
        (e = d[h.e].e),
        (c += b.substring(k, e));
  ...
  g.Tk = function (a) {
    a != this.nf &&
      ...
      (a = a.ma()),
      this.lk
        ? a != this.lk && this.lb.replaceChild(a, this.lk)
  ...
  g.sh = function (a) {
    this.Nj
      ? this.Co != a && this.Nj.replaceChild(a, this.Co)
      : (this.mt(), this.Nj.appendChild(a));
    this.Co = a;
  };
  g.mt = function () {
    ...
    this.fg.isVisible() ||
      (this.Ic(this.lb, !1), this.Ic(this.Aa, !0), this.Gc());
    this.yi = this.lb;
  };
  g.rt = function () {
    this.Aa = Yl();
    ...
    this.C.Wv &&
      ((this.nc = Xl("iframe", "gstl_" + this.rq + " gssb_k")),
      this.Ic(this.nc, !1),
      (this.C.We || document.body).appendChild(this.nc));
    if ((this.Md = this.C.Tm))
      "number" == typeof this.Md && (this.Md += this.C.Jd[2]),
        this.bl(this.Aa, this.Md);
    this.$p();
  };
  g.$p = function () {
    ...
    c
      ...
      : this.jp || !this.No
      ? ((this.lb.style.width = ""), (this.Aa.style.width = ""))
      : ((this.lb.style.width = "100%"),
        (c = b + this.C.Jd[2]),
        this.bl(this.Aa, c));
  ...
  g.wv = function (a, b, c) {
    ...
    if ("right" == this.wo)
      return {
        My:
          (jm(this.Aa) || window).document.documentElement.clientWidth -
          (a.Jb - e + b),
        Ie: d,
      };
    a = a.Jb + e;
  ...
  g.zy = function () {
    if (this.nc) {
      var a = this.C.ys[0],
        b = this.nc.style;
      "relative" != this.C.Xe &&
        ((b.top = this.Aa.style.top),
        (b.left = this.Aa.offsetLeft + this.ce.offsetWidth + "px"));
  ...
  g.Nz = function (a) {
    if (this.jp != a) {
      var b = this.dk.style;
      a
        ? (this.ce.hasChildNodes() || this.ce.appendChild(this.dk),
          (b.width = a + "px"),
          Ml && (b.paddingLeft = "1px"))
        : (this.ce.hasChildNodes() && this.ce.removeChild(this.dk),
          (b.paddingLeft = ""));
      this.jp = a;
    }
  };
  ...
  var Bn = function () {
    ...
    function c(w) {
      ...
      if (eb) {
        ...
        oa.removeChild(eb);
        G
          ? Ga.parentNode.insertBefore(eb, Ga.nextSibling)
          : oa.insertBefore(eb, Ga);
      }
      Oa &&
        ((Oa.dir = w),
        (oa = Oa.parentNode),
        oa.removeChild(Oa),
        G
          ? oa.insertBefore(Oa, Ga)
          : Ga.parentNode.insertBefore(Oa, Ga.nextSibling));
      0 != da &&
        ((G = 0),
        (oa = q.style),
        "INPUT" != q.nodeName && (G += 1),
        (oa.left = oa.right = ""),
        (oa["rtl" == w ? "right" : "left"] = G + "px"));
    }
    ...
    function m(w) {
      ...
      O.Xh && (G.style.textIndent = -1 == w.indexOf("url") ? "0" : O.Xh + "px");
    }
    ...
    function pa() {
      ...
      if (w)
        (Oa = Ya.get("gs_ttc")),
          (Ga = Ya.get("gs_tti")),
          p.Gj() && W && ((sb = W.ma()), (eb = sb.parentNode));
      else {
        w = Yl();
        w.id = Ya.Ga("gs_id");
      ...
      Sl &&
        Ol &&
        ((q.style.height = "1.25em"), (q.style.marginTop = "-0.0625em"));
      C(w);
      Na = w;
    }
    ...
    function M(w) {
      w = w.type;
      "compositionstart" == w ? p.Jq(!0) : "compositionend" == w && p.Jq(!1);
    }
    ...
    function db() {
      ea && (window.clearTimeout(ea), (ea = null));
    }
    ...
    function Fa() {
      if (Ml) {
        ...
        G.initKeyEvent &&
          (G.initKeyEvent("keypress", !0, !0, null, !1, !1, !0, !1, 27, 0),
          w.dispatchEvent(G));
      }
    }
        ...
        a: {
          ...
          try {
            if ("selectionStart" in w) {
              ...
              Sa.inRange(Ad) &&
                (Sa.setEndPoint("EndToStart", Ad),
                (G = Sa.text.length),
                Sa.setEndPoint("EndToEnd", Ad),
                (oa = Sa.text.length));
            }
            if (void 0 !== G) {
              var Ng = xl(G, oa);
      ...
      gb = {
        ua: function (w, G) {
          ...
          w.Uf() ||
            ...
            Ll && G.addRule(".gsib_a input::-ms-clear", "display: none"),
        ...
        ya: function (w) {
          ...
          (p.cw() || p.Gj() || H || w.ku) && pa();
          w.Xt &&
            (A.La(q, "blur", db, 10), A.La(q, "focus", La, 10), (Ba = !0));
          A.tb(8, Fa);
          K();
          Ka();
        },
  ...
  var Cn = function () {
    ...
    function k() {
      ...
      for (; (n = ya.firstChild); )
        (n = ya.removeChild(n)),
          n.ax ? Ka.push(n) : n != sa && n != I && wa.push(n);
      La = [];
    }
    ...
    var F,
      ...
      W = {
        ua: function (n, q) {
          ...
          q.addRule(
            "#gssb_b",
            "font-size:11px;color:#36c;text-decoration:none"
          );
          q.addRule(
            "#gssb_b:hover",
  ...
  g.Vd = function (a) {
    ...
    a &&
      ...
      a in this.ci
        ? (b = this.ci[a])
        : ($l(this.Mb, Al(a)),
          (this.ci[a] = b = this.Mb.offsetWidth),
          $l(this.Mb, "")));
    return b;
  };
  g.Yb = function () {
  ...
  g.im = function () {
    ...
    if (!this.Yl || this.Yl + 3e3 < a) {
      ...
      a = this.Mb;
      var b = jm(a);
      a = (a = b.getComputedStyle ? b.getComputedStyle(a, "") : a.currentStyle)
        ? a.fontSize
        : null;
      (this.Zl && a == this.Zl) ||
        ((this.ci = {}), (this.bi = null), (this.Zl = a));
    }
  };
  var En = function () {
    this.Cd = {};
  ...
  g.H = function (a) {
    ...
    this.Bc
      ? (this.Af || (this.Af = bb(this.Qv, this)),
        this.J.cc(this.bc, "webkitspeechchange", this.Af))
      : this.Af &&
        (this.J.ul(this.bc, "webkitspeechchange", this.Af), (this.Af = null));
    this.Bc && this.vo
      ? (this.ud || (this.ud = bb(this.Ar, this)),
        this.J.tb(4, this.ud),
        this.J.tb(5, this.ud),
        this.J.tb(1, this.ud))
      : this.ud && (this.J.LA(this.ud), (this.ud = null));
  };
  g.getType = function () {
    return 419;
  };
  ...
  g.Ar = function () {
    ...
    a != this.da &&
      (this.da
        ? this.bc.removeAttribute("x-webkit-speech")
        : this.bc.setAttribute("x-webkit-speech", ""),
      (this.da = a));
  };
  g.Fs = function (a, b) {
    b = Al(b);
    ...
    for (var c, d = 0; d < b.length; ++d)
      (c = b[d]), 0 > a.indexOf(c) && (b[d] = c.bold());
  ...
  g.Qv = function (a) {
    ...
    if (this.eg(this.Bf)) {
      ...
      for (var c = 0; c < b; ++c) {
        var d = a[c].utterance;
        this.eg(d) ||
          ((d = gl(this.Fs(this.Bf, d), d, c, 40, null)), this.xh.push(d));
      }
  ...
  Jn.prototype.render = function (a, b, c) {
    ...
    c
      ? (ne(this.Xa, Lh(c + " &raquo;")), (this.Xa.style.display = ""))
      : this.Xa && (this.Xa.style.display = "none");
  };
  ...
  Ln.prototype.Cg = function (a) {
    var b = a.Ig();
    return this.il && "input" == b && this.il.Zj == a.hb()
      ? (this.il.Ss(), 3)
      : 1;
  };
  ...
  g.ua = function (a, b) {
    ...
    a.Uf() ||
      (b.addRule(
        ".gscb_a",
        "display:inline-block;font:27px/13px arial,sans-serif"
      ),
  ...
  g.ya = function (a) {
    ...
    this.zf ||
      ((this.zf = Xl("span", "gscb_a")),
      (this.zf.id = this.Ea.Ga("gs_cb")),
      (a = Lh("&times;")),
      me(this.zf, a));
    a = bb(this.Nv, this);
    this.J.tb(4, a);
  ...
  g.ua = function (a, b) {
    ...
    a.Uf() ||
      ...
      b.addRule(
        ".gsst_e",
        "vertical-align:middle;" + (km() + ":" + lm(0.55) + ";")
      ),
      b.addRule(
        ".gsst_a:hover .gsst_e,.gsst_a:focus .gsst_e",
        km() + ":" + lm(0.72) + ";"
      ),
      b.addRule(".gsst_a:active .gsst_e", km() + ":" + lm(1) + ";"),
      ...
      b.addRule(
        ".gsst_h",
        "background-color:white;height:1px;margin-bottom:-1px;position:relative;top:-1px"
      ));
  };
  g.Od = function () {
    var a = {
  ...
  g.H = function (a) {
    ...
    if (this.$v) {
      ...
      for (var b; (b = this.Ge[a++]); ) {
        var c = !!this.Fe[b.Hg()];
        if (b.isEnabled() != c) {
          for (; this.ba.hasChildNodes(); )
            this.ba.removeChild(this.ba.lastChild);
          this.kn();
          this.qm();
          break;
        }
  ...
  g.Hj = function () {
    this.Ci &&
      ((this.Fe[this.Ci].className = "gsst_a"), this.Ot.Zc(), (this.Ci = null));
  };
  g.Tf = function (a) {
  ...
  var Un = function () {
    var a = {
      ...
      Ka = function (p, I, A, W, n) {
        ...
        C = W;
        K = A || "partner-generic";
        (m = n.brandingPlaceholder) && I.setAttribute("placeholder", m);
        D(f, "gsc-input");
      ...
      La = function (p, I) {
        ...
        A &&
          ...
          "button" != (A.getAttribute("role") || null) &&
      ...
      db = function () {
        ...
        p.ih = I;
        p.Gm =
          "partner-generic-exp" === p.Ne || "partner-web-exp" === p.Ne
            ? "cse_exp"
            : "cse";
        p.VD = !0;
        p.oA = {
        ...
        v &&
          ((p.tn = f.id),
          (p.vn = "gsc-input-hover"),
          (p.un = "gsc-input-focus"));
        p.Jd = [-1, 0, 0];
        p.lo = !0;
        p.Oc = !0;
        p.Ng = !0;
      ...
      Fa = function (p, I) {
        if ((U = !!I.useKennedyLookAndFeel))
          v &&
            ((p.tn = f.parentNode.id),
            (p.vn = "gsc-input-box-hover"),
            (p.un = "gsc-input-box-focus")),
            (p.Jd = [3, -1, 2]),
            (p.Ng = !0);
        ...
        k &&
          ((u = I.brandingImageStyle + " url(" + k + ")"),
          (p.Xh = I.backgroundTextIndent));
      ...
      ya = {
        ...
        install: function (p, I, A, W, n) {
          ...
          if (W.isLoggingWithHiddenFormFields) {
            ...
            (M = !0),
              d &&
                (d.addEventListener
                  ? d.addEventListener("submit", va, !1)
                  : d.attachEvent && d.attachEvent("onsubmit", va));
        },
        Bw: function (p, I, A, W) {
          v = A;
          Ka(p, I, v.Fg(), v.Ag() || "", W);
        ...
        r: function (p) {
          v
            ? U
              ? (p.addRule(".gssb_a", "padding:0 9px"),
                p.addRule(".gsib_a", "padding:5px 9px 4px 9px"),
                p.addRule(".gscb_a", "line-height:27px"))
              : p.addRule(".gssb_a", "padding:0 7px")
            : p.addRule(".gssb_a", "padding:0 2px");
  ...
  var Y = {
    ...
    ao = Ii["no-results"];
  y(
    "module$exports$cse$searchcontrol.SearchControl.NO_RESULTS_DEFAULT_STRING",
    ao
  );
  ...
  y(
    "module$exports$cse$searchcontrol.SearchControl.REFINEMENT_AS_LINK",
    "link"
  );
  y("module$exports$cse$searchcontrol.SearchControl.MODE_STANDARD", "standard");
  y(
    "module$exports$cse$searchcontrol.SearchControl.MODE_SEARCHBOX_ONLY",
    "searchbox-only"
  );
  y(
    "module$exports$cse$searchcontrol.SearchControl.MODE_RESULTS_ONLY",
    "searchresults-only"
  );
  var bo = {},
    co =
  ...
  X.prototype.Si = function (a, b) {
    ...
    if (b) {
      ...
      void 0 != b.numTopAds &&
        ((a.Nb = Math.max(0, Math.min(4, b.numTopAds))),
        (a.enabled = a.Nb ? !0 : !1));
      void 0 != b.numSideAds &&
        ((c.Nb = Math.max(0, Math.min(8, b.numSideAds))),
        (c.enabled = c.Nb ? !0 : !1));
  ...
  X.prototype.Mc = function (a, b, c) {
    ...
    b = new $n(a, this, b);
    c
      ? (c.ha.push(b), (b.he = c), (b.ed = c.ed + 1))
      : (this.K.push(b), (b.ed = 0));
    this.tf(a) && (this.Vv = !0);
    a.ve = "gsc";
  };
  ...
  X.prototype.Dm = function (a) {
    a.Ob.root &&
      ((a.Pj = !1),
      D(a.Ob.root, "gsc-resultsRoot"),
      qg(a.Ob.root, "gsc-resultsbox-visible"),
      D(a.Ob.root, "gsc-resultsbox-invisible"));
  ...
  g.ln = function (a) {
    ...
    for (
      ...
      !(
        a.href &&
        a.getAttribute("data-cturl") &&
        a.getAttribute("data-ctorig")
      );
  ...
  g.oi = function (a, b) {
    ...
    $b && (a += " gs-spacer-opera");
    b
      ? ((b = b.gb), D(c.V, this.ly), D(c.V, this.xk))
      : ((b = this.xb), D(c.V, "gsc-tabHeader"), D(c.V, "gsc-tabhInactive"));
    ...
    if (1 != a.ha.length) {
      ...
      if (b) {
        ...
        a.parentNode &&
          ...
          c && E(a.parentNode, c),
          (b = b.fa.Cb),
          b.parentNode && E(b.parentNode, b));
      }
    }
  };
  g.Xn = function (a) {
    for (var b = 0; b < this.Dc.length; ++b) if (this.Dc[b].key == a) return b;
    return null;
  };
  g.Fx = function (a) {
  ...
  g.bz = function (a) {
    ...
    this.Ja.style.top =
      qj(this.Ja, this.Ec) + qj(this.uf, this.Ec) - qj(b, this.Ec) + "px";
    a.cancelBubble = !0;
    a.stopPropagation && a.stopPropagation();
  };
  g.Jt = function (a) {
  ...
  g.ot = function () {
    ...
    this.root.attachEvent
      ? (this.root.attachEvent("onmousedown", b),
        document.attachEvent("onmousedown", b))
  ...
  g.Id = function (a, b) {
    ...
    b
      ? b.ja
        ? ((this.ja = b.ja),
          ...
          (this.og = b.og),
          (this.He = b.He),
          "searchbox-only" == this.qb && (this.oa = b.oa))
        : (this.ja = 1)
      : (this.ja = 1);
    ...
    b &&
      b.kc &&
      ((this.kc = !0),
      this.T && this.T.Tq(this.hp(b.ob)),
      this.W && this.W.Tq(this.hp(b.ob)));
    null != c
      ? ((this.input = c),
        (this.input.onkeyup = this.yw),
        (this.input.onpaste = this.zw),
        (this.rd = !1))
      : ((this.rd = !0),
        null == d ? (d = this.root) : (d.dir = yi),
        (this.ue = new io(!0, d, {
          Hh: !0,
          FC: this.kc,
          Tl: !0,
        })),
        this.ue.Nq(this, this.Qb),
        (this.input = this.ue.input),
        (d = this.ue.jh),
        (e = {
        ...
        this.kc &&
          ((e.brandingImageUrl =
            "https://www.google.com/cse/static/images/1x/" +
            b.ob +
            "/branding.png"),
          (e.brandingImage2xUrl =
            "https://www.google.com/cse/static/images/2x/" +
            b.ob +
            "/branding.png"),
          (e.brandingImageStyle = "#FFFFFF " + zi + " no-repeat"),
          (e.brandingPlaceholder = "")),
        this.Wf
          ? this.Vf &&
            ((e.maxSuggestions = this.Vf.maxCompletions),
            (e.maxPromotions = this.Vf.maxPromotions))
          : (e.disableAutoCompletions = !0),
        this.oa && (e.enableAsynchronousLogging = !vj(uj(this.oa.Lk))),
        (e.enableSpeech = b ? b.og : !1),
        (this.od = Un()),
        this.od.Bw(d, this.input, this, e),
        e.useKennedyLookAndFeel && D(d, "gsc-search-box-tools"));
    c ||
      "searchresults-only" != this.qb ||
      ((this.ue.jh.style.display = "none"),
      (this.root.style.visibility = "hidden"));
    if (!this.oa) {
      this.pe = L("gsc-resultsbox-invisible");
      this.Ym && ((this.re = this.qt()), E(this.pe, this.re));
      this.ea = this.Cp
        ? L("gsc-results-wrapper-overlay")
        : L("gsc-results-wrapper-nooverlay");
      E(this.root, this.ea);
      this.Cp &&
        ((this.de = L("gsc-modal-background-image")),
        E(this.root, this.de),
        this.Oa(this.de, X.prototype.Qb),
        (this.qe = L("gsc-results-close-btn")),
        E(this.ea, this.qe),
        this.Oa(this.qe, X.prototype.Qb));
      if (2 == this.ja)
        for (
          this.xb = L("gsc-tabsAreaInvisible"),
            ...
            E(b, this.mb),
            E(this.ea, b),
            this.sd && ((b = L("gsc-refinementsGradient")), E(this.mb, b)),
            b = 0;
          b < this.K.length;
          b++
        )
      ...
      this.Ap &&
        2 == this.ja &&
        ((b = dj(b, "gsc-orderby-container")),
        (this.bb = this.ot()),
        E(b, this.bb),
        og(this.bb, "gsc-orderby-invisible"));
      this.nb = this.ea;
      if (this.Nc) {
        var f = this.ea;
      ...
      for (b = 0; b < this.K.length; b++)
        this.Dm(this.K[b]),
          (c = this.K[b].fa.Cb),
          2 == this.ja && c && (D(c, "gsc-tabData"), D(c, "gsc-tabdInactive"));
      if (2 == this.ja && 0 < this.K.length) {
        this.F = this.K[0].fa;
        this.Ee(this.F);
        if ((b = this.K[0].fa.Cb))
          qg(b, "gsc-tabdInactive"), D(b, "gsc-tabdActive");
  ...
  g.Ee = function (a) {
    1 == a.level
      ? a.V.onclick
        ? (jj(a.V, null), qg(a.V, this.xk), D(a.V, this.Tp))
        : (this.Oa(a.V, this.Ce, [a]), qg(a.V, this.Tp), D(a.V, this.xk))
      : a.V.onclick
      ? (jj(a.V, null), qg(a.V, "gsc-tabhInactive"), D(a.V, "gsc-tabhActive"))
      : (this.Oa(a.V, this.Ce, [a]),
        qg(a.V, "gsc-tabhActive"),
        D(a.V, "gsc-tabhInactive"));
  };
  g.Ce = function (a, b) {
    if (this.F != a) {
      this.al(!0);
      ...
      1 == this.F.level &&
        c != d &&
        (D(c.gb, "gsc-refinementBlockInvisible"), this.Ee(c.fa));
      this.F = a;
      c = this.F.ta;
      this.Ee(this.F);
      ...
      !b &&
        this.na &&
        this.na.isEnabled() &&
        ((d = this.na.getState()), this.Xq(a, d));
      if ((a = this.F.Cb)) D(a, "gsc-tabdActive"), qg(a, "gsc-tabdInactive");
      var e = (a = b ? b.query : this.ae) && a == c.Ib;
      b && (e = e && b.page == c.wg());
      if (e) {
        d && ((d["gsc.page"] = c.wg()), this.na.pushState(d));
        if (!this.Cr(c.Ib, c.wg()) || ($b && b))
          (this.Zb = c.Zb), this.Zi(c.Ib, c.wg());
        this.F.context.fp ||
          (this.dr(this.F.context), this.jn(c), this.bb && this.yr());
  ...
  g.Cr = function (a, b) {
    ...
    return (
      ...
      this.zb.query == a &&
      (this.zb.adPage || 1) == b &&
      !(c.enabled && this.F && this.F.context.ca != c.R.parentNode)
    );
  };
  g.jn = function (a) {
    var b = a.results,
    ...
    1 != this.ja && 0 < b.length && c && c.resultCount && c.searchResultTime
      ? ((a = Zi(Gi["result-info"](c.resultCount, c.searchResultTime))),
        Wi(this.ne, a),
        og(this.ne, "gsc-result-info"))
      : (og(this.ne, "gsc-result-info-invisible"), Vi(this.ne));
  };
  g.mn = function (a, b) {
    if (a.u.M)
  ...
  g.Zp = function (a, b, c) {
    ...
    if ("object" == typeof b) for (var f in b) this.Zp(f, b[f], a);
  ...
  g.dl = function (a, b) {
    var c = this.root,
      d = a.sa;
    b
      ? (D(c, "gsc-loading-fade"),
        (a.fp = !0),
        D(d, "gsc-loading-resultsRoot"),
        0 == a.ed && this.mb && D(this.mb, "gsc-loading-refinementsArea"))
      : (qg(c, "gsc-loading-fade"),
        (a.fp = !1),
        qg(d, "gsc-loading-resultsRoot"),
        this.mb && qg(this.mb, "gsc-loading-refinementsArea"));
  };
  g.np = function () {
    ...
    this.Nc &&
      (null != this.lf
        ...
        : this.wc(function (a, b) {
            0 < b.gd
              ? (og(b.R, b.className), b.fb && D(this.nb, b.fb))
              : (og(b.R, "gsc-adBlockInvisible"), b.fb && qg(this.nb, b.fb));
          }));
  };
  g.submit = function () {
    return this.kr();
  ...
  g.zp = function (a) {
    ...
    b =
      this.oa.Lk +
      (0 <= this.oa.Lk.indexOf(b) ? "&" : b) +
      encodeURIComponent(this.oa.gy) +
      "=" +
  ...
  g.qs = function (a) {
    ...
    return function (c, d) {
      if (d) {
        ...
        e == f
          ? (window.clearTimeout(b.Gt), b.xi())
          : 1 == f &&
            (b.Gt = window.setTimeout(function () {
              b.xi();
            }, 200));
      }
    };
  ...
  X.prototype.fh = function (a) {
    ...
    else if (((this.input.value = a), this.input.onfocus))
  ...
  X.prototype.hp = function (a) {
    ...
    var d =
      "https://www.google.com/cse/static/images/2x/" + a + "/branding.png";
    a = ej(
      "https://www.google.com/cse/static/images/1x/" + a + "/branding.png",
      null,
      null,
      b.rw
    );
  ...
  g.$i = function (a, b, c, d, e) {
    if (a.length) {
      ...
      this.na &&
        this.na.isEnabled() &&
        ((d = d || this.na.getState()),
        (d["gsc.q"] = a),
        null == b ? delete d["gsc.page"] : (d["gsc.page"] = b),
        this.bb &&
          this.F.ta instanceof R &&
          (d["gsc.sort"] = this.Dc[this.we].key),
        this.na.pushState(d));
      ...
      if (2 == this.ja) d = this.en(this.F.context, this.F.Cb, a, e, b, c) || d;
        ...
        for (var f = 0; f < this.K.length; f++)
          d = this.en(this.K[f], this.K[f].root, a, e, b, c) || d;
      c = this.Cr(a, b);
  ...
  g.Zi = function (a, b) {
    ...
    var c = this.Nc;
    c &&
      ((this.Vv && 1 == this.ja) || (2 == this.ja && this.tf(this.F.ta))) &&
      (c = !1);
    var d = this.Fu();
    ...
    if (c)
      if ((this.iz(), this.yn)) {
        ...
        this.zb = {
          ...
          containerWidth: this.Zo || this.ea.offsetWidth,
        };
        d && (this.zb.cx = d);
        b && (this.zb.adPage = b);
        void 0 !== this.Fp && (this.zb.personalizedAds = this.Fp);
        this.Te &&
          ((this.zb.afdToken = this.Te), (this.aa[Y.eb].Nb = this.sd ? 2 : 3));
        this.zb.cseGoogleHosting =
          "full" == this.Rf || "iframe" == this.Rf || "partner" == this.Rf
            ? this.Rf
            : "partner";
        if ((b = uk()) && b in fo) {
          b = fo[b];
        ...
        google.ads && google.ads.search && google.ads && google.ads.search.Ads
          ? this.aq()
          : (this.zk = !0);
      } else {
        e = "";
        this.aa[Y.eb].enabled && (e = e + "w" + this.aa[Y.eb].Nb);
        this.aa[Y.Ua].enabled && (e = e + "n" + this.aa[Y.Ua].Nb);
        e =
          "http://www.google.com/" +
          (d ? "cse" : "search") +
  ...
  g.Ax = function (a) {
    ...
    var b = this.aa[Y.eb],
      c = this.aa[Y.Ua];
    if (b.R)
      if ((Fe(b.R, ""), Fe(c.R, ""), (b.gd = c.gd = 0), !a || 1 > a.length))
        this.gf();
      else {
        if (!this.xb)
          ...
          if ("text/wide" == k.type) {
            ...
            c.enabled &&
              ...
              d ||
                ((d = !0),
                D(this.nb, c.fb),
                c.R && (E(c.R, e.cloneNode(!0)), og(c.R, c.className))),
              (l = L("gsc-ad")),
              (m = gj(k.url, k.line1, "_blank")),
              E(l, m),
              (m = aj()),
              si(m, this.$b.Sa(k.line2 + "<br/>" + k.line3)),
              E(l, m),
              (m = document.createElement("cite")),
              si(m, this.$b.Sa(k.visible_url)),
              E(l, m),
  ...
  g.Cx = function () {
    ...
    a &&
      ...
      (this.Zd = window.setTimeout(
        Ui(this, X.prototype.execute, [null]),
        this.ic
      )));
  };
  g.Dx = function () {
  ...
  X.prototype.al = function (a) {
    a
      ? (og(this.pe, "gsc-resultsbox-visible"),
        this.ea && D(this.ea, "gsc-results-wrapper-visible"),
        this.qe && D(this.qe, "gsc-results-close-btn-visible"),
        this.de &&
          (D(this.de, "gsc-modal-background-image-visible"),
          D(document.getElementsByTagName("body")[0], "gsc-overflow-hidden")))
      : (og(this.pe, "gsc-resultsbox-invisible"),
        this.ea && qg(this.ea, "gsc-results-wrapper-visible"),
        this.qe && qg(this.qe, "gsc-results-close-btn-visible"),
        this.de &&
          (qg(this.de, "gsc-modal-background-image-visible"),
          qg(document.getElementsByTagName("body")[0], "gsc-overflow-hidden")));
    for (var b = 0; b < this.K.length; b++)
      if (!this.K[b].Pj) {
        var c = this.K[b].root;
        a
          ? (qg(c, "gsc-resultsbox-invisible"), D(c, "gsc-resultsbox-visible"))
          : (qg(c, "gsc-resultsbox-visible"), D(c, "gsc-resultsbox-invisible"));
      }
  };
  X.prototype.Qb = function () {
    ...
    if (
      "searchbox-only" != this.qb &&
      ("searchresults-only" == this.qb &&
        (this.root.style.visibility = "hidden"),
      this.al(!1),
      this.xb && og(this.xb, "gsc-tabsAreaInvisible"),
      this.mb && og(this.mb, this.Up),
      this.wc(function (b, c) {
        c.R && (og(c.R, "gsc-adBlockInvisible"), c.fb && qg(this.nb, c.fb));
      }),
      this.wd && og(this.wd, "gsc-above-wrapper-area-invisible"),
      this.na && this.na.isEnabled())
    ) {
  ...
  g.Xk = function (a, b, c, d, e) {
    a = a.ec ? a.ec(b) : b;
    d
      ? ((b = {}), (b[d] = e), (d = Ui(this, this.execute, [a, void 0, b])))
      : (d = Ui(this, this.execute, [a]));
    jj(c, d);
  };
  g.yr = function () {
    this.bb &&
      (this.F.context.u instanceof R
        ? og(this.bb, "gsc-orderby")
        : og(this.bb, "gsc-orderby-invisible"));
  };
  g.fm = function (a) {
    var b = function (c, d) {
  ...
  g.jd = function (a) {
    ...
    if (!this.ag) {
      this.fm(a);
      var b = a.u;
      "please trigger recaptcha" !== this.pj() ||
        b.fw() ||
        (b.completionStatus = 429);
      if (429 === b.completionStatus) this.It(a, b.tw.bind(b));
        ...
        var e = b.promotions;
        var f =
          a.u.Kd && 400 <= a.u.completionStatus
            ? a.u.Xi
              ? [a.u.nu()]
              : [a.u.lu()]
            : 0 == a.u.results.length && a.Ob.fd && 200 == a.u.completionStatus
            ? [a.u.mu(a.Ob.fd)]
            : a.u.results;
        d = "web" === b.Ta;
        var h = !0,
        ...
        if (k) {
          ...
          if (f) {
            ...
            for (
              ...
              M = {};
              T = r(z);
              for (var V = T.next(); !V.done; V = T.next()) {
                var N = r(V.value);
                V = N.next().value;
                N = N.next().value;
                C[V] && ((K = !0), (M[N] = C[V]));
          ...
          for (l = e.next(); !l.done; l = e.next())
            (l = l.value),
              ...
              l.html &&
                ...
                D(m, "gsc-result"),
                D(m, "gsc-promotion"),
                E(m, l.html.cloneNode(!0)),
                a.sa.insertBefore(m, a.ca),
                k.push(m));
          e = k;
        } else e = [];
        ...
        k = [];
        if (h)
          for (f = r(f), h = f.next(); !h.done; h = f.next())
            (h = h.value),
              h.html || b.Re(h),
              h.html && ((l = !0), k.push(this.Xx(a, h)));
        if (!d && !a.u.Kd) {
          b = r(k);
          for (f = b.next(); !f.done; f = b.next())
            (f = f.value),
              this.Oa(f.firstElementChild, this.FA, [f]),
              this.ds(f.firstElementChild, Ik, Jk);
  ...
  X.prototype.FA = function (a) {
    ...
    this.Zg
      ? this.Zg.vd(this.ae, "toggleImagePreviewVisibility_", 2, c)()
      : c();
  };
  X.prototype.tr = function (a) {
    for (
      var b = r(this.F.context.sa.children), c = b.next();
      !c.done;
      c = b.next()
    ) {
      var d = c.value;
      if ("none" !== d.style.display) d.style.setProperty("display", "none");
        ...
        Yi(d.getElementsByClassName("gs-previewTitle")[0], c.titleNoFormatting);
        Yi(e, c.visibleUrl);
        ...
        for (e = d.next(); !e.done; e = d.next())
          (e = e.value),
            e.setAttribute("href", c.originalContextUrl),
            e.setAttribute("target", c.target);
      }
    }
  };
  X.prototype.EA = function (a) {
    for (var b = jo(a), c = tj(a); c; c = c.nextElementSibling)
      if (c !== a && pg(c, "gs-selectedImageResult")) {
        ...
        d &&
          (qg(d, "gs-imagePreviewArea"), D(d, "gs-imagePreviewArea-invisible"));
      }
    pg(a, "gs-selectedImageResult")
      ? qg(a, "gs-selectedImageResult")
      : D(a, "gs-selectedImageResult");
    c = a.getElementsByClassName("gs-imagePreviewArea")[0];
    d = a.getElementsByClassName("gs-imagePreviewArea-invisible")[0];
    if (c) qg(c, "gs-imagePreviewArea"), D(c, "gs-imagePreviewArea-invisible");
    else if (d)
      ko(d, this.F.ta.results[b]),
        qg(d, "gs-imagePreviewArea-invisible"),
        D(d, "gs-imagePreviewArea");
    else
      throw Error(
      ...
      b.type && "SPELL_CORRECTED_RESULTS" == b.type
        ? d &&
          ...
          (this.Xk(
            ...
            b.correctedQuery,
            d[0],
            b.correctedParamName,
            b.correctedParamValue
          ),
          this.Xk(
            a.u,
            b.originalQuery,
            d[1],
            b.originalParamName,
            b.originalParamValue
          ))
        : d && 0 < d.length && this.Xk(a.u, b.correctedQuery, d[0]);
      b = L(a.u.Uc());
      D(b, "gsc-result");
      E(b, c);
  ...
  g.bs = function (a, b) {
    var c =
      ...
      this.F.ta &&
      "Web" == this.F.ta.td &&
      0 < a.u.results.length &&
      0 === a.u.cursor.currentPageIndex;
    if (b && c) {
      c = L(a.u.Uc());
      D(c, "gsc-result");
      E(c, b.cloneNode(!0));
  ...
  g.Xx = function (a, b) {
    ...
    (b = this.aa[Y.Ba].R) && b.parentNode == a.ca
      ? a.ca.insertBefore(c, b)
      : a.ca && E(a.ca, c);
    return c;
  };
  g.ks = function (a, b) {
    a
      ? b.ff && Wi(b.ff, Zi("(" + b.u.results.length + ")"))
      : (b.ff && Wi(b.ff, Zi("(0)")), this.fm(b));
    var c = this.Kb,
      d = this.sd;
      ...
      if (d || e) {
        if ((d && this.Us(a), b.facets && 0 < b.facets.length)) {
          ...
          for (b = 0; b < h.length; b++) {
            ...
            d || (e && !a.u.Yd(l))
              ? this.Am(c, l, k.anchor)
              : (a.u.vb(k.anchor), this.pp(c), (f = !0));
          }
          e && !f && this.pp(c);
        }
      } else if (a.le && b.facets && 0 < b.facets.length)
        for (c = b.facets, d = 0; d < c.length; d++)
          (e = c[d]), a.u.Yd(e.label) && a.u.vb(e.anchor);
      a.le && (a.le = !1);
    }
  ...
  g.dr = function (a) {
    a.gb
      ? (qg(a.gb, "gsc-refinementBlockInvisible"),
        D(a.gb, "gsc-refinementBlock"),
        this.F != a.Le && ((this.F = a.Le), this.Ee(this.F)))
      : a.he &&
        a.he.gb &&
        (qg(a.he.gb, "gsc-refinementBlockInvisible"),
        D(a.he.gb, "gsc-refinementBlock"));
  };
  g.kw = function (a) {
  ...
  g.Us = function (a) {
    if (0 != a.ha.length) {
      ...
      for (a.gb = null; 0 < a.ha.length; )
        (b = a.ha.pop()), b.root && (Vi(b.root), this.pe.removeChild(b.root));
    }
  };
  g.gt = function (a) {
  ...
  g.ht = function (a) {
    for (
      var b = L("gsc-cursor"), c = a.u.cursor, d = 0;
      d < c.pages.length;
      d++
    ) {
      var e = d + 1,
  ...
  g.it = function (a) {
    ...
    0 < d &&
      (h.appendChild(f(!0)),
      this.Oa(h, X.prototype.kh, [a, d - 1]),
      b.appendChild(h));
  ...
  X.prototype.fr = function (a) {
    ...
    if (
      !(b = !a) &&
      (b = !(!window.history || !window.history.pushState) || Ok())
    )
      a: {
        b = Pk(Qk()).state;
        for (var c in b) {
  ...
  X.prototype.ao = function (a, b) {
    if (null == a || 0 > a || a >= this.K.length) a = this.F;
      ...
      if (c.u.M && b) {
        ...
        a = this.mn(c, d);
        a ||
          (c.gb || this.zm(c), (b = this.Am(c, d, b)), (b.le = !0), (a = b.fa));
      } else a = c.Le || c.fa;
    }
    return a;
  };
  ...
  var io = function (a, b, c) {
      ...
      if (
        c &&
        (c.buttonText && (f = e = c.buttonText), c.clickableBrandingUrl)
      ) {
      ...
      c &&
        ...
        (this.Rj = L("gsc-input-box")),
        (this.Rj.id = "gsc-iw-id" + mo),
        E(this.Rj, this.input),
        (f = this.Rj));
      ...
      a &&
        ...
        (this.di.title = Ii["clear-results"]),
        (a = dj(c, "gsc-clear-button")),
        E(a, this.di));
    },
    mo = 0;
  ...
  var Z = function (a, b, c) {
    ...
    this.Vb =
      null != b.experimentNames ? -1 < b.experimentNames.indexOf("csqr") : !1;
    this.Sc = Array.isArray(b.experimentNames)
      ? 0 <= Ob(b.experimentNames, "dev")
      : !1;
    ...
    if (b.adoptions)
      for (var d in b.adoptions)
        b.adoptions.hasOwnProperty(d) && (c[d] = b.adoptions[d]);
    ...
    if (!b.disableWebSearch || !b.enableImageSearch) {
      var e = {};
      b["restrict-extended"] &&
        (e["restrict-extended"] = b["restrict-extended"]);
    ...
    if (b.enableImageSearch) {
      a = {};
      b["restrict-safesearch"] &&
        (a["restrict-safesearch"] = b["restrict-safesearch"]);
      b.isSafeSearchActive && (a.isSafeSearchActive = b.isSafeSearchActive);
      if (b.imageSearchOptions)
        for (var h in b.imageSearchOptions) a[h] = b.imageSearchOptions[h];
    ...
    b.googleAnalyticsOptions &&
      ...
      ((this.Bj = b.googleAnalyticsOptions), this.Zq(null, no));
    b.enableOrderBy &&
      ((this.Ap = !0),
      (this.Dc =
        b.orderByOptions &&
        b.orderByOptions.keys &&
        0 < b.orderByOptions.keys.length
          ? b.orderByOptions.keys
          : [
              {
                key: "",
      ...
      void 0 !== e &&
        b.orderByOptions &&
        e["restrict-extended"] &&
        void 0 !== e["restrict-extended"].sort_by &&
        (this.Fd = this.Xn(e["restrict-extended"].sort_by) || 0),
      void 0 == this.Fd && (this.Fd = 0));
  ...
  var oo = null,
    ...
    qo = function () {
      po ||
        ...
        (oo.src = "https://www.googleapis.com/generate_204"),
        (po = !0));
    };
  uk() && qo();
  Z.prototype.au = function (a) {
    this.T ||
      ...
      a &&
        (a.cse_token
          ? this.T.vf(a.cse_token)
          : this.T.vf("AHKYotWVmvV1wohA3g8oNFAm_6cK:1495660148313"),
        a.resultSetSize && this.T.Na(a.resultSetSize),
        a["restrict-extended"] &&
          this.T.Hc("restrict-extended", a["restrict-extended"]),
        a["restrict-safesearch"] &&
          this.T.Hc("restrict-safesearch", a["restrict-safesearch"]),
        a.isSafeSearchActive && this.T.xf(a.isSafeSearchActive),
        a.linkTarget && this.T.Ma(a.linkTarget),
        a.queryAddition && this.T.hc(a.queryAddition),
        a.experimentNames && this.T.Ae(a.experimentNames),
        a.cselibVersion &&
          (this.T.wf(a.cselibVersion),
          this.T.mi("cse.customWebSearch", this.sc, a.experimentNames),
          (this.Zg = new hk(
            "cse.searchControl",
            a.cselibVersion,
            this.sc,
  ...
  Z.prototype.Wt = function (a) {
    if (
      ...
      a.cse_token
        ? this.W.vf(a.cse_token)
        : this.W.vf("AHKYotWVmvV1wohA3g8oNFAm_6cK:1495660148313");
      a.resultSetSize && this.W.Na(a.resultSetSize);
      a["restrict-safesearch"] &&
        this.W.Hc("restrict-safesearch", a["restrict-safesearch"]);
      a.isSafeSearchActive && this.W.xf(a.isSafeSearchActive);
      a["restrict-extended"] &&
        this.W.Hc("restrict-extended", a["restrict-extended"]);
      a.linkTarget && this.W.Ma(a.linkTarget);
      a.queryAddition && this.W.hc(a.queryAddition);
      var b = [];
      a.experimentNames &&
        (this.W.Ae(a.experimentNames), (b = a.experimentNames.slice()));
      a.cselibVersion &&
        (this.W.wf(a.cselibVersion),
        this.W.mi("cse.customImageSearch", this.sc, b),
        (this.Zg = new hk("cse.searchControl", a.cselibVersion, this.sc, b)));
    }
  };
  ...
  var so = function (a, b, c, d) {
    if (c instanceof X && window.console)
      return (
        window.console.log(
          "We no longer support attachAutoCompletionWithOptions for SearchControl object"
        ),
        {}
      );
    a = ro(a);
    ...
    b = sj(b);
    if (!e) for (var f = b; f; ) (f = f.parentNode), rj(f) && (e = f);
    f = Un();
    var h = {
      clearToolTitle: Ii["clear-tool-title"],
      interfaceLanguage: "en",
    ...
    (d = d.searchButton ? sj(d.searchButton) : null) &&
      ("submit" != d.type
        ? (h.searchButton = d)
        : window.console &&
          window.console.warn(
            "Cannot associate searchButton with a button of type submit."
          ));
    if (h.isLoggingWithHiddenFormFields && !h.searchButton)
      return (
        window.console &&
          window.console.warn(
            'The "searchButton" option is required when "isLoggingWithHiddenFormFields" is true.'
          ),
        {}
      );
    d = c && (c.execute || c.submit);
    rj(e)
      ? ((h.isLoggingWithHiddenFormFields =
          h.isLoggingWithHiddenFormFields || vj(uj(e.action))),
        f.install(e, b, a, h))
      : f.Cw(d ? Ti(c, d) : function () {}, b, a, h);
    return {
      getInputQuery: f.la,
      prefillQuery: f.Pb,
    };
  ...
  y(
    "module$exports$cse$customsearchcontrol.CustomSearchControl.attachAutoCompletionWithOptions",
    so
  );
  ...
  Z.prototype.Id = function (a, b) {
    ...
    this.oa ||
      ...
      E(b, this.root),
      og(this.root, "gsc-control-wrapper-cse"));
    og(b, a);
    D(b, a + "-en");
  };
  ...
  Z.prototype.$i = function (a, b, c, d, e) {
    if (this.oa) this.zp();
      ...
      this.Zo = f;
      if (500 > new Date().getTime() - this.DA && this.Nc)
        try {
  ...
  Z.prototype.kv = function () {
    ...
    return this.ea
      ? (E(this.ea, a), (b = this.ea.offsetWidth), this.ea.removeChild(a), b)
      : 0;
  };
  Z.prototype.vb = function (a) {
    "string" == typeof a
      ? this.T
        ? this.T.vb(a)
        : this.W && this.W.vb(a)
      : (a.web && this.T && this.T.vb(a.web),
        a.image && this.W && this.W.vb(a.image));
  };
  ...
  y(
    "module$exports$cse$customsearchcontrol.CustomSearchControl.getTrackingCategory",
    to
  );
  var no = function (a, b, c) {
    ...
    c = [
      ...
      d.search,
      d.search ? "&" : "?",
      encodeURIComponent(a.Bj.queryParameter),
      "=",
      encodeURIComponent(c),
    ];
    a.Bj.categoryParameter &&
      (b = to(b.Ta, b.M, b.rc())) &&
      c.push(
        "&",
        encodeURIComponent(a.Bj.categoryParameter),
        "=",
  ...
  y(
    "module$exports$cse$customsearchcontrol.CustomSearchControl.AUTO_PUBID",
    ""
  );
  ...
  g.Yr = function (a) {
      ...
      return (
        wj(
          "Name of the component, " +
            a.wa +
            ", should match name of the element, " +
            this.wa +
            "."
        ),
        this.fe
    ...
    wj(
      "Component of type " +
        a.type +
        " is not allowed for Element named " +
        this.wa +
        " of type " +
        this.type +
        "."
  ...
  g.Jx = function (a, b) {
    a.hasOwnProperty("webSearchSafesearch") &&
      (a.isSafeSearchActive = a.webSearchSafesearch);
    a.hasOwnProperty("safeSearch") && (a.isSafeSearchActive = a.safeSearch);
    Uj(function (c) {
      if (
        a.hasOwnProperty(c.name) &&
        c.s &&
        ("searchbox+results" == b || void 0 == c.m || c.m == b)
      ) {
        var d = c.l(a[c.name]);
        null != d &&
          ("webSearchExtendedRestricts" === c.i
            ? (this.v.webSearchExtendedRestricts ||
                (this.v.webSearchExtendedRestricts = {}),
              (this.v.webSearchExtendedRestricts[c.name] = d))
      ...
      for (b = a.next(); !b.done; b = a.next()) {
        ...
        b &&
          (this.v[c] =
            "function" == typeof b
              ? b
              : "string" == typeof b && "function" === typeof x[b]
              ? x[b]
              : null);
      }
    }
  ...
  g.fs = function (a, b, c) {
    b = wd(
      new fd(
        dd,
        "https://www.google.com/cse/static/element/%{versionDir}/mobile%{suffix}+%{lang}.css"
      ),
      {
        versionDir: a,
        suffix: b,
  ...
  g.Lt = function (a) {
    ...
    Uj(function (h) {
      h.g &&
        void 0 != this.v[h.name] &&
        ((h.i ? b[h.i] : b)[h.g] = this.v[h.name]);
    }, this);
    ...
    if (
      "forced" == this.v.mobileLayout ||
      ("enabled" == this.v.mobileLayout && this.v.isMobileDevice)
    )
      document.querySelector("head>meta[name=viewport]") ||
        console.warn(
          "Mobile layout requested, but viewport meta tag is missing. Page layout may not be optimal."
        ),
        this.fs(this.Ca, "", this.ob),
        (b.useMobileLayout = !0);
    void 0 != this.v.cssThemeVersion &&
      ((b.cssThemeVersion = this.v.cssThemeVersion),
      (0, bk.$q)(this.v.cssThemeVersion));
    void 0 != this.v.autoCompleteSource &&
      (b.autoCompleteOptions.clientName = this.v.autoCompleteSource);
    ...
    void 0 != this.v.numTopRefinements && d.Yq(this.v.numTopRefinements);
    ...
    "searchbox-only" == this.type
      ? ((e = this.v.resultsUrl),
        !e && this.Dd
          ? (e = "https://cse.google.com/cse?cx=" + encodeURIComponent(this.Dd))
          : void 0 == e && (e = window.location.href),
        this.v.personalizedAds || (e += "&personalized_ads=0"),
        d.$m(e, this.v.queryParameterName, this.v.newWindow),
        (e = a.searchbox))
      : "searchresults-only" == this.type
      ? (d.Zm(), (e = a.results))
      : "two-column" == this.type
      ? (d.Wk(a.searchbox), (e = a.results))
      : (e = a["searchbox+results"]);
    c.Id(e, d);
    this.v.noResultsString && ((a = te(this.v.noResultsString)), c.Be(a));
    this.v.enableHistory
      ? c.fr(Ti(this, this.zc)) && void 0 == this.v.linkTarget && c.Ma("_self")
      : this.zc(c);
    return c;
  };
  g.zc = function (a) {
    ...
    if (b && this.v.autoSearchOnLoad)
      if ("searchbox-only" == this.type) a.fh(b);
        ...
        for (var c = this.Jc, d = {}, e = 0; e < Vj.length; e++)
          c.hasOwnProperty(Vj[e]) && (d[Vj[e]] = c[Vj[e]]);
  ...
  var vo = function (a) {
    ...
    this.sb = new hk("cse.manager", this.Ca, this.Dd, this.Ze);
  };
  g = vo.prototype;
  g.zv = function (a) {
    a = a || {};
    ...
    Uj(function (c) {
      ...
      null != e
        ? (b[d] = e)
        : void 0 != c.defaultValue && (b[d] = c.defaultValue);
    }, this);
    return b;
  };
  g.Kt = function () {
    ...
    return (this.vk = !!(
      a.querySelectorAll && 0 < a.querySelectorAll("G\\:TEST").length
    ));
  };
  g.go = function (a) {
    var b = this;
    this.sb
      .vd(this.Jc.q, "go", null, function () {
        return b.Cv(a);
      })
      .apply(this);
  };
  ...
  g.render = function (a, b) {
    var c = this;
    return this.sb
      .vd(this.Jc.q, "render", null, function () {
        return c.xy(a, b);
      })
      .apply(this);
  };
  g.xy = function (a, b) {
    if (b && "searchbox" != a.tag && "searchresults" != b.tag)
      return (
        wj(
          'First and second components must be of tag "searchbox"  and "searchresults" separately.'
        ),
        null
      );
    if (b && a.gname != b.gname)
      return wj("First and second components must be of the same gname."), null;
    a = [a];
    b && a.push(b);
    b = [];
    for (var c = 0; c < a.length; c++) {
      ...
      if (!Nj[a[c].tag])
        return wj("tag named " + a[c].tag + " is not recognized"), null;
      var d = sj(a[c].div);
      if (d && 1 === d.nodeType) {
        d = new Xj(d, a[c]);
        var e = d.wa;
  ...
  g.lj = function (a) {
    var b = this;
    return this.sb
      .vd(this.Jc.q, "getElement", null, function () {
        return b.Iu(a);
      })
      .apply(this);
  };
  ...
  g.pu = function () {
    var a = this;
    return this.sb
      .vd(this.Jc.q, "getAllElements", null, function () {
        return a.qu();
      })
      .apply();
  };
  ...
  g.xs = function () {
    if (this.wk) {
      ...
      b.type = "text/css";
      b.styleSheet
        ? (b.styleSheet.cssText = this.wk)
        : b.appendChild(document.createTextNode(this.wk));
      a.appendChild(b);
    }
  };
  g.rn = function () {
  ...
  var Bo = x.window.setTimeout,
    ...
    Fo = function (a) {
      if ("loading" === Do.readyState)
        ...
        else if (Co.attachEvent)
          Co.attachEvent("onreadystatechange", function c() {
    ...
    Go = function (a) {
      if (Co.addEventListener)
        ...
        Co.attachEvent("onload", function c() {
  ...
  var Io = function (a, b) {
      for (
        var c = r(Ha.apply(2, arguments)), d = c.next();
        !d.done;
        d = c.next()
      )
        (d = d.value), y(b + "." + d, a[d]);
