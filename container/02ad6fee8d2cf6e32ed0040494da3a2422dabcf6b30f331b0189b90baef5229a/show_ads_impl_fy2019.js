(function(sttc) {
    ...
    */
    ...
    function ta(a, b, c) {
        Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? ta = qa : ta = ra;
    ...
    function Oc(a) {
        return a instanceof Lc && a.constructor === Lc ? a.j : "type_error:TrustedResourceUrl"
    }
    ...
    var Tc = /%{(\w+)}/g,
        Sc = RegExp("^((https:)?//[0-9a-z.:[\\]-]+/|/[^/\\\\]|[^:/\\\\%]+/|[^:/\\\\%]*[?#]|about:blank#)", "i"),
        Nc = /^([^?#]*)(\?[^#]*)?(#[\s\S]*)?/,
        Kc = {};
    ...
    var Xc = RegExp('^(?:audio/(?:3gpp2|3gpp|aac|L16|midi|mp3|mp4|mpeg|oga|ogg|opus|x-m4a|x-matroska|x-wav|wav|webm)|font/\\w+|image/(?:bmp|gif|jpeg|jpg|png|tiff|webp|x-icon)|video/(?:mpeg|mp4|ogg|webm|quicktime|x-matroska))(?:;\\w+=(?:\\w+|"[\\w;,= ]+"))*$', "i"),
    ...
    function cd(a) {
        a instanceof Vc || (a = "object" == typeof a && a.ga ? a.aa() : String(a), a = bd.test(a) ? new Vc(a, Uc) : ad(a));
        return a || dd
    }
    ...
    function gd(a) {
        return a instanceof hd && a.constructor === hd ? a.j : "type_error:SafeStyle"
    }
    ...
    function id(a) {
        ...
        for (let c in a)
            if (Object.prototype.hasOwnProperty.call(a, c)) {
                ...
                let d = a[c];
                null != d && (d = Array.isArray(d) ? d.map(jd).join(" ") : jd(d), b += `${c}:${d};`)
            }
    ...
    function jd(a) {
        if (a instanceof Vc) return 'url("' + Wc(a).replace(/</g, "%3c").replace(/[\\"]/g, "\\$&") + '")';
    ...
    const nd = RegExp("^[-,.\"'%_!#/ a-zA-Z0-9\\[\\]]+$"),
        md = RegExp("\\b(url\\([ \t\n]*)('[ -&(-\\[\\]-~]*'|\"[ !#-\\[\\]-~]*\"|[!#-&*-\\[\\]-~]*)([ \t\n]*\\))", "g"),
        ld = RegExp("\\b(calc|cubic-bezier|fit-content|hsl|hsla|linear-gradient|matrix|minmax|repeat|rgb|rgba|(rotate|scale|translate)(X|Y|Z|3d)?|var)\\([-+*/0-9a-zA-Z.%#\\[\\], ]+\\)", "g"),
        od = /\/\*/;
    ...
    function ud(a) {
        return a instanceof vd && a.constructor === vd ? a.j : "type_error:SafeHtml"
    }
    ...
    function Bd(a, b, c) {
        ...
        !0 === Fc[a.toLowerCase()] ? e += ">" : (d = Dd(c), e += ">" + ud(d).toString() + "</" + a + ">", d = d.Ea());
    ...
    function Ed(a) {
        ...
        const d = [],
            e = f => {
                Array.isArray(f) ? f.forEach(e) : (f = wd(f), d.push(ud(f).toString()), f = f.Ea(), 0 == c ? c = f : 0 != f && c != f && (c = null))
            };
        a.forEach(e);
    ...
    */
    ...
    function Ld() {
        var a, b;
        if (void 0 === Kd) try {
            Kd = null !== (b = null === (a = Jd()) || void 0 === a ? void 0 : a.createPolicy("google#safe", {
                createHTML: c => c,
                createScript: c => c,
                createScriptURL: c => c
            })) && void 0 !== b ? b : null
    ...
    function Od(a) {
        var b;
        const c = null === (b = Ld()) || void 0 === b ? void 0 : b.createScriptURL(a);
    ...
    function Qd(a) {
        var b;
        a = Pd(a);
        return (null === (b = Jd()) || void 0 === b ? 0 : b.isScriptURL(a)) ? TrustedScriptURL.prototype.toString.apply(a) : a
    };
    var Rd = class {};
    class Sd extends Rd {
        constructor(a) {
    ...
    function Td(a) {
        var b, c = null === (b = Ld()) || void 0 === b ? void 0 : b.createScript(a);
    ...
    function ge(a, b) {
        ...
        else b = b instanceof Jc && b.constructor === Jc ? b.j : "type_error:SafeScript";
        a.textContent = b;
        fe(a)
    }
    ...
    async function ve(a) {
        var b = "https://pagead2.googlesyndication.com/getconfig/sodar" + `?sv=${200}&tid=${a.j}` + `&tv=${a.l}&st=` + `${a.Ma}`;
        let c = void 0;
        try {
            c = await we(b)
        } catch (g) {}
    ...
    function Ue() {
        var a = u.document;
        return a.querySelector ? (a = a.querySelector("script[nonce]")) && (a = a.nonce || a.getAttribute("nonce")) && Te.test(a) ? a : "" : ""
    };
    ...
    function af(a, b) {
        ...
        return a.replace(bf, function(e, f) {
            ...
            g || (g = xd(e + " ", null), Re(d, g), g = d.firstChild.nodeValue.slice(0, -1));
            return c[e] = g
        })
    }
    var bf = /&([^;\s<&]+);?/g;
    ...
    function kf(a, b) {
        xc(b, function(c, d) {
            ...
            "style" == d ? a.style.cssText = c : "class" == d ? a.className = c : "for" == d ? a.htmlFor = c : lf.hasOwnProperty(d) ? a.setAttribute(lf[d], c) : 0 == d.lastIndexOf("aria-", 0) || 0 == d.lastIndexOf("data-", 0) ? a.setAttribute(d, c) : a[d] = c
        })
    }
    var lf = {
    ...
    function nf(a) {
        ...
        return qb && Cb("10") && a.pageYOffset != b.scrollTop ? new Ye(b.scrollLeft, b.scrollTop) : new Ye(a.pageXOffset || b.scrollLeft, a.pageYOffset || b.scrollTop)
    }
    ...
    p.Ca = function(a, b, c) {
        var d = this.j,
            ...
            f = e[1],
            g = qf(d, String(e[0]));
        f && ("string" === typeof f ? g.className = f : Array.isArray(f) ? g.className = f.join(" ") : kf(g, f));
    ...
    var Qf = me(() => cb(["Google Web Preview", "Mediapartners-Google", "Google-Read-Aloud", "Google-Adwords"], Pf) || 1E-4 > Math.random());
        ...
        Df(f => {
            ...
            for (let k = 0; k < g.length; k++) try {
                a: {
                    var h = g[k];
                    try {
                        var l = h.contentWindow || (h.contentDocument ? of (h.contentDocument) : null);
                        break a
                    } catch (m) {}
                    l =
                    null
    ...
    var lg = (a, b) => {
        ...
        mg = (a, b) => {
            "complete" === a.document.readyState ? (hg.push(b), 1 == hg.length && (window.Promise ? Promise.resolve().then(ig) : window.setImmediate ? setImmediate(ig) : setTimeout(ig, 0))) : a.addEventListener("load", b)
        },
        ng = (a, b) => {
            const c = Hf("DIV");
            c.id = a;
    ...
    function wg(a, b) {
        var c = vg(a, b);
        if (!c || !c.height || !c.width) return [new ug(a.left, a.top, a.width, a.height)];
        c = [];
        var d = a.top,
            e = a.height,
            f = a.left + a.width,
            ...
            h = b.left + b.width,
            l = b.top + b.height;
        b.top > a.top && (c.push(new ug(a.left, a.top, a.width, b.top - a.top)), d = b.top, e -= b.top - a.top);
    ...
    ug.prototype.contains = function(a) {
        return a instanceof Ye ? a.x >= this.left && a.x <= this.left + this.width && a.y >= this.top && a.y <= this.top + this.height : this.left <= a.left && this.left + this.width >= a.left + a.width && this.top <= a.top && this.top + this.height >= a.top + a.height
    };
    ...
    function Ag() {
        const a = zg();
        return a && la(a.rootBounds) ? new Ze(a.rootBounds.width, a.rootBounds.height) : null
    }
        ...
        const f = g => {
            if (a.ampInaboxInitialized) g = !0;
                ...
                a.ampInaboxPendingMessages && !l && (h = /^amp-(\d{15,20})?/.exec(g.data)) && (a.ampInaboxPendingMessages.push(g), g = h[1], a.ampInaboxInitialized ||
                    g && !/^\d{15,20}$/.test(g) || a.document.querySelector('script[src$="amp4ads-host-v0.js"]') || Gf(a.document, g ? Rc(vc("https://cdn.ampproject.org/rtv/%{ampVersion}/amp4ads-host-v0.js"), {
                        ampVersion: g
    ...
    const Ig = [Hg("data"), Hg("http"), Hg("https"), Hg("mailto"), Hg("ftp"), new Gg(a => /^[^:]*([/?#]|$)/.test(a))];
    ...
    function Og(a, b) {
        ...
        if (!c) {
            var d = ef(b);
            c = d;
            void 0 === a.style[d] && (d = (vb ? "Webkit" : ub ? "Moz" : qb ? "ms" : null) + ff(d), void 0 !== a.style[d] && (c = d));
            Pg[b] = c
        }
        return c
    }
    ...
    function Rg(a, b) {
        return Qg(a, b) || (a.currentStyle ? a.currentStyle[b] : null) || a.style && a.style[b]
    }
    ...
    function Tg(a) {
        ...
        d = !qb || 9 <= Number(Fb) || "CSS1Compat" == gf(d).j.compatMode ? d.documentElement : d.body;
        if (a == d) return c;
        a = Sg(a);
        b = nf(gf(b).j);
        c.x = a.left + b.x;
    ...
    function Vg(a) {
        var b = a.offsetWidth,
            c = a.offsetHeight,
            d = vb && !b && !c;
        return (void 0 === b || d) && a.getBoundingClientRect ? (a = Sg(a), new Ze(a.right - a.left, a.bottom - a.top)) : new Ze(b, c)
    }
    ...
    var $g = a => "number" === typeof a && 0 < a,
        ...
        ah = a => Object.entries(ch(a)).map(([b, c]) => `${b}=${encodeURIComponent(String(c))}`).join("&"),
        ch = a => {
            const b = {};
            Mf(a, (c, d) => {
    ...
    var R = () => {
            if (ih && !Cf(jh)) {
                let a = "." + Ne.domain;
                try {
                    for (; 2 < a.split(".").length && !Cf(jh);) Ne.domain = a = a.substr(a.indexOf(".") + 1), jh = window.parent
                } catch (b) {}
                Cf(jh) || (jh = window)
            }
            jh !== window && .01 > Math.random() && Fg({
                stack: Error().stack,
        ...
        ph = (a, b) => a.source !== b.contentWindow && a.source.parent !== b.contentWindow ? !1 : !0;
    class qh {
        constructor(a, b) {
            this.error = a;
    ...
    const rh = RegExp("^https?://(\\w|-)+\\.cdn\\.ampproject\\.(net|org)(\\?|/|$)");
    var sh = class {
            constructor(a, b) {
                this.j = a;
                this.l = b
    ...
    function wh(a, b, c, d, e) {
        ...
        } else if ("object" == typeof a) return e = e || 0, 2 > e ? encodeURIComponent(vh(a, b, c, d, e + 1)) : "...";
    ...
    function Ch(a, b, c, d, e) {
        if ((d ? a.j : Math.random()) < (e || .01)) try {
            let f;
            c instanceof zh ? f = c : (f = new zh, Mf(c, (h, l) => {
                var k = f,
                    m = k.B++;
                h = uh(l, h);
                k.j.push(m);
    ...
    function Nh() {
        var a = Oh;
        a.j = !1;
        a.events != a.l.google_js_reporting_queue && (Lh() && Ya(a.events, Mh), a.events.length = 0)
    }
    ...
    class Vh {
        ...
        ua(a, b, c, d, e) {
            ...
            try {
                ...
                g.j.push(1);
                g.l[1] = uh("context", a);
                b.error && b.meta && b.id || (b = new qh(b, {
                    message: Rh(b)
                }));
                if (b.msg) {
                    g = E;
    ...
    (a => {
        ...
        wi = new Vh(Oh);
        wi.A = !0;
        "complete" == u.document.readyState ? u.google_measure_js_timing || Nh() : Oh.j && K(u, "load", () => {
    ...
    var Si = () => {
        ...
        Ti = () => {
            ...
            try {
                const a = Ff(u);
                if (a && -1 !== a.location.hash.indexOf("auto_ads_logging") || u.localStorage.getItem("auto_ads_logging")) Ri = !0
            } catch (a) {}
            return Ri
        },
        Ui = (a, b = []) => {
            ...
            c && Si() && Gf(u.document,
                Pc(tc(vc("https://pagead2.googlesyndication.com/pagead/js/logging_library.js"))))
        };
    ...
    var mk = new W(1084),
        ...
        al = new W(360245598),
        bl = new kk(1927),
        cl = new lk(1934, ["",
        ...
        tl = new W(392736476),
        ul = new kk(406149835),
        vl = new lk(1932, ["AxujKG9INjsZ8/gUq8+dTruNvk7RjZQ1oFhhgQbcTJKDnZfbzSTE81wvC2Hzaf3TW4avA76LTZEMdiedF1vIbA4AAABueyJvcmlnaW4iOiJodHRwczovL2ltYXNkay5nb29nbGVhcGlzLmNvbTo0NDMiLCJmZWF0dXJlIjoiVHJ1c3RUb2tlbnMiLCJleHBpcnkiOjE2NTI3NzQ0MDAsImlzVGhpcmRQYXJ0eSI6dHJ1ZX0=",
    ...
    var El = 728 * 1.38,
        Fl = (a, b = 420) => (a = Y(a).clientWidth) ? a > b ? 32768 : 320 > a ? 65536 : 0 : 16384,
        Gl = a => {
        ...
        Kl = (a, b) => Jl(b) || 10 === b || !a.adCount ? !1 : 1 == b || 2 == b ? !(!a.adCount[1] &&
            !a.adCount[2]) : (a = a.adCount[b]) ? 1 <= a : !1,
        Ll = (a, b) => a && a.source ? a.source === b || a.source.parent === b : !1,
        Ml = a => void 0 === a.pageYOffset ? (a.document.documentElement || a.document.body.parentNode || a.document.body).scrollTop : a.pageYOffset,
        Nl = a => void 0 === a.pageXOffset ? (a.document.documentElement || a.document.body.parentNode || a.document.body).scrollLeft : a.pageXOffset,
        Ol = a => {
            const b = {};
            let c;
    ...
    var Vl = (a, b = !1) => {
        try {
            return b ? (new Ze(a.innerWidth, a.innerHeight)).round() : mf(a || window).round()
        } catch (c) {
    ...
    var am = (a, b, c) => {
        ...
        cm = a => {
            let b = 0;
            try {
                b |= a != a.top ? 512 : 0, zf() || (b |= 1048576), 1200 >= Math.floor(a.document.body.getBoundingClientRect().width) || (b |= 32768), bm(a) && (b |= 33554432)
            } catch (c) {
                b |= 32
            }
            return b
    ...
    const wm = new vm("IMG AMP-IMG IFRAME AMP-IFRAME HR EMBED OBJECT VIDEO AMP-VIDEO INPUT BUTTON SVG".split(" "));
    var zm = (a, b) => {
        const c = new xm(a, b);
        return () => ym(c)
    };
    ...
    class Jm {
        ...
        init(a, b) {
            null == a ? (this.C = a = Hl(this.j, !0), this.j.addEventListener("scroll", this.G), null != b && b(a)) : this.B = this.j.setTimeout(() => {
                this.init(void 0, b)
            }, a)
        }
        da() {
    ...
    var dn = a => {
        ...
        fn = a => {
            var b = en(a);
            a = [];
            for (let c of b) b = String(c.Qa), a.push(c.xa + "." + (20 >= b.length ? b : b.slice(0, 19) + "_"));
            return a.join("~")
        };
    const en = a => {
            const b = [],
    ...
    function nn(a) {
        return null == a ? null : new ln(null, {
    ...
    function un(a, b, c) {
        ...
        rn(b) && (b.setAttribute("data-init-display", b.style.display), b.style.display = "block")
    }
    ...
    function vn(a) {
        if (a && a.parentNode) {
            ...
            b.removeChild(a);
            rn(b) && (b.style.display = b.getAttribute("data-init-display") || "none")
        }
    };
    var xn = (a, b, c, d = 0) => {
            var e = wn(b, c, d);
    ...
    function On(a) {
        ...
        Ya(b, function(c) {
            ...
            e && (c.setAttribute("data-pub-vars", JSON.stringify(d)), c.removeAttribute("height"), c.style.removeProperty("height"), c.removeAttribute("width"), c.style.removeProperty("width"), Nn(a, c))
        })
    }
    ...
    const Qn = (a, b) => {
        if (3 == b.nodeType) return 3 == b.nodeType ? (b = b.data, a = -1 != b.indexOf("&") ? af(b, a.document) : b, a = /\S/.test(a)) : a = !1, a;
        if (1 == b.nodeType) {
    ...
    const jo = class {
        ...
        l(a, b, c, d) {
            ...
            if (e = y(e, 1)) {
                ...
                f.ha.setAttribute("data-native-settings-key",
                    e);
                Ln(f, a, null, b);
                a = f
            } else a = null;
    ...
    function no(a, b, c, d) {
        ...
        switch (y(a, 8)) {
            case 1:
                return l = l.Hd || null, new oo(f, new go(co(D(a, zj, 3), null)), l, g, 0, h, e, c, b, d, a);
            case 2:
                return new oo(f, new jo(a), l.ae || new lo("text"), g, 1, h, e, c, b, d, a)
        }
        return null
    }
    ...
    function vo(a, b = null, c = null) {
        return new oo(a.H, b || a.D, c || a.T, a.I, a.Ga, a.ic, a.bb, a.j, a.Z, a.G, a.A, a.C, a.O)
    }
    class oo {
    ...
    function xo(a, b, c, d) {
        ...
        b = [];
        for (const f of c) c = Xa(e, f), 0 > c || b.push(new yo(a, [f], c, f, 3, uf(f).trim(), d));
        return b
    }
    ...
    function zo(a, b, c) {
        ...
        for (let n = 0; n < g; n++) {
            ...
            if (1 == k.nodeType || 3 == k.nodeType) {
                ...
                m ? (d.length && l && e.push(new yo(a, d, n - 1, m, 0, l, c)), d = [], h = n + 1, l = "") : (d.push(k), k = uf(k).trim(), l += k && l ? " " + k : k)
            }
        }
    ...
    function Bo(a) {
        const b = Aj();
        return new oo(new io(a.Lb, a.Mb), new go({
            clearBoth: !0
    ...
    function Co(a) {
        return fb(a.B ? zo(a.j, a.na, a.l) : [], a.A ? xo(a.j, a.A, a.na, a.l) : []).filter(b => {
            var c = b.Lb.tagName;
            c ? (c = wo[c.toUpperCase()], b = null != c && c.Sa.contains(b.Mb)) : b = !1;
            return !b
        })
    }
    class Do {
            ...
            for (const k of e) {
                ...
                if (d.B || e.zb) {
                    if (d.j.length) {
                        ...
                        b: {
                            var g = f.N();
                            var h = f.Ra[f.Ra.length - 1];f = e.Hb.Ra[0];
                            if (!h || !f) {
                                g = !1;
                                break b
                            }
        ...
        Ko = (a, b) => {
            ...
            a.forEach(d => {
                ...
                if (e) {
                    ...
                    e = c.get(f);
                    (d = (d = D(d, Xi, 2)) ? y(d, 7) : null) ? e.pb = e.pb ? e.pb + "," + d : d: e.Ec = !0
                }
            });
            return tm(c).map(d => {
    ...
    const Mo = a => {
        ...
        Po = (a, b) => a.na.getBoundingClientRect().top - b.na.getBoundingClientRect().top;
    var Qo = a => (null == a ? 0 : a.google_ad_slot) ? Vm(new cn(1, {
            qd: a.google_ad_slot
        ...
        So = a => {
            switch (a.Ga) {
                ...
                case 1:
                    var b = a.A;
                    null == b ? a = null : (a = b.V(), null == a ? a = null : (b = b.l(), a = null == b ? null : new cn(0, {
                        xc: [a],
                        Yc: b
                    })));
                    return null != a ? Vm(a) : Xm("Missing dimension when creating placement id");
                case 2:
                    return a = Ro(a), null != a ? Vm(a) : Xm("Missing dimension when creating placement id");
                default:
        ...
        try {
            ...
            for (f = 0; f < d.length; f++) {
                ...
                var F =
                    ...
                    I = e[f];
                c.push(new Wo(I.Vc, I.anchorElement, new Dm(F.left + b, F.top + l, F.right - F.left)))
            }
        } finally {
        ...
        if (!a.l) {
            if (a.A >= a.B.length) var b = null;
            else {
                {
                    ...
                    la(c) && 1 == c.nodeType ? b = ap(a, c, 0) : (b = a.j.document.createElement("div"), L(b, {
                        display: "none"
                    }), c.parentNode.insertBefore(b, c), b = ap(a, b, 3))
                }
                b = Xo([b], a.j)[0] || null
            }
            if (b) return b;
    ...
    function ap(a, b, c) {
        return new oo(new io(b, c), new go({}), null, !0, 2, [], null, a.j, null, null, null, a.C.j, null)
    }
    var Zo = class {
        constructor(a, b, c) {
            this.j = a;
    ...
    var yp = (a, b) => {
        ...
        let k = [].concat(gb(b.document.querySelectorAll("iframe[id^=aswift_],iframe[id^=google_ads_frame]")), gb(b.document.querySelectorAll("ins.adsbygoogle")));
        b = [];
        for (const [m, n] of [
                [a.wb, c],
                [a.Fa, d],
    ...
    const zp = a => {
        ...
        tp = a => gb(a.document.querySelectorAll('ins.adsbygoogle[data-anchor-shown="true"]')),
        up = a => gb(a.document.querySelectorAll("ins.adsbygoogle[data-ad-format=autorelaxed]")),
        vp = a => (zp(a) || gb(a.document.querySelectorAll("div[id^=div-gpt-ad]"))).concat(gb(a.document.querySelectorAll("iframe[id^=google_ads_iframe]"))),
        wp = a => gb(a.document.querySelectorAll("div.trc_related_container,div.OUTBRAIN,div[id^=rcjsload],div[id^=ligatusframe],div[id^=crt-],iframe[id^=cto_iframe],div[id^=yandex_], div[id^=Ya_sync],iframe[src*=adnxs],div.advertisement--appnexus,div[id^=apn-ad],div[id^=amzn-native-ad],iframe[src*=amazon-adsystem],iframe[id^=ox_],iframe[src*=openx],img[src*=openx],div[class*=adtech],div[id^=adtech],iframe[src*=adtech],div[data-content-ad-placement=true],div.wpcnt div[id^=atatags-]"));
    var xp = a => {
        const b = [];
        for (const c of a) {
            a = !0;
    ...
    var Ap = yi(453, yp),
        Bp = yi(454, (a, b) => {
            ...
            return xp([].concat(!0 === a.wb ? c : [], !0 === a.Fa ? d : [], !0 === a.Zd ? e : [], !0 === a.xb ? f : [], !0 === a.yb ? g : [], !0 === a.Xd ? h : [], !0 === a.Yd ? b : []))
        });
    ...
    function Dp(a) {
        ...
        return b.map(e => {
            ...
            return (e = !!e.className && -1 != e.className.indexOf("google-auto-placed")) || Gp(f) ? {
                box: {
                    top: f.top + d,
                    right: f.right + c,
                    bottom: f.bottom + d,
    ...
    function Ep(a, b, c) {
        return void 0 != b && a.length <= (void 0 != c ? c : 8) ? Jp(a, b) : ab(a, d => new rp(d.box, 1))
    }
    ...
    function Op(a, b) {
        ...
        b.forEach(e => {
            if (nc(e, pj, 1, sj)) {
                ...
                D(e, nj, 3) && D(e, nj, 3).V() && (f = Pp(a, D(e, nj, 3).V())) && c.set(na(f), D(e, nj, 3).l())
            } else nc(e, qj, 2, sj) ? Qp(a, nc(e, qj, 2, sj), c) : nc(e, rj, 3, sj) && Rp(a, nc(e, rj, 3, sj), d)
        });
        return new Sp(c, d)
    }
    class Sp {
    ...
    const Qp = (a, b, c) => {
            D(b, Xi, 1) && (a = Tp(a, D(b, Xi, 1))) && a.forEach(d => {
                d = na(d);
                c.set(d, 1);
                c.set(d, 4);
                c.set(d, 2);
    ...
    function Rq(a, b, c, d) {
        ...
        return f && 0 != f.length ? (b = D(b, Yi, 27)) ? D(b, Zi, 2) ? Vm(new Sq(a, f, b, c, d)) : Xm("No AudioSenseConfig.PlacementConfig found") : Xm("No AudioSenseConfig found") : Xm("No ArticleStructure found")
    }
    ...
    function Uq(a) {
        return (a = D(a.l, aj, 3)) ? G(a, bj, 1).some(b => 1 === ac(b, 1, 0)) : !1
    }
    ...
    var ar = (a, b) => (b = D(b, vj, 6)) ? Lo(G(b, wj, 1), a).map(c => Bo(c)) : [];
    var br = {},
        cr = {};
    ...
    function ir(a) {
        return null != a && a.Qb === br ? String(String(a.pa()).replace(jr, "").replace(kr, "&lt;")).replace(lr, mr) : String(a).replace(nr, mr)
    }

    function or(a) {
        null != a && a.Qb === cr ? a = hr(a.pa()) : null == a ? a = "" : a instanceof hd ? a = hr(gd(a)) : a instanceof sd ? a = hr(a instanceof sd && a.constructor === sd ? a.j : "type_error:SafeStyleSheet") : (a = String(a), a = pr.test(a) ? a : "zSoyz");
        return a
    }
    const qr = {
        "\x00": "&#0;",
    ...
    const nr = /[\x00\x22\x26\x27\x3c\x3e]/g,
        ...
        pr = /^(?!-*(?:expression|(?:moz-)?binding))(?:(?:[.#]?-?(?:[_a-z0-9-]+)(?:-[_a-z0-9-]+)*-?|(?:rgb|hsl)a?\([0-9.%,\u0020]+\)|[-+]?(?:[0-9]+(?:\.[0-9]*)?|\.[0-9]+)(?:e-?[0-9]+)?(?:[a-z]{1,4}|%)?|!important)(?:\s*[,\u0020]\s*|$))*$/i,
    ...
    */
    var rr = class {
        ...
        init() {
            ...
            var b = this.host,
                c = this.language;
            a = gr('<div class="gcse-search" data-gname="' + ir("auto-rs-prose") + '" data-adclient="' + ir(a) + '" data-as_sitesearch="' + ir(b) + '" data-gl="' + ir(c) + '"></div>');
            a = er(a);
            ...
            var d = {
                    src: Rc(vc("https://cse.google.com/cse.js?cx=9d449ff4a772956c6&language=%{lang}"), {
                        lang: this.language
                    })
                },
                e = {};
    ...
    function yr(a) {
        ...
        K(a.l, "scroll", () => {
            if (a.J) {
                ...
                a.l.scrollTop > a.B ? (Ar(a, b), a.l.scrollTop = a.B) : 10 > a.l.scrollTop && (a.l.scrollTop = 10, 30 > b ? Ar(a, b) : zr(a))
            }
        })
    }
    ...
    var Er = class {
        constructor(a, b, c) {
            ...
            c = b.appendChild;
            var e = this.D;
            e = gr("<style>.cse-drawer-container {height: 100%; left: 0; position: fixed; top: 0; transition: visibility 0s linear .5s; visibility: hidden; width: 100%; z-index: " + or(100002) + ";}.cse-modal-background {background-color: black; height: 100%; opacity: 0; position: absolute; transition: opacity .5s ease-in-out; width: 100%;}.cse-drawer {bottom: 0; position: absolute; transform: translateY(" + or(e) + "px); transition: transform .5s ease-in-out; width: 100%;}.cse-drawer-handle {border-radius: 20px 20px 0 0; background: white; height: " +
                or(30) + "px;}.cse-drawer-contents {background: white; height: " + or(e) + "px; padding-top: " + or(10) + "px; overflow: auto;}</style>");
            e = er(e);
            var f = d.j;
            d = qf(f, "DIV");
    ...
    function Hr(a) {
        ...
        const d = yf(a.l, "IMG");
        de(d, cd("https://www.google.com/s2/favicons?sz=64&domain_url=" + encodeURIComponent(c)));
        ce(d, id({
            display: "block",
            "float": "left",
            height: "16px",
        ...
        const e = yf(a.l, "P");
        be(e, Ir(a.C.trim().substring(0, 2),
    ...
    function Pr(a, b) {
        ...
        Qr(a, c);
        Se(c, "https://www.gstatic.com/adsense/autoads/icons/gpp_good_24px_grey_800.svg");
        L(c, {
    ...
    function Sr(a, b, c) {
        ...
        Se(d, "https://www.gstatic.com/adsense/autoads/icons/arrow_left_24px_grey_800.svg");
    ...
    var $r = a => !X(il) && /Firefox/.test(a) || /Android 2/.test(a) || /iPhone OS [34]_/.test(a) || /Windows Phone (?:OS )?[67]/.test(a) || /MSIE.*Windows NT/.test(a) || /Windows NT.*Trident/.test(a),
        ds = (a, b = null) => {
            const c = as(a.innerWidth, 0, Math.min(Math.round(a.innerWidth / 320 * 50), bs) + 15);
            return cs(a, c, b)
        },
        es = (a, b = null) => {
    ...
    function js(a, b, c, d = null) {
        ...
        var e = "GoogleActiveViewInnerContainer" == a.getAttribute("class") || 1 >= Ug(a).width && 1 >= Ug(a).height ? !0 : !1;
        d && Ch(d, "ach_evt", {
            url: b.location.href,
            tn: a.tagName,
    ...
    class us {
        ...
        init() {
            this.I ? (this.A = new Mr(this.C, this.I, this.L, this.H), this.A.init(), Tm(this.B, this.A.G()), Sm(this.D, 1), null == this.j && (this.j = new Jm(this.C), this.j.init(2E3)), Hm(this.j, () => {
                ss(this);
                ts(this)
            })) : ts(this)
        }
    ...
    var vs = (a, b, c, d, e) => {
        a = new us(a, Zr(a, e), new Yr(b, d, "#FFF", "#4A4A4A", "normal"), new Ur(b, c, d), "google-dns-link-placeholder");
        a.init();
        return a
    };
    ...
    class Js {
        ...
        pa(a, b, c, d) {
            c = Ds(a);
            const e = Fs(a, "https://www.gstatic.com/adsense/autoads/icons/gpp_good_24px_grey_800.svg", d),
                f = Fs(a, "https://www.gstatic.com/adsense/autoads/icons/gpp_good_24px_grey_800.svg", this.l),
                g = Gs(this, a),
                h = Fs(a, "https://www.gstatic.com/adsense/autoads/icons/close_24px_grey_700.svg", b, this.C);
            L(h, {
                "margin-left": "auto"
            });
            c.appendChild(e);
    ...
    function Ks(a) {
        Ls(a.l, b => {
            ...
            (new us(c, Zr(c, a.A), new Yr(d, b, "#1A73E8", "#FFF", "bold", "https://www.gstatic.com/adsense/autoads/icons/gpp_good_24px_blue_600.svg", "2px solid #ECEDED", f), new Js(d, e, f, b), "google-revocation-link-placeholder")).init()
        }, () => {
            wr(a.j)
        })
    }
    ...
    function Os(a) {
        if (!0 !== a.j.adsbygoogle_ama_fc_has_run) {
            var b = !1;
            Ns(a.l) && (b = new Ms(a.j, a.C, a.B || G(a.l, Dj, 4), a.A), vr(b.j), Ks(b), b = !0);
            var c;
            a: if ((c = a.l) && Xb(c, 3)) switch (c = y(c, 3), c) {
                case 1:
                    c = !0;
                    break a;
                case 2:
    ...
    function ct(a, b) {
        ...
        at(a, "addEventListener", f => {
            f && (c = f, c.internalErrorState = Ws(c), Xs(c) && (0 != c.internalErrorState && (c.tcString = "tcunavailable"), at(a, "removeEventListener", null, c.listenerId), e && (clearTimeout(e), e = 0), d()))
        })
    }
    ...
    function dt(a, b) {
        ...
        at(a, "addEventListener", (f, g) => {
            ...
            if (0 != c.internalErrorState || Xs(c)) at(a, "removeEventListener", null, c.listenerId), d()
        })
    }
    ...
    class ft extends Us {
        ...
        addEventListener(a) {
            ...
            const e = (f, g) => {
                clearTimeout(d);
                f ? (b = f, b.internalErrorState = Ws(b), g && 0 === b.internalErrorState || (b.tcString = "tcunavailable",
    ...
    function gt(a) {
        const b = Rc(vc("https://fundingchoicesmessages.google.com/i/%{id}?ers=%{ers}"), {
            id: a.l,
            ers: 2
        });
        Rs(a.j, b, () => {}, () => {})
    ...
    var it = (a, b, c) => {
        ...
        if (!d) return [];
        c = Lo(G(d, wj, 1), c);
        return (a = Sj(a)) && A(a, 11) ? c.map(e => Bo(e)) : c.map(e => {
            const f = Aj();
            return new oo(new io(e.Lb, e.Mb), new Sn, new ho(b), !0, 2, [], f, e.l, null, null, null, e.A, e.j)
        })
    };
    ...
    var yt = (a, b, c) => {
        ...
        e ? (d = f.l || (f.l = Y(f.A).scrollHeight || null), e = !d || 0 > d ? -1 : f.l * e - Ip(f)) : e = void 0;
        a = null == e || 50 <= e ? Bt(b, f, {
            types: a
        }, c) : null;
        return {
            mb: f,
    ...
    var Ct = a => {
        ...
        Et = a => {
            ...
            c && (b = kn(a.J, b), d = Jn(a.j.document, a.G, null, null, {}, b)) && (yn(d.Da, c, 2, 256), Dt(a, d, b))
        },
        Gt = (a, b) => {
            var c = Ct(a);
            c.oc = [5];
    ...
    wt[8] = function(a) {
        var b = a.N().document;
        if ("complete" != b.readyState) return b.addEventListener("readystatechange", () => wt[8](a), {
            once: !0
        }), !0;
        if (!a.B) return !1;
        if (!a.Cb()) return !0;
    ...
    wt[9] = function(a) {
        ...
        for (var c of b.$a) {
            var d = c;
            var e = a.l.Yb || null;
            null == e ? d = null : (e = vo(d.P, new Ht, new It(e, a.N())), d = new Wo(e, d.V(), d.U));
            if (d && !(uo(d.P) > b.ob) && At(a, d, {
                    Nc: b.ob,
                    Ld: !0
    ...
    function Ot(a, b) {
        b && (a.l.apv = y(b, 4), Xb(b, 23) && (a.l.sat = "" + y(D(b, Xj, 23), 1)));
        return a
    }
    ...
    function Ut(a, b, c) {
        30 >= c.length ? a.j[b] = Vt(c) : (a.j[b] = Vt(c.slice(0, 30)), a.j[b + "_c"] = c.length.toString())
    }
    ...
    function zu() {
        ...
        if (!a.B) return fu();
        let b, c;
        const d = ou(nu(mu(lu(ku(ju(iu(hu(eu(new gu, null != (b = a.B) ? b : []), a.C), a.G), a.H), a.J), a.L), null != (c = a.D) ? c : 0), tm(a.j).map(e => {
            var f;
            var g = new du;
            g = z(g, 1, e.wa);
    ...
    function Du(a, b) {
        const c = a.B.filter(d => sm(d.qb).every(e => d.qb.get(e) === b.get(e)));
        return 0 === c.length ? (a.l.push(19), null) : c.reduce((d, e) => d.qb.Wa() > e.qb.Wa() ? d : e, c[0])
    }
    ...
    var Hu = class {
        constructor(a) {
            ...
            this.A = new um;
            let b;
            this.B = ((null == (b = D(a, Kj, 2)) ? void 0 : G(b, Lj, 1)) || []).map(c => ({
                qb: dn(c.ub()),
                te: c.$b(),
                wa: c.ub()
            }));
    ...
    function Lu(a, b) {
        return b.sort((c, d) => {
            const e = c.P.G,
                f = d.P.G;
            var g;
            null == e || null == f ? g = null == e && null == f ? Ju(a, c) - Ju(a, d) : null == e ? 1 : -1 : g = e - f;
            return g
        })
    }
    class Mu {
    ...
    class Nu {
        ...
        find(a, b = 0) {
            ...
            let h = this.A;
            h = Nm(Nm(Nm(Nm(Nm(Nm(Nm(h, jq(c), Ou(1, b)), kq(a.Ua || []), Ou(2, b)), nq(a.Wb || []), Ou(3, b)), oq(a.ni || []), Ou(4, b)), pq(a.oc || []), Ou(5, b)), lq(a.nc || []), Ou(6, b)), le(qo), Ou(7, b));
            let l = h = h.apply(eq(this.j));
            l = a.nb &&
                a.Bc ? Nm(l, iq(d, a.Bc, this.j, a.mb), Pu(16, b)) : Nm(l, hq(d, this.j, a.mb), Pu(9, b));
            ...
            a.gb ? l = Lu(this.l, l) : a.Ie ? (l = Iu(this.l, l), Mm(h, k => {
                su(k);
                var m;
                null != (m = this.l.j) && (m = Eu(m, k), null != (null == m ? void 0 : m.wa) && wu(k, m.wa))
            }), Mm(l, k => uu(k))) : l = Ku(this.l, l);
            a.cb && (l = Pm(l, df(this.j.location.href + this.j.localStorage.google_experiment_mod)));
            1 === c.length &&
                Mt(this.B, c[0], {
                    Cd: h.j.length,
                    Je: l.j.length
    ...
    function Tu(a) {
        ...
        for (var F of C) {
            ...
            l.push(E);
            k.push(I * E);
            F.className && -1 != F.className.indexOf("google-auto-placed") ? (t += 1, F.className && -1 != F.className.indexOf("pedestal_container") && (B = I)) : (x = Math.min(x, T), n.push(C), r += 1, h.push(I), m.push(I * E));
            H = Math.min(H, T);
            q.push(C)
        }
        x = Infinity === x ? null : x;
    ...
    function Xu(a) {
        return Xe.apply(null, $a(a, b => 0 < b)) || null
    }
    ...
    function av(a) {
        ...
        var c = Ap({
            ...
            xb: !1,
            yb: !1
        }, a).map(d => d.getBoundingClientRect()).filter(Gp);
        b.rd = c.length;
        c = Bp({
            xb: !0
        }, a).map(d => d.getBoundingClientRect()).filter(Gp);
        ...
        c = Ap({
            Fa: !1
        }, a).map(d => d.getBoundingClientRect()).filter(Gp).filter(ta(bv, null, c));
        b.sd = c.length;
        a = Tu(a);
        c = null != a.j.Sb ? a.j.Sb :
            null;
        null != c && (b.ge = c);
    ...
    function At(a, b, {
        ...
        if (l = !k && !(!l && 2 == h && !Su(g))) g = 1 == h || 2 == h ? g : g.parentNode, l = !(g && !rn(g) && 0 >= g.offsetWidth);
        if (!l) return !1;
        c = null == c ? null : new ln(null, {
            google_max_responsive_height: c
        });
        g = mn(y(f.bb, 2) || 0);
        h = f.G;
        h = null == h ? null : new ln(null, {
            google_ml_rank: h
        });
        l = cv(a, f);
        d = kn(a.J, f.T ?
        ...
        if (e) {
            if (c) {
                ...
                if (e) {
                    e = a.j;
                    g = c.ha;
                    if (h = Fn(e, g)) g.style.border = g.style.borderStyle = g.style.outline = g.style.outlineStyle = g.style.transition = "none", g.style.borderSpacing = g.style.padding = "0", Dn(g, h, "0px"), g.style.width = Y(e).clientWidth + "px", Gn(e, g, h), g.style.zIndex =
                        30;
                    e = !0
                } else vn(c.Da), e = !1
            } else e = !1;
    ...
    function ov(a) {
        return pm(a.j.document.querySelectorAll("INS.adsbygoogle-placeholder")).map(b => new oo(new io(b, 1), new go(nv), a.l, !1, 0, [], null, a.j, null))
    }
    class pv {
        constructor(a, b) {
            this.j = a;
    ...
    function rv(a, b, c) {
        const d = qv(c.sb, "gapsMeasurementWindow") || qv(c.Va, "gapsPerMeasurementWindow") || qv(c.Za, "maxGapsToReport");
        return null != d ? Xm(d) : c.wc || -1 != c.Va || -1 != c.Za ? Vm(new sv(a, b, c)) : Xm("ShouldHaveLimits")
    }
    ...
    function wv(a, b) {
        const c = b.P;
        return !a.D && c.A && Xb(c.A, 8) && 1 == y(c.A, 8) ? [] : c.B ? (c.J || []).map(d => Gm(Em(d, a.j))) : [Gm(new Fm(b.U.j, 0))]
    }
    ...
    function Cv(a) {
        ...
        b = xv(c);
        c = new um;
        for (d = 0; d < b.length; ++d) e = b[d], f = a.H ? 0 : Math.floor(e.j / a.B), qm(c, f) || c.set(f, []), c.get(f).push(e);
        b = Av(a, c);
        c = new kt;
        c = z(c, 1, a.l);
        c = z(c, 2, a.B);
    ...
    var Pv = {
        ...
        Qv = a => (a = a.innerText || a.innerHTML) && (a = a.replace(/^\s+/, "").split(/\r?\n/, 1)[0].match(/^\x3c!--+(.*?)(?:--+>)?\s*$/)) && RegExp("google_ad_client").test(a[1]) ? a[1] : null,
        Rv = a => {
                ...
                if (b.google_ad_client) var f = String(b.google_ad_client);
                    ...
                    if (null !== (d = null !== (f = null === g || void 0 === g ? void 0 : g.google_ad_client) && void 0 !== f ? f : null === (c = b.document.querySelector(".adsbygoogle[data-ad-client]")) || void 0 === c ? void 0 : c.getAttribute("data-ad-client")) && void 0 !== d) f = d;
                        ...
                        c: {
                            ...
                            b.navigator && b.navigator.userAgent || "";b = RegExp("appbankapppuzdradb|daumapps|fban|fbios|fbav|fb_iab|gsa/|messengerforios|naver|niftyappmobile|nonavigation|pinterest|twitter|ucbrowser|yjnewsapp|youtube", "i").test(b) || /i(phone|pad|pod)/i.test(b) && /applewebkit/i.test(b) && !/version|safari/i.test(b) && !lh() ? Qv : Rv;
            ...
            if (c)
                if (d) {
                    ...
                    try {
                        ...
                        Ti() && Ui(15, [r]), Pq(b, Fq, Nq(Pt(Ot((new Qt(0)).La(c), d), m).la(1), r)), Tv(ji(Uv), new Ev)
                    }
                } else Pq(b, Fq, (new Qt(0)).La(c).la(8)), Tv(ji(Uv),
                    new Ev);
        ...
        a.G.forEach(b => {
            switch (b) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    (c = D(a.j, Fj, 18)) && Os(new Ps(a.l, new ht(a.l, a.C), c, new ur(a.l), G(a.j, Dj, 1)));
                    break;
                case 3:
                    $v(a);
                    break;
                case 4:
                    (b = D(a.j, Gj, 29)) && aw(a.ka, {
                        win: a.l,
                        webPropertyCode: a.C,
                        Wd: b,
                        yd: null != (d = null == (c = D(a.j, vj, 6)) ? void 0 : G(c, wj, 1)) ? d : []
                    })
            }
        })
    }
    ...
    function Zv(a) {
        ...
        a: {
            var c = a.l;
            var d = gp(c);c = Y(c).clientHeight || dp[d];
            var e = jp(G(b, fj, 2), d);
            if (e && (e = mp(e, c))) {
                d = e;
                break a
        ...
        if (a.B.W && Xb(a.B.W, 10) && (c = $b(D(a.B.W, bk, 10), 1), null !== c && void 0 !== c)) {
            var f = a.l;
            d = c;
            c = gp(f);
            e = Y(f).clientHeight || dp[c];
            var g = void 0;
            b && (g = (g = (g = jp(G(b, fj, 2), c)) ? D(g, hj, 7) : void 0) ? np(g, e) : void 0);
            var h = gp(f);
            f = Y(f).clientHeight || dp[h];
            const O = lp(ep[h].qc, f);
            f = null ===
                O ? hp(h, f) : new ip(O, O, op(O, O, 8), 8, .3, g);
            g = lp(ep[c].ed, e);
            h = lp(ep[c].qc, e);
            e = lp(ep[c].dd, e);
            c = f.A;
        ...
        if (Xb(a.j, 26)) {
            ...
            var m;
            k = g ? [] : null != (m = kp(null == c ? void 0 : G(c, gj, 3), f)) ? m : d.D;
            var n;
            m = null != (n = null == c ? void 0 : y(c, 4)) ? n : d.l;
            var q;
            n = null != (q = null == c ? void 0 : $b(c, 6)) ? q : d.B;
            var r;
            q = null != (r = (null == c ? 0 : Xb(c, 7)) ? np(D(c, hj, 7), f) : null) ? r : d.j;
        ...
        e = X(Jk);
        f = !1;
        Qj(k) && 1 === y(Qj(k), 1) && (g = D(Qj(k), ck, 6)) && (c = y(g, 2) || 0, 1 === y(g, 1) && (f = !0));
        var x, H;
        g = (null == (t = D(k, Ij, 24)) ? void 0 : null == (x = D(t, Mj, 3)) ?
            void 0 : null == (H = D(x, Nj, 3)) ? void 0 : nc(H, Oj, 2, Pj)) || !1;
        if (e || f || g) t = lv(new mv(a.l)), m = m.concat(t), tu.J = !0, tu.D = t.length;
        ...
        var B, C;
        (null ==
            (B = dv(a.A)) ? 0 : null == (C = B.optimization) ? 0 : C.ablatingThisPageview) && !zt(a.A) && (On(a.l), tu.C = !0);
        C = a.B.W ? Zb(a.B.W, 2) : [];
        B = a.A;
        b = gv(y(b, 1), C, {
            Cb: B.Cb(),
        ...
        B = a.H;
        b = new nm;
        for (B.j.B = !0; 0 < B.l.length;) C = B, (t = wt[B.l[0]]) ? C = t(C.j) : (C.j.la(12), C = !0), C || B.j.la(5), B.l.shift();
        try {
            var F = b.resolve,
        ...
        $m(Rq(a.l, a.j, a.da, {
            ...
            if (d) {
                ...
                if (0 < e.document.getElementsByTagName("google-read-aloud-player").length) e =
                    ...
                    ge(k, Lg `window.ga=window.ga||function(){(ga.q=ga.q||[]).push(arguments)};ga.l=+new Date;`);
                    l.appendChild(k);
                    vq(h, l, vc("https://www.google-analytics.com/analytics.js"));
                    vq(h, l, vc("https://www.gstatic.com/readaloud/player/web/api/audiosense/js/api.js"));
                    ...
                    f && (Xb(f, 1) && 0 != ac(f, 1, 0) && h.setAttribute("data-docking-begin-trigger", wq[ac(f, 1, 0)]), Xb(f, 2) && h.setAttribute("data-experiment", J(f, 2)));
                    l.appendChild(h);
                    Vo(d, l);
                    e = Vm(e.document.getElementsByTagName("google-read-aloud-player")[0])
                }
                null != e.j ? (b.A = e.j.value, c && Tq(b), Vq(b, {
                    sts: "ok",
                    pp: d.U.j
                })) : Vq(b, {
                    sts: "wf"
    ...
    function ew(a) {
        return a.B.W && Xb(a.B.W, 10) ? .5 <= ($b(D(a.B.W, bk, 10), 1) || 0) : !0
    }

    function fw(a, b) {
        for (var c = Mq(Mq(new Qt(b.Aa), b.errors), a.L), d = b.hb, e = 0; e < d.length; e++) a: {
        ...
        if (c = b.Ob) a.l.as_count = c.rd, a.l.d_count = c.Sd, a.l.ng_count = c.le, a.l.am_count = c.ud, a.l.atf_count = c.sd, a.l.mdns = Rt(c.ge), a.l.alldns = Rt(c.td);
        c = b.Ib;
        null != c && (a.l.allp = c);
        if (c = b.Ud) {
            d = [];
            for (var h of sm(c)) 0 <
                c.get(h).length && (e = c.get(h)[0], d.push("(" + [h, e.Cd, e.Je].join() + ")"));
            a.l.fd = d.join(",")
        }
        h = b.kc;
        null != h && (a.l.pgh = h);
    ...
    function gw(a, b) {
        var c = fw(a, b);
        Pq(a.D, 0 < b.errors.length || 0 < a.L.length || void 0 !== b.exception ? 0 < a.J ? Hq : Fq : 0 < a.J ? Gq : Eq, c);
        if (D(a.j, Ij, 24)) {
            if (null != (b = a.A.A.l.j)) {
                tu.B = [...Zb(b.j, 1)];
                var d;
                let k;
                tu.H = !!(null == (d = D(b.j, Mj, 3)) ? 0 : null == (k = D(d, Nj, 3)) ? 0 : nc(k, Oj, 2, Pj));
                d = new um;
                var e;
                let m;
                for (const n of null != (m = null == (e = D(b.j, Kj, 2)) ? void 0 : G(e, Lj, 1)) ? m : []) d.set(n.ub(), n.$b());
                tu.l = d
            }
            e = dv(a.A);
            var f;
            ...
            f = tu;
            c = new cu(c);
            f.B ? (g = null != (h = f.B) ? h : [], c.j.sl = g.join("~"), c.j.ab = Tt(f.G), c.j.rr = Tt(f.J), c.j.oab = Tt(f.H), null != f.A && (c.j.sab = Tt(f.A)), f.C && (c.j.fb = Tt(f.C)), c.j.ls = Tt(f.L), St(c, f.l.Wa()), null != f.D && (c.j.rp = Tt(f.D)), yu(f, c)) : (h = c, f = "irr".replace(RegExp("~", "g"), ""), h.j.e = h.j.e ? h.j.e + ("~" + f) : f);
            h = c;
            Pq(a.D, Kq, h)
        }
    }
    ...
    function iw(a) {
        return Qj(a.j) && 1 === y(Qj(a.j), 1) ? !(D(Qj(a.j), ck, 6) && 1 <= (y(D(Qj(a.j), ck, 6), 3) || 0)) : !1
    }
        ...
        if (bw(a)) {
            ...
            Hm(a.I, c => {
                ...
                if (null == (d = a.j) ? 0 : null == (e = Sj(d)) ? 0 : bc(e, 21, !1)) {
                    ...
                    try {
                        let h;
                        if (null == (h = a.G) ? 0 : h.includes(0)) a.J++, Zv(a), cw(a, "r", dw(a), c)
                    } catch (h) {
                        cw(a, "f", dw(a), c), Pq(a.D, Hq, Nq(Pt(Ot((new Qt(0)).La(a.C), a.j), a.G).la(1), h))
                    }
                }
            })
        }
    ...
    function mw(a, b) {
        ...
        null != a.A && (a = rv(a.l, a.A, {
            sb: -1,
            Va: -1,
            Za: -1,
            Lc: !0,
            wc: !0
        }), null != a.j ? (c.placementPositionDiffs = Dv(a.j.value), b = Cv(a.j.value), a = new qt, a = hc(a, 2, rt, b), c.placementPositionDiffsReport = kc(a)) : (b = a.l.message, c.placementPositionDiffs = "E" + b, a = new qt, a = ec(a, 1, rt, b), c.placementPositionDiffsReport = kc(a)))
    }
    ...
    function bw(a) {
        let b, c, d;
        return null != (d = null == (b = a.j) ? void 0 : null == (c = Sj(b)) ? void 0 : bc(c, 18, !1)) ? d : !1
    }
                ...
                yi(753, () => {
                    if (X(Ek) && null != this.A) {
                        var d = rv(this.l, this.A, {
                            ...
                            e = Cc(c);
                        null != d.j ?
                            (d = Dv(d.j.value), e.placementPositionDiffs = d) : e.placementPositionDiffs = "E" + d.l.message;
                        e = fw(this, e);
                        Pq(this.D, Iq, e)
                    }
                })()
    ...
    function pw() {
        ...
        return null != b && "object" == typeof b && null != b.S && "object" == typeof b.S ? qw = b : a.google_persistent_state_async = qw = new rw
    }
    ...
    p.set = function(a, b, c) {
        let d, e, f, g = !1,
            h;
        "object" === typeof c && (h = c.oi, g = c.De || !1, f = c.domain || void 0, e = c.path || void 0, d = c.Oc);
    ...
    var Gw = ({
        ...
        b = pw();
        (b = uw(b, 24, void 0)) ? (b = Cw(new Dw, Ys(b)), a = Fw(a, b)) : a = new Wm(null, Error("tcunav"));
        return a
    };
        ...
        if (!(d = !d && $s(new ft(a)))) {
            if (c = !c) {
                if (b) {
                    a = ow(a);
                    if (null != a.j)
                        if ((a = a.j.value) && Xb(a, 1)) b: switch (a = y(a, 1), a) {
                            case 1:
                                a = !0;
                                break b;
                            default:
    ...
    function Rw(a) {
        !a.A || a.j.__uspapi || a.j.frames.__uspapiLocator || (a.j.__uspapiManager = "fc", Ts(a.j, "__uspapiLocator"), wa("__uspapi", (...b) => Sw(a, ...b)))
    }
    ...
    class Qw {
        constructor(a) {
            this.j = a;
            this.l = a.document;
            this.A = (a = (a = Ow(this.l)) ? D(a, Mw, 5) || null : null) ? y(a, 2) : null;
            Nw(this.l);
            Nw(this.l)
        }
    };
    ...
    function aw(a, {
        ...
        Aq(8, b, a.j).then(f => f.runGallerify({
            win: b,
            webPropertyCode: c,
    ...
    var ax = (a, b, c, d, e, f, g = null, h) => {
        ...
        if (d = n) {
            ...
            Ov(a, 2) && (Ui(5, [d.toJSON()]), e = Xw(c), f = new $w(f), c = q.W, e.google_package = c && y(c, 4) || "", Wv(a, b, d, q, f, new ln(["google-auto-placed"], e), g, {
                url: a.location.href,
                eb: h
            }));
            return !0
        ...
        for (let F = 0; F < b.childNodes.length; F++) {
            ...
            if (h.nodeType === Node.TEXT_NODE && "" !== h.textContent) {
                ...
                a: {
                    ...
                    for (;;) {
                        ...
                        b: for (const sa of G(I, ox, 2))
                            for (const O of G(sa, px, 2)) {
                                ...
                                for (var C = E; C < q.length;) {
                                    C = q.indexOf(ha, C);
                                    if (-1 === C) break;
                                    if (C > H || C === H && null !== T && ha.length < T.length) break;
                                    if (!qx(q.charAt(C -
                                            1)) || !qx(q.charAt(C + ha.length))) break;
                                    if (r.j + rx(q.substr(E, C - E)) >= Al(zk)) {
                                        const Ma = k.getComputedStyle(n),
                                            hb = Ma.fontSize.match(/\d+/);
                                        if (!(hb && 12 <= Number(hb[0]) && db(jx, Ma.display))) break b;
                                        H = C;
                                        T = ha;
                                        B = J(sa, 1);
                                        break
                        ...
                        if (null === T) {
                            ...
                            E < q.length && (m = q.substr(E), x.push(k.document.createTextNode(m)), r.j += rx(m));
                            k = x;
                            break a
                        }
                        ...
                        a: {
                            ...
                            for (k = l; k;) {
                                b: switch (k.tagName) {
                                    ...
                                    case "OL":
                                    case "TABLE":
                                        l = !!k.parentElement && db(jx, h.getComputedStyle(k.parentElement).display);
                                        break b;
                                    default:
                                        l = !1
                                }
                ...
                a: if (x = r = k = void 0, l = h, l.nodeType !== Node.ELEMENT_NODE || (null === (x = l.classList) || void 0 === x ? 0 : x.contains("google-adfil-skip"))) l = !1;
                        ...
                        default:
                            q = n = m = x = r = k = void 0,
                                t = l, l = !((null === (m = null === (n = (q = t.className).toUpperCase) || void 0 === n ? void 0 : n.call(q)) || void 0 === m ? 0 : m.includes("CRUMB")) || (null === (k = null === (r = (x = t.id).toUpperCase) || void 0 === r ? void 0 : r.call(x)) || void 0 === k ? 0 : k.includes("CRUMB")) || t.innerText.includes("\u00bb"))
                    }
    ...
    function tx(a) {
        if (a.nodeType === Node.ELEMENT_NODE) {
            if ("A" === a.tagName) {
                ...
                var d = dx(a);
                if (d = b && c && d ? Uw(c, d) < Math.min(Uw(b, d), 4.5) ? b : null : b) {
                    b = d[0];
                    c = d[1];
                    d = d[2];
                    b = Number(b);
    ...
    function sx(a, b, c, d) {
        ...
        g.addEventListener("click", l => {
            ...
            S("adfil-clk", k, 1);
            lx || (k = a.innerHeight,
                (lx = new Er(a, Math.round(.5 * k), k - 40)).init());
    ...
    function Fx(a, b, c, d) {
        ...
        e && xi(898, () => {
            a: {
                ...
                if (a.performance && g && null !== (f = g.classList) && void 0 !== f && f.contains && !g.hasAttribute("data-google-affiliate-annotated")) {
                    ...
                    if (!X(Ak)) {
                        ...
                        if (m instanceof Lc || m instanceof Md) m = m instanceof Md ? Pd(m).toString() : Oc(m).toString(), k.href = m;
                        else {
                            if (-1 === ee.indexOf("stylesheet")) throw Error('TrustedResourceUrl href attribute required with rel="stylesheet"');
                            k.href = Zd(m)
                        }
                        k.rel = "stylesheet";
                        h.head.appendChild(k)
                    }
                    b.hasOwnProperty("adfcb") || (b.adfcb = Qf() ? null : Math.floor(20 * Lf()));
                    k = b.adfcb;
                    if (null != k) {
                        h = new zx;
                        ...
                        if ("" !== n) var q = new Set([n]);
                            ...
                            var t = Bx(r);
                            t.size || (n = a.navigator, t = Bx((null === (q = n.languages) || void 0 === q ? 0 : q.length) ? n.languages : [n.language]));
                            q = t
                        }
                        h.C = m;
                        h.B = new Set(q);
                        g < Al(yk) ? q = "sw" : a.document.querySelector('script[src*="www.google.com/adsense/search/ads.js"]') ? q = "si" : q.has(m) ? (t = new mx, q = nx(a, a.document.body, l, db(kx, J(l.j, 7)) ? 1 : 0, t, h), t.l && !X(Ak) && (l = l.j, g = a.document.createElement("A"), g.appendChild(a.document.createTextNode(J(l,
                            6))), ae(g, gx), g.setAttribute("target", "_blank"), ux(g), L(g, {
                            padding: "0 8px"
                        }), m = a.document.createElement("P"), m.className = "google-adfil-skip", m.appendChild(a.document.createTextNode(J(l, 3))), m.appendChild(g), yx(m), L(m, {
                            ...
                            "text-align": "center",
                            width: "auto"
                        }), l = m, t = t.l, t.parentNode && t.parentNode.insertBefore(l, t), tx(l)), q = q ? "a" : "p") : q = "sl";
                        f = a.performance.now() - f;
                        !X(Ak) && 0 < h.j && (l = a.document, t = l.createElement("SCRIPT"),
                            t.setAttribute("async", "async"), he(t, N `https://www.google.com/adsense/search/ads.js`), l.body.appendChild(t));
                        var x;
                        k = {
                            wp: d,
                            c: k,
    ...
    var Mx = a => {
            ...
            d = (new Date).getTime();
            Array.isArray(b.google_color_bg) && (b.google_color_bg = Lx(a, b.google_color_bg, d));
            Array.isArray(b.google_color_text) && (b.google_color_text = Lx(a, b.google_color_text, d));
            Array.isArray(b.google_color_link) && (b.google_color_link = Lx(a, b.google_color_link, d));
            Array.isArray(b.google_color_url) && (b.google_color_url = Lx(a, b.google_color_url, d));
            Array.isArray(b.google_color_border) && (b.google_color_border = Lx(a, b.google_color_border, d));
            Array.isArray(b.google_color_line) && (b.google_color_line = Lx(a, b.google_color_line, d))
        },
        Lx = (a, b, c) => {
            a.j |= 2;
            return b[c % b.length]
    ...
    var Rx = (a, b) => {
        var c = wi,
            d;
        var e;
        d = (e = (e = yg()) && (d = e.initialLayoutRect) && "number" === typeof d.top && "number" === typeof d.left && "number" === typeof d.width && "number" === typeof d.height ? new ug(d.left, d.top, d.width, d.height) : null) ? new Ye(e.left, e.top) : (d = zg()) && la(d.rootBounds) ? new Ye(d.rootBounds.left + d.boundingClientRect.left, d.rootBounds.top + d.boundingClientRect.top) : null;
        if (d) return d;
        try {
            var f = new Ye(0, 0),
                g = of (jf(b));
    ...
    function dy(a) {
        X(mk) && S("abg_adsensesettings_lserr", {
            s: a,
            g: X(nk),
            c: by(),
            r: .01
    ...
    function oy(a, b, c) {
        ...
        if (0 === a.l) {
            ...
            else if (e = a.j, A(b, 5) && Aw(e) && (new yw(e.document)).set("GoogleAdServingTest", "Good", void 0), e = "Good" === Bw("GoogleAdServingTest", b, a.j)) {
                var f = a.j;
                A(b, 5) && Aw(f) && (new yw(f.document)).remove("GoogleAdServingTest", void 0, void 0)
            }
            a.l = e ? 2 : 1
        }
        2 === a.l && (d = ny(c, b, a));
    ...
    function py(a, b, c, d) {
        ...
        var e = jy(b, "__gads", a);
        e && (d.cookie = e);
        X(Yk) && ((e = jy(b, "__gpi", a)) && !e.includes("&") && (d.gpi_cookie = e), d.gpid_exp = "1");
        const f = Mc(Pc(tc(vc("https://partner.googleadservices.com/gampad/cookie.js"))), d),
            g = oy(b, a, c);
        g ? new Promise(h => {
            c._gfp_s_ = l => {
                g(l).then(h)
    ...
    function wy(a, b = null) {
        ...
        if (!X(ml)) return 32;
        let d = a != a.top ? 512 : 0;
        $r(null === (c = a.navigator) || void 0 === c ? void 0 : c.userAgent) && (d |= 1048576);
    ...
    function Ay(a, b) {
        return null !== xf(a, c => c.nodeType === Node.ELEMENT_NODE && "fixed" === b.getComputedStyle(c, null).position)
    }
    ...
    function Ey(a) {
        return `f-${Dy({position:a.position,Ka:a.Ka,scrollY:0,M:a.M,R:a.R})}`
    }
    ...
    function xy(a) {
        ...
        if (!b.has(d)) {
            b.set(d, 0);
            d = new Set([...Array.from(c.K.document.querySelectorAll("[data-anchor-status]")), ...c.ta]);
        ...
        for (var l = 0; 12 > l; l++) {
            ...
            a: {
                ...
                for (let I = 0; 8 > I; I++) {
                    ...
                    x || (x = E.offsetHeight >= .25 * t.R, x = E.offsetWidth >= .9 * t.M && x);
    ...
    var Iy = (a, b, c, d) => {
            switch (c) {
                ...
                case 4:
                    return 0 === wy(a, c);
                case 8:
                    return b = "on" === b.google_adtest || Vx(a.location, "google_ia_debug") ? -1 : 3600, 0 == (uy(a) | vy(a, b, d));
                case 9:
                    return b = !("on" === b.google_adtest || Vx(a.location, "google_scr_debug")), !Tl(a, b, d);
                case 30:
                    return 0 == cm(a);
                case 26:
                    return 0 == ty(a);
            ...
            switch (c) {
                ...
                case 4:
                    return wy(a,
                        c);
                case 8:
                    return b = "on" === b.google_adtest || Vx(a.location, "google_ia_debug") ? -1 : 3600, uy(a) | vy(a, b, d);
                case 9:
                    return Tl(a, !("on" === b.google_adtest || Vx(a.location, "google_scr_debug")), d);
                case 16:
        ...
        My = a => {
            ...
            return !a.google_reactive_ads_config && Ly(a) && 16 !== b && 10 !== b && 11 !== b && 40 !== b
        },
        Ny = a => {
        ...
        Py = (a, b) => {
            ...
            null != c && null == c.debugCard && Mf(ut, d => {
                !c.debugCardRequested && "number" === typeof d && Xx(d, a.location) && (c.debugCardRequested = !0, Oy(a, b, e => {
        ...
        Wy = (a, b, c) => {
            b = yi(b, c);
            return Aq(1, R(), Mc($d(a), ji(zl).j(tk.j, tk.defaultValue) ? {
    ...
    const Xy = a => {
        a.adsbygoogle || (a.adsbygoogle = [], Gf(a.document, $d(N `https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js`)))
    };
    var Yy = (a, b) => {
            K(a, "load", () => {
                Xy(a);
    ...
    var az = a => "number" === typeof a.google_reactive_sra_index,
        fz = (a, b, c) => {
            ...
            Ag() || Vl(b.pubWin.top);
            f = Di(b.pubWin, "rsrai", yi(429, (g, h) => dz(b, d, e.google_ad_client, a, g, h, c)), yi(430, ua(Pl, b.pubWin, 431, Bh)));
            b.l.push(f);
    ...
    const ez = (a, b, c) => {
        ...
        b = Di(a.pubWin, "apcnf", yi(353, (f, g) => {
            var h = a.pubWin,
    ...
    var dz = (a, b, c, d, e, f, g) => {
        ...
        hz = (a, b, c, d, e, f) => {
            ...
            for (let h = 0; h < a.length; h++) {
                ...
                k && n && m ? (l.pubVars = gz(e, l), delete l.google_reactive_sra_index, g.push(k), xi(466, () => n.verifyAndProcessConfig(b, l, f))) : S("rasra::ivc", {
                    af: k,
                    ak: m,
                    c
                }, .1)
    ...
    function nz(a, b) {
        ...
        if (a.j != c) {
            ...
            a = xw();
            for (const d of a)
                if (d.mc.offsetWidth != d.offsetWidth || d.F.google_full_width_responsive_allowed) d.offsetWidth = d.mc.offsetWidth, xi(467, () => {
                    var e = d.mc,
                        f = d.F;
                    const g = lz(e, f);
                    ...
                    R().google_spfd(e, f, b);
                    const h = lz(e, f);
                    !h && g && 1 == e.childNodes.length ? (mz(g, !1), f.google_reactive_ad_format = 16, f.google_ad_section = "responsive_resize", e.dataset.adsbygoogleStatus = "reserved", e.className += " adsbygoogle-noablate", Xy(b), b.adsbygoogle.push({
                            element: e,
                            params: f
                        })) : h && g ?
                        h != g && (mz(g, !1), mz(h, !0)) : S("auto_size_refresh", {
    ...
    function uz(a, b, c) {
        ...
        const d = b.msg_type;
        let e;
        "string" === typeof d && (e = a.tc[d]) && Th(a.ya, 168, () => {
            e.call(a, b, c)
        })
    }
    class vz extends Us {
        constructor(a) {
            ...
            this.Kd = Uh(this.ya, 169, (d, e) => Pl(this.j, "ras::xsf", this.ka, d, e));
            this.Na = [];
            this.Z(this.tc);
    ...
    class Dz extends wz {
        constructor(a, b) {
            ...
            this.hd = pe(yi(651, () => {
                ...
                var c = this.J;
                this.J = Ml(this.j);
                this.A < this.D ? (c = this.J - c, 0 < c && (this.ma += c, this.ma >= this.Gd ?
                    (yz(this), Az(this, this.D)) : (this.A = Math.min(this.D, this.A + c), Az(this, c), zz(this)))) : te(this.j, "scroll", this.O)
            }), this);
            this.O = () => {
                var c = this.hd;
        ...
        Z(a) {
            a["expand-on-scroll"] = (b, c) => {
                ph(c, this.l) && (b = Ol(b), this.ea = b.i_expid, this.ra = b.qid, this.ib = b.gen204_fraction, this.jb || (this.jb = !0, b = Bz(this, b), "0" === b && K(this.j, "scroll", this.O, qe), c.source.postMessage(JSON.stringify({
                        msg_type: "expand-on-scroll-result",
                        eos_success: "0" === b,
                        googMsgType: "sth"
                    }),
            ...
            a["expand-on-scroll-force-expand"] = (b, c) => {
                ph(c, this.l) && !this.uc && (this.uc = !0, yz(this), te(this.j, "scroll", this.O))
            }
        }
        B() {
    ...
    class Fz extends Us {
        ...
        G() {
            ...
            if (a && !this.A) {
                ...
                c && (Ei(c, "ig", b, "*", 2), 10 <= ++this.D && this.j && te(this.l, "scroll", this.j, qe))
            }
            this.A = a
        }
    };
    class Gz extends wz {
        ...
        Z(a) {
            a.interscroller = (b, c) => {
                if (ph(c, this.l) && (c = Ol(b), b = c.i_h, c = c.i_f, null != b && "" !== b && null != c && "" !== c)) {
    ...
    class Kz extends wz {
        constructor(a, b) {
            ...
            this.C = Tg(this.A).y;
            this.J = null;
            this.ra = u.requestAnimationFrame || u.webkitRequestAnimationFrame || u.mozRequestAnimationFrame || u.oRequestAnimationFrame || u.msRequestAnimationFrame;
            this.ma = yi(636, () => {
                ...
                d + c > this.C ? (d = d + c - this.C, c = Math.min(d,
                    this.ea), d = this.D - d, d = Math.max(0, d), 0 >= d ? Ng(this.l, {
                    position: "absolute",
                    top: "0px",
                    bottom: "auto"
                }) : Ng(this.l, {
        ...
        Z(a) {
            a["parallax-scroll"] = (b, c) => {
                ...
                !this.L && ph(c, this.A) && (this.L = !0, b = Iz(this, b), c.source.postMessage(JSON.stringify({
    ...
    function Lz(a, b) {
        ...
        var e = Mz(a, b, c, a.j.j.elementsFromPoint(Ve(c.left + c.width / 2, c.left, c.right - 1), Ve(c.bottom - 1 - 2, c.top, c.bottom - 1)), 1, []),
            f = Mz(a, b, c, a.j.j.elementsFromPoint(Ve(c.left + c.width / 2, c.left, c.right - 1), Ve(c.top + 2, c.top, c.bottom - 1)), 2, e.sa),
            g = Mz(a, b, c, a.j.j.elementsFromPoint(Ve(c.left + 2, c.left, c.right - 1), Ve(c.top + c.height / 2,
                c.top, c.bottom - 1)), 3, [...e.sa, ...f.sa]);
        const h = Mz(a, b, c, a.j.j.elementsFromPoint(Ve(c.right - 1 - 2, c.left, c.right - 1), Ve(c.top + c.height / 2, c.top, c.bottom - 1)), 4, [...e.sa, ...f.sa, ...g.sa]);
        var l = Nz(a, b, c),
            k = n => db(a.A, n.overlapType) && db(a.B, n.overlapDepth) && db(a.l, n.overlapDetectionPoint);
        ...
        e = [...ab(e, n => new ug(n.elementRect.left,
            n.elementRect.top, n.elementRect.width, n.elementRect.height)), ...jb(ab(k, n => wg(m, n.elementRect))), ...$a(wg(m, new ug(0, 0, d.width, d.height)), n => 0 <= n.top && n.top + n.height <= d.height)];
        return {
            entries: l,
    ...
    function Nz(a, b, c) {
        ...
        for (b = b.parentElement; b; b = b.parentElement) {
            ...
            if (f) {
                var e = If(b, a.j.N());
                e && "visible" !== e.overflow && ("auto" !== e.overflowY && "scroll" !== e.overflowY && c.bottom > f.bottom + 2 ? d.push(Sz(a, c, b, f, 5, 1)) : (e = "auto" === e.overflowX || "scroll" === e.overflowX, !e && c.left < f.left - 2 ? d.push(Sz(a, c, b, f, 5, 3)) : !e && c.right > f.right + 2 && d.push(Sz(a, c, b, f, 5, 4))))
            }
        }
        return d
    }
    ...
    function Oz(a, b) {
        ...
        for (let d = 1; d < 1 << b.length; d++) {
            let e = a,
                f = 0;
            for (let g = 0; g < b.length && (!(d & 1 << g) || (f++, e = vg(e, b[g]), e)); g++);
        ...
        if (db(a.A, e) && db(a.l, f)) {
            ...
            if ((a = Wz(a, c)) && tg(b, a)) c = 4;
                ...
                if (qb) {
                    ...
                    e = new rg(l, f, k, e)
                } else e = Qg(c, "paddingLeft"), f = Qg(c, "paddingRight"), l = Qg(c, "paddingTop"), k = Qg(c, "paddingBottom"), e = new rg(parseFloat(l), parseFloat(f), parseFloat(k), parseFloat(e));
                tg(b, new rg(a.top +
                    e.top, a.right - e.right, a.bottom - e.bottom, a.left + e.left)) ? c = 3 : (c = Xz(c, d), c = tg(b, c) ? 2 : 1)
            }
            h.overlapDepth = c
        }
    ...
    function Wz(a, b) {
        ...
        a.setEndAfter(c);
        a = a.getBoundingClientRect();
        return 0 === a.width || 0 === a.height ? null : new rg(a.top, a.right, a.bottom, a.left)
    }
    ...
    function Xz(a, b) {
        ...
        return new rg(b.top + c.top, b.right - 1 - c.right, b.bottom - 1 - c.bottom, b.left + c.left)
    }
    class Zz {
        constructor(a, b = $z) {
            this.j = gf(a);
    ...
    function dA(a, b) {
        Array.isArray(b) || (b = [b]);
        b = b.map(function(c) {
            return "string" === typeof c ? c : c.lc + " " + c.duration + "s " + c.timing + " " + c.delay + "s"
        });
    ...
    var eA = me(function() {
        ...
        return "" != ("undefined" !== typeof b ? b : a.style[Og(a, "transition")] || "")
    });
    ...
    function iA(a, b, c, d) {
        return "" != a.A || b ? null : "" == a.j.replace(jA, "") ? null != c && a.l[0] || null != d && a.l[1] ? !1 : !0 : !1
    }
    ...
    function sA(a) {
        ...
        a.H && (a.L ? (dA(c, wA), dA(a.L, wA)) : dA(c, "opacity 1s cubic-bezier(.4, 0, 1, 1), width .2s cubic-bezier(.4, 0, 1, 1) .3s, height .5s cubic-bezier(.4, 0, 1, 1)"));
    ...
    function xA(a) {
        if (a.B && !a.Na || null == a.A && null == a.l && null == a.O && a.B) return a.j;
        var b = a.B;
        a.B = !1;
        mA(a);
        a.B = b;
    ...
    function qA(a, b) {
        ...
        "absolute" == b.position ? (gA(a.j, "a"), c = !0) : "fixed" == b.position && (gA(a.j, "f"), c = !0);
        return c
    }
    ...
    function oA(a, b, c, d) {
        ...
        l = !m && pA(d);
        x = m || x || l || !(f || n || d && (!zA(String(d.minWidth)) || !AA(String(d.maxWidth))));
        k = m || g || l || k || !(h || t || d && (!zA(String(d.minHeight)) || !AA(String(d.maxHeight))));
        ...
        if (a.jb) {
            ...
            (f = null != a.l && d && q && Math.round(q) !== a.l) && !(f = !h) && (f = q, f = (X(Qk) || b.location && "#gffwroe2ettq" == b.location.hash) && Math.round(f) < .8 * Math.round(b.innerHeight));
            f = f && "100%" !== d.minHeight;
            if (c = a.B && !c && f) c = !(a.ma && d && (X(Mk) || b.location && "#gffwroe2etoq" == b.location.hash) && Math.round(Vf(d.minHeight)) === Math.round(b.innerHeight));
            c && (e.setProperty("height", "auto", "important"), d && !zA(String(d.minHeight)) && e.setProperty("min-height", "0px", "important"), d && !AA(String(d.maxHeight)) && a.l && Math.round(q) < a.l && e.setProperty("max-height", "none", "important"))
        } else BA(a, 1, k, c, "height", h, a.D, a.l), CA(a, 1, "d", k, e, d, "height", t, a.D, a.l), CA(a, 1, "m", k, e, d, "minHeight", e && e.minHeight,
            a.D, a.l), CA(a, 1, "M", k, e, d, "maxHeight", e && e.maxHeight, a.D, a.l);
        return m
    }
    ...
    function CA(a, b, c, d, e, f, g, h, l, k) {
        if (null != k) {
            f = f && f[g];
            "string" != typeof f || ("m" == c ? zA(f) : AA(f)) || (f = Vf(f), null == f ? gA(a.j, "p") : null != l && gA(a.j, f == l ? "E" : "e"));
            if ("string" == typeof h) {
    ...
    function GA(a, b, c) {
        var d;
        (d = a.j) && !(d = !a.B) && (c ? (b = a.l + Math.min(b, FA(a.getHeight())), a = a.j && b >= a.A) : a = a.j && a.l >= a.A, d = a);
        return d
    }
    var DA = class {
        constructor(a) {
    ...
    var uA = "margin-left margin-right padding-left padding-right border-left-width border-right-width".split(" "),
        vA = "margin-top margin-bottom padding-top padding-bottom border-top-width border-bottom-width".split(" ");
    let KA = "opacity 1s cubic-bezier(.4, 0, 1, 1), width .2s cubic-bezier(.4, 0, 1, 1), height .3s cubic-bezier(.4, 0, 1, 1) .2s",
        LA = uA;
    for (let a = 0; a < LA.length; a++) KA += ", " + LA[a] + " .2s cubic-bezier(.4, 0, 1, 1)";
    LA = vA;
    for (let a = 0; a < LA.length; a++) KA += ", " + LA[a] + " .3s cubic-bezier(.4, 0, 1, 1) .2s";
    var wA = KA;
    ...
    function MA(a, b, c, d, e, f, g, h, l, k) {
        ...
        if (EA(n, f, d, l)) {
            ...
            k.r_cui && Uf(k.r_cui.toString()) && L(r, {
                height: (null ===
                    d ? 0 : d - 48) + "px",
                top: "24px"
            });
            ...
            k.err = "0";
            NA(a, k, n);
            cb(ji(vi).l(), x => db([248427477, 248427478], x)) && a.j === m && Qz(new Zz(a.j, void 0), r).then(x => {
                Ui(8, [x]);
                return x
            }).then(x => {
                S("resize-ovlp", {
    ...
    function OA(a, b, c) {
        ...
        b && (d.str = GA(b, Tf(c.r_nh), Uf(c.r_cab)), d.ad_y = b.l, d.vph = b.A);
        Mf(c, (e, f) => {
            d[f] = e
        });
        return d
            ...
            a["resize-me"] = (b, c) => {
                if (Ll(c, this.l.contentWindow)) {
                    ...
                    if (null == d || "" === d) {
                        ...
                        var h = b.r_str;
                        h = h ? h : null;
                        e = MA(this, d, e, f, g, h, Uf(b.r_ao), Uf(b.r_ifr),
                            Uf(b.r_cab), b);
                        d = {
    ...
    var ZA = a => {
        ...
        c = b.length;
        for (d = 0; d < c; ++d)
            if (e = b[d], e.hasAttribute("href") && (e = e.getAttribute("href"), XA.test(e) || YA.test(e))) return 6;
        ...
        for (a = 0; a < c; ++a)
            if (d = b[a], "stylesheet" == d.getAttribute("rel") && d.hasAttribute("href") && (d = d.getAttribute("href"), VA.test(d))) return 2;
        return 0
    };
    let $A = navigator;
    var aB = a => {
    ...
    function jB(a, b, c) {
        const d = Hf("LINK", a);
        try {
            d.rel = "preload", d.href = b instanceof Lc ? Oc(b).toString() : b instanceof Vc ? Wc(b) : Wc(ed(b))
        } catch (e) {
            return
        }
        d.as = "script";
    ...
    const pB = () => {
        ...
        const a = va();
        mB[1] && mB[3] > a && 0 < mB[2] || (mB[1] = "", mB[2] = -1, mB[3] = -1, mB[4] = "", mB[6] = "");
    ...
    const tB = (a = {}, b = 0) => {
        ...
        var k = !(mB[3] >= va()) && 0 != b;
        if (l || d || k) d = va(), e = d + 1E3 * e, f = d + 1E3 * f, 1E-5 > Math.random() && Dg(u, "https://pagead2.googlesyndication.com/pagead/gen_204?id=imerr" +
            `&err=${b}`), h[5] = b, h[1] = c, h[2] = e, h[3] = f, h[4] = g, h[6] = a, pB();
        if (l || !rB.Zb()) {
            b = rB.Gc();
    ...
    function xB(a) {
        ...
        try {
            ...
            if (null === h || void 0 === h ? 0 : h.type) return null !== (d = vB.get(h.type)) && void 0 !== d ? d : 0
        } catch (h) {}
        return null !== (g = wB.get(null === (f = null === (e = a.performance) || void 0 === e ? void 0 : e.navigation) || void 0 === f ? void 0 : f.type)) && void 0 !== g ? g : 0
    };
    var yB = {
    ...
    function EB(a, b) {
        ...
        !X(xl) && b && 0 < Object.keys(b).length && (a.additionalSigningData = Jb(JSON.stringify(b)));
        return a
    }
    ...
    function GB() {
        ...
        return window.fetch(a, b).then(c => {
            ...
            c && "NoModificationAllowedError" === c.name ? FB(yB.issuerOrigin, 6, !0) : FB(yB.issuerOrigin, 5)
        })
    }
    ...
    function HB() {
        ...
        return window.fetch(a, {
            ...
            if (b && "NoModificationAllowedError" === b.name) return FB(yB.issuerOrigin, 10), GB();
    ...
    function IB() {
        ...
        return document.hasTrustToken(yB.issuerOrigin).then(a => a ? GB() : HB())
    }
    ...
    function JB() {
        ...
        if (window.Promise) {
            ...
            a = a.then(e => window.fetch(b, c).then(f => {
                ...
                if (f && "NoModificationAllowedError" === f.name) FB(Z.issuerOrigin,
                    18, !0);
                else {
            ...
            return a.then(e => {
                ...
                return e && e.srqt && e.cs ? (FB(Z.issuerOrigin, 23), window.fetch(`${f}?cs=${e.cs}&correlator=${d}`, {
                    keepalive: !0,
                    trustToken: {
                        type: "token-request"
                    }
                ...
                if (e && e.srdt && e.cs) return FB(Z.issuerOrigin,
    ...
    function KB(a) {
        if (document.hasTrustToken && !X(sl) && a.l) {
            ...
            if (b && b instanceof Map) {
                ...
                a.j.some(d => d.issuerOrigin === Z.issuerOrigin) && (a = b.get(Z.issuerOrigin), a || (a = JB(), b.set(Z.issuerOrigin, a)), c.push(a));
    ...
    var QB = (a, b) => {
            ...
            m ? (e.google_page_url = c.google_page_url, e.google_page_location = (g ? d.referrer : d.URL) || "EMPTY") : (g && Cf(f.top) && d.referrer && f.top.document.referrer === d.referrer ? e.google_page_url = f.top.document.URL : e.google_page_url = g ? d.referrer : d.URL, e.google_page_location = null);
            ...
            e ? (e = e.toString(), 0 == e.indexOf("http://") ? e = e.substring(7, e.length) : 0 == e.indexOf("https://") && (e = e.substring(8, e.length)), d = e.indexOf("/"), -1 == d && (d = e.length), e = e.substring(0, d).split("."), d = !1, 3 <= e.length && (d = e[e.length - 3] in QA), 2 <= e.length && (d = d || e[e.length - 2] in QA), e = d) : e = !1;
            ...
            d.google_ad_client && PB.test(f) && (q = "/pagead/lopri?");
            a = bh(b, `https://${e}${q}` + (bc(a.X, 9) && c.google_debug_params ? c.google_debug_params : ""));
            return c.google_ad_url = a
        },
        RB = a => encodeURIComponent("RS-" + a.google_reactive_sra_index + "-") + "&" + ah({
        ...
        UB = (a, b) => {
            a = (a = Ff(a.pubWin)) && a.document ? Xl(a.document, a) : new Ye(-12245933, -12245933);
    ...
    var WB = a => {
        ...
        XB = (a, b, c) => {
            ...
            var h;
            (h = yg(e)) && la(h.data) && "string" === typeof h.data.type ? (h = h.data.type.toLowerCase(), h = "doubleclick" == h || "adsense" == h ? null :
                h) : h = null;
            ...
            if (!nh(d)) {
                c = a.pubWin.document;
                g = "";
                if (c.documentMode && (h = yf(new hf(c), "IFRAME"), h.frameBorder = "0", h.style.height = 0, h.style.width = 0, h.style.position = "absolute", c.body)) {
            ...
            if (!Ly(d) && (e = oh(d))) {
                ...
                a: {
                    try {
                        ...
                        if (C = F) {
                            F = [];
                            I = 0;
                            for (var T = Date.now(); 100 >= ++I && 50 > Date.now() - T && (C = SB(C));) 1 === C.nodeType && F.push(C);
                            var sa = F;
                            b: {
                            ...
                            if (Ma) {
                                b: {
                                    const Q = Date.now();Ma = /^html|body$/i;ha = /^fixed/i;
                                    for (O = 0; O < sa.length && 50 > Date.now() - Q; O++) {
                                        const Zc = sa[O];
                                        if (!Ma.test(Zc.tagName) && ha.test(Zc.style.position || Rg(Zc, "position"))) {
                                            var hb = Zc;
                                            break b
                                        }
                                    }
                ...
                hb && hb.offsetWidth * hb.offsetHeight <= 4 * e.width * e.height && (B = 1);
                b.pfx = B
            }
            a: {
        ...
        YB = (a, b) => {
            let c = 0;
            a.location && a.location.ancestorOrigins ? c = a.location.ancestorOrigins.length : Df(() => {
                c++;
                return !1
            }, !0, !0, a);
            c && (b.nhd = c)
        ...
        $B = (a, b, c) => {
                ...
                if (M) {
                    {
                        ...
                        if (U) {
                            let fa = U.pageViewId;
                            const V = U.clientId;
                            "string" === typeof V && (fa += V.replace(/\D/g, "").substr(0, 6));
                            var B = fa
                        } else B = null
                    }
                    var C = +B
            ...
            if (yg()) var Yp = R().gaGlobal || {};
                ...
                if (nC) {
                    var Pi =
                        Yb.split("__utma=" + Kf + ".")[1].split(";")[0].split(".");
                    ...
                    if (!ma.vid) {
                        ...
                        Q ? U += Q.width + "x" + Q.height + Q.colorDepth : u.java && u.java.awt && (M = u.java.awt.Toolkit.getDefaultToolkit().getScreenSize(),
                ...
                if (!ma.cid) {
                    b: {
                        var $c = Ni;
                        let M = 999;$c && ($c = 0 == $c.indexOf(".") ? $c.substr(1) : $c, M = $c.split(".").length);
                        let U, fa = 999;
                        const V = Yb.split(";");
                    ...
                    const P = bq;Zp && P &&
                    -1 != P.search(/^\d+\.\d+$/) ? (ma.vid = P, ma.from_cookie = !0) : P != ma.vid && (ma.cid = P)
                }
                ma.dh = Kf;
    ...
    const aC = (a, b) => {
        ...
        c && (b.npa = 1);
        a && (Xb(a, 3) && (b.gdpr = A(a, 3) ? "1" : "0"), (c = y(a, 1)) && (b.us_privacy = c), (c = y(a, 2)) && (b.gdpr_consent = c), (c = y(a, 4)) && (b.addtl_consent = c), (a = y(a, 7)) && (b.tcfe = a))
    };
    var bC = (a, b) => {
            const c = a.F;
            aC(a, b);
            ...
            Ly(c) && (a = Zy(c), b.fa = a);
            b.pi || null == c.google_ad_slot || (a = Qo(c), null != a.j && (a = fn(a.j.value), b.pi = a))
        },
        cC = (a, b) => {
            var c = Ag() || Vl(a.pubWin.top);
            c && (b.biw = c.width, b.bih = c.height);
            c = a.pubWin;
            c !== c.top && (a = Vl(a.pubWin)) && (b.isw = a.width, b.ish = a.height)
        },
        dC = (a, b) => {
            var c = a.pubWin;
            null !== c && c != c.top ? (a = [c.document.URL], c.name && a.push(c.name), c = Vl(c, !1), a.push(c.width.toString()), a.push(c.height.toString()), a = Of(a.join(""))) : a = 0;
            0 !== a && (b.ifk = a)
        },
        eC = (a, b) => {
        ...
        fC = (a, b, c) => {
            ...
            b.pem = c;X(Pk) && (a = a.pubWin.tmod) && (b.tmod = a)
        },
        gC = (a, b) => {
        ...
        hC = (a, b) => {
            const c = X(AB(window) ? rl : ql),
                d = X(tl);
            (a = BB(a.pubWin, c, d)) && 0 < a.length && (b.tt_state = Jb(JSON.stringify(a)))
        },
        iC = (a, b) => {
    ...
    function BC(a, b, c, d) {
        ...
        const r = t => {
            try {
                ...
                q === x.paw_id && (te(a, "message", r), x.error ? n.j(Error(x.error)) : n.resolve(d(x)))
            } catch (x) {}
        };
        return "function" === typeof(null === (e = a.gmaSdk) || void 0 === e ? void 0 : e.getQueryInfo) ? (K(a, "message", r), q = c(a.gmaSdk), n.promise) : "function" === typeof(null === (h = null === (g = null === (f = a.webkit) || void 0 === f ? void 0 : f.messageHandlers) || void 0 === g ? void 0 : g.getGmaQueryInfo) || void 0 === h ? void 0 :
            h.postMessage) || "function" === typeof(null === (m = null === (k = null === (l = a.webkit) || void 0 === l ? void 0 : l.messageHandlers) || void 0 === k ? void 0 : k.getGmaSig) || void 0 === m ? void 0 : m.postMessage) ? (q = String(Math.floor(2147483647 * Lf())), K(a, "message", r), b(a.webkit.messageHandlers, q), n.promise) : null
    }
    ...
    function EC(a) {
        var b;
        return "function" === typeof(null === (b = a.l) || void 0 === b ? void 0 : b.__uspapi) || null != DC(a)
    }
    ...
    function OC(a) {
        a.D || (a.j || (a.j = a.l.googlefc ? a.l : bg(a.l, "googlefcPresent")), a.D = !0);
        return !!a.j
    }
    ...
    var SC = class extends Us {
        ...
        TC = (a, b, c, d) => {
            ...
            const e = D(b, JC, 3);
            b = D(b, MC, 2);
            return e && b && 1 === y(b, 1) && 2 === y(e, 1) ? RC(a, "getM25Consent").then(f => {
                var g = D(f, LC, 4);
                if (g) {
                    if (f = d, c) {
                        const h = Zb(g, 1);
    ...
    const UC = (a, b) => {
        try {
            ...
            var f = new Fe(De(ac(b, 2, 0)), J(b, 3), e),
                g = null !== (d = null === (c = D(b, Ce, 5)) || void 0 === c ? void 0 : J(c, 1)) && void 0 !== d ? d : "";
            f.Ya = g;
            f.j = l;
            f.win = a;
            var h = f.build();
    ...
    function VC(a, b) {
        a.goog_sdr_l || (Object.defineProperty(a, "goog_sdr_l", {
            value: !0
        }), "complete" === a.document.readyState ? UC(a, b) : K(a, "load", () => void UC(a, b)))
    };
    ...
    function YC(a) {
        if (a === a.top || Cf(a.top)) return Promise.resolve({
            status: 4
        });
        const b = WC(a);
        ...
        if (a.parent === a.top && XC(a.document.referrer)) return Promise.resolve({
            status: 3
        });
        const c = new xq;
        ...
        xi(639, () => {
            {
                ...
                if (n && 1 === k.google_responsive_auto_format && !0 === k.google_full_width_responsive_allowed) {
                    var m;
                    (m = (m = n.document.getElementById(k.google_async_iframe_id)) ? wf(m, "INS", "adsbygoogle") : null) ? (k = new pz(n, m, k), k.l = u.setInterval(ta(k.G, k), 500),
                        k.G(), k = !0) : k = !1
                } else k = !1
            }
            return k
    ...
    function aD(a) {
        ...
        var b = pw(),
            c = uw(b, 22, !1);
        c || (b.S[sw(22)] = !0);
        c || (c = a.F, b = a.X, ji(vi).j(13), ji(vi).j(11), c = Nv(c), (b = J(b, 10)) && c.push(b));
        b = pw();
        ...
        if (!c) {
            ...
            e &&
                Os(new Ps(b.j, new ht(b.j, b.A), e, new ur(b.j)))
        }
        b = !yg() && !Pa();
    ...
    function hD(a, b, c) {
        if (!c || 0 > b) return !1;
        var d = a.F;
        if (!Jl(d.google_reactive_ad_format) && (Ly(d) || d.google_reactive_ads_config) || !Yl(c) || dD(a, c) <= b) return !1;
        var e = pw();
        const f = uw(e, 8, {});
        e = uw(e, 9, {});
        ...
        b = new u.IntersectionObserver((h, l) => {
            Ya(h, k => {
                0 >= k.intersectionRatio || (l.unobserve(k.target), xi(294, () => {
                    cD(a)
                }))
            })
        }, {
    ...
    async function cD(a) {
        ...
        Mx(a);
        mD(a);
        Ly(a.F) && (Wx() && (a.F.google_adtest = a.F.google_adtest || "on"), a.F.google_pgb_reactive = a.F.google_pgb_reactive || 3);
        nD(a.K);
        return oD(a)
    }

    function mD(a) {
        a.K && (Py(a.K, a.$.Pd), Ny(a.K.location) && Yy(a.K, {
    ...
    function sD(a, b, c) {
        return 9 == a.F.google_reactive_ad_format && wf(a.ba, null, "fsi_container", void 0) ? (a.Y.appendChild(b), Promise.resolve(b)) : Wy(a.$.Wc, 525, d => {
            a.Y.appendChild(b);
    ...
    function tD(a, b, c) {
        VC(a.pubWin, oc(ze(pc(pc(ye(new Ae, Be(new Ce, String(jg(a.pubWin)))), 4), 2), J(a.X, 2)), 6, !0));
        const d = a.K;
        ...
        vD(a, b);
        X(Zk) && wD(a, b);
        !d || Ly(a.F) && !$y(a.F) || (e(new Gz(a, b)), e(new PA(d, b, a.F)), e(new Kz(a, b)), e(new Dz(a, b)), e(d.IntersectionObserver ? null : new Fz(d,
            b, a.Y)));
        d && (e(new xz(d, b)), a.l.push(jz(d, a.F)), ji(oz).init(d), a.l.push(tz(d, a.ba, b)));
    ...
    function yD(a, b) {
        ...
        c && (c = Le(Ke(Je(Ie(new Me, c), 2147483647), "/"), Bf(b.F.google_page_url.match(Af)[3] || null)), ky(a, "__gpi_opt_out", c, b.A))
    }

    function wD(a, b) {
        const c = Ci(a.pubWin, "gpi-uoo", (d, e) => {
            if (e.source === b.contentWindow) {
                e = Le(Ke(Je(Ie(new Me, d.userOptOut ? "1" : "0"), 2147483647), "/"), Bf(a.F.google_page_url.match(Af)[3] || null));
                var f = new my(a.pubWin);
                ky(f, "__gpi_opt_out", e, a.A);
                if (d.userOptOut || d.clearAdsData) ly(f, "__gads", a.A), ly(f, "__gpi", a.A)
            }
        });
        a.l.push(c)
    }
    ...
    function uD(a, b, c, d) {
        Qz(new Zz(a, void 0), c).then(e => {
            Ui(8, [e]);
            return e
        }).then(e => {
            const f = c.parentElement;
            (f && Hn.test(f.className) ? f : c).setAttribute("data-overlap-observer-io", e.isOverlappingOrOutsideViewport);
            return e
        }).then(e => {
            const f = b.F.armr || "",
                g = e.executionTime || "",
    ...
    function BD(a, b, c) {
        ...
        (null === (t = a.pubWin.document.featurePolicy) || void 0 === t ? 0 : t.features().includes(n)) && zD(n, k);
        l ? (t = d, k.name = "", X(Xk) && (k.src = t), k = qD(k), c = sD(a, k, c)) :
            c = pD(d, f, k, a);
        e && (e = a.$.Ke, b = {
            id: f,
            url: d,
            ...
            be: e.toString(),
            ac: a.pubWin
        }, b = !b.id || !b.url || 0 >= b.width || 0 >= b.height || !b.zc || !b.ac ? void 0 : Ci(b.ac, "ct", ua(Fi, b, e)), b && a.l.push(b));
        return c
    }
    async function CD(a) {
        var b = a.F,
        ...
        f && (Vy(a.K, f), fz(f, a, zw(d)), f = f.page_level_pubvars, la(f) && Ec(a.F, f));
        A(d, 5) && await DD();
        ...
        f = "";
        az(b) ?
            (f = a.$.Le.toString() + "#" + RB(b), ZB(b, pw()), ED(b)) : (5 == b.google_pgb_reactive && b.google_reactive_ads_config || !My(b) || Ky(c, b, e)) && ED(b) && (f = QB(a, d));
        Ui(2, [b, f]);
    ...
    function DD() {
        return (Sa() ? 0 <= La(Wa(), 11) : Ra() && 0 <= La(Wa(), 65)) ? new Promise(a => {
            uB(a.bind(null, !0))
    ...
    function HD(a) {
        ...
        u.googlefc && !b && S("adsense_fc_has_namespace_but_no_iframes", {
            publisherId: a
        }, 1)
    }
    ...
    async function KD(a) {
        ...
        if (c) try {
            ...
            return (null === d || void 0 === d ? void 0 : d.length) > Al(rk) ? (zi(809, Error(`ML:${d.length}`)), "0") : d
        } catch (d) {
            return zi(809, d), "0"
        }
    }
    ...
    async function ND(a) {
        ...
        var b = new SC(a.pubWin),
            c = await ID(b);
        b = [GD(a.pubWin), FD(a.pubWin), TC(b, c, a.F.google_ad_client, bc(a.X, 6))];
            ...
            a: {
                ...
                if (/Win|Mac|Linux|iPad|iPod|iPhone/.test(k) && !/^Opera/.test(l)) {
                    ...
                    if (/Win/.test(k) && /Trident/.test(l) &&
                        11 <= b.documentMode || !r && "Gecko" === c.product && 27 <= t && !q.test(l) || 536 <= r) {
                        var g = !0;
                        break a
                    }
                }
    ...
    function lD(a) {
        const b = a.K;
        if (b && !Mv(b).ads_density_stats_processed && !yg(b) && (Mv(b).ads_density_stats_processed = !0, X(Tk) || .01 > Lf())) {
            const c = () => {
                if (b) {
                    var d = Yu(Tu(b), a.F.google_ad_client, b.location.hostname, iy(a.F).split(","));
                    S("ama_stats", d, 1)
                }
            };
            mg(b, () => {
    ...
    function nD(a) {
        a && !Mv(a).host_pinged_back && (Mv(a).host_pinged_back = !0, S("abg_host", {
...
}).call(this, "[2019,\"r20220112\",\"r20110914\",null,[],null,null,null,null,null,[],null,[],null,null,null,null,-1]");