    ...
    return (() => {
        var e = {
                948: (e, t, r) => {
                    ...
                    var W, V, J, Q = null,
                        $ = (W = -1, V = -1, J = void 0, function(e) {
                            var t = ++W;
                            return Promise.resolve(e).then((function(e) {
                                return J && t < V ? J : (V = t, J = e, e)
                            }))
                        });
                    ...
                    function z(e) {
                        ...
                        if (f(o), d(u.defaultActiveItemId), !o && !1 === u.openOnFocus) {
                            var v, h = c.getState().collections.map((function(e) {
                                return M(M({}, e), {}, {
                                    items: []
                                })
                            }));
                            return m("idle"), s(h), p(null !== (v = n.isOpen) && void 0 !== v ? v : u.shouldPanelOpen({
                                state: c.getState()
                            })), $(h).then((function() {
                                return Promise.resolve()
                            }))
                        }
                        return m("loading"), Q = u.environment.setTimeout((function() {
                            m("stalled")
                        }), u.stallThreshold), $(u.getSources(M({
                            query: o,
                            refresh: a,
                            state: c.getState()
                        }, l)).then((function(e) {
                            return Promise.all(e.map((function(e) {
                                return Promise.resolve(e.getItems(M({
                                    query: o,
                                    refresh: a,
                                    state: c.getState()
                                }, l))).then((function(t) {
                    ...
                    function le(e) {
                        ...
                        return {
                            getEnvironmentProps: function(e) {
                                ...
                                return ie({
                                    onTouchStart: function(e) {
                                        !1 !== n.getState().isOpen && e.target !== r && !1 === [u, o].some((function(t) {
                            ...
                            getFormProps: function(e) {
                                return e.inputElement, ie({
                                    action: "",
                                    noValidate: !0,
                                    role: "search",
                                    onSubmit: function(o) {
                                        var i;
                                        o.preventDefault(), t.onSubmit(ie({
                                            event: o,
                                            refresh: r,
                                            state: n.getState()
                            ...
                            getInputProps: function(e) {
                                function o(e) {
                                    (t.openOnFocus || Boolean(n.getState().query)) && z(ie({
                                        event: e,
                                        props: t,
                                    ...
                                    onKeyDown: function(e) {
                                        ! function(e) {
                                            ...
                                            if ("ArrowUp" === t.key || "ArrowDown" === t.key) {
                                                ...
                                                t.preventDefault(), !1 === u.getState().isOpen && (r.openOnFocus || Boolean(u.getState().query)) ? z(X({
                                                    event: t,
                                                    props: r,
                                                ...
                                                var c = q(u.getState()),
                                                    ...
                                                    p = c.itemUrl,
                                                    f = c.source;
                                                if (t.metaKey || t.ctrlKey) void 0 !== p && (f.onSelect(X({
                                                    event: t,
                                                    item: l,
                                                    itemInputValue: s,
                                                    itemUrl: p,
                                                ...
                                                else if (t.shiftKey) void 0 !== p && (f.onSelect(X({
                                                    event: t,
                                                    item: l,
                                                    itemInputValue: s,
                                                    itemUrl: p,
                                                    ...
                                                    if (void 0 !== p) return f.onSelect(X({
                                                        event: t,
                                                        item: l,
                                                        itemInputValue: s,
                                                        itemUrl: p,
                    ...
                    function ve(e) {
                        var t, r, n, u, o = e.plugins,
                            i = e.options,
                            a = null === (t = ((null === (r = i.__autocomplete_metadata) || void 0 === r ? void 0 : r.userAgents) || [])[0]) || void 0 === t ? void 0 : t.segment,
                            c = a ? me({}, a, Object.keys((null === (n = i.__autocomplete_metadata) || void 0 === n ? void 0 : n.options) || {})) : {};
                        return {
                            ...
                            ua: pe.concat((null === (u = i.__autocomplete_metadata) || void 0 === u ? void 0 : u.userAgents) || [])
                        }
                    }
                    ...
                    var _e = function(e, t) {
                        switch (t.type) {
                            ...
                            case "ArrowDown":
                                var r = ge(ge({}, e), {}, {
                                    activeItemId: t.payload.hasOwnProperty("nextActiveItemId") ? t.payload.nextActiveItemId : De(1, e.activeItemId, s(e), t.props.defaultActiveItemId)
                                });
                                return ge(ge({}, r), {}, {
                                    completion: he({
                                        state: r
                            ...
                            case "blur":
                                return t.props.debug ? e : ge(ge({}, e), {}, {
                                    isOpen: !1,
                                    activeItemId: null
                                });
                            case "mousemove":
                    ...
                    function Ce(e) {
                            ...
                            r = function(e, t) {
                                ...
                                return b(b({
                                    ...
                                    getSources: function(r) {
                                        return Promise.all([].concat(D(u.map((function(e) {
                                            return e.getSources
                        ...
                        return r.plugins.forEach((function(e) {
                            ...
                            function(e) {
                                var t, r = e.metadata,
                                    n = e.environment;
                                if (null === (t = n.navigator) || void 0 === t ? void 0 : t.userAgent.includes("Algolia Crawler")) {
                                    var u = n.document.createElement("meta"),
                                        o = n.document.querySelector("head");
                                    u.name = "algolia:metadata", setTimeout((function() {
                    ...
                    function ke(e, t, r) {
                        ...
                        if ("style" === t)
                            ...
                            for (t in r) o && r[t] === o[t] || Be(e.style, t, r[t]);
                        else "o" === t[0] && "n" === t[1] ? (n = t !== (t = t.replace(/Capture$/, "")), (u = t.toLowerCase()) in e && (t = u), t = t.slice(2), e._listeners || (e._listeners = {}), e._listeners[t] = r, r ? o || e.addEventListener(t, Ie, n) : e.removeEventListener(t, Ie, n)) : "list" !== t && "tagName" !== t && "form" !== t && "type" !== t && "size" !== t && "download" !== t && "href" !== t && t in e ? e[t] = null == r ? "" : r : "function" != typeof r && "dangerouslySetInnerHTML" !== t && (null == r || !1 === r && !/^ar/.test(t) ? e.removeAttribute(t) : e.setAttribute(t, r))
                    }
                    ...
                    function Te(e, t) {
                        for (var r in t) "o" === r[0] && "n" === r[1] || ke(e, xe(r), t[r])
                    }
                    var qe = ["children"];
                    ...
                    function Ue(e) {
                        return function(t, r) {
                            ...
                            return Ne(i, o), i.append.apply(i, Re(u)), i
                        }
                    }
                    var He = ["autocompleteScopeApi", "environment", "classNames", "getInputProps", "getInputPropsCore", "onDetachedEscape", "state"];
                    ...
                    function st(e, t) {
                        if (null == t) return e.__ ? st(e.__, e.__.__k.indexOf(e) + 1) : null;
                    ...
                    function ft(e) {
                        (!e.__d && (e.__d = !0) && Ye.push(e) && !dt.__r++ || et !== Xe.debounceRendering) && ((et = Xe.debounceRendering) || Ze)(dt)
                    }

                    function dt() {
                        for (var e; dt.__r = Ye.length;) e = Ye.sort((function(e, t) {
                            return e.__v.__b - t.__v.__b
                        })), Ye = [], e.some((function(e) {
                            var t, r, n, u, o, i;
                            e.__d && (o = (u = (t = e).__v).__e, (i = t.__P) && (r = [], (n = ut({}, u)).__v = u.__v + 1, _t(i, u, n, t.__n, void 0 !== i.ownerSVGElement, null != u.__h ? [o] : null, r, null == o ? st(u) : o, u.__h), Ot(r, u), u.__e != o && pt(u)))
                        }))
                    }

                    function mt(e, t, r, n, u, o, i, a, c, l) {
                        var s, p, f, d, m, v, h, D = n && n.__k || rt,
                            y = D.length;
                        for (r.__k = [], s = 0; s < t.length; s++)
                            if (null != (d = r.__k[s] = null == (d = t[s]) || "boolean" == typeof d ? null : "string" == typeof d || "number" == typeof d || "bigint" == typeof d ? at(null, d, null, null, d) : Array.isArray(d) ? at(ct, {
                                    children: d
                                }, null, null, null) : d.__b > 0 ? at(d.type, d.props, d.key, null, d.__v) : d)) {
                                if (d.__ = r, d.__b = r.__b + 1, null === (f = D[s]) || f && d.key == f.key && d.type === f.type) D[s] = void 0;
                                else
                                    for (p = 0; p < y; p++) {
                                ...
                                _t(e, d, f = f || tt, u, o, i, a, c, l), m = d.__e, (p = d.ref) && f.ref != p && (h || (h = []), f.ref && h.push(f.ref, null, d), h.push(p, d.__c || m, d)), null != m ? (null == v && (v = m), "function" == typeof d.type && null != d.__k && d.__k === f.__k ? d.__d = c = vt(d, c, e) : c = ht(e, d, f, D, m, c), l || "option" !== r.type ? "function" == typeof r.type && (r.__d = c) : e.value = "") : c && f.__e == c && c.parentNode != e && (c = st(f))
                            }
                        for (r.__e = v, s = y; s--;) null != D[s] && ("function" == typeof r.type && null != D[s].__e && D[s].__e == r.__d && (r.__d = st(n, s + 1)), Ct(D[s], D[s]));
                        if (h)
                    ...
                    function vt(e, t, r) {
                        var n, u;
                        for (n = 0; n < e.__k.length; n++)(u = e.__k[n]) && (u.__ = e, t = "function" == typeof u.type ? vt(u, t, r) : ht(r, u, u, e.__k, u.__e, t));
                        return t
                    }
                    ...
                    function Dt(e, t, r) {
                        "-" === t[0] ? e.setProperty(t, r) : e[t] = null == r ? "" : "number" != typeof r || nt.test(t) ? r : r + "px"
                    }
                    ...
                    function yt(e, t, r, n, u) {
                        ...
                        else if ("o" === t[0] && "n" === t[1]) o = t !== (t = t.replace(/Capture$/, "")), t = t.toLowerCase() in e ? t.toLowerCase().slice(2) : t.slice(2), e.l || (e.l = {}), e.l[t + o] = r, r ? n || e.addEventListener(t, o ? bt : gt, o) : e.removeEventListener(t, o ? bt : gt, o);
                    ...
                    function _t(e, t, r, n, u, o, i, a, c) {
                        var l, s, p, f, d, m, v, h, D, y, g, b = t.type;
                        if (void 0 !== t.constructor) return null;
                        null != r.__h && (c = r.__h, a = t.__e = r.__e, t.__h = null, o = [a]), (l = Xe.__b) && l(t);
                        try {
                            e: if ("function" == typeof b) {
                                if (h = t.props, D = (l = b.contextType) && n[l.__c], y = l ? D ? D.props.value : l.__ : n, r.__c ? v = (s = t.__c = r.__c).__ = s.__E : ("prototype" in b && b.prototype.render ? t.__c = s = new b(h, y) : (t.__c = s = new lt(h, y), s.constructor = b, s.render = Ft), D && D.sub(s), s.props = h, s.state || (s.state = {}), s.context = y, s.__n = n, p = s.__d = !0, s.__h = []), null == s.__s && (s.__s = s.state), null != b.getDerivedStateFromProps && (s.__s == s.state && (s.__s = ut({}, s.__s)), ut(s.__s, b.getDerivedStateFromProps(h, s.__s))), f = s.props, d = s.state, p) null == b.getDerivedStateFromProps && null != s.componentWillMount && s.componentWillMount(), null != s.componentDidMount && s.__h.push(s.componentDidMount);
                                else {
                                    if (null == b.getDerivedStateFromProps && h !== f && null != s.componentWillReceiveProps && s.componentWillReceiveProps(h, y), !s.__e && null != s.shouldComponentUpdate && !1 === s.shouldComponentUpdate(h, s.__s, y) || t.__v === r.__v) {
                                        s.props = h, s.state = s.__s, t.__v !== r.__v && (s.__d = !1), s.__v = t, t.__e = r.__e, t.__k = r.__k, t.__k.forEach((function(e) {
                                            e && (e.__ = t)
                                ...
                                s.context = y, s.props = h, s.state = s.__s, (l = Xe.__r) && l(t), s.__d = !1, s.__v = t, s.__P = e, l = s.render(s.props, s.state, s.context), s.state = s.__s, null != s.getChildContext && (n = ut(ut({}, n), s.getChildContext())), p || null == s.getSnapshotBeforeUpdate || (m = s.getSnapshotBeforeUpdate(f, d)), g = null != l && l.type === ct && null == l.key ? l.props.children : l, mt(e, Array.isArray(g) ? g : [g], t, r, n, u, o, i, a, c), s.base = t.__e, t.__h = null, s.__h.length && i.push(s), v && (s.__E = s.__ = null), s.__e = !1
                            } else null == o && t.__v === r.__v ? (t.__k = r.__k, t.__e = r.__e) : t.__e = At(r.__e, t, r, n, u, o, i, c);
                            (l = Xe.diffed) && l(t)
                        }
                        catch (e) {
                            t.__v = null, (c || null != o) && (t.__e = a, t.__h = !!c, o[o.indexOf(a)] = null), Xe.__e(e, t, r)
                        }
                    }

                    function Ot(e, t) {
                        Xe.__c && Xe.__c(t, e), e.some((function(t) {
                            try {
                    ...
                    function At(e, t, r, n, u, o, i, a) {
                        ...
                        if ("svg" === m && (u = !0), null != o)
                            for (; v < o.length; v++)
                                if ((c = o[v]) && (c === e || (m ? c.localName == m : 3 == c.nodeType))) {
                                    e = c, o[v] = null;
                                    break
                                }
                        if (null == e) {
                            if (null === m) return document.createTextNode(d);
                            e = u ? document.createElementNS("http://www.w3.org/2000/svg", m) : document.createElement(m, d.is && d), o = null, a = !1
                        }
                        if (null === m) f === d || a && e.data === d || (e.data = d);
                        else {
                            if (o = o && rt.slice.call(e.childNodes), l = (f = r.props || tt).dangerouslySetInnerHTML, s = d.dangerouslySetInnerHTML, !a) {
                                if (null != o)
                            ...
                            if (function(e, t, r, n, u) {
                                    var o;
                                    for (o in r) "children" === o || "key" === o || o in t || yt(e, o, null, r[o], n);
                                    for (o in t) u && "function" != typeof t[o] || "children" === o || "key" === o || "value" === o || "checked" === o || r[o] === t[o] || yt(e, o, t[o], r[o], n)
                                }(e, d, f, u, a), s) t.__k = [];
                            else if (v = t.props.children, mt(e, Array.isArray(v) ? v : [v], t, r, n, u && "foreignObject" !== m, o, i, e.firstChild, a), null != o)
                                for (v = o.length; v--;) null != o[v] && ot(o[v]);
                            a || ("value" in d && void 0 !== (v = d.value) && (v !== e.value || "progress" === m && !v) && yt(e, "value", v, f.value, !1), "checked" in d && void 0 !== (v = d.checked) && v !== e.checked && yt(e, "checked", v, f.checked, !1))
                        }
                        return e
                    }
                    ...
                    function Ct(e, t, r) {
                        var n, u, o;
                        if (Xe.unmount && Xe.unmount(e), (n = e.ref) && (n.current && n.current !== e.__e || Et(n, null, t)), r || "function" == typeof e.type || (r = null != (u = e.__e)), e.__e = e.__d = void 0, null != (n = e.__c)) {
                    ...
                    function Pt(e, t, r) {
                        var n, u, o;
                        Xe.__ && Xe.__(e, t), u = (n = "function" == typeof r) ? null : r && r.__k || t.__k, o = [], _t(t, e = (!n && r || t).__k = it(ct, null, [e]), u || tt, tt, void 0 !== t.ownerSVGElement, !n && r ? [r] : u ? null : t.firstChild ? rt.slice.call(t.childNodes) : null, o, !n && r ? r : u ? u.__e : t.firstChild, n), Ot(o, e)
                    }
                    ...
                    Xe = {
                        ...
                        var r;
                        r = null != this.__s && this.__s !== this.state ? this.__s : this.__s = ut({}, this.state), "function" == typeof e && (e = e(ut({}, r), this.props)), e && ut(r, e), null != e && this.__v && (t && this.__h.push(t), ft(this))
                    }, lt.prototype.forceUpdate = function(e) {
                        this.__v && (this.__e = !0, e && this.__h.push(e), ft(this))
                    }, lt.prototype.render = ct, Ye = [], Ze = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, dt.__r = 0;
                    ...
                    function xt(e) {
                        ...
                        return "string" != typeof u && (u = jt(t, n) || ""), Bt({
                            highlightedValue: u
                        })
                    }
                    var Nt = {
                    ...
                    function Lt(e, t) {
                        ...
                        return Tt.test((u = o.value) && Rt.test(u) ? u.replace(qt, (function(e) {
                            return Nt[e]
                    ...
                    var Yt = ["classNames", "container", "getEnvironmentProps", "getFormProps", "getInputProps", "getItemProps", "getLabelProps", "getListProps", "getPanelProps", "getRootProps", "panelContainer", "panelPlacement", "render", "renderNoResults", "renderer", "detachedMediaQuery", "components", "translations"];
                    ...
                    function fr(e) {
                        return function(e) {
                            ...
                            if (e) {
                                ...
                                var r = Object.prototype.toString.call(e).slice(8, -1);
                                return "Object" === r && e.constructor && (r = e.constructor.name), "Map" === r || "Set" === r ? Array.from(e) : "Arguments" === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r) ? dr(e, t) : void 0
                            }
                        }(e) || function() {
                            throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
                        }()
                    ...
                    var vr = function(e) {
                        return e && "object" === mr(e) && "[object Object]" === Object.prototype.toString.call(e)
                    };
                    ...
                    function hr() {
                        ...
                        return t.reduce((function(e, t) {
                            return Object.keys(t).forEach((function(r) {
                                var n = e[r],
                                    u = t[r];
                                Array.isArray(n) && Array.isArray(u) ? e[r] = n.concat.apply(n, fr(u)) : vr(n) && vr(u) ? e[r] = hr(n, u) : e[r] = u
                            })), e
                        }), {})
                    }
                    ...
                    function br(e) {
                        var t, r = function() {
                            ...
                            v = a((function() {
                                return m.value.core.environment.matchMedia(m.value.renderer.detachedMediaQuery).matches
                            })),
                            h = a((function() {
                                return Ce(yr(yr({}, m.value.core), {}, {
                                    onStateChange: function(e) {
                                        var t, r, n;
                                        l.current = e.state.collections.some((function(e) {
                                            return e.source.templates.noResults
                                        })), null === (t = d.current) || void 0 === t || t.call(d, e), null === (r = (n = m.value.core).onStateChange) || void 0 === r || r.call(n, e)
                                    },
                                    shouldPanelOpen: p.current.shouldPanelOpen || function(e) {
                                        ...
                                        var n = Boolean(l.current || m.value.renderer.renderNoResults);
                                        return !r && n || r
                                    },
                        ...
                        function O(e) {
                            ...
                            var t = {
                                    ...
                                    panelContainer: v.value ? b.value.detachedContainer : m.value.renderer.panelContainer,
                                    propGetters: y,
                                    state: D.current
                                },
                                r = !s(e) && !l.current && m.value.renderer.renderNoResults || m.value.renderer.render;
                            ! function(e) {
                                var t = e.autocomplete,
                                    r = e.autocompleteScopeApi,
                                    n = e.dom,
                                    u = e.propGetters,
                                    o = e.state;
                                Te(n.root, u.getRootProps(lr({
                                    state: o,
                                    props: t.getRootProps({})
                                }, r))), Te(n.input, u.getInputProps(lr({
                                    state: o,
                        ...
                        function A() {
                            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                            u(), p.current = hr(m.value.renderer, m.value.core, {
                                initialState: D.current
                            }, e), c(), o(), h.value.refresh().then((function() {
                                O(D.current)
                            }))
                        }
                        ...
                        return n((function() {
                            ...
                            return Ne(m.value.core.environment, e),
                                function() {
                                    Ne(m.value.core.environment, Object.keys(e).reduce((function(e, t) {
                                        return yr(yr({}, e), {}, gr({}, t, void 0))
                                    }), {}))
                                }
                        })), n((function() {
                            var e = v.value ? m.value.core.environment.document.body : m.value.renderer.panelContainer,
                                t = v.value ? b.value.detachedOverlay : b.value.panel;
                            return v.value && D.current.isOpen && E(!0), O(D.current),
                                function() {
                            ...
                            return d.current = function(t) {
                                    var r = t.state,
                                        n = t.prevState;
                                    v.value && n.isOpen !== r.isOpen && E(r.isOpen), v.value || !r.isOpen || n.isOpen || _(), r.query !== n.query && m.value.core.environment.document.querySelectorAll(".aa-Panel--scrollable").forEach((function(e) {
                            ...
                            var e = Pe((function() {
                                var e = v.value;
                                v.value = m.value.core.environment.matchMedia(m.value.renderer.detachedMediaQuery).matches, e !== v.value ? A({}) : requestAnimationFrame(_)
                            }), 20);
                            return m.value.core.environment.addEventListener("resize", e),
                                function() {
                            ...
                            var r = m.value.core.environment.matchMedia(getComputedStyle(m.value.core.environment.document.documentElement).getPropertyValue("--aa-detached-modal-media-query"));
                            e(r.matches);
                    ...
                    function Or(e) {
                        for (var t = 1; t < arguments.length; t++) {
                            var r = null != arguments[t] ? arguments[t] : {};
                            t % 2 ? _r(Object(r), !0).forEach((function(t) {
                                Ar(e, t, r[t])
                            })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r)) : _r(Object(r)).forEach((function(t) {
                                Object.defineProperty(e, t, Object.getOwnPropertyDescriptor(r, t))
                            }))
                        }
                        return e
                    ...
                    var xr = function(e) {
                        ...
                        return function(e) {
                            var t = e.searchClient,
                                ...
                                n = e.userAgents,
                                u = void 0 === n ? [] : n;
                            return "function" == typeof t.addAlgoliaAgent && [].concat(wr(pe), wr(u)).forEach((function(e) {
                                var r = e.segment,
                                    n = e.version;
                                t.addAlgoliaAgent(r, n)
                            })), t.search(r.map((function(e) {
                                var t = e.params;
                                return Fr(Fr({}, jr(e, Er)), {}, {
                                    params: Fr({
                                        hitsPerPage: 5,
                                        highlightPreTag: wt,
                                        highlightPostTag: St
                ...
                934: function(e) {
                    ...
                    e.exports = function() {
                            ...
                            return Promise.all(t.map((function(t) {
                                ...
                                var r = e.filter((function(e) {
                                    ...
                                    n = e.filter((function(e) {
                                        return function(e) {
                                            return e.status === D && Date.now() - e.lastUpdate <= 12e4
                                        }(e)
                                    })),
                                    u = [].concat(o(r), o(n));
                                return {
                                ...
                                d = function t(r, o) {
                                    ...
                                    var d = {
                                        ...
                                        v = {
                                            ...
                                            onRetry: function(n) {
                                                var u = m(n);
                                                return n.isTimedOut && f++, Promise.all([e.logger.info("Retryable failure", j(u)), e.hostsCache.set(s, y(s, n.isTimedOut ? D : h))]).then((function() {
                                                    return t(r, o)
                                                }))
                                            },
                                            onFail: function(e) {
                        ...
                        var w = function(e) {
                            ...
                            S = function(e) {
                                return function(t, r) {
                                    return t.method === b ? e.transporter.read(t, r) : e.transporter.write(t, r)
                                }
                            },
                            B = function(e) {
                                return function(t) {
                    ...
                    var o = r(948),
                        ...
                        l = function() {
                            ...
                            return t = e, (r = [{
                                ...
                                key: "createClient",
                                value: function() {
                                    var e = (0, i.default)(this.options.appId, this.options.apiKey);
                ...
                920: (e, t, r) => {
                    ...
                    function u(e, t) {
                        ...
                        for (var o = 1; o < 7 && u < 3; ++o) {
                            var i = "lvl".concat(o);
                            e.hierarchy[i] && e.hierarchy[i].length > 0 && (u > 0 && r.push(" > "), r.push((0, n.jsx)(t.Highlight, {
                                hit: e.hierarchy,
                                attribute: i
                            }, void 0)), ++u)
                        }
                    ...
                    function o(e, t) {
                        ...
                        return o && "full" === o.matchLevel ? (0, n.jsx)(t.Snippet, {
                            hit: e,
                            attribute: "description"
                        }, void 0) : i && "full" === i.matchLevel ? (0, n.jsx)(t.Snippet, {
                            hit: e,
                            attribute: "content"
                        }, void 0) : o && !i ? (0, n.jsx)(t.Snippet, {
                            hit: e,
                            attribute: "description"
                        }, void 0) : i ? (0, n.jsx)(t.Snippet, {
                            hit: e,
                            attribute: "content"
                    ...
                    t.templates = {
                        poweredBy: function(e) {
                            ...
                            return (0, n.jsxs)("div", Object.assign({
                                ...
                                children: ["Search by", (0, n.jsx)("a", Object.assign({
                        ...
                        item: function(e, t) {
                            var r, i;
                            return (0, n.jsx)("a", Object.assign({
                                href: e.url
                            }, {
                                children: (0, n.jsxs)("div", Object.assign({
                                    ...
                                    children: [(0, n.jsx)("div", Object.assign({
                                        ...
                                        children: (0, n.jsx)("svg", Object.assign({
                                            width: "20",
                                            height: "20",
                                            viewBox: "0 0 20 20"
                                        }, {
                                        ...
                                        children: [(0, n.jsx)("div", Object.assign({
                                            ...
                                            children: null !== (i = null === (r = e.hierarchy) || void 0 === r ? void 0 : r.lvl0) && void 0 !== i ? i : (0, n.jsx)(t.Highlight, {
                                                hit: e,
                                                attribute: "title"
                                            }, void 0)
                                        }), void 0), e.hierarchy && (0, n.jsx)("div", Object.assign({
                ...
                275: (e, t, r) => {
                    ...
                    function b() {
                        for (var e; b.__r = i.length;) e = i.sort((function(e, t) {
                            ...
                            var t, r, n, u, o, i;
                            e.__d && (o = (u = (t = e).__v).__e, (i = t.__P) && (r = [], (n = f({}, u)).__v = u.__v + 1, j(i, u, n, t.__n, void 0 !== i.ownerSVGElement, null != u.__h ? [o] : null, r, null == o ? D(u) : o, u.__h), w(r, u), u.__e != o && y(u)))
                        }))
                    }

                    function _(e, t, r, n, u, o, i, a, c, p) {
                        var f, d, h, y, g, b, _, E = n && n.__k || s,
                            C = E.length;
                        for (r.__k = [], f = 0; f < t.length; f++)
                            if (null != (y = r.__k[f] = null == (y = t[f]) || "boolean" == typeof y ? null : "string" == typeof y || "number" == typeof y || "bigint" == typeof y ? m(null, y, null, null, y) : Array.isArray(y) ? m(v, {
                                    children: y
                                }, null, null, null) : y.__b > 0 ? m(y.type, y.props, y.key, null, y.__v) : y)) {
                                if (y.__ = r, y.__b = r.__b + 1, null === (h = E[f]) || h && y.key == h.key && y.type === h.type) E[f] = void 0;
                                else
                                    for (d = 0; d < C; d++) {
                                ...
                                j(e, y, h = h || l, u, o, i, a, c, p), g = y.__e, (d = y.ref) && h.ref != d && (_ || (_ = []), h.ref && _.push(h.ref, null, y), _.push(d, y.__c || g, y)), null != g ? (null == b && (b = g), "function" == typeof y.type && y.__k === h.__k ? y.__d = c = O(y, c, e) : c = A(e, y, h, E, g, c), "function" == typeof r.type && (r.__d = c)) : c && h.__e == c && c.parentNode != e && (c = D(h))
                            }
                        for (r.__e = b, f = C; f--;) null != E[f] && ("function" == typeof r.type && null != E[f].__e && E[f].__e == r.__d && (r.__d = D(n, f + 1)), I(E[f], E[f]));
                        if (_)
                            for (f = 0; f < _.length; f++) B(_[f], _[++f], _[++f])
                    }

                    function O(e, t, r) {
                        for (var n, u = e.__k, o = 0; u && o < u.length; o++)(n = u[o]) && (n.__ = e, t = "function" == typeof n.type ? O(n, t, r) : A(r, n, n, u, n.__e, t));
                        return t
                    }
                    ...
                    function j(e, t, r, n, o, i, a, c, l) {
                        var s, p, d, m, D, y, g, b, O, A, E, C = t.type;
                        if (void 0 !== t.constructor) return null;
                        null != r.__h && (l = r.__h, c = t.__e = r.__e, t.__h = null, i = [c]), (s = u.__b) && s(t);
                        try {
                            e: if ("function" == typeof C) {
                                if (b = t.props, O = (s = C.contextType) && n[s.__c], A = s ? O ? O.props.value : s.__ : n, r.__c ? g = (p = t.__c = r.__c).__ = p.__E : ("prototype" in C && C.prototype.render ? t.__c = p = new C(b, A) : (t.__c = p = new h(b, A), p.constructor = C, p.render = k), O && O.sub(p), p.props = b, p.state || (p.state = {}), p.context = A, p.__n = n, d = p.__d = !0, p.__h = []), null == p.__s && (p.__s = p.state), null != C.getDerivedStateFromProps && (p.__s == p.state && (p.__s = f({}, p.__s)), f(p.__s, C.getDerivedStateFromProps(b, p.__s))), m = p.props, D = p.state, d) null == C.getDerivedStateFromProps && null != p.componentWillMount && p.componentWillMount(), null != p.componentDidMount && p.__h.push(p.componentDidMount);
                                else {
                                    if (null == C.getDerivedStateFromProps && b !== m && null != p.componentWillReceiveProps && p.componentWillReceiveProps(b, A), !p.__e && null != p.shouldComponentUpdate && !1 === p.shouldComponentUpdate(b, p.__s, A) || t.__v === r.__v) {
                                ...
                                p.context = A, p.props = b, p.state = p.__s, (s = u.__r) && s(t), p.__d = !1, p.__v = t, p.__P = e, s = p.render(p.props, p.state, p.context), p.state = p.__s, null != p.getChildContext && (n = f(f({}, n), p.getChildContext())), d || null == p.getSnapshotBeforeUpdate || (y = p.getSnapshotBeforeUpdate(m, D)), E = null != s && s.type === v && null == s.key ? s.props.children : s, _(e, Array.isArray(E) ? E : [E], t, r, n, o, i, a, c, l), p.base = t.__e, t.__h = null, p.__h.length && a.push(p), g && (p.__E = p.__ = null), p.__e = !1
                    ...
                    function S(e, t, r, u, o, i, a, c) {
                        ...
                        if ("svg" === h && (o = !0), null != i)
                            for (; y < i.length; y++)
                                if ((s = i[y]) && (s === e || (h ? s.localName == h : 3 == s.nodeType))) {
                                    e = s, i[y] = null;
                                    break
                                }
                        if (null == e) {
                        ...
                        if (null === h) m === v || c && e.data === v || (e.data = v);
                            ...
                            if (i = i && n.call(e.childNodes), p = (m = r.props || l).dangerouslySetInnerHTML, f = v.dangerouslySetInnerHTML, !c) {
                                if (null != i)
                                    for (m = {}, y = 0; y < e.attributes.length; y++) m[e.attributes[y].name] = e.attributes[y].value;
                            ...
                            else if (y = t.props.children, _(e, Array.isArray(y) ? y : [y], t, r, u, o && "foreignObject" !== h, i, a, i ? i[0] : r.__k && D(r, 0), c), null != i)
                                for (y = i.length; y--;) null != i[y] && d(i[y]);
                            c || ("value" in v && void 0 !== (y = v.value) && (y !== e.value || "progress" === h && !y) && C(e, "value", y, m.value, !1), "checked" in v && void 0 !== (y = v.checked) && y !== e.checked && C(e, "checked", y, m.checked, !1))
                        }
                        return e
                    }
                    ...
                    }, o = 0, h.prototype.setState = function(e, t) {
                        var r;
                    ...
                    }, h.prototype.render = v, i = [], a = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, b.__r = 0;
                    var x = 0;
