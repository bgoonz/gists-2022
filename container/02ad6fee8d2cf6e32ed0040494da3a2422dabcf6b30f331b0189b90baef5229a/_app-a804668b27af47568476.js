            ...
            var u = function(e) {
                var t, n = !1 !== e.prefetch,
                    ...
                    u = i.default.useMemo((function() {
                        ...
                        return {
                            href: i,
                            as: e.as ? o.resolveHref(a, e.as) : l || i
                        }
                    }), [a, e.href, e.as]),
                    d = u.href,
                    f = u.as,
                ...
                var x = (t = i.default.Children.only(h)) && "object" === typeof t && t.ref,
                    j = s.useIntersection({
                        rootMargin: "200px"
                    }),
                    w = r(j, 2),
                    y = w[0],
                    k = w[1],
                    E = i.default.useCallback((function(e) {
                        y(e), x && ("function" === typeof x ? x(e) : "object" === typeof x && (x.current = e))
                    }), [x, y]);
                ...
                var O = {
                    ref: E,
                    onClick: function(e) {
                        t.props && "function" === typeof t.props.onClick && t.props.onClick(e), e.defaultPrevented || function(e, t, n, r, a, i, l, s) {
                            ("A" !== e.currentTarget.nodeName || ! function(e) {
                                var t = e.currentTarget.target;
                                return t && "_self" !== t || e.metaKey || e.ctrlKey || e.shiftKey || e.altKey || e.nativeEvent && 2 === e.nativeEvent.which
                            }(e) && o.isLocalURL(n)) && (e.preventDefault(), null == l && r.indexOf("#") >= 0 && (l = !1), t[a ? "replace" : "push"](n, r, {
                                shallow: i,
                                locale: s,
                                scroll: l
                            }))
                    ...
                    onMouseEnter: function(e) {
                        o.isLocalURL(d) && (t.props && "function" === typeof t.props.onMouseEnter && t.props.onMouseEnter(e), p(a, d, f, {
                            priority: !0
                        }))
                    }
                };
                if (e.passHref || "a" === t.type && !("href" in t.props)) {
                    var N = "undefined" !== typeof b ? b : a && a.locale,
                        S = a && a.isLocaleDomain && o.getDomainLocale(f, N, a && a.locales, a && a.domainLocales);
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                var t = e.rootMargin,
                    ...
                    f = a.useCallback((function(e) {
                        s.current && (s.current(), s.current = void 0), n || u || e && e.tagName && (s.current = function(e, t, n) {
                            var r = function(e) {
                                    var t = e.rootMargin || "",
                                        n = l.get(t);
                                    if (n) return n;
                            ...
                            return o.set(e, t), i.observe(e),
                                function() {
                                    o.delete(e), i.unobserve(e), 0 === o.size && (i.disconnect(), l.delete(a))
                                }
                        }(e, (function(e) {
                            return e && d(e)
                        }), {
        ...
        6503: function(e, t, n) {
            ...
            var d = (0, a.forwardRef)((({
                    ...
                    const b = (0, a.useRef)(!1),
                        ...
                        [R, C] = (0, a.useState)(S),
                        [_, D] = (0, a.useState)(M);
                    (0, a.useEffect)((() => (b.current = !0, () => {
                        b.current = !1
                    })), []), (0, a.useImperativeHandle)(m, (() => ({
                        continuousStart(e, t = 1e3) {
                            if (O.active) return;
                            if (k) return void console.warn("react-top-loading-bar: You can't use both controlling by props and ref methods to control the bar!");
                            const n = e || u(10, 20);
                            y({
                                active: !0,
                                refreshRate: t,
                        ...
                        complete() {
                            k ? console.warn("react-top-loading-bar: You can't use both controlling by props and ref methods to control the bar!") : (j(100), L(100))
                        }
                    }))), (0, a.useEffect)((() => {
                        C({ ...R,
                            background: r
                        ...
                        if (m) {
                            if (m && void 0 !== e) return void console.warn('react-top-loading-bar: You can\'t use both controlling by props and ref methods to control the bar! Please use only props or only ref methods! Ref methods will override props if "ref" property is available.');
                            L(x), E(!1)
                        } else e && L(e), E(!0)
                    }), [e]);
                    const L = e => {
                        e >= 100 ? (C({ ...R,
                            ...
                            b.current && (C({ ...R,
                                ...
                                b.current && (w.active && (y({ ...w,
                                    active: !1
                                }), j(0), L(0)), O.active && (N({ ...O,
                                    active: !1
                                }), j(0), L(0)), o && o(), j(0), L(0))
                            }), l))
                        }), c)) : (C((t => ({ ...t,
                    ...
                    return function(e, t, n) {
                        ...
                        const e = u(10, 20);
                        x + e < 90 && (j(x + e), L(x + e))
                    }), w.active ? w.refreshRate : null), (0, a.createElement)("div", {
                        className: g,
                        style: { ...P,
                            ...f
                        }
