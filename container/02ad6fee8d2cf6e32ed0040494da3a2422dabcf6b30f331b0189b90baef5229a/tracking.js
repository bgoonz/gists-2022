!(function () {
  ...
  function l(e, n) {
    for (var t = n.length - 1; t >= 0; t--) if (e(n[t])) return n[t];
  }
  ...
  function m(e, n, t) {
    var i = (function (e, n) {
      for (
        var t = "string" == typeof e ? e.split(".") : e, i = 0, r = n;
        r && t.length > i;
  ...
  var F = /[^:]+:\/\/[^(/|?)\s]+/,
    ...
    R =
      (RegExp("^[\0-]*(" + B("javascript") + "|" + B("data") + "):", "i"),
      /^((http(s)?:)?\/\/)/),
    V = function (e) {
      return function (n, t) {
        if (0 === n) {
      ...
      if (0 === e)
        for (
          var i = n.length,
            ...
            a = 0,
            u = function (e) {
              if (0 !== e) for (var n = 0; i > n; n++) r[n] && r[n](e);
            },
            c = function (e) {
              n[e](0, function (n, c) {
                0 === n
              ...
              if (0 === n)
                return (
                  ...
                  e(0, function (e, n) {
                    if (0 !== e)
                      return 1 === e
                        ? ((u = void 0), o(2), r(2), void (a && i(2)))
                        : void (
                            2 === e &&
                            ((o = null), n && ((u = n), r(2), a && i(e, n)))
                          );
                    (o = n)(1);
                  }),
                  (a = !0),
  ...
  var me = (function (e, n, t) {
      ...
      function i(e, n, t) {
        ...
        for (var i = n.length, r = 0; i > r; r++) if (!e(n[r], t[r])) return !1;
        return !0;
      }
      ...
      function r(e) {
        ...
        return function () {
          return (
            i(n, r, arguments) || (o = e.apply(null, arguments)),
            (r = arguments),
            o
          );
        };
    ...
    return function (e) {
      ...
      "function" == typeof t
        ? (console.warn(
          ...
          (r = new i()),
          (o = t))
        : ((r = t.cacheObject || new i()),
          (o = t.selectorCreator || me.createSelector));
      var a = function () {
        var t = e.apply(void 0, arguments);
        if ("string" == typeof t || "number" == typeof t) {
          var i = r.get(t);
          return (
            void 0 === i && ((i = o.apply(void 0, n)), r.set(t, i)),
  ...
  me.createSelector(
    ...
    function (e, n) {
      return (function (e, n, t) {
        for (var i = n; i >= 0; i--) if (e(t[i])) return i;
        return -1;
      })(
        function (e) {
          return (
  ...
  var Pe = "application/x-postmate-v1+json",
    ...
    qe = (function () {
      ...
      return (
        (e.prototype.sendHandshake = function (n) {
          var t,
            i = this,
            r = (function (e) {
              ...
              n.href = e;
              var t =
                  n.protocol.length > 4 ? n.protocol : window.location.protocol,
                i = n.host.length
          ...
          return new e.Promise(function (e, a) {
            i.parent.addEventListener(
              ...
              function n(o) {
                return (
                  !!Me(o, r) &&
                  ("handshake-reply" === o.data.postmate
                    ? (clearInterval(t),
  ...
  var He = function (n) {
    ...
    return new qe(i).then(function (n) {
      var i = n.on,
        ...
        s = {};
      return (
        (t.resolveRemoteCall = function (e) {
          var n = e.id,
            t = e.value,
            i = s[n];
          delete s[n], i(t);
  ...
  function We(e, t) {
    ...
    if (Array.isArray(e)) {
      ...
      for (var o = 0; t.length > o; o++)
        void 0 !== t[o] && (i[o] = Fe(t[o], i[o]));
    } else
      for (var a in ((i = n({}, e)), t))
        r(a, t) && (void 0 === t[a] ? delete i[a] : (i[a] = Fe(t[a], i[a])));
    return i;
  }
  var Be = function (n) {
      return new e(function (e) {
    ...
    tn = function (e) {
      return function (n) {
        var t = window.LC_API || {};
        if (("function" == typeof n && n(t), "function" == typeof t[e]))
          try {
            t[e]();
          } catch (e) {
            nn(e);
    ...
    rn = function (e, n) {
      ...
      return (
        !!t &&
        [].concat(e, ["livechatinc.com", "lc.chat"]).some(function (e) {
          var n = t.length - e.length;
          return (
            -1 !== t.indexOf(e, n) &&
            (t.length === e.length || "." === t.charAt(n - 1))
          );
        })
      );
    },
    ...
    return function (i) {
      var r,
        ...
        l = (function (e) {
          var n = "";
          return {
            desktopVisibility: (n = e.initiallyHidden
              ? e.disabledMinimized
                ? cn
                : sn
              : un),
            mobileVisibility: e.hasCustomMobileSettings
              ? e.hiddenOnMobile
                ? cn
                : e.initiallyHiddenOnMobile
                ? e.disabledMinimizedOnMobile
                  ? cn
                  : sn
                : un
              : n,
      ...
      var v = h.filter(function (e) {
        ...
        g = [].concat(v, m);
      return -1 !== s.indexOf("console.log")
        ? g
            .map(function (e) {
              return e.msg;
            })
  ...
  function Sn(e, n, t) {
    ...
    Z(
      ...
      Z(
        ...
        Y(function () {
          return zn(i.on_chat_started, {
            agent_name: xe(e.state, Ce(e.state, Pn).properties.currentAgent)
              .name,
          });
        })
      ),
      ...
      fn(e, i, "on_postchat_survey_submitted"),
      fn(e, i, "on_prechat_survey_submitted"),
      fn(e, i, "on_rating_comment_submitted"),
      fn(e, i, "on_rating_submitted"),
      fn(e, i, "on_ticket_created"),
      (i.set_custom_variables = function (n) {
        an("LC_API.set_custom_variables", n), vn(e, pn(n));
      }),
      (i.update_custom_variables = function (n) {
        an("LC_API.update_custom_variables", n),
          hn(e, {
            properties: pn(n),
          });
      }),
      (i.set_visitor_name = function (n) {
        an("LC_API.set_visitor_name", n),
          hn(e, {
            name: mn(n),
          });
      }),
      (i.set_visitor_email = function (n) {
        an("LC_API.set_visitor_email", n),
          hn(e, {
            email: mn(n),
          });
      }),
      ...
      (i.agents_are_available = function () {
        return (
          an("LC_API.agents_are_available"),
          "online" === Oe(e.state, "availability")
        );
      }),
      ...
      (i.visitor_engaged = function () {
        return (
          an("LC_API.visitor_engaged"),
          i.visitor_queued() ||
            i.chat_running() ||
            !!Ce(e.state, Pn).properties.fakeAgentMessageId
        );
      }),
  ...
  function Fn(e, t, i) {
    ...
    function h(n, t, i) {
      switch (t) {
        ...
        case "rich_message_button_clicked":
          return void o[n](t, i);
        case "ready":
          return void (Oe(e.state, "readyState") !== In
            ? en(function () {
                return i({
                  state: _("state"),
        ...
        default:
          return void console.error(
            '[LiveChatWidget] callback "' + t + '" does not exist.'
          );
      }
    }
    ...
    function _(n) {
      switch (n) {
        ...
        default:
          return void console.error(
            '[LiveChatWidget] property "' + n + '" not exists.'
          );
      }
    }
    ...
    function k(n, i) {
      switch (
        (an.apply(void 0, ["LiveChatWidget.call", "'" + n + "'"].concat(i)), n)
      ) {
        case "hide":
        case "maximize":
        case "minimize":
    ...
    void 0 === (r = p.other) && (r = []),
      ...
      Z(
        Q(e, "on_rating_submitted"),
        Y(function (e) {
          return l("rating_submitted", e);
        })
      ),
      Z(
        K(Q(e, "add_event"), Q(e, "send_event")),
        X(function (e) {
      ...
      Z(
        K(
          ...
          Z(
            Q(e, "rich_greeting_button_clicked"),
            ne(function (e) {
              var n = e.event;
              return {
                eventId: n.id,
      ...
      Z(
        K(
          Z(
            Q(e, "on_ticket_created"),
            ne(function () {
              return "ticket";
            })
          ),
          Z(
            Q(e, "on_prechat_survey_submitted"),
            ne(function () {
              return "prechat";
            })
          ),
          Z(
            Q(e, "on_postchat_survey_submitted"),
            ne(function () {
              return "postchat";
            })
          )
  ...
  var Wn = function () {
    ...
    Rn = {
      ...
      pageTracker: function (e) {
        ...
        n &&
          "function" == typeof n._trackEvent &&
          n._trackEvent("LiveChat", e.event, e.label, null, e.nonInteraction);
      },
      ...
      if (0 !== r.length) {
        ...
        Z(
          ...
          ["prechat", "postchat", "ticket", "offline"].forEach(function (n) {
            var t;
            Z(
              K(Q(e, "set_default_view"), Q(e, "set_current_view")),
              X(function (e) {
                return (
                  e.viewInfo &&
                  "Chat" === e.viewInfo.view &&
                  e.viewInfo.default === n
                );
              }),
              he(Q(e, "unbind")),
              ((t = function () {
                ...
                return Z(
                  (function () {
                    for (
                      var e = arguments.length, n = Array(e), t = 0;
                      e > t;
                      t++
                    )
                      n[t] = arguments[t];
    ...
    Qn = function (e) {
      var n,
        t = (n = e.match(Yn)) ? n[1].toLowerCase() : "";
      ...
      var e,
        ...
        r =
          (((e = {}).new_message = [
            ...
            "https://cdn.livechatinc.com/widget/static/media/new_message.f3efb3d2.mp3",
          ]),
          (n = e),
          (t = rt()),
          (i = ot(n)),
    ...
    ft = function () {
      return (
        g(navigator.platform, [
          ...
          "iPhone",
          "iPod",
        ]) && g("Version/15", navigator.userAgent)
      );
    },
    pt = function () {
      return (
        /mobile/gi.test(navigator.userAgent) &&
        !("MacIntel" === navigator.platform && g("iPad", navigator.userAgent))
      );
    },
    ht = function () {
      ...
      if (
        ...
        var o,
          ...
          u = function (e) {
            ...
            return (
              n.eyeCatcher.hidden ||
              "minimized" !== n.visibility.state ||
              "online" !== n.availability ||
              n.readyState === In
            );
          },
          c = function () {
  ...
  var kt = function (e) {
      Z(
        ...
        X(function (e) {
          ...
          return (
            "custom" === n.type &&
            n.properties.customId &&
            -1 !==
              n.properties.customId.indexOf("cyber-finger-snapshot-request-")
          );
        }),
        Y(function (n) {
          var t,
            i = n.event.properties.customId.replace(
  ...
  function Tt(e) {
    (xt = "pointer"),
      ("mousedown" !== e.type && "pointerdown" !== e.type) || (Et = !0);
  }
  ...
  var Mt =
    ...
    window.addEventListener("focus", zt, !0),
    window.addEventListener("blur", St, !1),
    "undefined" != typeof PointerEvent
      ? (document.addEventListener("pointerdown", Tt, !0),
        document.addEventListener("pointermove", Tt, !0),
        document.addEventListener("pointerup", Tt, !0))
      : (document.addEventListener("mousedown", Tt, !0),
        document.addEventListener("mousemove", Tt, !0),
        document.addEventListener("mouseup", Tt, !0)),
    function () {
      document.removeEventListener("keydown", Ot, !0),
        document.removeEventListener("keyup", Ot, !0),
        document.removeEventListener("click", Pt, !0),
        window.removeEventListener("focus", zt, !0),
        window.removeEventListener("blur", St, !1),
        "undefined" != typeof PointerEvent
          ? (document.removeEventListener("pointerdown", Tt, !0),
            document.removeEventListener("pointermove", Tt, !0),
            document.removeEventListener("pointerup", Tt, !0))
          : (document.removeEventListener("mousedown", Tt, !0),
            document.removeEventListener("mousemove", Tt, !0),
            document.removeEventListener("mouseup", Tt, !0));
    });
  ...
  var Nt = {
      ...
      var n =
        ...
        i = function () {
          var e,
            ...
            r =
              ((e = document.body),
              Object.keys(Nt).reduce(function (n, t) {
    ...
    Ht = function (e, n) {
      ...
      return (
        n.region && (t = t.replace("secure", "secure-" + n.region)),
      ...
      return {
        ...
        hidden:
          ...
          (function (e) {
            ...
            return Dt && n.hasCustomMobileSettings
              ? n.initiallyHiddenOnMobile
              : n.initiallyHidden;
          })(t),
      ...
      return i
        ? ((t = n),
          new e(function (e) {
            ...
            return e
              ? i.waitForIdle(5e3).then(function () {
    ...
    Ut = function (e) {
      ...
      return (
        ...
        (_(n)
          ...
          : n[0].domContentLoadedEventStart)
      );
    },
    Jt = function () {
              ...
              var n,
                t =
                  ...
                  (n = performance
                    ...
                    .filter(function (e) {
                      return /livechatinc\.com\/(.+\/)?tracking.js/.test(
                        e.name
                      );
                    })).length
                    ? null
  ...
  var Kt,
    ...
    ri =
      ((function (e) {
        ...
        try {
          ...
          return (
            n.setItem(ni, ti),
            n.getItem(ni) !== ti ? !1 : (n.removeItem(ni), !0)
          );
        } catch (e) {
          return !1;
        }
      ...
      ((Kt = {}).CONNECTION_LOST = "Connection lost."),
      (Kt.MISDIRECTED_CONNECTION = "Connected to wrong region."),
      function (e) {
        return e.map(function (e) {
          switch (e.type) {
            case "group_chooser":
    ...
    ai = function (e) {
      ...
      return (
        "https://" +
        (!g("cdn.livechatinc.com/cloud/?uri", n) &&
        !g(".livechat-static.com/", n)
    ...
    si = function (e, n) {
      return (
        "https://api" +
        ((i = (t = n).region) ? "-" + i : "") +
        ((1520 === t.licenseId ? ".staging" : "") +
          ".livechatinc.com/v3.3/customer/action/") +
        e
      );
      var t, i;
    },
    ...
    li = function (e) {
      ...
      if ((e.allowAutoplay && !ht() && a.push("autoplay;"), r)) {
        ...
        a = [].concat(
          ...
          Object.keys(
            ((n = Boolean),
            Object.keys((t = u)).reduce(function (e, i) {
    ...
    yi = function (e, n, t, i, r) {
      e.call("storeMethod", ["setLocalization", i]),
        t.custom ||
          vt(t.element, function () {
            return gn(e.state, "hidden");
          }),
        fi || "wix" === n.integrationName || mt(e, r, i),
        gi(e.frame),
        (function (e, n, t) {
                  ...
                  __unsafeProperties: n(
                    ...
                    },
                    {
                      group: {
                        ...
                        disabledMinimized:
                          "1" === a.group["chat_window.disable_minimized"],
                        disabledMinimizedOnMobile:
                          "1" ===
                          a.group["chat_window.mobile_disable_minimized"],
                        disabledOnMobile:
                          "1" === a.group["chat_window.hide_on_mobile"],
                        eyeCatcher:
                          "1" === a.group["embedded_chat.display_eye_catcher"]
                            ? ci(e)
                            : {
                                enabled: !1,
                              },
                        hasAgentAvatarsEnabled:
                          "1" === a.group["chat_window.display_avatar"],
                        hasCustomMobileSettings:
                          "1" === a.group["chat_window.custom_mobile_settings"],
                        hasHiddenTrademark:
                          "1" === a.group["chat_window.hide_trademark"],
                        hasSoundsEnabled:
                          "0" === a.group["chat_window.disable_sounds"],
                        initiallyHidden:
                          "1" === a.group["chat_window.hide_on_init"] ||
                          "1" === a.group["chat_window.disable_minimized"],
                        initiallyHiddenOnMobile:
                          "1" === a.group["chat_window.mobile_hide_on_init"] ||
                          "1" ===
                            a.group["chat_window.mobile_disable_minimized"],
                        language: a.group.language,
                        linksUnfurlingEnabled: "1" === a.group.links_unfurling,
                        logo:
                          "1" === a.group["chat_window.display_logo"]
                            ? {
                                enabled: !0,
                        ...
                        minimizedTypeOnMobile:
                          a.group["chat_window.mobile_minimized_theme"],
                        offlineMessagesEnabled: "0" === a.group.tickets_enabled,
                        offsetX: parseInt(a.group["chat_window.offset_x"]),
                        offsetXOnMobile: parseInt(
                          a.group["chat_window.mobile_offset_x"]
                        ),
                        offsetY: parseInt(a.group["chat_window.offset_y"]),
                        offsetYOnMobile: parseInt(
                          a.group["chat_window.mobile_offset_y"]
                        ),
                        prechatFormAfterGreetingEnabled:
                          "1" === a.group.pre_chat_survey_after_greeting,
                        ratingEnabled: "1" === a.group["rate_me.enabled"],
                        screenPosition: a.group["chat_window.screen_position"],
                        screenPositionOnMobile:
                          a.group["chat_window.mobile_screen_position"],
                        transcriptButtonEnabled:
                          "1" ===
                          a.group["chat_window.display_transcript_button"],
                        theme: {
                          name: a.group["chat_window.new_theme.name"],
                          variant:
                            a.group["chat_window.new_theme.variant"] || "light",
                          customJson:
                            a.group["chat_window.new_theme.custom_json"],
                          agentbarBackgroundColor:
                            a.group[
                              "chat_window.new_theme.agentbar_background_color"
                            ],
                          agentbarText:
                            a.group["chat_window.new_theme.agentbar_text"],
                          agentMessageColorBackground:
                            a.group[
                              "chat_window.new_theme.agent_message_color_background"
                            ],
                          agentMessageColorText:
                            a.group[
                              "chat_window.new_theme.agent_message_color_text"
                            ],
                          backgroundColor:
                            a.group["chat_window.new_theme.background_color"],
                          ctaColor: a.group["chat_window.new_theme.cta_color"],
                          minimizedColorBackground:
                            a.group[
                              "chat_window.new_theme.minimized_color_background"
                            ],
                          minimizedColorIcon:
                            a.group[
                              "chat_window.new_theme.minimized_color_icon"
                            ],
                          minimizedColorText:
                            a.group[
                              "chat_window.new_theme.minimized_color_text"
                            ],
                          systemMessageColor:
                            a.group[
                              "chat_window.new_theme.system_message_color"
                            ],
                          titlebarBackgroundColor:
                            a.group[
                              "chat_window.new_theme.titlebar_background_color"
                            ],
                          titlebarText:
                            a.group["chat_window.new_theme.titlebar_text"],
                          ...
                          visitorMessageColorText:
                            a.group[
                              "chat_window.new_theme.visitor_message_color_text"
                            ],
                        },
                      },
                      license: {
                        continuousChatWidgetEnabled:
                          "1" === a.license.continuous_chat_widget_enabled,
                        creditCardMaskingEnabled:
                          "1" === a.license.mask_credit_cards,
                        customerHistoryEnabled:
                          "1" === a.license.customer_history_enabled,
                        fileSharingEnabled:
                          "1" === a.license["attachments.enable_for_visitors"],
                        inboundForwardingToHelpdeskEnabled:
                          "1" === a.license["helpdesk.inbound_forwarding"],
  ...
  window.__lc_inited ||
    ((window.__lc_inited = !0),
    3 ===
    [1].reduce(function (e, n) {
      return e + n;
    }, 2)
      ? (function (t) {
          window.performance &&
            ...
            .then(function (r) {
              ...
              if (
                ...
                if (
                  ...
                  var d = Jt(),
                    l = (function (e) {
                      ...
                      return "object" != typeof n ||
                        "function" != typeof n.getToken ||
                        "function" != typeof n.getFreshToken ||
                        "function" != typeof n.hasToken ||
                        "function" != typeof n.invalidate
                        ? (console.error(
                  ...
                  p.custom || s.appendChild(p.element),
                    window.performance &&
                      "function" == typeof window.performance.mark &&
                    ...
                    e
                      ...
                      .then(function (e) {
                        window.performance &&
                          ...
                          d &&
                            d.getLogs().then(function (n) {
                              var t;
                              e.call(
                                "logInfo",
                                "loading_time_measured",
                                a((t = n))
                                  ? t.filter(function (e) {
                                      return null != e;
                                    })
          ...
          ((Qt = window.__lc),
          {
            ...
            requestedGroupId:
              ((Zt = void 0 !== Qt.group ? Qt.group : Qt.skill),
              (ei = "string" == typeof Zt ? parseInt(Zt, 10) : Zt),
              (function (e) {
            ...
            integrationName: Qt.wix
              ? "wix"
              : "string" == typeof Qt.integration_name
              ? Qt.integration_name
              : null,
            ...
            customIdentityProviderInitializer:
              "function" == typeof Qt.custom_identity_provider
                ? Qt.custom_identity_provider
                : null,
            iframeAddress: null,
          })
        )
      : console.error(
          "[LiveChat] This site has overriden Array.prototype.reduce (for example by using Prototype library) to a version that is not compatible with Web standards. LiveChat code couldn't be initialized because of this."
        ));
})();
