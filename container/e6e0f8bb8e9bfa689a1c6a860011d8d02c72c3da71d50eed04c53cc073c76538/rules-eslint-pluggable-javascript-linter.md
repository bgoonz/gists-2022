...
### Using configuration files[](https://eslint.org/docs/user-guide/configuring/rules#using-configuration-files)
...
### Using configuration files[](https://eslint.org/docs/user-guide/configuring/rules#using-configuration-files-1)
