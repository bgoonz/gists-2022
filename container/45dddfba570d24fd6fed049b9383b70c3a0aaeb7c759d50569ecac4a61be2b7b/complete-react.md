...
[Example on Codepen](https://codepen.io/flaviocopes/pen/maVPKa)
...
[Example on Codepen](https://codepen.io/flaviocopes/pen/WLrxXp)
...
The complete example code can be seen at [https://codepen.io/flaviocopes/pen/QzEQPR](https://codepen.io/flaviocopes/pen/QzEQPR)
...
The example uses, in addition to React, the [Axios](https://flaviocopes.com/axios/) library. It's a nice useful and lightweight library to handle network requests. Add it to the Pen settings in Codepen, or install it locally using `npm install axios`.
...
![cZoqPqmbwvuUaIiWJ16fTj6VOhTIquXDECnP](https://cdn-media-1.freecodecamp.org/images/cZoqPqmbwvuUaIiWJ16fTj6VOhTIquXDECnP)

Check it out on Codepen at [https://codepen.io/flaviocopes/pen/oJLyeY](https://codepen.io/flaviocopes/pen/oJLyeY)
...
You can see an example of it working at [https://codesandbox.io/s/18qq31rp3](https://codesandbox.io/s/18qq31rp3).
...
> [_Here is a list of Babel plugins_](https://babeljs.io/docs/en/plugins)
...
![kbXOiSFaO06VSDxcLC29Nh4a8ycSoaL9LDup](https://cdn-media-1.freecodecamp.org/images/kbXOiSFaO06VSDxcLC29Nh4a8ycSoaL9LDup)

Here's the development bundle:

![W-1sAge4rvYL0aH00e7FuyJ5NLv7PJYpves0](https://cdn-media-1.freecodecamp.org/images/W-1sAge4rvYL0aH00e7FuyJ5NLv7PJYpves0)
...
![QJ4lMCN6PhDyBBZ8mPyLmLciew9p9cUE9ug0](https://cdn-media-1.freecodecamp.org/images/QJ4lMCN6PhDyBBZ8mPyLmLciew9p9cUE9ug0)
...
![vGSvRogM-QF8N3EP5j9vUYYrkWvRc89OhE98](https://cdn-media-1.freecodecamp.org/images/vGSvRogM-QF8N3EP5j9vUYYrkWvRc89OhE98)
...
![WYyCsxacP34Fss8u9jT5lT0u3O--1Uwz9cKW](https://cdn-media-1.freecodecamp.org/images/WYyCsxacP34Fss8u9jT5lT0u3O--1Uwz9cKW)
...
![wsyP30ZeaXYM6LTu4UOiTIg4cFjUOo4GtutV](https://cdn-media-1.freecodecamp.org/images/wsyP30ZeaXYM6LTu4UOiTIg4cFjUOo4GtutV)
...
![8j7LKC8uKE5Tw0X4WN4Gm0rD3NziyPxNwyCn](https://cdn-media-1.freecodecamp.org/images/8j7LKC8uKE5Tw0X4WN4Gm0rD3NziyPxNwyCn)
...
![F9HWCuZKWwG1RMZdNkDAaGMRsC0zaIsMokia](https://cdn-media-1.freecodecamp.org/images/F9HWCuZKWwG1RMZdNkDAaGMRsC0zaIsMokia)
...
![7xWQMgM0PC9AGUBewAzcCgNWvHIjjxerfRxR](https://cdn-media-1.freecodecamp.org/images/7xWQMgM0PC9AGUBewAzcCgNWvHIjjxerfRxR)
...
![imS-QSkC1rmVVRYLkLYSJrGk5b3DOjodEJkx](https://cdn-media-1.freecodecamp.org/images/imS-QSkC1rmVVRYLkLYSJrGk5b3DOjodEJkx)
...
![DKFPyZSWF0O2ldKLAMyz7i0Di9NLqMs-ChQ4](https://cdn-media-1.freecodecamp.org/images/DKFPyZSWF0O2ldKLAMyz7i0Di9NLqMs-ChQ4)

A test file can contain multiple tests:

![iWZgjKzyxhyAtvjpsyTTEpzs4pKot938aVjk](https://cdn-media-1.freecodecamp.org/images/iWZgjKzyxhyAtvjpsyTTEpzs4pKot938aVjk)
...
We are going to use the `react-testing-library`, which is a great help as it allows us to inspect the output of every component and to apply events on them. You can read more about it on [https://github.com/kentcdodds/react-testing-library](https://github.com/kentcdodds/react-testing-library) or watch [this video](https://www.youtube.com/watch?v=JKOwJUM4_RM).
...
Check the code working on this CodeSandbox: [https://codesandbox.io/s/pprl4y0wq](https://codesandbox.io/s/pprl4y0wq)
...
![wBBqzsveZC9evvtqiPb6yrFav9V5UjExd0HE](https://cdn-media-1.freecodecamp.org/images/wBBqzsveZC9evvtqiPb6yrFav9V5UjExd0HE)
...
![nEBXVSebNz6KzUWgNg62w-clo2vL7tnLIYpl](https://cdn-media-1.freecodecamp.org/images/nEBXVSebNz6KzUWgNg62w-clo2vL7tnLIYpl)
...
![urgIpOydqbjE4i9nyELblMonOjrK0Plrn3OJ](https://cdn-media-1.freecodecamp.org/images/urgIpOydqbjE4i9nyELblMonOjrK0Plrn3OJ)
...
Next.js by default provides support for [styled-jsx](https://github.com/zeit/styled-jsx), which is a CSS-in-JS solution provided by the same development team, but you can use whatever library you prefer, like Styled Components.
...
You can set up multiple Next.js instances to listen to different URLs, yet the application to an outside user will simply look like it's being powered by a single server: [https://github.com/zeit/next.js/#multi-zones](https://github.com/zeit/next.js/#multi-zones)

#### Plugins

Next.js has a list of plugins at [https://github.com/zeit/next-plugins](https://github.com/zeit/next-plugins)
...
This command creates a brand new Gatsby site in the `mysite` folder, using the _starter_ available at [https://github.com/gatsbyjs/gatsby-starter-hello-world](https://github.com/gatsbyjs/gatsby-starter-hello-world).

![rNWB5DuHCS526rLjNuhwMdYAErq4TTAJFqg5](https://cdn-media-1.freecodecamp.org/images/rNWB5DuHCS526rLjNuhwMdYAErq4TTAJFqg5)

A _starter_ is a sample site that you can build upon. Another common starter is `default`, available at [https://github.com/gatsbyjs/gatsby-starter-default](https://github.com/gatsbyjs/gatsby-starter-default).

> [_Here you can find a list of all the starters you can use_](https://www.gatsbyjs.org/docs/gatsby-starters/)_._
...
![tThFtYg35ax6YBnuLS9z4y92JYUhdxJZaBaj](https://cdn-media-1.freecodecamp.org/images/tThFtYg35ax6YBnuLS9z4y92JYUhdxJZaBaj)

And here is our Hello World starter in action:

![i-aQLpALPcniL3pkUylOWeoqYCKvnzDHX8Sx](https://cdn-media-1.freecodecamp.org/images/i-aQLpALPcniL3pkUylOWeoqYCKvnzDHX8Sx)
...
![g4uWZNxitB4AAVbqOFmCKKPugS7yrxKYH-ld](https://cdn-media-1.freecodecamp.org/images/g4uWZNxitB4AAVbqOFmCKKPugS7yrxKYH-ld)
...
Depending on the solution you choose, you'll need different steps here, but generally you'll push to a Git repository and let the Git post-commit hooks do the job of deploying. [Here are some great guides for some popular hosting platforms](https://www.gatsbyjs.org/docs/deploying-and-hosting/) where you can deploy Gatsby.
