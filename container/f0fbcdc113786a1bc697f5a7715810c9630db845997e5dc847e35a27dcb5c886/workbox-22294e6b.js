define(["exports"], (function(t) {
    ...
    class R {
        ...
        async cacheMatch(t) {
            ...
            const {
                cacheName: n,
                matchOptions: r
            } = this.u, i = await this.getCacheKey(e, "read"), a = Object.assign(Object.assign({}, r), {
                cacheName: n
            });
    ...
    class v {
        ...
        async v(t, e, n) {
            ...
            try {
                if (r = await this.D(e, t), !r || "error" === r.type) throw new s("no-response", {
                    url: e.url
                })
            } catch (s) {
            ...
            for (const s of t.iterateCallbacks("handlerWillRespond")) r = await s({
                event: n,
                request: e,
                response: r
            });
            ...
            return this.U || (this.U = await
                function(t, e, {
                    ...
                    return n && a.addEventListener("upgradeneeded", (t => {
                        ...
                        i && t.addEventListener("close", (() => i())), r && t.addEventListener("versionchange", (() => r()))
                    })).catch((() => {})), o
    ...
    class F {
        constructor(t, e = {}) {
            this.N = !1, this.O = !1, this.T = e.maxEntries, this.k = e.maxAgeSeconds, this.B = e.matchOptions, this._ = t, this.P = new A(t)
        }
        async expireEntries() {
    ...
    async function H(t, e) {
        try {
            ...
            const r = function(t) {
                    ...
                    if (!e.startsWith("bytes=")) throw new s("unit-must-be-bytes", {
                        normalizedRangeHeader: e
                    });
                    if (e.includes(",")) throw new s("single-range-only", {
                        normalizedRangeHeader: e
                    });
                    const n = /(\d*)-(\d*)/.exec(e);
                    if (!n || !n[1] && !n[2]) throw new s("invalid-range-values", {
                        normalizedRangeHeader: e
                    });
                    return {
                ...
                a = function(t, e, n) {
                    const r = t.size;
                    if (n && n > r || e && e < 0) throw new s("range-not-satisfiable", {
                        size: r,
                        end: n,
                        start: e
                    });
    ...
    class Y extends v {
        constructor(t = {}) {
            t.cacheName = w(t.cacheName), super(t), this.W = !1 !== t.fallbackToNetwork, this.plugins.push(Y.copyRedirectedCacheableResponsesPlugin)
        }
        async D(t, e) {
        ...
        async S(t, e) {
            let n;
            const r = e.params || {};
            if (!this.W) throw new s("missing-precache-entry", {
    ...
    class Z {
        constructor({
            ...
            this.A = new Map, this.F = new Map, this.H = new Map, this.u = new Y({
                cacheName: w(t),
                plugins: [...e, new V({
        ...
        addToCacheList(t) {
            ...
            for (const n of t) {
                ...
                const {
                    cacheKey: t,
                    url: r
                } = z(n), i = "string" != typeof n && n.revision ? "reload" : "default";
                if (this.A.has(r) && this.A.get(r) !== t) throw new s("add-to-cache-list-conflicting-entries", {
