...
((e, t, o) => {
    const n = {
            "popover.content.approval": "We will try not to show you this content anymore.",
    ...
    function b(n) {
        ...
        c && l && TRC.dom.isInIframe(!0) && (c = !1), r.forEach(e => e.className = "trc_popover_aug_container"), [o.userX.mainPopoverContainer] = r, t.body.appendChild(o.userX.mainPopoverContainer), n.cssLiteInject && !n.global["css-isolation"] ? o.dom.aggregateStyles(u(i)) : o.dom.injectStyle(u(i), t), d = TRC.util.parseTimeout(n.global["defer-userx-render"]), o.userX.popover = y(r[2], n), TRC.dom.on(e, "resize", $), s = TRC.translationManager.getLabel({
            feature: "userx"
        }), o.userX.isInitialized = !0, TRC.tlf && console.timeEnd("init userx")
    }

    function f() {
        const {
            mainPopoverContainer: e
        } = o.userX;
        e && e.parentNode && e.parentNode.removeChild(e), o.userX.isInitialized = !1
    }
    ...
    function x(e) {
        if (!e.hasFloatingButton) {
            ...
            n && "static" !== n || (e.style.position = "relative"), o.dom.addClass(r, "trc_user_exclude_btn"), r.setAttribute("title", s["removeBtn.title"]), r.onclick = function(t) {
                D(t, e)
            }.trcBind(e.rbox), e.appendChild(r), o.dom.addClass(a, "trc_exclude_overlay trc_fade"), e.appendChild(a), o.dom.addClass(i, "trc_undo_btn"), i.innerHTML = s["undoBtn.label"], i.onclick = function(t) {
                S(t, e)
            }.trcBind(this), e.appendChild(i), o.dom.addClass(e, "trc_excludable")
        }
    }
    ...
    function y(e) {
        const n = t.createElement("div"),
            r = t.createElement("div");
        return o.dom.addClass(n, "trc_popover trc_popover_fade trc_bottom"), o.dom.addClass(r, "trc_popover_arrow"), n.appendChild(r), e.appendChild(n), o.dom.on(t, "keyup", p), o.dom.on(t, "click", l), o.dom.on(n, "mouseover", I), o.dom.on(n, "mouseout", A), c ? w.renderIFrame(n) : w.renderElement(n), n
    }
    ...
    const w = {
        renderElement: e => {
            e.innerHTML += k(), e.trcContentElement = e.querySelector(".popupContentWrapper"), e.trcContentDoc = t, o.dom.injectStyle(v(), t)
        },
        renderIFrame: e => {
            const t = h(e);
            ...
            try {
                ...
                return void __trcError("User X popup choice failed to render inside an iFrame.", e)
            }
            g(t, T(), () => {
    ...
    function C() {
        const e = "<" + "script>",
            t = "<" + "/script>";
        let o = "";
        return document.domain !== location.hostname && (o += `${e}\n                        document.domain='${document.domain}';\n                     ${t}`), o += `${e}\n                    document.head = document.head || document.getElementsByTagName('head')[0];\n                ${t}`
    }
    ...
    function E(e, t, n) {
        ...
        e = e || r.videoCube, r.anchor && o.dom.removeClass(r.anchor, "trc_anchor"), r.videoCube = e, c && (r.trcContentIFrame.style.height = `${r.trcContentDoc.body.offsetHeight}px`), o.dom.addClass(r, "trc_in"), t = t || e, r.anchor = t, 9 === o.Browser.ie && (r.style.display = "block"), X(), I(), n && (a = new L(W, n)), r.isVisible = !0
    }
    ...
    function W() {
        ...
        o.dom.removeClass(e, "trc_in"), e.anchor && o.dom.removeClass(e.anchor, "trc_anchor"), 9 === o.Browser.ie && (e.style.display = "none"), e.isVisible = !1, I()
    }

    function B(e) {
        const {
            popover: t
        } = o.userX, n = t.trcContentDoc.getElementById("trc_userx_popover_content");
        if (n.innerHTML = "", "string" != typeof e) try {
            n.appendChild(e)
        } catch (t) {
    ...
    function R(e) {
        const {
            popover: t
        } = o.userX, n = t.trcContentDoc.getElementById("trc_userx_popover_title");
        n.innerHTML = e
    }
        ...
        const t = {},
            ...
            r = function(e) {
                ...
                if (window.getComputedStyle) {
                    ...
                    t.left = parseInt(o.borderLeftWidth.slice(0, -2), 10), t.top = parseInt(o.borderTopWidth.slice(0, -2), 10), t.right = parseInt(o.borderRightWidth.slice(0, -2), 10), t.bottom = parseInt(o.borderBottomWidth.slice(0, -2), 10)
                } else t.left = n(e.style.borderLeftWidth), t.top = n(e.style.borderTopWidth), t.right = n(e.style.borderRightWidth), t.bottom = n(e.style.borderBottomWidth);
                return t
            };
        if (t.x = 0, t.y = 0, null !== e)
            if (e.getBoundingClientRect) {
                const n = document.documentElement,
                    ...
                    i = o.Browser.ie,
                    s = i || window.scrollX === n.scrollLeft || void 0 === window.scrollX ? n.scrollLeft : window.scrollX,
                    a = i || window.scrollY === n.scrollTop || void 0 === window.scrollY ? n.scrollTop : window.scrollY;
                ...
                for (; null != i;) {
                    ...
                    if ((o.Browser.firefoxAtleast(3) || o.Browser.chrome) && "td" === e && (s = r(i), t.x += s.left, t.y += s.top), i !== document.body && i !== document.documentElement && (t.x -= i.scrollLeft, t.y -= i.scrollTop), !o.Browser.ie && !o.Browser.opera || o.Browser.ieAtleast(8))
                        for (; i !== n && null !== n;) t.x -= n.scrollLeft, t.y -= n.scrollTop, (o.Browser.firefoxUpto(3) || o.Browser.webkit) && (s = r(n), t.x += s.left, t.y += s.top), n = n.parentNode;
    ...
    function X() {
        const {
            popover: e
        } = o.userX, t = e && e.videoCube && e.videoCube.rbox.findElement(e => e.className.search("trc_popover_arrow") >= 0, e, "div"), n = e && e.anchor;
        let r, i, s;
        n && t && (o.dom.addClass(n, "trc_anchor"), i = (r = z(n)).x - e.offsetWidth + n.offsetWidth / 2 + t.clientLeft + t.offsetWidth / 2 + 1, s = r.y + n.offsetHeight, i < 0 ? (t.style.right = `${q(e,r,t,n)}px`, i = 0) : t.style.right = null, e.style.left = `${i}px`, e.style.top = `${s}px`)
    }
    ...
    function N() {
        ...
        return o.dom.addClass(e, "trc_question_container"), o.Browser.ie && o.dom.addClass(e, "trc_question_container_ie"), n.innerHTML = s["popover.content.questionnaire.tellUsWhy"], o.dom.addClass(n, "trc_question_title"), e.appendChild(n), Object.keys(r).forEach(o => {
            const n = t.createElement("label"),
                i = t.createElement("input");
            i.setAttribute("type", "radio"), i.setAttribute("name", "excludeReason"), i.setAttribute("value", o), i.addEventListener("change", function(e) {
                this.checked = !0, TRC.userX.explainExclude(e, TRC.userX.popover.videoCube, 400)
            });
            const s = t.createElement("span");
            s.innerText = r[o], n.appendChild(i), n.appendChild(s), e.appendChild(n)
        }), e
    }
    ...
    function M(e) {
        const t = e && e.video_data,
            o = {};
        return t ? (o.ii = t && t["item-id"], o.prt = "rc", t["is-syndicated"] && (o.prt = "sc"), t["is-in-network"] && (o.prt = "nt"), t["is-native"] && (o.prt = "nav"), o.p = t.publisher || "", TRC.pageManager.getValue("past-exclusions") && (o.px = TRC.pageManager.getValue("past-exclusions")), o) : (__trcWarn("No video data have been found for user exclude event request params. aborting."), !1)
    }

    function D(e, t) {
        e = e || event;
        const n = M(t);
        return t && "true" === t.getAttribute("data-excluded") || !n ? (__trcDebug("No recommendation to exclude. Not sending exclude event."), o.dom.stopEvent(e)) : (t.rbox.sendEvent("exclude", n, null, !1), H(t), o.dom.stopEvent(e))
    }

    function H(e) {
        const t = e.rbox.findElement(e => e.className.search("trc_undo_btn") >= 0, e, "div"),
            n = e && e.video_data["is-syndicated"] ? s["popover.title.scRemoved"] : s["popover.title.removed"];
        o.userX.popover.videoCube = e, o.pageManager.storeValue("past-exclusions", 1), R(n), B(N()), E(e, t, r), e.setAttribute("data-excluded", "true"), o.dom.addClass(e, "trc_user_excluded")
    }

    function S(e, t) {
        e = e || event;
        const n = M(t);
        return t && t.getAttribute("data-excluded") && n ? (t.rbox.sendEvent("excludeundo", n, null, !1), F(t), o.dom.stopEvent(e)) : (__trcDebug("No recommendation to unexclude. Not sending exclude-undo event."), o.dom.stopEvent(e))
    }

    function F(e) {
        e.removeAttribute("data-excluded"), o.dom.removeClass(e, "trc_user_excluded"), W()
    }

    function U(e, t, o) {
        const n = (e = e || event).target || e.srcElement,
            r = M(t);
        I(), t && t.getAttribute("data-excluded") && r ? (r.xr = n.getAttribute("value"), t.rbox.sendEvent("excludeexplain", r, null, !1)) : __trcDebug("No recommendation exclude to explain. Not sending exclude-explain event."), o ? setTimeout(() => {
            P()
        }, o) : P()
    }
    ...
    function P() {
        const {
            popover: e
        } = o.userX, t = o.Browser.ieUpto(9) ? 0 : 250;
        W(), o.dom.addClass(e.anchor, "trc_anchor"), setTimeout(() => {
            R(s["popover.title.thankYou"]), B(s["popover.content.approval"]), E(e.videoCube, e.anchor, i)
        }, t)
    }
    o.userX = {
        init: b,
